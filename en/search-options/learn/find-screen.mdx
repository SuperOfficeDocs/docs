...
keywords: ['typical search', 'search criteria', 'OR function']
...
1. <SelectField />
    ...
    First click **Sale** (<i class="ph ph-currency-circle-dollar" aria-hidden="true"></i>), and then **Amount**.
...
1. <SelectField />
    ...
    First click **Sale**, and then **Registered date**.
...
1. <SelectField />
    ...
    First click <i class="ph ph-buildings" aria-hidden="true"></i> **Company** , and then **Country**.
...
1. <SelectField />
    ...
    First click **Company**, and then **Our contact**.
...
1. <SelectField />
    ...
    First click **Sale**, and then **Status**.
...
1. <SelectField />
    ...
    First click <i class="ph ph-user-circle" aria-hidden="true"></i> **Contact**, and then **Last name**.
...
1. <SelectField />
    ...
    First click <i class="ph ph-clipboard-text" aria-hidden="true"></i> **Project**, and then **From date**.
...
1. <SelectField />
    ...
    First click <i class="ph ph-calendar-blank" aria-hidden="true"></i> **Follow-up**, and then **Intention**.
...
1. <SelectField />
    ...
    First click **Follow-up**, and then **End date**.
...
1. <SelectField />
    ...
    First click **Follow-up**, and then **Completed**.
