...
related:
  ...
  - /en/learn/basics/history
  - Create a search and save it as a selection: /en/search-options/selection/learn/create
  - Broaden your search using the OR function: /en/search-options/learn/find-screen
language: en
---
...
## Use typical searches as a starting point {#typical}
...
## Create a search and save it as a selection {#search-to-selection}
...
<Frame caption="Watch this video or follow the steps below to learn how you can create a search and save it as a dynamic selection (video length - 1:26)">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/b1YsCcHwz-o"
    title="Watch this video or follow the steps below to learn how you can create a search and save it as a dynamic selection (video length - 1:26)"
    frameborder="0"
...
[2]: /en/search-options/learn/freetext-search
[3]: /en/search-options/learn/in-navigator
[6]: /en/search-options/learn/search-criteria
[8]: /en/search-options/learn/in-dialogs
