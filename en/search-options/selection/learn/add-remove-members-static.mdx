...
sidebarTitle: "Add/remove static members"
...
related:
  - /en/search-options/selection/learn/copy-members-to
  - Perform tasks using selections: /en/learn/getting-started/index
language: en
---
...
## Remove members using search criteria {#remove}
