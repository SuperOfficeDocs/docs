...
keywords: ['dynamic selection', 'static selection', 'combined selection', 'selection member', 'Selection screen', 'selection']
author: digitaldiina
date: 06.10.2026
so_version: 12.0
...
related:
  - Add selection as a favorite: /en/learn/basics/fav
  - /en/search-options/selection/learn/create
  - Edit and delete selections: /en/search-options/selection/learn/update
  - /en/search-options/selection/learn/howto/index
  - Display selections as charts: /en/search-options/selection/learn/howto/display-as-charts
language: en
---
...
### Filtering the list of members {#filter}
...
## Examples of how you can use selections {#ex}
...
[3]: /en/search-options/selection/learn/howto/display-as-charts
[6]: /en/search-options/selection/learn/howto/export
[8]: /en/search-options/selection/learn/howto/create-mailings
[4]: /en/search-options/selection/learn/combine
[7]: /en/search-options/selection/learn/add-remove-members-static
[9]: /en/search-options/learn/search-criteria
[10]: /en/learn/section-tabs/configure-columns#calculate
[12]: /en/learn/section-tabs/filter
[16]: /en/dashboard/learn/create
