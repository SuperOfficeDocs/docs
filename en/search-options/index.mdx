...
<Columns cols={4}>
<Card title="Search options (in the UI)" icon="book" href="./learn/index">
  <span className="card-label">Reference</span>
</Card>

<Card title="User guide for selections" icon="book" href="./selection/learn/index">
  <span className="card-label">Reference</span>
</Card>

<Card title="Template variables" icon="book" href="../document/templates/variables/for-selections">
  <span className="card-label">Reference</span>
</Card>
...
<ul className="concept-links">
  <li><Icon icon="graduation-cap" /> <a href="./learn/index">How to search for information</a></li>
  <li><Icon icon="graduation-cap" /> <a href="./learn/index">How to use a typical search</a></li>
  <li><Icon icon="graduation-cap" /> <a href="./selection/learn/create">How to create a search and save it as a selection</a></li>
  <li><Icon icon="graduation-cap" /> <a href="./learn/find-screen">How to broaden a search using the "OR" function</a></li>
</ul>
...
<ul className="concept-links">
  <li><Icon icon="book" /> <a href="../admin/user-preferences/reference/freetext">User preference for free-text search</a></li>
  <li><Icon icon="list" /> <a href="../admin/options/learn/freetext-search/enable">Enable free-text search</a></li>
  <li><Icon icon="list" /> <a href="../admin/options/learn/freetext-search/configure">Specify search criteria</a></li>
  <li><Icon icon="list" /> <a href="../admin/options/learn/freetext-search/stopwords">Stopwords</a></li>
</ul>
...
<ul className="concept-links">
  <li><Icon icon="map" /> <a href="../customization/web-panels/admin/index">Web panels</a></li>
  <li><Icon icon="compass" /> <a href="../customization/soprotocol/index">SoProtocol</a></li>
</ul>
...
<ul className="concept-links">
  <li><Icon icon="map" /> <a href="../custom-objects/overview">Custom fields</a></li>
