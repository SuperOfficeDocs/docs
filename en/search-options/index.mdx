...
<Card title="Selection table" icon="book" href="../database/tables/selection">
  <span className="card-label">Reference</span>
</Card>
...
<ul className="concept-links">
  ...
  <li><Icon icon="graduation-cap" /> <a href="/en/search-options/learn/index.html">How to use a typical search</a></li>
  <li><Icon icon="graduation-cap" /> <a href="selection/learn/create">How to create a search and save it as a selection</a></li>
  <li><Icon icon="graduation-cap" /> <a href="/en/search-options/learn/find-screen.html">How to broaden a search using the "OR" function</a></li>
</ul>
...
<ul className="concept-links">
  ...
  <li><Icon icon="list" /> <a href="/en/admin/options/learn/freetext-search/regenerate-index">Regenerate the free-text index</a></li>
</ul>
