...
keywords: ['do not allow overwrite', 'overwrite', 'do not show in forms']
author: digitaldiina
date: 05.04.2026
so_version: 11.13
content_type: howto
...
userflow_index: true
related:
  - /en/marketing/forms/learn/field-options
  - Create a form: /en/marketing/forms/learn/create
  - /en/marketing/forms/admin/manage-fonts
language: en
---
