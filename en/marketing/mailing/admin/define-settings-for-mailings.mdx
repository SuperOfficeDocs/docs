...
keywords: ['Marketing', 'mailing', 'sms']
...
import MailingSmtpFields from "../../learn/snippets/mailing-smtp-fields.md";
import MailingSettingsSms from "../../learn/snippets/mailing-settings-sms.md";
...
For information about additional connectors, see [SMS][1].
