...
keywords: ['marketing automation', 'flow setting']
...
related:
  - Move, duplicate, or remove step: /en/marketing/flows/learn/update
  - /en/marketing/flows/learn/define-flow-actions
  - Split flow: /en/marketing/flows/learn/split
  - Start flow: /en/marketing/flows/learn/run-pause-end
language: en
---
...
## Define flow start trigger and filters {#trigger}
