...
## 1. Enable UTM data transfer {#enable}
...
## 2. Add the UTM tracking script to your website {#script}
...
## 3. Create UTM-tagged campaign links {#build-url}
...
## 4. Apply the tagged URL in your campaigns {#tag}
...
## 5. Publish your form correctly {#publish}
...
## 6. Test and verify the setup {#test}
...
## 7. Analyze and visualize results {#analyze}
