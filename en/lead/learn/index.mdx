...
keywords: ['lead status', 'potential customer', 'qualification', 'mql', 'sales process']
author: digitaldiina
date: 10.01.2026
so_version: 12.5
...
boost: 1.5
related:
  - /en/lead/learn/work-with-leads
  - /en/marketing/utm/learn/index
  - Set up lead management - in Settings and maintenance: /en/lead/admin/index
  - Configure company categories: /en/lead/admin/add-company-category
...
## Potential customer categories {#category}
