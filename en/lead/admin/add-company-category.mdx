...
keywords: ['lead status', 'potential customer', 'list']
author: digitaldiina
date: 01.13.2026
so_version: 11.8
content_type: howto
...
userflow_index: true
related:
  - Potential customer categories: /en/lead/learn/index
  - Enable lead status for company categories: /en/lead/admin/index
  - /en/lead/admin/add-lead-status
  - Automate lead categorization: /en/admin/lists/user-group-filtering
  - /en/admin/lists/user-group-filtering
language: en
---
