...
keywords: ['screen layout', 'change layout', 'delete layout', 'Reset to factory settings']
author: digitaldiina
date: 06.10.2026
so_version: 12.0
content_type: howto
...
userflow_index: true
related:
  - /en/customization/screen-designer/admin/working-with-archives
language: en
---
