...
keywords: ['new layout', 'screen layout', 'Assign layouts to']
author: digitaldiina
date: 06.10.2026
so_version: 12.0
content_type: howto
...
userflow_index: true
related:
  - How do I configure what information the users of our company can access in SuperOffice CRM?: /en/admin/user-management/role/index
  - How do I create a new User Group in SuperOffice CRM?: /en/admin/user-management/user-groups
  - Delete layout: /en/customization/screen-designer/admin/edit-layout#delete
language: en
---
