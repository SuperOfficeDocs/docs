...
keywords: ['layout', 'UI', 'customization', 'configurable screen']
author: digitaldiina
date: 06.10.2026
so_version: 12.0
...
userflow_index: true
related:
  - Add a layout: /en/customization/screen-designer/admin/add-layout
  - Edit layout - Main cards: /en/customization/screen-designer/admin/edit-layout
  - /en/customization/screen-designer/admin/working-with-fields
  - Working with archives (section tabs): /en/customization/screen-designer/admin/working-with-archives
language: en
---
