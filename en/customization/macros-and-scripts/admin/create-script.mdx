...
userflow_index: true
related:
  - About CRMScript: /en/automation/crmscript/index
  - Debug scripts: /en/automation/crmscript/debugging/built-in-debugger
  - Trace scripts: /en/automation/crmscript/debugging/using-trace
language: en
---
...
## Macro/script folder properties {#folder}
