...
Each request to the *default.aspx* page invokes the PageBuilder framework and uses SuperState to determine which panels, cards, views, and controls are shown.
...
Panels have child elements called **cards**, which have child elements called **views**, which have child elements called **controls**, and so on. Page configurations are detailed in the Web client page configuration section.
...
**SoProtocol** has everything needed to perform the necessary calculations that determine what, and what not, to update in the UI. Callback requests arrive as SoProtocol containing querystring key-value parameters. A module called **SoProtocolModule** parses SoProtocol strings and updates current SuperState changes with the parameters in the last request.
...
[4]: ./change-page-config

[img1]: /media/loc/en/ui/web-client-page-framework.png
[img2]: /media/loc/en/ui/web-client-pagebuilder-framework2-1.png
[img3]: /media/loc/en/ui/web-client-filter-engine.png
[img4]: /media/loc/en/ui/web-client-merge-file-process.png
[img5]: /media/loc/en/ui/web-client-page-builder-process.png
[img6]: /media/loc/en/ui/config-lifecycle.png
