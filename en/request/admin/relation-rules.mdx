...
keywords: ['request relation', 'parent-child', 'relation rule', 'automation', 'close request', 'Relation rules tab']
author: digitaldiina
date: 04.08.2026
so_version: 11.12
content_type: howto
...
related:
  ...
  - Request types: /en/request/admin/type/index
language: en
---
...
[3]: ../../customization/screen-designer/admin/index
