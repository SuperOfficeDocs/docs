...
keywords: ['link requests', 'parent request', 'child request', 'related requests', 'Add relation']
author: digitaldiina
date: 06.10.2026
so_version: 12.0
content_type: howto
...
related:
  - Split request: /en/request/learn/split-request
  - /en/request/learn/merge
  - Requests section tab: /en/learn/section-tabs/requests-tab
  - Company and contact relations: /en/learn/basics/relations
  - Relation rules (Settings and maintenance): /en/request/admin/relation-rules
language: en
---
...
## Remove request relation {#delete}
