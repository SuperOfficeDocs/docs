...
keywords: ['reply to request', 'reply all', 'add message', 'add comment', 'comment', 'internal', 'external']
author: digitaldiina
date: 17.09.2026
so_version: 12.4
content_type: howto
...
1. Preview a request from a request list.
1. Click <i class="ph ph-arrow-bend-up-left" aria-label="Reply"></i> or <i class="ph ph-arrow-bend-double-up-left" aria-label="Reply all"></i>.
...
The request updates, including its status, exactly as it would from a reply sent in the full request view, and the list refreshes automatically.

<Tip>
If you cancel or select another request while your reply has unsent text, you are asked before it is discarded.
</Tip>

This option is not offered on requests marked as spam, deleted, or merged.
