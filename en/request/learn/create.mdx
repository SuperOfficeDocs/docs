...
keywords: ['add request', 'new request', 'request properties', 'request details', 'message', 'ticket']
author: digitaldiina
date: 06.10.2026
so_version: 12.0
content_type: howto
...
related:
  ...
  - /en/request/learn/tags
  - Reply template variables: /en/knowledge-base/learn/reply-templates/template-variables
  - Create reply template: /en/knowledge-base/learn/reply-templates/index
  - /en/request/learn/request-relations
language: en
---
