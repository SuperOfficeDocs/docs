...
keywords: ['locate request', 'last requests', 'own open requests', 'unassigned requests', 'show only own categories', 'search']
author: digitaldiina
date: 17.09.2026
so_version: 12.4
content_type: howto
...
related:
  - Use tags in requests: /en/request/learn/tags
  - /en/search-options/learn/find-screen
  - Use the Navigator search: /en/learn/getting-started/main-screen/navigator#navigator
  - Create selection: /en/search-options/selection/learn/create
language: en
---
...
This section of the screen displays the contents of the request selected under **Search result**. You have the same options as when [processing requests][6], including sending a [quick reply][20] without opening the request in full.

If the preview section is not visible, click **Show preview** at the bottom of the screen.

[6]: ./accept
[9]: ../admin/next-in-queue
[10]: ../../search-options/selection/learn/index
[11]: ../../search-options/learn/find-screen
[12]: ../../search-options/learn/freetext-search
[13]: ../../search-options/selection/learn/create
[14]: ../../search-options/learn/search-criteria
[18]: ../../dashboard/learn/index
[19]: ../../learn/getting-started/main-screen/navigator#navigator
[20]: ./reply#quick-reply
