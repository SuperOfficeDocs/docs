...
title: Automatic assignment methods for requests
sidebarTitle: "Automatic assignment methods"
description: Assignment methods for requests
keywords: ['assignment method', 'assign request', 'request']
author: digitaldiina
date: 06.10.2026
so_version: 12.0
content_type: howto
...
related:
  - Process a request: /en/request/learn/index
  - /en/request/learn/create
  - Accept a request: /en/request/learn/accept
  - Ask another request handler for help (transfer): /en/request/learn/transfer
  - /en/request/admin/next-in-queue
  - Availability status: /en/request/learn/index#available
language: en
---
