...
keywords: ['new reply template', 'copy reply template', 'reply template properties']
author: digitaldiina
date: 06.10.2026
so_version: 12.0
content_type: howto
...
redirect_from:
  - /en/request/reply-templates/learn/copy
  - /en/request/reply-templates/learn/create
related:
