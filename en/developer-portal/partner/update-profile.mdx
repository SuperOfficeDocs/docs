...
keywords: ['Developer Portal', 'profile image', 'user profile', 'user']
...
platform: web
related:
  - Update partner logo: /en/developer-portal/standard-app/app-store/update-partner-profile
  - Add or change app icon: /en/developer-portal/standard-app/app-store/images-and-videos
---
