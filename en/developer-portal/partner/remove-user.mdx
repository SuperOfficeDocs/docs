...
keywords: ['Developer Portal', 'access']
...
platform: web
related:
  - Delete a user in SuperOffice Settings and maintenance: /en/admin/user-management/update-user#delete
...
[1]: ./manage-technical-contacts
[img1]: /media/loc/en/developer-portal/reassign-technical.png
[img2]: /media/loc/en/developer-portal/reassign-admin.png
[img3]: /media/loc/en/developer-portal/reassign-partner-and-app.png
