...
import NoteClearToReplace from "./snippets/note-clear-to-replace.mdx";
import DefAppCredentials from "../../snippets/def-app-credentials.md";
import GoToAppPage from "../../snippets/go-to-app-page.md";
import NoteExpiration from "./snippets/note-expiration.mdx";
import ReadyToPublish from "../snippets/ready-to-publish.md";
