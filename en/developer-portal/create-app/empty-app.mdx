...
title: Register a blank app config
...
import CustAppReqLicense from "./snippets/cust-app-req-license.md";
import NoteAppName from "./snippets/note-app-name.mdx";
import SetTechnicalContact from "./snippets/set-technical-contact.md";
