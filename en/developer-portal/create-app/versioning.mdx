...
All applications start in SuperOffice Online Development (SOD) and might eventually go live (via our stage environment). <WhatToPublish />
...
[img1]: /media/loc/en/developer-portal/app-versions-2.png
[img2]: /media/loc/en/developer-portal/more-versions.png
