...
If you use an AI coding assistant such as Claude Code or Cursor to build your app, install the SuperOffice CRM skill for up-to-date, agent-ready context.
