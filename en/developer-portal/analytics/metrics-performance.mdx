...
title: Check application API performance
description: How to check the API performance for your application.
keywords: ['API metrics', 'metered services']
...
import DefMetrics from "./snippets/def-metrics.md";
import GoToAppPage from "../snippets/go-to-app-page.md";
import ImprovePerformance from "./snippets/improve-performance.md";
...
[img1]: /media/loc/en/developer-portal/metrics-performance-landing.png
[img2]: /media/loc/en/developer-portal/metrics-performance-selected-row.png
[img3]: /media/loc/en/developer-portal/metrics-performance-selected-sample.png
[img4]: /media/loc/en/developer-portal/metrics-disable-sampling.png
