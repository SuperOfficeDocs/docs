...
import NoteUsersCollection from "../../partner/snippets/note-users-collection.mdx";
...
[2]: ./images-and-videos
[7]: ./prices-and-terms
[8]: ./user-guide#how-to-install
[9]: ./user-guide#links
[3]: ../../create-app/versioning
[4]: ../../create-app/request-to-publish
[5]: ../requirements/marketing#application-description
[6]: https://www.charactercountonline.com
[10]: https://appstore-sod.superoffice.com/
[11]: ./app-settings

[img1]: /media/loc/en/developer-portal/app-store-listing.png
[img3]: /media/loc/en/developer-portal/warn-mandatory-missing.png
[img4]: /media/loc/en/developer-portal/warn-no-links.png
[img2]: /media/loc/en/developer-portal/request-to-publish.png
[img5]: /media/loc/en/developer-portal/error-reporting-emails.png
