...
title: About Telenor Cyberdefence initial security evaluation
sidebarTitle: "Initial security evaluation"
description: About Telenor Cyberdefence initial security evaluation
keywords: ['Combitech', 'Watchcom', 'certification']
...
[2]: ../../getting-started/index#terminology
[3]: ../../getting-started/app-envir
[4]: ./certify-app
[5]: ../app-store/update-app-page
[6]: ../publish
