...
> "Working with Watchcom and SuperOffice to certify Visma.net Sync for SuperOffice gave an interesting perspective on security, and some valuable lessons on how to tighten the security of your web application."
>
> **Ole Melhus, ON IT AS**
