...
import SecurityChecklist from "../snippets/security-checklist.md";
import ExplicitConsent from "../snippets/explicit-consent.md";
import ProtectWebpanels from "../snippets/protect-webpanels.md";
import UsecForbiddenOnline from "../../../snippets/usec-forbidden-online.mdx";
import ProtectDatabase from "../snippets/protect-database.mdx";
