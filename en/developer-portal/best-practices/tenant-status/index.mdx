...
keywords: ['monitor', 'State Change URL', 'state API', 'availability']
...
## Receive tenant status (Push) {#notify}
...
[1]: /en/developer-portal/best-practices/tenant-status/check-status
[2]: /en/developer-portal/best-practices/tenant-status/get-notifications
[3]: /en/developer-portal/best-practices/tenant-status/check-status#state
[4]: /en/developer-portal/best-practices/tenant-status/get-notifications#payload
