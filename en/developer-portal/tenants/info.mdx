...
deployment: online
related:
  - Check tenant status via State API: /en/developer-portal/best-practices/tenant-status/check-status
  - Licenses in Settings and maintenance: /en/admin/license/index
---
