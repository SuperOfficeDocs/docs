...
keywords: ['quote template', 'template', 'quote document', 'quote details', 'merge field']
...
related:
  - Update quote template: /en/document/templates/admin/update-template
  - Tutorial: /en/document/templates/admin/tutorial
  - /en/document/templates/merge-fields/index
  - Template variable reference: /en/document/templates/variables/for-quote-line
  - System.Globalization.CultureInfo: https://docs.microsoft.com/en-us/dotnet/api/system.globalization.cultureinfo?view=net-5.0
  - Aspose (handles document generation): http://www.aspose.com
language: en
---
...
## Types of quote document templates {#types}
...
### Structure of merge fields {#structure}
...
### Formatting numeric and date data {#culture}
