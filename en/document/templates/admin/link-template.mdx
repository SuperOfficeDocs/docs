...
<Frame caption="Watch this video or follow the guided steps below to learn how you can add a document template (video length - 2:30)">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/FnhcmjP-TgE"
    title="Watch this video or follow the guided steps below to learn how you can add a document template (video length - 2:30)"
    frameborder="0"
