...
keywords: ['document', 'edit mode', 'read mode', 'completed', 'document properties', 'document content', 'SharePoint', 'download']
author: digitaldiina
date: 18.09.2026
so_version: 12.2
content_type: howto
...
Downloading a document saves a copy of the document file to your device.

1. Click the **Task** button (<i class="ph ph-dots-three-circle-vertical" aria-hidden="true"></i>) in the **Document** dialog.
2. Choose **Download**.

![Download the email or document from Task button -screenshot][img6]

<Tip>
You can also download a document directly from the [Activities section tab][4] by right-clicking it and choosing **Download**.
</Tip>
