...
keywords: ['SharePoint', 'upload document', 'online text-editing']
...
related:
  - /en/document/learn/edit
  - /en/document/learn/lock
  - Save email attachment to SuperOffice: /integrations/mail-link/archive
  - Send email attachments from SuperOffice: /en/document/learn/send-as-email
  - Manage document templates in Settings and maintenance: /en/document/templates/admin/link-template
language: en
---
...
## How to enter information {#fields}
