...
import Searchcriterion from "./includes/searchcriterion.md";
...
|SearchCriteriaGroup\_id|Owning group|FK [SearchCriteriaGroup](./searchcriteriagroup)| |
...
|operatorId|Operator ID|Enum [CriterionOperator](./enums/criterionoperator)| |
|linkType|Link type, AND or OR|Enum [CriterionLinkType](./enums/criterionlinktype)| |
