...
|SearchCriteriaGroup\_id|Owning group|FK [SearchCriteriaGroup](./searchcriteriagroup)|No|
...
|operatorId|Operator ID|Enum [CriterionOperator](./enums/criterionoperator)|No|
|linkType|Link type, AND or OR|Enum [CriterionLinkType](./enums/criterionlinktype)|No|
