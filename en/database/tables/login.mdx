...
|user\_id|The id of the user this entry references.|FK [ejuser](./ejuser)|No|
...
|flags|Bitmask of flags for a service login session|Enum [LoginFlags](./enums/loginflags)|Yes|
