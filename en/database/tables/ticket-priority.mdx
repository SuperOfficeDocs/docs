...
|status|The status (normal/deleted) of the priority.|Enum [TicketPriorityStatus](./enums/ticketprioritystatus)|Yes|
|flags|A bitmask of flags.|Enum [TicketPriorityFlags](./enums/ticketpriorityflags)|Yes|
...
|ticket\_read|This field indicates what to do with the escalation chain when the request is read|Enum [TicketPriorityEscalateEvent](./enums/ticketpriorityescalateevent)|Yes|
|changed\_owner|This field indicates what to do with the escalation chain when the request changes owner (manually)|Enum [TicketPriorityEscalateEvent](./enums/ticketpriorityescalateevent)|Yes|
|ticket\_newinfo|This field indicates what to do with the escalation chain when the request gets new info|Enum [TicketPriorityEscalateEvent](./enums/ticketpriorityescalateevent)|Yes|
|ticket\_closed|This field indicates what to do with the escalation chain when the request is closed|Enum [TicketPriorityEscalateEvent](./enums/ticketpriorityescalateevent)|Yes|
|ticket\_changed\_priority|This field indicates what to do with the escalation chain when the request is changed into this priority|Enum [TicketPriorityEscalateEvent](./enums/ticketpriorityescalateevent)|Yes|
|ticket\_new|This field indicates what to do with the escalation chain when a new request is registered|Enum [TicketPriorityEscalateEvent](./enums/ticketpriorityescalateevent)|No|
