...
import Contactinterest from "./includes/contactinterest.md";
...
|contact\_id|Owning contact|FK [contact](./contact)| |
|cinterest\_idx|Contact interest link|FK [ContInt](./contint)| |
