...
import Dashboard from "./includes/dashboard.md";
...
|associate\_id|Associate who owns this dashboard|FK [associate](./associate)|&#x25CF;|
|name|The name of this dashboard|String(4000)|&#x25CF;|
|description|Detailed description|String(4000)|&#x25CF;|
|dashboard\_theme\_id|The theme belongs to set of slyle rules for the dashboard|FK [dashboard_theme](./dashboard-theme)|&#x25CF;|
