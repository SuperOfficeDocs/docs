...
import Recurrencerule from "./includes/recurrencerule.md";
...
|pattern|Recurrence pattern (daily, weekly etc)|Enum [RecurrencePattern](./enums/recurrencepattern)| |
|subPattern|Subpattern (workday, everyday, weekday etc)|Enum [RecurrenceSubPattern](./enums/recurrencesubpattern)| |
