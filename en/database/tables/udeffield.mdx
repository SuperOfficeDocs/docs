...
|lastVersionId|UDefFieldId this field had in the previous version, 0 = field is new in this version|FK [UDefField](./udeffield.mdx)|Yes|
...
|justification|Justification - 0 = default, left, right, center|Enum [UdefJustification](./enums/udefjustification.mdx)|Yes|
