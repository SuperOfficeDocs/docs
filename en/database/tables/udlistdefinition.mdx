...
import Udlistdefinition from "./includes/udlistdefinition.mdx";
...
|------|-------------|------|:----:|
|UDListDefinition\_id|Primary key|PK|No|
...
|listTableId|The table ID of the list table that this record contains the name of|TableNumber|No|
...
![UDListDefinition table relationship diagram](/media/loc/en/database/tables/UDListDefinition.png)
