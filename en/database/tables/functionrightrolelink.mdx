...
import Functionrightrolelink from "./includes/functionrightrolelink.md";
...
|roleId|Role id|FK [Role](./role)| |
|functionRightId|Functional right id|FK [FunctionRight](./functionright)| |
