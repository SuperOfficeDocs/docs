...
import Quoteversionattachment from "./includes/quoteversionattachment.mdx";
...
|QuoteVersionId|Link to QuoteVersion|FK [QuoteVersion](./quoteversion)|No|
...
![QuoteVersionAttachment table relationship diagram](/media/loc/en/database/tables/QuoteVersionAttachment.png)
