...
|QuoteVersionId|The version that owns this alternative (the chain is Sale 1-&gt;1 Quote 1-&gt;+ QuoteVersion 1-&gt;+ QuoteAlternative.|FK [QuoteVersion](./quoteversion.mdx)|No|
