...
import Dataright from "./includes/dataright.md";
...
|roleId|Role this dataright is valid for|FK [Role](./role)| |
...
|relationToOwner|How is the owner related to the target -  0 = Owner, 1 = Primary group, 2 = Other, 3 = Other group, 4 = External, 5 = Anonymous, 6 = My company, 7 = Same project, 8 = Other to external, 9 = Hide this relation (used with ShownOtherCompanyAssoc functional right)|Enum [RelationToOwner](./enums/relationtoowner)| |
