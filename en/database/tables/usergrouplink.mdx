...
import Usergrouplink from "./includes/usergrouplink.md";
...
|assoc\_id|Link to associate|FK [associate](./associate)| |
|UserGroup\_id|Link to group|FK [UserGroup](./usergroup)| |
