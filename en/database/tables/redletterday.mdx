...
import Redletterday from "./includes/redletterday.md";
...
|country\_id|Which country does this red letter day belong to. It will show up in the diary for associates with this country as homecountry.|FK [country](./country)| |
