...
import Ejpackage from "./includes/ejpackage.md";
...
|attachment\_id|The attachment.id for the attachment containing the xml|FK [attachment](./attachment)| |
|uploaded\_at|Time of upload of this package|DateTime|&#x25CF;|
|uploaded\_by|Uploaded by|FK [ejuser](./ejuser)| |
