...
|mail\_in\_filter|A reference to the id of the mail box|FK [mail_in_filter](./mail-in-filter)|No|
|locking\_id|A reference to the id of lock|FK [locking](./locking)|No|
