...
import Amountclass from "./includes/amountclass.md";
...
|currencyId|Currency the limits in this amount class refer to. Mixing currencies between classes can give rise to overlapping intervals and thus unpredictable classifications.|FK [Currency](./currency)|&#x25CF;|
