...
import Taskmenu from "./includes/taskmenu.md";
...
|taskType|Type of task item Url, SoProtocol or CRMScript.|Enum [TaskListItemType](./enums/tasklistitemtype)|&#x25CF;|
|crmScript\_id|The CRMScript or Macro which will be run task item is selected.|FK [ejscript](./ejscript)|&#x25CF;|
|showInClient|Show task list item in which clients (web, mobile)|Enum [ShowTaskItemInClient](./enums/showtaskiteminclient)|&#x25CF;|
|archiveBehaviour|None, rightclick on, multiselect|Enum [ArchiveBehaviour](./enums/archivebehaviour)|&#x25CF;|
...
|encoding|Encoding for url|Enum [UrlEncoding](./enums/urlencoding)|&#x25CF;|
