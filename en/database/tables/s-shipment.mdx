...
import SShipment from "./includes/s-shipment.md";
...
|status|Sending/stopped/failed etc.|Enum [ShipmentStatus](./enums/shipmentstatus)| |
...
|selection\_id|Set if this shipment should be related to a Selection|FK [selection](./selection)|&#x25CF;|
|project\_id|Set if this shipment should be related to a Project|FK [project](./project)|&#x25CF;|
|generated\_document\_id|ID of the merged document that is the result of the shipment|FK [document](./document)|&#x25CF;|
...
|sorting|Which sorting should be used on the document mailing recipient list, used when generating PDF|Enum [RecipientSorting](./enums/recipientsorting)| |
...
|shipmenttype\_id|Id of subscriptionType that this shipment has, so we may check for reservations|FK [ShipmentType](./shipmenttype)|&#x25CF;|
