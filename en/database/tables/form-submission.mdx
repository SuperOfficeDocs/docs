...
import FormSubmission from "./includes/form-submission.mdx";
...
|form\_id|The id of the parent form.|FK [form](./form)|No|
|when\_submitted|The time of the submit.|DateTime|Yes|
|contact\_id|The optional id of the contact of the person who submitted.|FK [contact](./contact)|No|
|person\_id|The optional id of the person who submitted.|FK [person](./person)|No|
|email\_address|The email address of the person who submitted|String(255)|Yes|
|response\_shipment\_addr\_id|The id of the s_shipment_addr that is the response mail|FK [s_shipment_addr](./s-shipment-addr)|No|
|response|The JSON-formatted response from this form|Clob|Yes|
|status|What is the status of this submission|Enum [FormSubmissionStatus](./enums/formsubmissionstatus)|No|
