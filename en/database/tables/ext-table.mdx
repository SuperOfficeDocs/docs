...
|ext\_datasource|The reference to the associated datasource.|FK [ext_datasource](./ext-datasource)|Yes|
|parent\_table|The reference to the parent table.|FK [ext_table](./ext-table)|Yes|
|child\_table|The reference to the child table.|FK [ext_table](./ext-table)|Yes|
