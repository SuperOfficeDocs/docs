...
import ExtTable from "./includes/ext-table.md";
...
|ext\_datasource|The reference to the associated datasource.|FK [ext_datasource](./ext-datasource)|&#x25CF;|
|parent\_table|The reference to the parent table.|FK [ext_table](./ext-table)|&#x25CF;|
|child\_table|The reference to the child table.|FK [ext_table](./ext-table)|&#x25CF;|
