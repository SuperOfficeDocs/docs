...
import EmailItem from "./includes/email-item.md";
...
|flags|Email flags - answered, deleted, seen, flagged, draft, recent...|Enum [EMailFlags](./enums/emailflags)|&#x25CF;|
|email\_folder\_id|Folder this email is in on the imap server|FK [email_folder](./email-folder)|&#x25CF;|
|mime|Mime text|Clob|&#x25CF;|
...
|priority|Email priority|Enum [EMailPriority](./enums/emailpriority)|&#x25CF;|
...
|person\_id|From person|FK [person](./person)|&#x25CF;|
|contact\_id|From company|FK [contact](./contact)|&#x25CF;|
|document\_id|Archived document|FK [document](./document)|&#x25CF;|
|appointment\_id|Archived on appointment|FK [appointment](./appointment)|&#x25CF;|
|sale\_id|Archived on sale|FK [sale](./sale)|&#x25CF;|
