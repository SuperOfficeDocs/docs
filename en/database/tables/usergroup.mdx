...
import Usergroup from "./includes/usergroup.mdx";
...
|------|-------------|------|:----:|
|UserGroup\_id|Primary key|PK|No|
|name|UserGroup name|String(239)|No|
...
|type|0 = department, other values = ? (workgroup, role, …)|UShort|Yes|
...
![UserGroup table relationship diagram](/media/loc/en/database/tables/UserGroup.png)
