...
import WebhookNotify from "./includes/webhook-notify.md";
...
|webhook\_id|The webhook that this notification is for|FK [Webhook](./webhook)| |
|associate\_id|Associate to notify. If set, email_recipient is ignored.|FK [associate](./associate)|&#x25CF;|
