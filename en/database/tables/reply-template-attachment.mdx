...
|entry\_id|The id of the reply_template this entry is connected to.|FK [reply_template](./reply-template)|No|
|attachment\_id|The id of the attachment this entry is connected to.|FK [attachment](./attachment)|No|
