...
import Ejselection from "./includes/ejselection.mdx";
...
|creator|The user who created this selection|FK [ejuser](./ejuser)|No|
|last\_count|Last result count|Int|Yes|
|result\_config|XML data|Clob|Yes|


![ejselection table relationship diagram](/media/loc/en/database/tables/ejselection.png)
