...
import MsFilterMail from "./includes/ms-filter-mail.md";
...
|mail\_sorter\_id|The reference to the mail filter entry.|FK [ms_filter](./ms-filter)| |
|mail\_in\_filter\_id|The reference to the mailbox.|FK [mail_in_filter](./mail-in-filter)| |
