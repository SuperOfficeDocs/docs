...
import Heading from "./includes/heading.mdx";
...
|------|-------------|------|:----:|
|heading\_id|Primary key|PK|No|
|name|The visible heading|String(239)|No|
...
|listTableId|Which List is this heading connected to? (table ID)|TableNumber|No|
|extraId|Extra ID for refining the list id|Id|Yes|
...
![Heading table relationship diagram](/media/loc/en/database/tables/Heading.png)
