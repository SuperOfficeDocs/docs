...
import ScriptTraceRun from "./includes/script-trace-run.md";
...
|script\_trace\_id|Id of parent script_trace record|FK [script_trace](./script-trace)|&#x25CF;|
...
|associate\_id|Associate who the script was executed as|FK [associate](./associate)|&#x25CF;|
