...
|script\_trace\_id|Id of parent script_trace record|FK [script_trace](./script-trace)|Yes|
...
|associate\_id|Associate who the script was executed as|FK [associate](./associate)|Yes|
