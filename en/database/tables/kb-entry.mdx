...
|category\_id|The id of the category in which this entry is located.|FK [kb_category](./kb-category)|No|
...
|created\_by|The id of the user who owns this entry.|FK [ejuser](./ejuser)|Yes|
...
|workflow\_phase|The workflow phase this entry is in|FK [kb_workflow](./kb-workflow)|No|
