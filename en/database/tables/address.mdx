...
import Address from "./includes/address.md";
...
|atype\_idx|Bit mask, combines address type (EAddressType) and owner type (EOwnerType)|Enum [AddressType](./enums/addresstype)| |
