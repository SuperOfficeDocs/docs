...
import Address from "./includes/address.mdx";
...
|atype\_idx|Bit mask, combines address type (EAddressType) and owner type (EOwnerType)|Enum [AddressType](./enums/addresstype)|No|
...
![address table relationship diagram](/media/loc/en/database/tables/address.png)
