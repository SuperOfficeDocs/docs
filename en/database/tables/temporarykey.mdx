...
import Temporarykey from "./includes/temporarykey.md";
...
|domain|The domain this is a key for|Enum [TemporaryKeyDomain](./enums/temporarykeydomain)| |
|target\_id|The primary key in the table this is a key for|Int|&#x25CF;|
|person\_id|The person this is a key for|FK [person](./person)|&#x25CF;|
