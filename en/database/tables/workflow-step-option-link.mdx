...
import WorkflowStepOptionLink from "./includes/workflow-step-option-link.md";
...
|workflow\_step\_option\_id|The workflow step option to connect to|FK [workflow_step_option](./workflow-step-option)|&#x25CF;|
|workflow\_step\_id|A workflow step connected to the option|FK [workflow_step](./workflow-step)|&#x25CF;|
