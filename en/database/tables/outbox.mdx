...
|ticket\_id|The ticket.id this reference is connected to.|FK [ticket](./ticket)|Yes|
|message\_id|The message.id this reference is connected to.|FK [ej_message](./ej-message)|Yes|
