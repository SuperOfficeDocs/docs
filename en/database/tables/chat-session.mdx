...
import ChatSession from "./includes/chat-session.md";
...
|customer\_id|The reference to the associated customer. May be NULL or -1.|FK [person](./person)| |
|customer\_alias|The alias for the customer.|String(64)|&#x25CF;|
|status|Enum indicating the status for the session (pending, active, closed, etc).|Enum [ChatSessionStatus](./enums/chatsessionstatus)|&#x25CF;|
...
|flags|Various flags for the chat session|Enum [ChatSessionFlags](./enums/chatsessionflags)|&#x25CF;|
|project\_id|The project that this chat session is connected to|FK [project](./project)|&#x25CF;|
|sale\_id|The sale that this chat session is connected to|FK [sale](./sale)|&#x25CF;|
|ticket\_id|The ticket that this chat session is connected to|FK [ticket](./ticket)|&#x25CF;|
|contact\_id|The contact that this chat session is connected to|FK [contact](./contact)|&#x25CF;|
|transfer\_to|The ejuser that has a pending transfer of the chat session|FK [ejuser](./ejuser)|&#x25CF;|
