...
import DocDocument from "./includes/doc-document.md";
...
|folder\_id|The id of the document folder this entry is located in.|FK [doc_folder](./doc-folder)| |
|attachment\_id|The attachment.id for the attachment associated with this document.|FK [attachment](./attachment)| |
