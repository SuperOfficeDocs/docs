...
import Configurablescreendelta from "./includes/configurablescreendelta.md";
...
|deltaType|Type of delta lik webpanel, but also system, customized.|Enum [DeltaType](./enums/deltatype)|&#x25CF;|
...
|deltaState|State of the delta, like draft or published|Enum [DeltaState](./enums/deltastate)|&#x25CF;|
