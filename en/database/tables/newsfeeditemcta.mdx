...
import Newsfeeditemcta from "./includes/newsfeeditemcta.md";
...
|newsfeeditem\_id|Foreign key to NewsFeedItem that this description belongs to.|FK [NewsFeedItem](./newsfeeditem)| |
...
|CtaType|The type of the CTA, which determines how the CTA button renders. Primary/Secondary/Link|Enum [CtaType](./enums/ctatype)| |
|CtaFlavor|The flavor of the CTA, which determines the style the CTA button renders its type. Info/Warning/Error/Accept/Reject|Enum [CtaFlavor](./enums/ctaflavor)| |
