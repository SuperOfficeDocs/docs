...
import Freetextindex from "./includes/freetextindex.md";
...
|freetextwords\_id|Reference to word|FK [freetextwords](./freetextwords)| |
...
|contact\_id|Set for contacts and person records to allow cross-table free-text searches. 0 for non-contact, non-person|FK [contact](./contact)| |
