...
import BoardViewSettings from "./includes/board-view-settings.md";
...
|selection\_id|The selection this board view settings belongs to|FK [selection](./selection)|&#x25CF;|
|associate\_id|The associate this board view settings belongs to (0 for all)|FK [associate](./associate)|&#x25CF;|
|entity\_type|The kind of board view entity these settings belong to|Enum [BoardViewEntityType](./enums/boardviewentitytype)|&#x25CF;|
