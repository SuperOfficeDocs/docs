...
|reldef\_id|Reference to definition|FK [relationdefinition](./relationdefinition)|No|
...
|group\_idx|User group owning this relation|FK [UserGroup](./usergroup)|Yes|
...
|associateId|Owner of this relation record|FK [associate](./associate)|No|
