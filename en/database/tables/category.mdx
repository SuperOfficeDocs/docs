...
import Category from "./includes/category.mdx";
...
|CategoryFamily\_id|Optional link to family, for grouping things like multiple kinds of customer category under family &apos;customer&apos;|FK [CategoryFamily](./categoryfamily)|Yes|
|category\_group|Category group|Enum [CategoryGroup](./enums/categorygroup)|Yes|
|enable\_lead\_status|Enable lead status qualification for categorygroup potential customers|Bool|Yes|


![Category table relationship diagram](/media/loc/en/database/tables/Category.png)
