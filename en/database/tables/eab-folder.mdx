...
import EabFolder from "./includes/eab-folder.md";
...
|folder\_id|The id of the parent folder for this folder. NULL or -1 if this is a toplevel folder.|FK [eab_folder](./eab-folder)| |
