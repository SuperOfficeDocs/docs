...
|language\_id|The reference to the associated customer language.|FK [cust_lang](./cust-lang)|Yes|
|category\_id|The reference to the associated category.|FK [ej_category](./ej-category)|Yes|
|parent\_id|The parent category for this cust_category. -1 if this is a toplevel cust_category.|FK [cust_category](./cust-category)|Yes|
