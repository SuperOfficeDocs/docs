...
|currency\_id|Default currency for this country|FK [Currency](./currency)|Yes|
...
|tzLocationId|Default timezone location for this country|FK [TZLocation](./tzlocation)|Yes|
