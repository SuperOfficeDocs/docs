...
|status|The &amp;apos;classic&amp;apos; ticket status. I.e. active/closed/postponed/deleted|Enum [TicketBaseStatus](./enums/ticketbasestatus)|No|
|ts\_rank|Sort order|Int|No|
|name|Name of user defined ticket status|String(255)|No|
|time\_counter|Which field in ticket we count time spent on (queue, internal, external) |Enum [TicketStatusTimeCounter](./enums/ticketstatustimecounter)|Yes|
