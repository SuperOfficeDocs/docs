...
|landing\_page\_id|The landing page this pin belongs to|FK [landing_page](./landing-page)|No|
...
|tab\_type|What kind of content the tab shows (selection, entity record, or a hardcoded provider)|Enum [LandingPageTabType](./enums/landingpagetabtype)|No|
