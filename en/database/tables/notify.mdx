...
|category\_id|The category involed in this notification|FK [ej_category](./ej-category.mdx)|Yes|
|chat\_topic\_id|Chat topic involed in this notification|FK [chat_topic](./chat-topic.mdx)|Yes|
|chat\_nick\_name|Chat customer nick name in this notification|String(255)|Yes|
|ticket\_alert\_id|Ticket alert used when tickets are escalated|FK [ticket_alert](./ticket-alert.mdx)|Yes|
