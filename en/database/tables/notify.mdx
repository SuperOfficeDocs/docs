...
import Notify from "./includes/notify.mdx";
...
|user\_id|The id of the user who should be notified.|FK [ejuser](./ejuser)|No|
|owner\_id|The id of the user who is the original owner of this notification.|FK [ejuser](./ejuser)|No|
|ticket\_id|The id of the ticket this notification message affects.|FK [ticket](./ticket)|No|
|user2\_id|A second user involved in this notification|FK [ejuser](./ejuser)|Yes|
|category\_id|The category involed in this notification|FK [ej_category](./ej-category)|Yes|
|chat\_topic\_id|Chat topic involed in this notification|FK [chat_topic](./chat-topic)|Yes|
|chat\_nick\_name|Chat customer nick name in this notification|String(255)|Yes|
|ticket\_alert\_id|Ticket alert used when tickets are escalated|FK [ticket_alert](./ticket-alert)|Yes|
|custom\_message|Text for custom notify messages|String(255)|Yes|
|contact\_id|Id of the assigned contact|FK [contact](./contact)|Yes|
|person\_id|Id of the assigned person|FK [person](./person)|Yes|
...
![notify table relationship diagram](/media/loc/en/database/tables/notify.png)
