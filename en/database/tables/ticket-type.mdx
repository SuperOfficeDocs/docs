...
|default\_status|Default ticket status for new tickets|FK [ticket_status](./ticket-status)|Yes|
|default\_priority|Default ticket priority for new tickets|FK [ticket_priority](./ticket-priority)|Yes|
|reply\_template|Reply template to use when replying to a ticket of this type|FK [reply_template](./reply-template)|Yes|
