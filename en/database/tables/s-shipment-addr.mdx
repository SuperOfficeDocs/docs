...
|shipment\_id|Which shipment this address belongs to|FK [s_shipment](./s-shipment)|No|
...
|customer\_id|Id of the customer if this entry is created by a dynamic list|FK [person](./person)|No|
...
|ticket\_id|Id of the ticket if this entry is created by a ticketSelection list|FK [ticket](./ticket)|No|
|status|Status for sending to this particular recipient|Enum [ShipmentAddrStatus](./enums/shipmentaddrstatus)|Yes|
|contact\_id|Id of contact bound to shipment address|FK [contact](./contact)|Yes|
...
|form\_submission\_id|If this mailing recipient is created from a form submission, this will contain a reference to that submission|FK [form_submission](./form-submission)|Yes|
...
|workflow\_step\_id|The row was created by this workflow step|FK [workflow_step](./workflow-step)|Yes|
|workflow\_instance\_id|The row was created by this workflow instance|FK [workflow_instance](./workflow-instance)|Yes|
