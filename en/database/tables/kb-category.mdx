...
|parent\_id|This entry contains a reference to the parent category. NULL or -1 if this is a toplevel category.|FK [kb_category](./kb-category)|No|
...
|created\_by|The id of the user who created this category.|FK [ejuser](./ejuser)|Yes|
