...
|durationUnit|Units for the duration (day, week, whatever)|Enum [DurationUnit](./enums/durationunit.mdx)|Yes|
...
|saleTypeCat\_id|Category of sale type, copied to sale|FK [SaleTypeCat](./saletypecat.mdx)|Yes|
...
|quoteLinesTemplate|The template that this sale type should use when producing the product lines offer document; the template must have DocTmplQuoteType=QuoteLines|FK [DocTmpl](./doctmpl.mdx)|Yes|
...
|confirmationLinesTemplate|The template that this sale type should use when producing the order confirmation lines document; the template must have DocTmplQuoteType=ConfirmationLines|FK [DocTmpl](./doctmpl.mdx)|Yes|
