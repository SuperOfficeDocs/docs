...
import Saletype from "./includes/saletype.md";
...
|durationUnit|Units for the duration (day, week, whatever)|Enum [DurationUnit](./enums/durationunit)|&#x25CF;|
...
|saleTypeCat\_id|Category of sale type, copied to sale|FK [SaleTypeCat](./saletypecat)|&#x25CF;|
...
|quoteLinesTemplate|The template that this sale type should use when producing the product lines offer document; the template must have DocTmplQuoteType=QuoteLines|FK [DocTmpl](./doctmpl)|&#x25CF;|
...
|confirmationLinesTemplate|The template that this sale type should use when producing the order confirmation lines document; the template must have DocTmplQuoteType=ConfirmationLines|FK [DocTmpl](./doctmpl)|&#x25CF;|
