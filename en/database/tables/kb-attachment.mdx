...
|entry\_id|The id of the corresponding kb_entry.|FK [kb_entry](./kb-entry)|No|
|attachment\_id|The id of the corresponding kb_category.|FK [attachment](./attachment)|No|
