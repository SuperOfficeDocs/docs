...
|message\_id|The message.id this invoice entry is connected to.|FK [ej_message](./ej-message)|No|
|description|A description of the invoice entry|String(255)|Yes|
|type|The type of this invoice entry|FK [invoice_type](./invoice-type)|No|
