...
|type|Type of event|Enum [TrlogTransType](./enums/trlogtranstype)|No|
|associate\_id|Who did it|FK [associate](./associate)|No|
|tablenumber|Table that was updated|TableNumber|No|
|record\_id|Record that was updated|RecordId|No|
|flags|Extra information about the operation, as a bit-masked field|Enum [TtlFlags](./enums/ttlflags)|Yes|
