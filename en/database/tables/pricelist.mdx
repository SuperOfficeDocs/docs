...
|QuoteConnectionId|(Reserved for future use) The connection to the ERP system used for this pricelist|FK [QuoteConnection](./quoteconnection)|Yes|
...
|CurrencyId|What is the currency for this pricelist|FK [Currency](./currency)|Yes|
