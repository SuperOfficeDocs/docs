...
import Pricelist from "./includes/pricelist.md";
...
|QuoteConnectionId|(Reserved for future use) The connection to the ERP system used for this pricelist|FK [QuoteConnection](./quoteconnection)|&#x25CF;|
...
|CurrencyId|What is the currency for this pricelist|FK [Currency](./currency)|&#x25CF;|
