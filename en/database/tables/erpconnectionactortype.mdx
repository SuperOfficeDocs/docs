...
import Erpconnectionactortype from "./includes/erpconnectionactortype.md";
...
|ErpConnectionId|The connection this actor is configured for|FK [ErpConnection](./erpconnection)| |
|ActorTypeErp|The actor type (ERP side)|Enum [ErpActorType](./enums/erpactortype)| |
|ActorTypeCrm|The actor type (CRM side)|Enum [CrmActorType](./enums/crmactortype)|&#x25CF;|
