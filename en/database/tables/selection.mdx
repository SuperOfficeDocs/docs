...
|associate\_id|Associate who owns the selection|FK [associate](./associate)|No|
|group\_idx|Original primary user group of associate|FK [UserGroup](./usergroup)|No|
|name|Name, freetext indexed|String(219)|No|
|text\_id|Description text|FK [text](./text)|Yes|
|postitText\_Id|Postit text|FK [text](./text)|Yes|
...
|searchCat\_id|Search category (list)|FK [SearchCat](./searchcat)|Yes|
...
|combinationType|How should the inputs of a combined selection be combined|Enum [SelectionUnionType](./enums/selectionuniontype)|Yes|
|leftSelectionId|ID of the left selection of a combined selection|FK [selection](./selection)|Yes|
|rightSelectionId|ID of the right selection of a combined selection|FK [selection](./selection)|Yes|
|dashboard\_tile\_definition\_id|The associated tile definition|FK [dashboard_tile_definition](./dashboard-tile-definition)|Yes|
|SystemType|Selection system type - defines if this selection is one that is managed by the system, and what kind it is|Enum [SelectionSystemType](./enums/selectionsystemtype)|Yes|
...
|lastLoadedBy|Who last loaded this selection|FK [associate](./associate)|Yes|
...
|lastMembershipChangeBy|Who last changed the membership|FK [associate](./associate)|Yes|
