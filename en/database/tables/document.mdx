...
|application\_id|Application this document was made with|FK [ExtApp](./extapp)|No|
...
|text\_id|Pointer to optional long description|FK [text](./text)|Yes|
...
|appointment\_id|points back to owning appointment|FK [appointment](./appointment)|Yes|
...
|userdef\_id|User-defined fields|FK [uddocsmall](./uddocsmall)|Yes|
|userdef2\_id|User-defined fields|FK [uddoclarge](./uddoclarge)|Yes|
