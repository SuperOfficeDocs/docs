...
import Userpreference from "./includes/userpreference.md";
...
|deflevel|The level: 0=hard default, 1=systemwide, 2=database, 3=group, 4=individual|Enum [PreferenceLevel](./enums/preferencelevel)| |
|maxlevel|Highest override level allowed|Enum [PreferenceLevel](./enums/preferencelevel)| |
