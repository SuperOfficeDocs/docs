...
|textId|Extra information (descriptive) for this Criteria set|FK [text](./text)|Yes|
|ownerType|Selection, Reporter, FindProject, ...|Enum [OwnerType](./enums/ownertype)|Yes|
