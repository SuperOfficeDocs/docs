...
import Audiencelayoutlink from "./includes/audiencelayoutlink.md";
...
|audienceLayoutId|The name of the installed instance of Audience - must match the web.config file|FK [AudienceLayout](./audiencelayout)| |
