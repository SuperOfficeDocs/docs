...
import EjpackageItem from "./includes/ejpackage-item.md";
...
|------|-------------|------|:----:|
|id|Primary key|PK| |
|ejpackage|The id of the package for which this item belongs|FK [ejpackage](./ejpackage)| |
...
|parent\_id|The parent for this package item link. -1 if this is a toplevel item link.|FK [ejpackage_item](./ejpackage-item)| |
