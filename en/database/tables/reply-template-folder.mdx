...
import ReplyTemplateFolder from "./includes/reply-template-folder.md";
...
|parent\_id|The id of the parent folder of this folder. NULL or -1 of this is a toplevel folder.|FK [reply_template_folder](./reply-template-folder)| |
