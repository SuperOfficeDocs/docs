...
import Tzdstrule from "./includes/tzdstrule.md";
...
|TZLocationId|Location that this rule is valid for - one location may have one or more rules; multiple rules are discerned by their validFrom dates|FK [TZLocation](./tzlocation)| |
