...
import Quote from "./includes/quote.md";
...
|SaleId|The foreign key to the corresponding sale|FK [sale](./sale)|&#x25CF;|
|QuoteConnectionId|The connection in the CRM system to where this quote came from. Identifies the ERP connection used for this quote. Each quote is bound to one and only one connection.|FK [QuoteConnection](./quoteconnection)|&#x25CF;|
...
|ActiveQuoteVersionId|The primary key of the Quote Version that is currently active. (The active version will always be the latest version.)|FK [QuoteVersion](./quoteversion)|&#x25CF;|
|AcceptedQuoteAlternativeId|The primary key of the Quote Alternative which was finally accepted by the customer. Set when the user is marking a quote as accepted.|FK [QuoteAlternative](./quotealternative)|&#x25CF;|
...
|DocumentId|The ID of the main Quote Document|FK [document](./document)|&#x25CF;|
