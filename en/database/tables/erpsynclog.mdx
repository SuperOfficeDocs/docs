...
import Erpsynclog from "./includes/erpsynclog.md";
...
|ErpExternalKeyId|Link to the external key, indirectly also to the connection and internal key|FK [ErpExternalKey](./erpexternalkey)|&#x25CF;|
