...
|workflow\_id|The workflow this emailflow belongs to|FK [workflow](./workflow)|Yes|
|shipment\_type\_id|Mailing type (subscription type)|FK [ShipmentType](./shipmenttype)|Yes|
...
|hierarchy\_id|This email flow is inside that hierarchy folder|FK [hierarchy](./hierarchy)|No|
...
|selected\_days|Selected days (flags, so several days can be selected) for time frame|Enum [Weekday](./enums/weekday)|Yes|
...
|from\_type|Email/Mailing From field address algorithm|Enum [EmailFromType](./enums/emailfromtype)|Yes|
|reply\_to\_type|Email/Mailing Reply-To field address algorithm|Enum [EmailReplyToType](./enums/emailreplytotype)|Yes|
|reply\_to\_name|Email Reply-To name|String(255)|Yes|
|main\_message\_id|The main email message, used for thumbnail creation|FK [s_message](./s-message)|Yes|
