...
import Foreignkey from "./includes/foreignkey.mdx";
...
|foreigndevice\_id|Reference to device definition|FK [foreigndevice](./foreigndevice)|No|
...
![foreignkey table relationship diagram](/media/loc/en/database/tables/foreignkey.png)
