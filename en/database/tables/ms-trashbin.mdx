...
import MsTrashbin from "./includes/ms-trashbin.md";
...
|mail\_sorter\_id|The id of the filter which sent this email to the trashbin.|FK [ms_filter](./ms-filter)| |
|mail\_in\_filter\_id|The id of the mailbox from which this email came.|FK [mail_in_filter](./mail-in-filter)| |
