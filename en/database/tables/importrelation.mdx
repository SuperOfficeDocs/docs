...
import Importrelation from "./includes/importrelation.md";
...
|source|The dependent object (source of relation edge)|FK [ImportObject](./importobject)| |
|target|The primary object (target of relation edge)|FK [ImportObject](./importobject)| |
