...
import ReplyTemplate from "./includes/reply-template.md";
...
|folder\_id|The id of the folder in which this reply template is located. NULL or -1 if this is a toplevel reply template.|FK [reply_template_folder](./reply-template-folder)| |
|owned\_by|The id of the user who owns this reply template.|FK [ejuser](./ejuser)|&#x25CF;|
