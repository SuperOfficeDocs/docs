...
import Text from "./includes/text.mdx";
...
|type|Text type, enum that specifies owning table and role|Enum [TextType](./enums/texttype)|Yes|
...
![text table relationship diagram](/media/loc/en/database/tables/text.png)
