...
import UtmParameters from "./includes/utm-parameters.md";

# utm\_parameters Table (547)
...
|created\_person\_id|Id of the created person|FK [person](./person)|&#x25CF;|
|created\_contact\_id|Id of the created contact|FK [contact](./contact)|&#x25CF;|
|form\_submission\_id|Id of formsubmission|FK [form_submission](./form-submission)|&#x25CF;|
