...
|hierarchy\_id|The script is inside this hierarchy folder|FK [hierarchy](./hierarchy)|No|
...
|extra\_menus\_id|Optional id of related extra menu pointing to this script|FK [extra_menus](./extra-menus)|Yes|
...
|type|The type/language of this script|Enum [ScriptType](./enums/scripttype)|No|
...
|blocked\_verbs|The verbs that are blocked when calling a ejscript over HTTP|Enum [EjScriptVerb](./enums/ejscriptverb)|No|
