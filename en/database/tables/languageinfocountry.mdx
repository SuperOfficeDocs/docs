...
import Languageinfocountry from "./includes/languageinfocountry.md";
...
|languageId|Key to language|FK [LanguageInfo](./languageinfo)| |
|countryId|Key to country|FK [country](./country)| |
|percentage|Percentage of Country that speaks Language, 0 means we don&apos;t know|Short| |
|official|1: This is an official language; 2: it&apos;s not; 0: We don&apos;t know|Enum [OfficialLanguage](./enums/officiallanguage)| |
