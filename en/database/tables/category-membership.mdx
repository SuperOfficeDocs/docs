...
import CategoryMembership from "./includes/category-membership.md";
...
|category\_id|The reference to the category.|FK [ej_category](./ej-category)| |
|user\_id|The reference to the ej user.|FK [ejuser](./ejuser)| |
