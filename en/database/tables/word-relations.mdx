...
|entry\_word\_id|A reference to the id of the word|FK [kb_entry_words](./kb-entry-words)|No|
|entry\_id|A reference to the id of the entry|FK [kb_entry](./kb-entry)|No|
