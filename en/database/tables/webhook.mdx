...
import Webhook from "./includes/webhook.md";
...
|state|Webhook status - should we post events to the URL? 1=Active, 2=Stopped or 3=TooManyErrors|Enum [WebhookState](./enums/webhookstate)| |
...
|notify\_via|How to notify recipients when this webhook changes state. 1=Email, 2=InApp.|Enum [WebhookNotifyVia](./enums/webhooknotifyvia)| |
|notify\_when|When to notify recipients. Bitflag: 1=FirstFailure, 2=Disabling.|Enum [WebhookNotifyWhen](./enums/webhooknotifywhen)| |
