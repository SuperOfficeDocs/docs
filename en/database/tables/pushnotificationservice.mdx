...
import Pushnotificationservice from "./includes/pushnotificationservice.md";
...
|AssociateId|To whom does this handle belong|FK [associate](./associate)| |
...
|DevicePlatform|Device platform. Apple, Google, Microsoft, etc.|Enum [NotificationPlatform](./enums/notificationplatform)| |
