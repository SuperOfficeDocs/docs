...
import TargetChange from "./includes/target-change.md";
...
|target\_revision\_id|The revision history changeset this change belongs to|FK [target_revision](./target-revision)|&#x25CF;|
