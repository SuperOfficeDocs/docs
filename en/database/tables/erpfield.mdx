...
import Erpfield from "./includes/erpfield.md";
...
|ErpConnectionActorTypeId|Link to Erp Connection/Actor type|FK [ErpConnectionActorType](./erpconnectionactortype)| |
...
|FieldType|Field type|Enum [FieldMetadataType](./enums/fieldmetadatatype)|&#x25CF;|
...
|Access|Access restrictions for the field|Enum [FieldAccess](./enums/fieldaccess)|&#x25CF;|
