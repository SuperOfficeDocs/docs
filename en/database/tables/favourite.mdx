...
import Favourite from "./includes/favourite.md";
...
|associate\_id|The user who has marked this favourited|FK [associate](./associate)|&#x25CF;|
|extra\_info|Optional extra information|String(254)|&#x25CF;|
|registered|Registered datetime|DateTime|&#x25CF;|
|registered\_by|Registered by whom|FK [associate](./associate)|&#x25CF;|
|Rank|Rank order|Int|&#x25CF;|
