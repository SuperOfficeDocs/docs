...
import LandingPagePin from "./includes/landing-page-pin.md";
...
|landing\_page\_id|The landing page this pin belongs to|FK [landing_page](./landing-page)| |
...
![landing_page_pin table relationship diagram](/media/loc/en/database/tables/landing_page_pin.png)
