...
|status|Status: 1 = open, 2 = sold, 3 = lost, 4 = stalled|Enum [SaleStatus](./enums/salestatus.mdx)|Yes|
...
|created\_by\_workflow\_id|The workflow this sale was created by|FK [workflow](./workflow.mdx)|Yes|
