...
import SMessage from "./includes/s-message.md";
...
|flags|Identifies if HTML or plain message is included in message.|Enum [ShipmentMessageType](./enums/shipmentmessagetype)| |
...
|document\_message|The SM document used as template for this mailing|FK [document](./document)|&#x25CF;|
...
|designtype|Enum containing the type of the design|Enum [DesignType](./enums/designtype)| |
