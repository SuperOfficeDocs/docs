...
|flags|Identifies if HTML or plain message is included in message.|Enum [ShipmentMessageType](./enums/shipmentmessagetype)|No|
...
|document\_message|The SM document used as template for this mailing|FK [document](./document)|Yes|
...
|designtype|Enum containing the type of the design|Enum [DesignType](./enums/designtype)|No|
