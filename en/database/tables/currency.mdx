...
import Currency from "./includes/currency.mdx";
...
|------|-------------|------|:----:|
|Currency\_id|Primary key|PK|No|
...
|rate|Exchange rate|Double|No|
|units|Exchange unit scale (0.01, 0.1, 1, 10, 100 etc)|Double|No|
...
|isoCode|ISO currency code, see http://www.xe.com/iso4217.php|String(9)|Yes|


![Currency table relationship diagram](/media/loc/en/database/tables/Currency.png)
