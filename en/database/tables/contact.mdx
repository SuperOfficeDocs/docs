...
import Contact from "./includes/contact.md";
...
|associate\_id|Our contact|FK [associate](./associate)|&#x25CF;|
|country\_id|Country|FK [country](./country)| |
|business\_idx|Link to Business|FK [Business](./business)| |
|category\_idx|Link to Category|FK [Category](./category)| |
...
|text\_id|Paperclip note|FK [text](./text)|&#x25CF;|
|mother\_id|Reserved|FK [contact](./contact)|&#x25CF;|
|userdef\_id|User defined table record 1|FK [udcontactSmall](./udcontactsmall)|&#x25CF;|
...
|userdef2\_id|User defined table record 2|FK [udcontactLarge](./udcontactlarge)|&#x25CF;|
...
|group\_id|Group id of original owning associate, semantics like appnt.grp_id|FK [UserGroup](./usergroup)|&#x25CF;|
|tzLocationId|Default timezone location for this contact|FK [TZLocation](./tzlocation)|&#x25CF;|
...
|supportPersonId|The person (at the customer) who support talks to (the counterpart of supportAssociateId)|FK [person](./person)|&#x25CF;|
