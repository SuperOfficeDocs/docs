...
import EjselEjsel from "./includes/ejsel-ejsel.md";
...
|------|-------------|------|:----:|
|id|Primary key|PK| |
|parent|The id of the selection for which this item is a source|FK [ejselection](./ejselection)| |
|child|The id of the child item selection|FK [ejselection](./ejselection)| |
