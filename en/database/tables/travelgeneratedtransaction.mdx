...
import Travelgeneratedtransaction from "./includes/travelgeneratedtransaction.md";
...
|tranlogfirst\_id|This up/dwnfile holds transaction from traveltransactionlog_id = this number|FK [traveltransactionlog](./traveltransactionlog)|&#x25CF;|
|tranloglast\_id|This up/dwnfile holds transaction to traveltransactionlog_id = this number|FK [traveltransactionlog](./traveltransactionlog)|&#x25CF;|
