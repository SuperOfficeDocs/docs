...
import Udprojectlarge from "./includes/udprojectlarge.mdx";
...
|------|-------------|------|:----:|
|udprojectLarge\_id|Primary key|PK|No|
...
![udprojectLarge table relationship diagram](/media/loc/en/database/tables/udprojectLarge.png)
