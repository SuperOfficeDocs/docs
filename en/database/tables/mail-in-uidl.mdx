...
import MailInUidl from "./includes/mail-in-uidl.mdx";
...
|filter\_id|The mailbox for this UIDL entry.|FK [mail_in_filter](./mail-in-filter.mdx)|No|
...
![mail_in_uidl table relationship diagram](/media/loc/en/database/tables/mail_in_uidl.png)
