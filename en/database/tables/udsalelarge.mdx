...
import Udsalelarge from "./includes/udsalelarge.mdx";
...
|------|-------------|------|:----:|
|udsalelarge\_id|Primary key|PK|No|
...
![udsalelarge table relationship diagram](/media/loc/en/database/tables/udsalelarge.png)
