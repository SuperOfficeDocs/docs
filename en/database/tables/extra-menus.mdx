...
|extra\_table|ExtraTable that the menu is connected to|FK [extra_tables](./extra-tables)|Yes|
|group\_id|Link to extra_menus table if this menu item is to be shown in a custom menu group|FK [extra_menus](./extra-menus)|Yes|
