...
import ElementProfile from "./includes/element-profile.md";
...
|screen\_definition\_element|The id of the screen_definition_element.|FK [screen_definition_element](./screen-definition-element)| |
...
|owned\_by\_user|The id of the user.|FK [ejuser](./ejuser)| |
