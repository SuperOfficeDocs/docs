...
|list\_id|Reference to the list|FK [s_list](./s-list)|No|
|shipment\_id|Reference to the shipment|FK [s_shipment](./s-shipment)|No|
|type|Indicates if this is a static/dynamic spmlist or a selection|Int|Yes|
|status|Status of shipment list|Enum [ShipmentListStatus](./enums/shipmentliststatus)|Yes|
