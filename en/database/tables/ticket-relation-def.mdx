...
import TicketRelationDef from "./includes/ticket-relation-def.md";
...
|relation\_type|Type of the relation (Related, Parent, Child)|Enum [TicketRelationType](./enums/ticketrelationtype)| |
