...
import Batchtask from "./includes/batchtask.md";
...
|BatchTaskDefinition\_id|Batch task definition, which is populated from code attributes|FK [BatchTaskDefinition](./batchtaskdefinition)|&#x25CF;|
