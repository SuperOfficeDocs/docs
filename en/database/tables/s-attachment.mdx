...
import SAttachment from "./includes/s-attachment.md";
...
|------|-------------|------|:----:|
|id|Primary key|PK| |
|attachment\_id|The id of the attachment|FK [attachment](./attachment)| |
|message\_id|The id of the message|FK [s_message](./s-message)| |
