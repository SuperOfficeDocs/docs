...
keywords: ['update follow-up', 'extend meeting', 'shorten meeting', 'change only this instance', 'delete follow-up', 'cancel meeting', 'diary', 'appointment', 'meeting', 'task', 'to-do', 'call', 'phone', 'invitation']
author: digitaldiina
date: 03.27.2026
so_version: 11.11
content_type: howto
...
related:
  ...
  - Stop repeating follow-ups: /en/diary/learn/recurrence/stop
  - Add link to document, sale, project, or website: /en/learn/basics/links
language: en
---
...
## Change the end time for a follow-up in the Diary {#change-end}
...
## Edit repeating follow-up {#repeat}
...
## Delete follow-up using the Diary {#delete}
