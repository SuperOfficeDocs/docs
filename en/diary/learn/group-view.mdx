...
keywords: ['add group view', 'new group view', 'edit group view', 'View tab', 'diary', 'follow-up']
...
related:
  - Learn about the View tab: /en/diary/learn/index#tabs
  - Create follow-up for associate: /en/diary/learn/create-follow-up#associate
language: en
---
...
### Why is the Edit option unavailable? {#troubleshoot}
