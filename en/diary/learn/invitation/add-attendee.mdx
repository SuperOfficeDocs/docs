...
keywords: ['invite contact', 'invite associate', 'add attendee', 'add resource', 'meeting', 'invitation', 'participant', 'attendee', 'diary']
author: digitaldiina
date: 03.27.2026
so_version: 11.11
content_type: howto
...
related:
  - Create a follow-up: /en/diary/learn/create-follow-up
  - Join a video meeting: /en/diary/learn/video-meetings
language: en
---
...
### Scheduling assistant {#availability}
...
### Preview and update invitation email {#preview}
