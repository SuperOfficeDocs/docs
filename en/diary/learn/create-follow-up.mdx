...
keywords: ['new follow-up', 'book meeting', 'schedule meeting', 'add to-do', 'add call', 'appointment', 'meeting', 'task', 'to-do', 'call', 'phone', 'diary']
...
related:
  - Follow-up types: /en/diary/learn/follow-ups
  - /en/learn/basics/activity
  - Create a video meeting from the SuperOffice diary: /en/diary/learn/video-meetings
language: en
---
...
### Create meeting for an associate {#associate}
...
## Copy a follow-up to the Diary {#copy}
...
[3]: ./set-alarm
[4]: ./recurrence/index
[5]: ./invitation/add-attendee
[8]: ../../learn/getting-started/preferences
[9]: ../../localization/learn/time-zones
