...
author: digitaldiina
date: 01.07.2022
keywords: ['automation', 'API', 'integration point', 'scripting', 'Jscript', 'Javascript']
...
import AutomationIntro from "./snippets/automation-intro.md";
...
## Script language options by platform {#languages}
...
[3]: ../ui/blogic/extra-menus
[4]: ../ui/blogic/button-scripts
[5]: ../ui/blogic/screen-events
