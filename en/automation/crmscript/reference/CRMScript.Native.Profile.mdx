...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String)[] - Information about a user's profile for the list-tickets tables in a SearchEngine- and DataTable-friendly way.
