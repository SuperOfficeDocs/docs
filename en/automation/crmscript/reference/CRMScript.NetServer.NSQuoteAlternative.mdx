...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - The tool-tip to use in the user interface (on the tab, for instance).
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - The discount the sales rep specifies, in whatever currency the sale is in.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - The discount the sales rep specifies, in percent. '12%' is represented as '12'.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Earning on this alternative, as an absolute amount.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - The earning on this alternative, in percent of total. The Percentage is given in integer form, '12%' is represented as '12'.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - The discount the system calculates based on customer /amount / whatever.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - The discount the system calculates based on customer /amount / whatever. The Percentage is given in integer form, '12%' is represented as '12'.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - Key that identifies this alternative in the ERP system, if it exists there.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - Name of Alternative. Shown in tab in user interface, intentionally kept short.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - The version that owns this alternative (the chain is Sale 1-&gt;1 Quote 1-&gt;+ QuoteVersion 1-&gt;+ QuoteAlternative.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Value to help the user interface, is computed by summing the total price of the quote lines, and NOT by summing their subtotals.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Sum of the QuoteLines.TotalPrice, AlternativeDiscount or QuoteLines.TotalCost + Earning based on what, if anything, the user has entered last. Shall be calculated by the connector.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Tax/VAT, THIS IS AN AMOUNT, available as a merge field in the quote document.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - Extra info about VAT that the connector might insert.
