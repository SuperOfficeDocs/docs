...
**Returns:** [CRMScript.NetServer.NSTimeZoneData](/en/automation/crmscript/reference/CRMScript.NetServer.NSTimeZoneData)
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - Custom data for Pocket, in JSON format.
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - Is push notification configured and enabled in Netserver.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Number of new invitations.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Number of overdue sales for current user.
...
**Returns:** [CRMScript.NetServer.NSPreference](/en/automation/crmscript/reference/CRMScript.NetServer.NSPreference)[] - All Pocket specific preferences, including WebPanels defined by the user in Pocket.
...
**Returns:** [CRMScript.NetServer.NSWebPanelEntity](/en/automation/crmscript/reference/CRMScript.NetServer.NSWebPanelEntity)[] - Web panels defined in Admin client, set to be shown in Pocket client.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer)[] - List of table rights for logged in user, in the same order as the Tables array parameter. See [CRMScript.NetServer.ETableRight](/en/automation/crmscript/reference/CRMScript.NetServer.ETableRight).
