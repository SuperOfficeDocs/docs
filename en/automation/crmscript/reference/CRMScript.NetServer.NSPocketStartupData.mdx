...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer)[] - List of table rights for logged in user, in the same order as the Tables array parameter. See &lt;xref href="CRMScript.NetServer.ETableRight" data-throw-if-not-resolved="false"&gt;&lt;/xref&gt;.
