...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer)[] - Array of attachment IDs.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - A string value of the column.
...
- badge: String, defines the initial source of message. See [CRMScript.NetServer.BadgeType](/en/automation/crmscript/reference/CRMScript.NetServer.BadgeType).
- x_... : Extra fields
</Note>
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - True if successful; otherwise, false.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - The database Id.
...
- message.slevelInteger, The security level of the message. See [CRMScript.NetServer.TicketSecurityLevel](/en/automation/crmscript/reference/CRMScript.NetServer.TicketSecurityLevel).
...
- message.messageCategory, The message category. See [CRMScript.NetServer.TicketMessageCategory](/en/automation/crmscript/reference/CRMScript.NetServer.TicketMessageCategory).
