...
**Returns:** [CRMScript.NetServer.NSPersonEntity](/en/automation/crmscript/reference/CRMScript.NetServer.NSPersonEntity) - Updated person object.
...
**Returns:** [CRMScript.NetServer.NSContactEntity](/en/automation/crmscript/reference/CRMScript.NetServer.NSContactEntity)
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - ID of copied contact.
...
**Returns:** [CRMScript.NetServer.NSContactEntity](/en/automation/crmscript/reference/CRMScript.NetServer.NSContactEntity) - New ContactEntity with default values.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - The database identity of the newly created entry.
...
**Returns:** CRMScript.NetServer.LocalizedField[][]
...
**Returns:** [CRMScript.NetServer.NSContact](/en/automation/crmscript/reference/CRMScript.NetServer.NSContact)
...
**Returns:** [CRMScript.NetServer.NSContact](/en/automation/crmscript/reference/CRMScript.NetServer.NSContact)[] - Array of NSContact.
...
**Returns:** [CRMScript.NetServer.NSContactSummary](/en/automation/crmscript/reference/CRMScript.NetServer.NSContactSummary) - Summary of contact, with recent requests, sales, follow-ups, chats.
...
**Returns:** [CRMScript.NetServer.NSContactEntity](/en/automation/crmscript/reference/CRMScript.NetServer.NSContactEntity) - ContactEntity with all data and persons.
...
**Returns:** [CRMScript.NetServer.NSDuplicateRule](/en/automation/crmscript/reference/CRMScript.NetServer.NSDuplicateRule)[] - All available duplicate rules.
...
**Returns:** [CRMScript.NetServer.NSDuplicateEntry](/en/automation/crmscript/reference/CRMScript.NetServer.NSDuplicateEntry)[] - Any records matching the specified name.
...
**Returns:** [CRMScript.NetServer.NSContactActivity](/en/automation/crmscript/reference/CRMScript.NetServer.NSContactActivity)[] - Array of contacts where there have been activity in the period.
...
**Returns:** [CRMScript.NetServer.NSContactEntity](/en/automation/crmscript/reference/CRMScript.NetServer.NSContactEntity) - The contact object with persons and interests.
...
**Returns:** [CRMScript.NetServer.NSContact](/en/automation/crmscript/reference/CRMScript.NetServer.NSContact)[] - The contact.
...
**Returns:** [CRMScript.NetServer.NSContact](/en/automation/crmscript/reference/CRMScript.NetServer.NSContact)[] - Array of contacts.
...
**Returns:** [CRMScript.NetServer.NSDuplicateEntry](/en/automation/crmscript/reference/CRMScript.NetServer.NSDuplicateEntry)[] - Any records matching the specified name and department.
...
**Returns:** [CRMScript.NetServer.NSPerson](/en/automation/crmscript/reference/CRMScript.NetServer.NSPerson)[] - Array of Persons.
...
**Returns:** [CRMScript.NetServer.NSAddress](/en/automation/crmscript/reference/CRMScript.NetServer.NSAddress)[] - The quote version addresses. Invoice and billing address, in that order.
...
**Returns:** [CRMScript.NetServer.NSContactEntity](/en/automation/crmscript/reference/CRMScript.NetServer.NSContactEntity) - The new or updated NSContactEntity.
...
**Returns:** [CRMScript.NetServer.NSAddress](/en/automation/crmscript/reference/CRMScript.NetServer.NSAddress) - The saved addresses.
