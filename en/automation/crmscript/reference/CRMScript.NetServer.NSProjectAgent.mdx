...
**Returns:** [CRMScript.NetServer.NSProjectEntity](/en/automation/crmscript/reference/CRMScript.NetServer.NSProjectEntity)
...
**Returns:** [CRMScript.NetServer.NSProjectEventEntity](/en/automation/crmscript/reference/CRMScript.NetServer.NSProjectEventEntity)
...
**Returns:** [CRMScript.NetServer.NSProjectMember](/en/automation/crmscript/reference/CRMScript.NetServer.NSProjectMember)
...
**Returns:** [CRMScript.NetServer.NSDuplicateRule](/en/automation/crmscript/reference/CRMScript.NetServer.NSDuplicateRule)[]
...
**Returns:** [CRMScript.NetServer.NSDuplicateEntry](/en/automation/crmscript/reference/CRMScript.NetServer.NSDuplicateEntry)[]
...
**Returns:** [CRMScript.NetServer.NSProjectEvent](/en/automation/crmscript/reference/CRMScript.NetServer.NSProjectEvent)[] - The list of events is filtered by the Audience Visibility restrictions set when the project event is created.
...
**Returns:** [CRMScript.NetServer.NSProjectEvent](/en/automation/crmscript/reference/CRMScript.NetServer.NSProjectEvent)
...
**Returns:** [CRMScript.NetServer.NSProjectEvent](/en/automation/crmscript/reference/CRMScript.NetServer.NSProjectEvent)[] - The list of events are filtered by the Audience Visibility restrictions set when the project event is created.
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - Does this project have a guide associated with its project type?
...
**Returns:** [CRMScript.NetServer.NSProjectEntity](/en/automation/crmscript/reference/CRMScript.NetServer.NSProjectEntity) - New or updated NSProjectEntity.
...
**Returns:** [CRMScript.NetServer.NSProjectEventEntity](/en/automation/crmscript/reference/CRMScript.NetServer.NSProjectEventEntity) - The new or updated NSProjectEventEntity.
