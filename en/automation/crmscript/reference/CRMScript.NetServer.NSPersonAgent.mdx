...
**Returns:** [CRMScript.NetServer.NSPersonEntity](/en/automation/crmscript/reference/CRMScript.NetServer.NSPersonEntity)
...
**Returns:** [CRMScript.NetServer.NSTemporaryKeyInfo](/en/automation/crmscript/reference/CRMScript.NetServer.NSTemporaryKeyInfo)
...
**Returns:** [CRMScript.NetServer.NSConsentPerson](/en/automation/crmscript/reference/CRMScript.NetServer.NSConsentPerson) - A new NSConsentPerson with default values.
...
**Returns:** [CRMScript.NetServer.NSPersonEntity](/en/automation/crmscript/reference/CRMScript.NetServer.NSPersonEntity) - A new NSPersonEntity with default values.
...
**Returns:** [CRMScript.NetServer.NSLocalizedField](/en/automation/crmscript/reference/CRMScript.NetServer.NSLocalizedField)[][] - The address.
...
**Returns:** [CRMScript.NetServer.NSConsentInfo](/en/automation/crmscript/reference/CRMScript.NetServer.NSConsentInfo)[]
...
**Returns:** [CRMScript.NetServer.NSConsentPerson](/en/automation/crmscript/reference/CRMScript.NetServer.NSConsentPerson)
...
**Returns:** [CRMScript.NetServer.NSPersonSummary](/en/automation/crmscript/reference/CRMScript.NetServer.NSPersonSummary)
...
**Returns:** [CRMScript.NetServer.NSResolvedPerson](/en/automation/crmscript/reference/CRMScript.NetServer.NSResolvedPerson)
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool)[] - An array of boolean values indicating whether each person was successfully added to the email flow.
