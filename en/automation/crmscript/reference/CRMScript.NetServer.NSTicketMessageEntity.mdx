...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Defines what kind of message this is. See [CRMScript.NetServer.TicketMessageCategory](/en/automation/crmscript/reference/CRMScript.NetServer.TicketMessageCategory).
...
**Returns:** [CRMScript.NetServer.NSTicketMessageHeader](/en/automation/crmscript/reference/CRMScript.NetServer.NSTicketMessageHeader)[] - Contains the message headers, like To, Cc, Bcc information, or custom headers.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - The security level of the message. See [CRMScript.NetServer.TicketSecurityLevel](/en/automation/crmscript/reference/CRMScript.NetServer.TicketSecurityLevel).
...
**Returns:** [CRMScript.NetServer.NSTicket](/en/automation/crmscript/reference/CRMScript.NetServer.NSTicket)
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - The type of the message (plaintext/html). See [CRMScript.NetServer.TicketMessageType](/en/automation/crmscript/reference/CRMScript.NetServer.TicketMessageType).
