...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - Description of the authentication type.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - The name of the credentials to be displayed in the user interface.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - Type of credentials, corresponding to name of plugin and type in the credentials table.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Type of control used to display the value. See [CRMScript.NetServer.CredentialControlType](/en/automation/crmscript/reference/CRMScript.NetServer.CredentialControlType).
