...
**Returns:** [CRMScript.NetServer.NSArchiveListResult](/en/automation/crmscript/reference/CRMScript.NetServer.NSArchiveListResult) - A new NSArchiveListResult with default values.
...
**Returns:** [CRMScript.NetServer.NSExportArchiveResult](/en/automation/crmscript/reference/CRMScript.NetServer.NSExportArchiveResult)
...
**Returns:** [CRMScript.NetServer.NSActivityFilter](/en/automation/crmscript/reference/CRMScript.NetServer.NSActivityFilter) - The activity filter for the specified list.
...
**Returns:** [CRMScript.NetServer.NSArchiveConfiguration](/en/automation/crmscript/reference/CRMScript.NetServer.NSArchiveConfiguration)
...
**Returns:** [CRMScript.NetServer.NSArchiveListItem](/en/automation/crmscript/reference/CRMScript.NetServer.NSArchiveListItem)[] - The columns returned will be those set as chosen columns, using either the SetChosenColumns service or the corresponding SelectableMDOList.SetSelected.
...
**Returns:** [CRMScript.NetServer.NSArchiveListItem](/en/automation/crmscript/reference/CRMScript.NetServer.NSArchiveListItem)[]
...
**Returns:** [CRMScript.NetServer.NSArchiveListResult](/en/automation/crmscript/reference/CRMScript.NetServer.NSArchiveListResult)
...
**Returns:** [CRMScript.NetServer.NSArchiveListResult](/en/automation/crmscript/reference/CRMScript.NetServer.NSArchiveListResult) - Includes a header that has various extra information, in addition to the actual rows.
...
Returns list of all columns supported by an archive provider. See also CRMScript.NetServer.NSArchiveAgent.GetArchiveConfiguration(String,String).

```crmscript
NSArchiveColumnInfo[] GetAvailableColumns(String providerName, String context)
```

**Returns:** [CRMScript.NetServer.NSArchiveColumnInfo](/en/automation/crmscript/reference/CRMScript.NetServer.NSArchiveColumnInfo)[]
...
Returns list of all entities supported by an archive provider. See also CRMScript.NetServer.NSArchiveAgent.GetArchiveConfiguration(String,String).
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer)[] - The associate IDs.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String)[] - Array of all archive provider names.
