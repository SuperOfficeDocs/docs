...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Units for the duration (day, week, whatever). See &lt;xref href="CRMScript.NetServer.DurationUnit" data-throw-if-not-resolved="false"&gt;&lt;/xref&gt;.
