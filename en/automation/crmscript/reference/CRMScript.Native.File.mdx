...
title: File
description: "Represents a file. **This class is not available in CRM Online.**"
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - True if a read passed the end of file has been attempted; otherwise, false.
...
**Returns:** [CRMScript.Global.Byte](/en/automation/crmscript/reference/CRMScript.Global.Byte)[] - Binary data.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - The next line from the file or a null string if no more data in the file.
