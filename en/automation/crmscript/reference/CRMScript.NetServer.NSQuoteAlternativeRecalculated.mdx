...
**Returns:** [CRMScript.NetServer.NSQuoteAlternative](/en/automation/crmscript/reference/CRMScript.NetServer.NSQuoteAlternative) - The recalculated NSQuoteAlternative.
...
**Returns:** [CRMScript.NetServer.NSChangedData](/en/automation/crmscript/reference/CRMScript.NetServer.NSChangedData) - Table name or record ID of data changed by this method.
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - If true any of the quote lines for the alternative has been changed.
