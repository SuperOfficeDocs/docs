...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - Default currency for the installation.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Number of all overdue sales within the period.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Summed amount for all overdue sales within the period in default currency for the installation.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Summed amount for all overdue sales within the period in default currency for the current user.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Weighted sum for all overdue sales within the period in default currency for the installation.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Weighted sum for all overdue sales within the period in default currency for the current user.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Number of all Future Pipe/All open sales with date after the period.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Summed amount for all Future Pipe/All open sales with date after the period in default currency for the installation.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Summed amount for all Future Pipe/All open sales with date after the period in default currency for the current user.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Weighted sum for all Future Pipe/All open sales with date after the period in default currency for the installation.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Weighted sum for all Future Pipe/All open sales with date after the period in default currency for the current user.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Number of all lost within the period.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Summed amount for all lost within the period in default currency for the installation.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Summed amount for all lost within the period in default currency for the current user.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Number of all open within the period.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Summed amount for all open within the period in default currency for the installation.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Summed amount for all open within the period in default currency for the current user.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Weighted sum for all open within the period in default currency for the installation.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Weighted sum for all open within the period in default currency for the current user.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - Default currency for the current user.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Number of all open sales with date before this period.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Summed amount for all open sales with date before this period in default currency for the installation.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Summed amount for all open sales with date before this period in default currency for the current user.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Weighted sum for all open sales with date before this period in default currency for the installation.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Weighted sum for all open sales with date before this period in default currency for the current user.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Number of all sold within the period.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Summed amount for all sold within the period in default currency for the installation.
...
**Returns:** [CRMScript.Global.Float](/en/automation/crmscript/reference/CRMScript.Global.Float) - Summed amount for all sold within the period in default currency for the current user.
