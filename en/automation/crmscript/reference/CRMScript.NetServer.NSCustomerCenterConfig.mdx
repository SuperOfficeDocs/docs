...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - What kind of data is in this row. What kind of data is in this row. See &lt;xref href="CRMScript.NetServer.ConfigType" data-throw-if-not-resolved="false"&gt;&lt;/xref&gt;
