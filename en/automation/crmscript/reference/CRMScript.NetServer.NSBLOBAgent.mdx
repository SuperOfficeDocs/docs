...
**Returns:** [CRMScript.NetServer.NSBlobEntity](/en/automation/crmscript/reference/CRMScript.NetServer.NSBlobEntity) - New BlobEntity with default values.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - The applications value, suggested to be a JSON, XML or other readable structure.
...
**Returns:** [CRMScript.NetServer.NSBlobEntity](/en/automation/crmscript/reference/CRMScript.NetServer.NSBlobEntity) - BlobEntity object.
...
**Returns:** [CRMScript.NetServer.NSStream](/en/automation/crmscript/reference/CRMScript.NetServer.NSStream) - The binary object as a Stream.
...
**Returns:** [CRMScript.NetServer.NSImage](/en/automation/crmscript/reference/CRMScript.NetServer.NSImage) - The image as a System.Drawing.Image. (If the the image is returned over web services, the stream is returned as a jpeg/base64 encoded string.).
...
**Returns:** [CRMScript.NetServer.NSImage](/en/automation/crmscript/reference/CRMScript.NetServer.NSImage) - The image as a System.Drawing.Image. (If the the image is returned over web services, the stream is returned as a Base64 encoded string.).
...
**Returns:** [CRMScript.NetServer.NSBlobEntity](/en/automation/crmscript/reference/CRMScript.NetServer.NSBlobEntity) - New or updated BlobEntity.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - The blob Id.
