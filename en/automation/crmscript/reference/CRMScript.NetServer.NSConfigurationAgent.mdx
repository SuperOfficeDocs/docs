...
**Returns:** [CRMScript.NetServer.NSDiaryViewEntity](/en/automation/crmscript/reference/CRMScript.NetServer.NSDiaryViewEntity) - New entity with default values.
...
**Returns:** [CRMScript.NetServer.NSSystemEventEntity](/en/automation/crmscript/reference/CRMScript.NetServer.NSSystemEventEntity) - New entity with default values.
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - Is there a system event with the given key?
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - A configuration fragment, with full reference resolution and parsing applied.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - XML structure containing the application configuration. A list of pages, with information about the name, main panel and preference mappings of each page.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - URl.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - A valid Service URL composed of the give parameters.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - The host name for where Service is installed.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - The value of the specified Registry entry.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - The www folder for Service.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - The URL to the customer center, without any actions.
...
**Returns:** [CRMScript.NetServer.NSDiaryViewEntity](/en/automation/crmscript/reference/CRMScript.NetServer.NSDiaryViewEntity)
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Number of days in the past for which we are fetching email.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - XML representing the list of filters and any configuration data they may need.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - URL to be used by the help system.
...
**Returns:** [CRMScript.NetServer.NSWindowPosSize](/en/automation/crmscript/reference/CRMScript.NetServer.NSWindowPosSize)[] - Array of window and dialog position and size settings.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - XML containing the object mappings, including assembly and class names.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - XML containing the configuration for the given page, from the page down to the control level.
...
**Returns:** [CRMScript.NetServer.NSSystemEventEntity](/en/automation/crmscript/reference/CRMScript.NetServer.NSSystemEventEntity)
...
**Returns:** [CRMScript.NetServer.NSWindowPosSize](/en/automation/crmscript/reference/CRMScript.NetServer.NSWindowPosSize)
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - URL to be used when clicking the logo.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - Link to urldispatch.aspx tagged with [SOSITEURL]
...
**Returns:** [CRMScript.NetServer.NSDiaryViewEntity](/en/automation/crmscript/reference/CRMScript.NetServer.NSDiaryViewEntity) - New or updated DiaryViewEntity.
...
**Returns:** [CRMScript.NetServer.NSSystemEventEntity](/en/automation/crmscript/reference/CRMScript.NetServer.NSSystemEventEntity) - New or updated SystemEventEntity.
...
**Returns:** [CRMScript.NetServer.NSWindowPosSize](/en/automation/crmscript/reference/CRMScript.NetServer.NSWindowPosSize) - The saved item.
...
**Returns:** [CRMScript.NetServer.NSWindowPosSize](/en/automation/crmscript/reference/CRMScript.NetServer.NSWindowPosSize)[] - The saved items.
