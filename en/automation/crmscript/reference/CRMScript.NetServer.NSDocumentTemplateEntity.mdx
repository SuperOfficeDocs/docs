...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - 1 = incoming, 2 = outgoing. See &lt;xref href="CRMScript.NetServer.TaskDirection" data-throw-if-not-resolved="false"&gt;&lt;/xref&gt;
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Type for sending email meeting invitation. See &lt;xref href="CRMScript.NetServer.DocTmplInvitationType" data-throw-if-not-resolved="false"&gt;&lt;/xref&gt;
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Indicator that this document template has a functional role, related to privacy/GDPR. See &lt;xref href="CRMScript.NetServer.DocTmplPrivacyType" data-throw-if-not-resolved="false"&gt;&lt;/xref&gt;
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - The role this document plays in the Quote system, if any. See &lt;xref href="CRMScript.NetServer.DocTmplQuoteType" data-throw-if-not-resolved="false"&gt;&lt;/xref&gt;
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - If email template, when DocType is Privacy or quote email, it is possible to make sender address like our contact, or our support contact, or always one address. See &lt;xref href="CRMScript.NetServer.SenderMailMode" data-throw-if-not-resolved="false"&gt;&lt;/xref&gt;
