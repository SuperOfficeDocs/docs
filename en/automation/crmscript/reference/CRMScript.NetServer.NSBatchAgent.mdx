...
**Returns:** [CRMScript.NetServer.NSBatchTaskInfo](/en/automation/crmscript/reference/CRMScript.NetServer.NSBatchTaskInfo) - A BatchTaskInfo.
...
**Returns:** [CRMScript.NetServer.NSBatchTaskInfo](/en/automation/crmscript/reference/CRMScript.NetServer.NSBatchTaskInfo)[] - An array of BatchTaskInfo.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - The ID of the created batch job.
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - true if the job was stopped successfully.
...
**Returns:** [CRMScript.NetServer.NSBatchTaskInfo](/en/automation/crmscript/reference/CRMScript.NetServer.NSBatchTaskInfo) - The updated BatchTaskInfo.
