...
**Returns:** [CRMScript.NetServer.NSRedLetterDetails](/en/automation/crmscript/reference/CRMScript.NetServer.NSRedLetterDetails) - Red-letter day text details, all the texts related to the given day.
