...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - The appointment status for this participant. See &lt;xref href="CRMScript.NetServer.AppointmentStatus" data-throw-if-not-resolved="false"&gt;&lt;/xref&gt;
