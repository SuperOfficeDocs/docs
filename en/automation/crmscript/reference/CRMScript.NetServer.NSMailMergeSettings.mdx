...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - How the merged document is delivered to the recipients. See &lt;xref href="CRMScript.NetServer.EMailMergeTargetType" data-throw-if-not-resolved="false"&gt;&lt;/xref&gt;
