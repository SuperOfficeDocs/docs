...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - Should custom attention always be used? If false, only use custom attention where there is no default.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - Custom value for attention.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - If specified, use this value as default mail body.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - If specified, use this value as default mail subject.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Identity of document to be used as merge draft.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - Used to store additional information for the delivery systems.
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - Include recipients that are marked with NoMailings.
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - Include recipients that are marked as retired.
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - If true, the selection is a temporary selection that can be deleted later.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - How the merged document is delivered to the recipients. See [CRMScript.NetServer.EMailMergeTargetType](/en/automation/crmscript/reference/CRMScript.NetServer.EMailMergeTargetType)
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Identity of project to use as source for recipients.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Remove this company interest on each company recipient.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Remove this person interest on each person recipient.
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - Should we save a reference to the merge document on each recipient.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Identity of selection to use as source for recipients.
...
**Returns:** [CRMScript.NetServer.NSMailMergeTask](/en/automation/crmscript/reference/CRMScript.NetServer.NSMailMergeTask) - If specified, register a task on recipients using properties from this object.
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - If true, do the merge task, but use current user as target, instead of selection members.
