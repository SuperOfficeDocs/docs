...
**Returns:** [CRMScript.NetServer.NSKbCategory](/en/automation/crmscript/reference/CRMScript.NetServer.NSKbCategory) - Root folder for FAQ suggestions.
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - Enable automatic FAQ suggestions.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - The base color of the widget.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - The font used in the widget.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - The language ISO code for the widget language.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Blob ID that contains logo image.
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - Indicates if the logo should be shown in the widget.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - filename/description of logo (from blob).
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Required field when creating ticket in offline mode. See [CRMScript.NetServer.WidgetRequiredFields](/en/automation/crmscript/reference/CRMScript.NetServer.WidgetRequiredFields)
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - Offline text shown in widget header.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - Offline message shown in widget.
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - Enable post chat form.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - Header text to show in post chat form.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - Message text to show in post chat form.
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - Enable transcript of chat session.
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - Enable pre-chat form for anonymous users.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - Message to be shown in a pre-chat.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Fields required to start a chat. See [CRMScript.NetServer.WidgetRequiredFields](/en/automation/crmscript/reference/CRMScript.NetServer.WidgetRequiredFields)
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - Use agent photo and name when chatting.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Chat widget size - normal or large. See [CRMScript.NetServer.ChatWidgetSize](/en/automation/crmscript/reference/CRMScript.NetServer.ChatWidgetSize).
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Predefined themes for the chat widget. See [CRMScript.NetServer.WidgetTheme](/en/automation/crmscript/reference/CRMScript.NetServer.WidgetTheme)
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - Short message displayed as long as the request is in queue or active.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - Short welcome message when user initiates a chat.
