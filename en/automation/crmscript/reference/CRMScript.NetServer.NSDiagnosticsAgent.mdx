...
**Returns:** [CRMScript.NetServer.NSWebAppUsage](/en/automation/crmscript/reference/CRMScript.NetServer.NSWebAppUsage)[]
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - true if viewState has been clicked at least once since FromDate, if asscoiateId &lt; 0 or FromDate is DateTime.MinValue no restriction given for those parameters.
