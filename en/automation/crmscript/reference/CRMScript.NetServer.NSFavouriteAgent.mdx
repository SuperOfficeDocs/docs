...
**Returns:** [CRMScript.NetServer.NSFavourite](/en/automation/crmscript/reference/CRMScript.NetServer.NSFavourite)[]
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - true if added; false if removed.
