...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - The state of the Sale (Open, Sold, Lost, Stalled). See &lt;xref href="CRMScript.NetServer.SaleStatus" data-throw-if-not-resolved="false"&gt;&lt;/xref&gt;.
