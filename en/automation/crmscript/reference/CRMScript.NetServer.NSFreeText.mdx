...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Starts with, contains or exact match. See &lt;xref href="CRMScript.NetServer.FreeTextOperator" data-throw-if-not-resolved="false"&gt;&lt;/xref&gt;
