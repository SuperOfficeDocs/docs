...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - A String composed by the Mail tag, the ticketId and the title of the ticket.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - A comma-separated list of email-addresses.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - The most appropriate from-address specified on with address, the ticket has arrived on, the category, etc.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - The owners name and email-address.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - The cellphone number of the owner of the ticket as a String.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - Returns a string representation of the wanted value.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - The ID of the saved ticket.
...
- ownedBy: (owned_by), the ID of the user who owns the ticket
- slevel: the security level of the ticket, See [CRMScript.NetServer.TicketSecurityLevel](/en/automation/crmscript/reference/CRMScript.NetServer.TicketSecurityLevel).
- priority: the id
- status: 1 = active, 2 = closed, 3 = postponed, 4 = deleted, 5 = composed
...
|---|---|---|
| theParser | [CRMScript.Native.Parser](/en/automation/crmscript/reference/CRMScript.Native.Parser) | The parser who will be filled with ticket-values. |
