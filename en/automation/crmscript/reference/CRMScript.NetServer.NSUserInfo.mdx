...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Primary group membership, See the UserGroupLink database table reference for secondary memberships.
