...
**Returns:** [CRMScript.NetServer.NSArchiveColumnInfo](/en/automation/crmscript/reference/CRMScript.NetServer.NSArchiveColumnInfo)[] - Array of ColumnInfo column specifications.
...
**Returns:** [CRMScript.NetServer.NSArchiveListItem](/en/automation/crmscript/reference/CRMScript.NetServer.NSArchiveListItem)[] - Array of archive list items (the service layer carrier for archive rows).
...
**Returns:** [CRMScript.NetServer.NSArchiveRestrictionGroup](/en/automation/crmscript/reference/CRMScript.NetServer.NSArchiveRestrictionGroup)[] - Array of restriction groups, including the default first group of restrictions.
...
**Returns:** [CRMScript.NetServer.NSArchiveRestrictionInfo](/en/automation/crmscript/reference/CRMScript.NetServer.NSArchiveRestrictionInfo)[] - Array of NSArchiveRestrictionInfo restriction specifications (for the first group if there are more than one).
