...
**Returns:** [CRMScript.NetServer.NSUser](/en/automation/crmscript/reference/CRMScript.NetServer.NSUser)
...
**Returns:** [CRMScript.NetServer.NSRoleEntity](/en/automation/crmscript/reference/CRMScript.NetServer.NSRoleEntity)
...
**Returns:** [CRMScript.NetServer.NSServiceAuth](/en/automation/crmscript/reference/CRMScript.NetServer.NSServiceAuth)
...
**Returns:** [CRMScript.NetServer.NSUntrustedCredentials](/en/automation/crmscript/reference/CRMScript.NetServer.NSUntrustedCredentials)
...
**Returns:** [CRMScript.NetServer.NSUserGroup](/en/automation/crmscript/reference/CRMScript.NetServer.NSUserGroup)
...
**Returns:** [CRMScript.NetServer.NSCredentialsGroup](/en/automation/crmscript/reference/CRMScript.NetServer.NSCredentialsGroup)[] - There will always be at least one groups even if the underlying provider does not support groups.
...
**Returns:** [CRMScript.NetServer.NSCredentialsGroupUsers](/en/automation/crmscript/reference/CRMScript.NetServer.NSCredentialsGroupUsers)
...
**Returns:** [CRMScript.NetServer.NSMDOListItem](/en/automation/crmscript/reference/CRMScript.NetServer.NSMDOListItem)[]
...
**Returns:** [CRMScript.NetServer.NSAccessGatewayInfo](/en/automation/crmscript/reference/CRMScript.NetServer.NSAccessGatewayInfo)
...
**Returns:** [CRMScript.NetServer.NSCredentialType](/en/automation/crmscript/reference/CRMScript.NetServer.NSCredentialType)[]
...
**Returns:** [CRMScript.NetServer.NSTokenManagementInfo](/en/automation/crmscript/reference/CRMScript.NetServer.NSTokenManagementInfo)
...
**Returns:** [CRMScript.NetServer.NSSelectableMDOListItem](/en/automation/crmscript/reference/CRMScript.NetServer.NSSelectableMDOListItem)[] - MDO List name = 'FunctionRights', extra='role=123'
...
**Returns:** [CRMScript.NetServer.NSRole](/en/automation/crmscript/reference/CRMScript.NetServer.NSRole)
...
**Returns:** [CRMScript.NetServer.NSUserInfo](/en/automation/crmscript/reference/CRMScript.NetServer.NSUserInfo)
...
**Returns:** [CRMScript.NetServer.NSUserValidationResult](/en/automation/crmscript/reference/CRMScript.NetServer.NSUserValidationResult)
...
**Returns:** [CRMScript.NetServer.NSResolvedUser](/en/automation/crmscript/reference/CRMScript.NetServer.NSResolvedUser)
