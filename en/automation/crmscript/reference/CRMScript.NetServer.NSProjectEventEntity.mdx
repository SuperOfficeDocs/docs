...
**Returns:** [CRMScript.NetServer.NSAssociate](/en/automation/crmscript/reference/CRMScript.NetServer.NSAssociate) - The person that created the project event.
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - Is the event enabled.
...
**Returns:** [CRMScript.Global.DateTime](/en/automation/crmscript/reference/CRMScript.Global.DateTime) - Date of the event; publishing/visibility dates are in Publish, and restrictions are in AudienceVisibility.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - ID of the external event.
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - Publish to external users? When true, the event/project information is visible to external users through the Audience portal. You can control the publish duration using the PublishFrom/PublishTo properties.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - The projectId for the project this projectEvent belongs to.
...
**Returns:** [CRMScript.Global.DateTime](/en/automation/crmscript/reference/CRMScript.Global.DateTime) - Publication valid from (inclusive).
...
**Returns:** [CRMScript.Global.DateTime](/en/automation/crmscript/reference/CRMScript.Global.DateTime) - Publication valid to (inclusive).
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - Type of publishing action. See [CRMScript.NetServer.PublishType](/en/automation/crmscript/reference/CRMScript.NetServer.PublishType)
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - Is Sign Off functionality enabled?
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - Text shown as confirmation text before accepting sign off.
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - If not 0, a task should be created when the external user Signs Off an event.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - If not 0, sign off should cause an Activity of this type to be registered.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - Default text for the activity created when signing off.
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - If 1, the SignOff task should be created as an Assigned task, triggering the invitation dialog.
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - Is Sign On functionality enabled.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - Text shown as confirmation text before accepting sign on.
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - If not 0, a task should be created when the external user Signs On to an event.
...
**Returns:** [CRMScript.Global.Integer](/en/automation/crmscript/reference/CRMScript.Global.Integer) - If not 0, sign on should cause an Activity of this type to be registered.
...
**Returns:** [CRMScript.Global.String](/en/automation/crmscript/reference/CRMScript.Global.String) - Default text for the activity created when signing on.
...
**Returns:** [CRMScript.Global.Bool](/en/automation/crmscript/reference/CRMScript.Global.Bool) - If 1, the SignOn task should be created as an Assigned task, triggering the invitation dialog.
...
**Returns:** [CRMScript.NetServer.NSAssociate](/en/automation/crmscript/reference/CRMScript.NetServer.NSAssociate) - The person that last updated the project event.
...
**Returns:** [CRMScript.NetServer.NSMDOListItem](/en/automation/crmscript/reference/CRMScript.NetServer.NSMDOListItem)[] - Array of categories that the event is visible for. MDO Table category.
...
**Returns:** [CRMScript.NetServer.NSMDOListItem](/en/automation/crmscript/reference/CRMScript.NetServer.NSMDOListItem)[] - Array of person interests (MDO table persint) that this event is visible for.
