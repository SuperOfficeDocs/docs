...
sidebarTitle: "Open external system (task menu)"
description: Create a task menu item that opens an external system using CRMScript
keywords: ['CRMScript', 'external URL', 'browser tab']
...
related:
  - How to create a CRMScript: /en/automation/crmscript/overview/envir-and-tools
  - How to create a Task menu item: /en/customization/admin/add-items-to-task-menu
  - Template variables from Service: /en/document/templates/variables/for-service
  - Template variables from the Company card: /en/document/templates/variables/from-company-card
---
...
[img1]: /media/loc/en/automation/tut-add-task-menu-item-url.png
[img2]: /media/loc/en/automation/tut-task-menu-openexternal-on-company.png
