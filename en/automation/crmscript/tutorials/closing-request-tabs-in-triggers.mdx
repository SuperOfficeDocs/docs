...
keywords: ['CRMScript', 'automation', 'trigger', 'Request tab']
author: kronicz
date: 02.11.2025
so_version: 10.5.2
...
## Step 1: Creating the CRMScript {#implementation}
...
[img1]: /media/loc/en/automation/tut-information-properties.png
[img2]: /media/loc/en/automation/tut-add-task-menu-item.png
[img3]: /media/loc/en/automation/tut-request-task-menu.png
