...
keywords: ['edit webhook', 'notification', 'event']
author: digitaldiina
date: 06.16.2026
so_version: 12.1
content_type: howto
...
userflow_index: true
related:
  - /en/automation/webhook/admin/index
  - Register a webhook via the API: /en/automation/webhook/dev/register
  - Create a CRMScript: /en/customization/macros-and-scripts/admin/create-script
language: en
---
