...
related:
  - Introduction to sales: /en/sale/learn/index
  - Create a sale: /en/sale/learn/create
  - Sales guide tutorial: /en/sale/learn/tutorial
  - /en/sale/admin/create-sales-guide
  - /en/sale/admin/edit-sales-guide
language: en
---

import ReqCoreTransitionSales from "../../../snippets/license/req-core-transition-sales.mdx";
...
<Frame caption="Watch this video to learn how easy it is to use the Sales guide">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/IyETjAtn3po"
    title="Watch this video to learn how easy it is to use the Sales guide"
    frameborder="0"
...
## Sales guide section tab {#sales-guide-tab}
...
## Move to the next stage {#change-stage}
