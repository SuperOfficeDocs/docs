...
keywords: ['copy quote', 'add product', 'Add/edit product dialog']
...
related:
  ...
  - /en/sale/learn/quote/send
  - Create an order: /en/sale/learn/quote/place-order
...
## Copy a quote from another sale {#copy}
...
## Add products to the quote {#add-products}
...
### Why do I see warnings or errors? {#warning}
