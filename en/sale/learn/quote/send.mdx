...
keywords: ['approve quote', 'edit sent quote', 'publish', 'approval', 'quote version', 'Attachments tab']
...
related:
  ...
  - Replace the quote document: /en/sale/learn/quote/create-quote-document#replace
  - /en/sale/learn/quote/place-order
  - Configure quote approval rules in Settings and maintenance: /en/sale/admin/sale-type#quote-fields
language: en
---
