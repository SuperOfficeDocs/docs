...
keywords: ['change quote document']
...
related:
  ...
  - Edit a document: /en/document/learn/edit
  - Quote document templates: /en/document/templates/learn/quote-templates
  - Template variables and merge fields: /en/document/templates/merge-fields/quote
language: en
---
...
## Replace the quote document {#replace}
