...
keywords: ['add sale type', 'Sale - Type Stages Quote list', 'Sale - Category list', 'Quote attachments tab', 'Quote defaults', 'Quote approval', 'quote']
...
userflow_index: true
related:
  - Add a sale stage: /en/sale/admin/sale-stage
  - Create a sales guide: /en/sale/admin/create-sales-guide
  - Edit a sales guide: /en/sale/admin/edit-sales-guide
...
## Quote fields explained {#quote-fields}
...
<Tabs>
<Tab title="Quote attachment tab">
...
## Restore a deleted sale type {#restore}
