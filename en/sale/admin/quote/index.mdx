...
keywords: ['quote connector', 'ERP connection', 'quote settings', 'price list', 'product', 'Quote/Sync screen', 'erp setup', 'quote connector settings', 'quoting integration', 'sales configuration', 'sync']
...
userflow_index: true
related:
  - Set up ERP connection: /en/sale/admin/quote/set-up-quote-connector
  - Add price lists and products: /en/sale/admin/quote/price-list-and-products
  - Customize the quote dialog: /en/sale/admin/quote/configure-product-fields
  - /en/erp/admin/index
language: en
---
...
## Tabs in the Quote/Sync screen {#tabs}
...
[1]: /en/sale/admin/quote/set-up-quote-connector
[2]: /en/sale/admin/quote/price-list-and-products
[3]: /en/sale/admin/quote/configure-product-fields
[4]: /en/erp/admin/index
[5]: /en/sale/admin/sale-type
