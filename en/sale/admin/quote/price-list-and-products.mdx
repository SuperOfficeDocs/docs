...
userflow_index: true
related:
  - /en/sale/admin/quote/configure-product-fields
  - /en/admin/import/products-from-excel
...
## Add products to a price list {#add-product}
...
## Add or change product image {#image}
...
## Deactivate products or price lists {#deactivate}
