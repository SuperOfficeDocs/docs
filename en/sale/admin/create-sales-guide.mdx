...
## Create stages for the sales guide {#create-stages}
...
## Create a sale type for the sales guide {#create-type}
...
## Create a sales guide {#create-guide}
...
## Add a follow-up for a stage {#add-fo-stage}
...
## Add a document for a stage {#add-doc-stage}
