...
keywords: ['edit privacy settings']
...
related:
  - Learn more about GDPR, privacy and consent management in SuperOffice: /en/security/privacy/index
language: en
---
...
## How to set privacy settings of many contacts all at once {#bulk}
