...
related:
  - Edit the privacy confirmation email in Settings and maintenance: /en/security/privacy/admin/edit-privacy-confirmation-email
language: en
---
...
<Frame caption="This video will show you how to create a basic web form and add it to your web page (video length - 7:49)">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/18m6Dx1t9wI"
    title="This video will show you how to create a basic web form and add it to your web page (video length - 7:49)"
    frameborder="0"
