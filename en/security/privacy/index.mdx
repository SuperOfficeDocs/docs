---
uid: privacy
title: Intro to General Data Protection Regulation (GDPR)
sidebarTitle: "GDPR introduction"
description: Intro to General Data Protection Regulation (GDPR)
keywords: ['privacy', 'EU', 'legal']
author: SuperOffice
date: 08.28.2023
content_type: concept
userflow_index: true
related:
  - GDPR-compliant software report from DLA Piper (PDF): https://www.superoffice.com/globalassets/home-trust-centre/gdpr-and-crm/dla-piper---gdpr-compliance-superoffice-crm_en.pdf
language: en
---
...
<Frame caption="In this video, we will show you how to set up privacy settings for GDPR in SuperOffice CRM. You will need to have the administrator's rights to do this with the consent management features in SuperOffice CRM.">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/1e0ZIUwX3IY"
    title="In this video, we will show you how to set up privacy settings for GDPR in SuperOffice CRM. You will need to have the administrator's rights to do this with the consent management features in SuperOffice CRM."
    frameborder="0"
...
[img1]: /media/loc/en/security/gdpr-circel.jpg
[img2]: /media/loc/en/security/8-privacy-rights-and-customer-lifecycle.jpg
