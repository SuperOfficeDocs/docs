...
redirect_from: /en/chat/learn/create-contact
language: en
---
...
1. Click **Add**. The new contact and company is added to SuperOffice. The contact is also linked to the chat for future reference.
