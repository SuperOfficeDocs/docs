...
keywords: ['new customer language', 'language code']
author: digitaldiina
date: 10.09.2025
so_version: 11.5
content_type: howto
...
userflow_index: true
related:
  - How SuperOffice selects the customer language for new contacts: /en/localization/learn/customer-languages
language: en
---
...
[1]: ../../request/admin/category/external-categories
[2]: ../learn/customer-languages
