---
uid: pocket-crm-client-requirements
title: Requirements for Pocket CRM mobile client
sidebarTitle: "Pocket CRM client requirements"
...
import MobileNetworkReq from "../../mobile/snippets/mobile-network-req.md";
