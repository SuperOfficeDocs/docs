---
uid: configure-pocket-onsite
title: Pocket CRM configuration
...
deployment: onsite
legacy: true
redirect_from: /en/mobile/pocket-crm/configure
language: en
---
...
[2]: ../../admin/lists/add-items
[3]: https://www.apple.com/business/docs/iOS_Security_Guide.pdf
[4]: https://source.android.com/security/encryption/full-disk
[5]: ../security/deployment-scenarios
[6]: ./upgrade-to-8
[7]: ../install/iis/reverse-proxy
[8]: ../web-config/diagnostics
[9]: ../web-config/soformsauthentication
[10]: ../web-config/globalization
