---
uid: upgrade-service
title: Upgrade SuperOffice Customer Service to SuperOffice Service
sidebarTitle: "Upgrade Customer Service to Service"
...
import WarnUpgradeAllToSameVersion from "../../snippets/warn-upgrade-all-to-same-version.mdx";
...
[1]: /en/onsite/upgrade/75-to-8/crm-server
[2]: /en/onsite/upgrade/75-to-8/web-client
[3]: /en/onsite/requirements/crm-server
[4]: /en/customer-center/templates
[5]: /en/onsite/automated-tasks/upgrade

[img1]: /media/loc/en/onsite/upgradeservice.png
[img2]: /media/loc/en/onsite/capture.png
