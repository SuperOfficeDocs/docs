...
title: Deployment of SuperOffice Ribbons in a Citrix or Terminal Server environment
sidebarTitle: "Ribbons on Citrix/Terminal Server"
...
import RegistryPropagation from "./snippets/registry-propagation.mdx";
import RegistryKeys from "./snippets/registry-keys.md";
import RegistryDeployRibbons from "./snippets/registry-deploy-ribbons.md";
