...
title: Manual steps to install Service
description: Manual steps to install Service
keywords: ['CS', 'CustomerService', 'CustomerService.exe', 'ejTermSetup.exe']
...
import WarnWebClientHttps from "../../snippets/warn-web-client-https.mdx";
import ServiceWebview from "../../snippets/service-webview.mdx";
...
[img1]: /media/loc/en/onsite/add-application-1.png
[img2]: /media/loc/en/onsite/run-installer.png
[img3]: /media/loc/en/onsite/uncheck-create-iis-web-site.png
[img4]: /media/loc/en/onsite/change-app-paths.png
[img5]: /media/loc/en/onsite/add-app-scripts.png
[img6]: /media/loc/en/onsite/add-app-csplugins.png
[img8]: /media/loc/en/onsite/verifyremotewebservices.png
[img9]: /media/loc/en/onsite/hostpath-and-odbc.png
[img10]: /media/loc/en/onsite/netserver-url-and-admin.png
[img11]: /media/loc/en/onsite/loginservice.png
[img12]: /media/loc/en/onsite/regid109wrong.png
[img13]: /media/loc/en/onsite/cgibinurlsconfig.png
