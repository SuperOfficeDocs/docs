---
title: Configure SuperOffice REST WebAPI
description: Describes how to setup and enable NetServer REST services in IIS.
author: Tony Yates
date: 11.26.2015
keywords: ['API', 'RESTful', 'HTTP Action Verbs', 'BASIC', 'SOTicket', 'authentication', 'XSRF Token', 'setRequestHeader', 'ODATA']
...
[5]: ../../web-config/security

[img1]: /media/loc/en/onsite/iis-configuration.png
[img2]: /media/loc/en/onsite/websiteauthentication.png
[img3]: /media/loc/en/onsite/soapplicationauthentication.png
[img17]: /media/loc/en/onsite/iis-authentication-windows.png
[img18]: /media/loc/en/onsite/iis-kernel-mode-auth.png
[img19]: /media/loc/en/onsite/iis-auth-providers.png
