---
title: Install NetServer / web services
...
[1]: /en/onsite/reporter/config
[2]: /en/onsite/install/web-client/index
[3]: /en/onsite/web-config/data#database
[4]: /en/onsite/web-config/documents
[5]: /en/onsite/web-config/globalization
