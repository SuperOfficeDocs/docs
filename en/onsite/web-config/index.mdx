...
This is not the case for integrations that use the [SuperOffice.WebApi][8] nuget package, or generate their own web service proxies from [REST Swagger][14] files.

<Danger>
The database connection settings are defined in the [Data element][1] of the application configuration. This is often the cause of connectivity issue, so if necessary consult the [NetServer configuration docs][10] to better understand those settings.
</Danger>

[1]: https://github.com/SuperOfficeDocs/superoffice-docs/blob/main/docs/en/api/reference/netserver/core/SuperOffice.Configuration.ConfigFile.yml
[2]: https://github.com/SuperOfficeDocs/superoffice-docs/blob/main/docs/en/api/reference/netserver/core/index.md
[3]: https://github.com/SuperOfficeDocs/superoffice-docs/blob/main/docs/en/api/reference/netserver/services/index.md
