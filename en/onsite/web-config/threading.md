...
keywords: ['config', 'web.config', 'DisableMultithreading', 'ForceMultithreading', 'MaxParellalThreads', 'single-threaded', 'multi-threaded', 'parallel']
...
[1]: https://github.com/SuperOfficeDocs/superoffice-docs/blob/main/docs/en/api/reference/netserver/core/SuperOffice.Configuration.ConfigFile.Threading.yml
