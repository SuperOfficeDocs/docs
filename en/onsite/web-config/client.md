...
keywords: ['web.config', 'ClientConfigurationProvider', 'export']
...
[1]: https://github.com/SuperOfficeDocs/superoffice-docs/blob/main/docs/en/api/reference/netserver/core/SuperOffice.Configuration.ConfigFile.Client.yml
