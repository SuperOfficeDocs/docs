...
related:
  - Show extra fields on the Details tab: /en/custom-objects/admin/show-extra-field-on-request-details
  - Create extra field: /en/custom-objects/admin/create-extra-field
language: en
---
...
### Relations (foreign keys) {#relation}
