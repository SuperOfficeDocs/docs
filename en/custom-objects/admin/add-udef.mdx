...
keywords: ['udef', 'custom field', 'field properties']
...
import UdefDanger from "../../../snippets/udef-screen-designer-warning/en-udef-screen-designer.mdx";
...
<Frame caption="Watch this video to find out how you can create your own extra fields in SuperOffice CRM (video length - 2:51)">
  <iframe
    ...
    title="Watch this video to find out how you can create your own extra fields in SuperOffice CRM (video length - 2:51)"
    frameborder="0"
