...
keywords: ['custom field', 'request', 'layout', 'screen designer', 'System design']
author: digitaldiina
date: 11.20.2025
so_version: 11.6
content_type: howto
...
<Tabs>
<Tab title="In new Requests screen with Screen Designer">
...
[1]: ../../customization/screen-designer/admin/working-with-fields
