...
related:
  - Template variables: /en/document/templates/variables/index
...
## Preferences dialog - options {#options}
...
| <i class="ph ph-at" aria-label="Email icon"></i> | Email | The settings for email and fax, for example, the email client you have installed and whether new emails open in your local email application. |
