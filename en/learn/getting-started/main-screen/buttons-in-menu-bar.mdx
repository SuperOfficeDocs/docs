...
keywords: ['button', 'Personal settings menu', 'Main menu options']
...
The **top bar** contains essential tools for navigating SuperOffice CRM. The buttons vary slightly depending on where you are, but their functions remain consistent. For example, only **Personal settings**, **Main menu**, and **Help** are shown in **Settings and maintenance**.
