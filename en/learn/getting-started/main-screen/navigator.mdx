...
keywords: ['navigate', 'menu', 'side menu', 'left menu', 'user interface']
author: digitaldiina
date: 11.05.2025
so_version: 11.6
...
| <i class="ph ph-robot" aria-label="Agents icon"></i> | **[Agents][35]** | Work with **AI agents** that propose results for you to approve. |
