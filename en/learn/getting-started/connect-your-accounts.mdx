...
Once connected, you can also choose whether new emails you create, and email addresses you click, open in your own local email application instead of SuperOffice's own compose dialog. Enable this under [Personal settings > Preferences > Email][2], using the **Use local e-mail app for new e-mail** preference.
