...
sidebarTitle: "Company and contact relations"
...
keywords: ['add relation', 'delete relation', 'relation', 'person']
author: digitaldiina
date: 04.08.2026
so_version: 11.12
content_type: howto
...
related:
  - Delete items in SuperOffice CRM: /en/learn/basics/deleting-elements
  - Group information in section tabs: /en/learn/section-tabs/index
  - Add items to the General - Relation list: /en/admin/lists/specialized-lists#relation
  - Custom field relations: /en/custom-objects/learn/extra-field#relation
language: en
---
