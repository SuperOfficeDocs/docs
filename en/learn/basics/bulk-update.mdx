...
title: Update multiple records (bulk update)
...
related:
  - How do I fill in the "Legal base", "Consent source" and "Purpose" fields to many contacts in SuperOffice CRM all at the same time?: /en/security/privacy/learn/edit-legal-base#bulk
