...
keywords: ['section tab', 'sales archive']
...
related:
  - How to add a sale: /en/sale/learn/create
  - Managing stakeholders in sales: /en/sale/learn/stakeholders/index
  - Filter activities and sales: /en/learn/section-tabs/filter
...
## Sales tab columns overview {#columns}
