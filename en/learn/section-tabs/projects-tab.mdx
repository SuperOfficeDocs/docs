...
keywords: ['section tab', 'project archive']
...
related:
  - How to add a project: /en/project/learn/create
  - Filter projects: /en/learn/section-tabs/filter
...
## Projects tab columns overview {#columns}
