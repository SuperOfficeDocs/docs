...
related:
  ...
  - Filter the list of selection members: /en/search-options/selection/learn/index#filter
language: en
---
...
<Frame caption="Learn how to customize views by configuring columns with this short video, or read the instructions below">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/HYYI4ZCl4S4"
    title="Learn how to customize views by configuring columns with this short video, or read the instructions below"
    frameborder="0"
