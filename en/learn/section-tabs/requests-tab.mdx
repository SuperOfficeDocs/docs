...
keywords: ['section tab', 'request archive', 'ticket archive']
author: digitaldiina
date: 04.08.2026
so_version: 11.12
content_type: howto
...
redirect_from:
  - /en/contact/learn/screen/requests-tab
  - /en/company/learn/screen/requests-tab
related:
  - How to create a request: /en/request/learn/create
  - Managing customer requests in SuperOffice CRM: /en/request/learn/reply
  - Group columns and summarize amounts: /en/learn/section-tabs/configure-columns#calculate
language: en
---
...
## Requests tab columns overview {#columns}
