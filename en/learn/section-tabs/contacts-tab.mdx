...
keywords: ['section tab', 'contact archive', 'enable middle name']
...
related:
  - Create new contacts: /en/contact/learn/create
  - Delete contacts: /en/contact/learn/delete
  - Configure columns in section tabs: /en/learn/section-tabs/configure-columns
language: en
---
...
## Contacts tab columns overview {#columns}
