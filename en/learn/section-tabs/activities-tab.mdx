...
keywords: ['section tab', 'activity archive', 'download']
author: digitaldiina
date: 18.09.2026
so_version: 12.2
content_type: howto
...
related:
  - Introduction to activities: /en/learn/basics/activity
  - Create follow-ups: /en/diary/learn/create-follow-up
  - /en/learn/section-tabs/send-email
  - /en/diary/learn/change-completed-status
  - Delete activities in the activities list: /en/learn/basics/activity
  - Filter activities: /en/learn/section-tabs/filter
  - Group columns and summarize: /en/learn/section-tabs/configure-columns#calculate
language: en
---
...
## Activities tab columns overview {#columns}
...
* **Download an email or document:** Locate the item, right-click, and choose **Download** to save a copy to your device. Not available when multiple items are selected.

    ![Context menu on Activities archive for Contact -screenshot][img3]
