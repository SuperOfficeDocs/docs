...
keywords: ['add project member', 'new project member', 'Add/edit project members dialog', 'project member']
...
## Add project members and stakeholders from section tabs {#from-section-tab}
