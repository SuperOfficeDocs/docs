...
keywords: ['project guide', 'guide', 'workflow', 'Project guide section tab']
...
redirect_from:
  - /en/project/learn/project-guide/index
  - /en/project/learn/project-guide/project-guide-tab
  - /en/project/learn/project-guide/view-followups-and-documents
  - /en/project/learn/project-guide/working-with
related:
  - Introduction to projects: /en/project/learn/index
  - Create a project: /en/project/learn/create
  - Edit or deactivate a project guide: /en/project/learn/edit
language: en
---
...
## Project guide section tab {#project-guide-tab}
...
## Move to next status {#change-status}
...
[7]: ../../diary/learn/create-follow-up
[8]: ../../document/learn/edit
