...
redirect_from:
  - /en/project/learn/screen/project-type-admin
  - /en/admin/lists/learn/project-type
userflow_index: true
related:
  - Add a project status: /en/project/admin/project-status
  - Create a project guide: /en/project/admin/create-project-guide
  - Edit a project guide: /en/project/admin/edit-project-guide
language: en
---
...
## Restore a deleted project type {#restore}
