...
redirect_from:
  - /en/project/learn/project-guide/create
  - /en/project/learn/screen/project-guide-admin
userflow_index: true
related:
  - Edit or deactivate a project guide: /en/project/admin/edit-project-guide
language: en
---
...
## Create statuses for the project guide {#create-stage}
...
## Create a project type for the project guide {#create-type}
...
## Create a project guide {#create-guide}
...
## Add a follow-up for a status {#add-fo-status}
...
## Add a document for a status {#add-doc-status}
...
[1]: ../../document/templates/variables/from-project-card
[4]: ../../document/templates/learn/index
[2]: ./project-status
[3]: ./project-type
