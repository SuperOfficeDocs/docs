...
keywords: ['email', 'Mailgun', 'public domain key', 'domain name', 'DNS console', 'host record']
...
import EnvirGoogle from "../snippets/envir-google.md";
import HostedByEnom from "../snippets/hosted-by-enom.mdx";
import OpenGoogleDomainSettings from "../snippets/open-google-domain-settings.md";
import NoteDnsPropagationTime from "../snippets/note-dns-propagation-time.mdx";
import MultipleDkims from "../snippets/multiple-dkims.mdx";
...
[1]: https://community.superoffice.com/order-dkim/
