...
keywords: ['TLS', 'PKI', 'port 443']
author: Margrethe Romnes, AntonyYates
date: 03.22.2024
so_version: 12
...
* October 2025: Disabled weak cipher suites for TLS 1.2.
...
[1]: /en/api/plugins/erp-connectors/online/secure-in-online
