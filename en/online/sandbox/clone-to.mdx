...
title: Steps performed when we clone a source database to a production sandbox
sidebarTitle: "Clone sandbox"
description: Steps performed when we clone a source database to a production sandbox
keywords: ['tenant', 'test environment']
author: digitaldiina, Margrethe Halvorsen
date: 12.11.2024
so_version: 12
...
[1]: /en/customization/macros-and-scripts/admin/schedule-task
