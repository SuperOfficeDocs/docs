...
keywords: ['migrate', 'crm7.DATABASEMODEL']
author: AnthonyYates
date: 07.31.2026
...
When this error message appears, it's generally the result of one or more custom tables created with the SuperOffice Dictionary SDK, a means to modify the database schema before we introduced  Continuous Database (CDD) with version 8.1.
...
[2]: /en/database/tables/databasemodel
[3]: https://www.linqpad.net/Download.aspx
[4]: /downloads/database-imp-exp-tool.zip

[img1]: /media/loc/en/online/errordatabasemodel.png
[img2]: /media/loc/en/online/linqpadadditionalnamespaceimports.png
[img3]: /media/loc/en/online/linqpadadditionalreferences.png
[img4]: /media/loc/en/online/linqpadmissingtablesexample.png
[img5]: /media/loc/en/online/linqpadnomissingtables.png
[img6]: /media/loc/en/online/linqpadrun.png
[img8]: /media/loc/en/online/sequencedictionary.png
