...
title: SQL Server schema for Database Mirroring
sidebarTitle: "SQL Server schema"
description: SQL Server schema used by the Database Mirroring replica.
keywords: ['crm7', 'dbo', '_ReplicationState', 'TablePrefix']
...
[1]: ./setup-guide
[2]: ./migrate#schema-alignment
[3]: ./blocked-tables
[4]: ./force-resync
[5]: ./setup-guide#command-reference
