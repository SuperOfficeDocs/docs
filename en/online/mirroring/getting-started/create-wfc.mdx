---
title: Get your mirroring service up and running in 10 minutes or less using NuGet (legacy)
sidebarTitle: "Create WCF service (legacy)"
description: Get your mirroring service up and running in 10 minutes or less using NuGet
keywords: ['WCF', 'appSettings']
...
New deployments should use the outbound-only client instead and there is no NuGet package, no WCF service, and no certificate management. See [Set up the Database Mirroring client][4]. If you are migrating an existing legacy deployment, see [Migrate from the legacy mirroring service][5].
</Note>
...
[img1]: /media/loc/en/online/createwcfservice.png
[img2]: /media/loc/en/online/wcfservicedefaultsolution.png
[img3]: /media/loc/en/online/wcfservicesolution.png
[img4]: /media/loc/en/online/installdatabasemirroring.png
[img5]: /media/loc/en/online/packageconfig.png
[img6]: /media/loc/en/online/installpackagesuccess.png
[img7]: /media/loc/en/online/solutionpostinstall.png
[img8]: /media/loc/en/online/webconfigpostinstall.png
[img10]: /media/loc/en/online/wcfserviceiniis.png
[img11]: /media/loc/en/online/wcfserviceiniis-https.png
[img12]: /media/loc/en/online/system-servicemodel-config.png
