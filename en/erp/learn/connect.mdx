...
keywords: ['connect company to ERP', 'connect contact to ERP', 'connect project to ERP', 'can', 't find match in ERP', 'create in ERP', 'create actor', 'ERP actor']
author: digitaldiina
date: 06.10.2026
so_version: 12.0
content_type: howto
...
## Create an actor in the ERP system {#create-actor}
