...
keywords: ['ERP tab', 'ERP system', 'ERP actor', 'Sync connector', 'ERP connection', 'sync', 'connector', 'connection', 'Quote/Sync screen']
author: digitaldiina
date: 06.10.2026
so_version: 12.0
...
userflow_index: true
related:
  - Add a sync connector and define an ERP connection: /en/erp/admin/add-connection
  - Edit an ERP connection: /en/erp/admin/update-connection
  - Configure field mapping and default values: /en/erp/admin/configure
  - Set sync priority: /en/erp/admin/configure#priority
