...
keywords: ['configure sync', 'field mapping', 'list mapping', 'default values', 'rank ERP fields', 'set sync priority', 'edit ERP connection', 'SuperOffice ERP integration', 'ERP tab', 'sync connector']
