...
keywords: ['update ERP connection', 'change ERP settings', 'sync connector', 'ERP config', 'SuperOffice sync']
...
userflow_index: true
related:
  - /en/erp/admin/add-connection
  - Connect companies, contacts, and projects to ERP actors: /en/erp/learn/connect
language: en
---
