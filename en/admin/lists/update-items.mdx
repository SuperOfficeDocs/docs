...
userflow_index: true
related:
  - Customize privacy lists: /en/security/privacy/admin/add-source
  - Customize your sales lists: /en/sale/admin/sale-type
language: en
---
...
<Frame caption="Watch this video to learn how you can edit list items is SuperOffice CRM (video length - 2:05)">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/2fIAT0-EjX0"
    title="Watch this video to learn how you can edit list items is SuperOffice CRM (video length - 2:05)"
    frameborder="0"
...
<Frame caption="Watch this video to learn how to add and edit subscription types (video length - 2:00)">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/tBtLjFKnBj4"
    title="Watch this video to learn how to add and edit subscription types (video length - 2:00)"
    frameborder="0"
    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
    referrerpolicy="strict-origin-when-cross-origin"
    allowfullscreen
...
## Delete predefined and user-defined list items {#delete}
