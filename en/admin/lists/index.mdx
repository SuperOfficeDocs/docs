...
related:
  ...
  - Add user-defined lists: /en/admin/lists/user-defined-lists
  - Add a list item: /en/admin/lists/add-items
  - Edit or delete a list item: /en/admin/lists/update-items
language: en
---
...
[1]: /en/admin/lists/headings
[5]: /en/admin/lists/user-defined-lists
[7]: /en/admin/lists/user-group-filtering
[9]: /en/admin/lists/restore
[10]: /en/custom-objects/admin/edit-udef-layout
