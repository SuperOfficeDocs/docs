...
title: SMS configuration in Global preferences
description: SMS
...
userflow_index: true
related:
  - SMS configuration for Intelecom and PsWinCom (onsite): https://help.superoffice.com/docs/11/en/admin/preferences/sms.html
language: en
---
