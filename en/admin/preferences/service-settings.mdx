...
title: Global preferences for SuperOffice Service system settings
sidebarTitle: "Service system settings"
...
userflow_index: true
related:
  - Service settings (onsite): https://help.superoffice.com/docs/11/en/admin/preferences/service-settings.html
language: en
---
