...
userflow_index: true
related:
  - Preference section reference: /en/admin/user-preferences/reference/appointment-dialog
  - UserPreference database table: /en/database/tables/userpreference
  - Changing personal settings - in SuperOffice CRM: /en/learn/getting-started/preferences
  - Global preferences - in Settings and maintenance: /en/admin/preferences/index
language: en
---
...
[1]: /en/api/web-services/howto/user-preferences/get-preferences-preferenceagent
[2]: /en/api/web-services/howto/user-preferences/set-preferences-preferenceagent
[3]: /en/api/entities/howto/user-preferences/get-preferences-sopreference
[4]: /en/api/entities/howto/user-preferences/set-preferences-sopreference
[6]: /en/database/tables/userpreference
