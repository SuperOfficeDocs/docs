...
userflow_index: true
related:
  - Manage your roles: /en/admin/user-management/role/index
  - Add a new user: /en/admin/user-management/add-associate
  - Create a user group: /en/admin/user-management/user-groups
  - Change user plans for active users: /en/admin/license/user-plans#change
  - Activate and update licenses: /en/admin/license/activate
  - CRM Suite plans: /en/admin/license/crm-suite
language: en
---
...
[6]: /en/admin/user-management/role/index
[7]: /en/admin/user-management/role/functional-rights
[14]: /en/admin/adjusting-views
[15]: /en/admin/preferences/index
