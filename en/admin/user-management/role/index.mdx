...
userflow_index: true
related:
  - /en/admin/user-management/role/create-role
  - Edit or delete a role: /en/admin/user-management/role/update-role
  - /en/admin/user-management/role/set-data-rights-for-role
language: en
---
...
Using role-based security in SuperOffice CRM, you can customize roles for different access levels in the company. The roles control the access rights the different users have in SuperOffice CRM.
...
[3]: /en/admin/user-management/role/set-data-rights-for-role
[6]: /en/admin/user-management/role/functional-rights
