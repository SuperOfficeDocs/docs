...
title: SuperOffice user plans and subscriptions
sidebarTitle: "User plans"
...
userflow_index: true
related:
  - /en/admin/license/dev/user-plans
  - Add new user: /en/admin/user-management/add-associate
  - Roles overview: /en/admin/user-management/role/index
language: en
---

import Req2025Packaging from "../../../snippets/license/req-2025-packaging.mdx";
...
## Change user plans for active users {#change}
