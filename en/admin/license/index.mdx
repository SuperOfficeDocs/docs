...
title: SuperOffice and licenses
...
userflow_index: true
related:
  - /en/admin/license/user-plans
  - Buy and activate licenses: /en/admin/license/activate
  - Licenses in earlier versions of SuperOffice: https://help.superoffice.com/Documentation/Help/EN/CRM/WebHelpAdmin/index.htm#t=chap03%2FCRM_and_licences.htm
  - System events: https://help.superoffice.com/docs/11/en/admin/onsite/add-system-event.html
  - /en/admin/license/dev/module-licenses
  - /en/admin/license/dev/hidden-licenses
  - /en/admin/license/dev/index
language: en
---
...
<Tabs>
<Tab title="Module-based subscriptions">
...
[16]: /en/admin/license/crm-suite
[1]: /en/admin/license/activate
[2]: /en/saint/learn/index
