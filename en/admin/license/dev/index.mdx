...
[5]: /en/api/reference/restful/agent/License_Agent/v1License_GetThirdPartyLicenseAssignments
[6]: /en/api/reference/restful/agent/License_Agent/v1User_GetCurrentPrincipal
