...
keywords: ['license server', 'LicenseAgent', 'Client Access Licenses', 'site license', 'licence']
author: xt1
date: 09.15.2026
so_version: 12.0
...
[1]: /en/admin/license/dev/user-plans
[2]: /en/api/reference/webapi/SuperOffice.License.SoLicenseNames
[3]: /en/admin/license/dev/hidden-licenses
[4]: /en/api/reference/restful/agent/license_agent/get-user-licenses
[5]: /en/api/reference/restful/agent/license_agent/get-third-party-license-assignments
[6]: /en/api/reference/restful/rest/user/get-current-principal
