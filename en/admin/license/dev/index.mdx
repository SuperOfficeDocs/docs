...
[4]: /en/api/reference/restful/agent/License_Agent/v1LicenseAgent_GetUserLicenses
[5]: /en/api/reference/restful/agent/License_Agent/v1LicenseAgent_GetThirdPartyLicenseAssignments
[6]: /en/api/reference/restful/rest/User/v1User_GetCurrentPrincipal
