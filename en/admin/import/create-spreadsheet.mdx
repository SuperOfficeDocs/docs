...
keywords: ['Excel', 'company', 'contact', 'product', 'spreadsheet', 'import company', 'import contact', 'import product']
author: digitaldiina
date: 09.15.2026
so_version: 10.5
content_type: howto
...
userflow_index: true
related:
  - Choosing settings for your import: /en/admin/import/settings
  - Import contacts to SuperOffice CRM: /en/admin/import/from-excel
  - Import products into a price list: /en/admin/import/products-from-excel
language: en
---
...
[Download the import template for companies and contacts][1] [Excel spreadsheet, ZIP]
...
[Download the import template for products][2] [Excel spreadsheet, ZIP]
