...
keywords: ['company', 'contact', 'spreadsheet', 'import company', 'import contact', 'import product']
author: digitaldiina
date: 09.15.2026
so_version: 10.5
content_type: howto
...
userflow_index: true
related:
  - /en/admin/import/settings
  - /en/admin/import/from-gmail
  - /en/admin/import/from-erp
language: en
---
