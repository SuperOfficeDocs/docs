...
tier: core
platform: mobile
redirect_from: /en/mobile/superoffice-mobile/interface-guide
related:
  - About Mobile CRM: /en/mobile/index
  - Install and log in: /en/mobile/login
  - /en/mobile/settings
language: en
userflow_index: true
---
...
1. Drag it to a new position.
1. Release to save it.

<Note>
The position is saved per device.
</Note>

![New button - Move the + button -app-screen][img6]
...
## Configure visible fields {#visible-fields}
...
[img6]: /media/loc/en/mobile/mobile-crm-move-add-button.png
