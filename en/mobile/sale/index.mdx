...
related:
  - Create a sale: /en/mobile/sale/create
  - Update a sale: /en/mobile/sale/update
  - About sales guides: /en/sale/learn/sales-guides
  - Quote approval flow: /en/mobile/sale/approve-quote
language: en
---
...
* In the **Stakeholders** list, each contact shows a person-type icon: green for you, blue for a colleague, grey for an external contact.
<ListOfTips />
