...
related:
  - /en/mobile/project/create
  - /en/mobile/project/update
  - Delete project (in SuperOffice CRM): /en/project/learn/delete
  - /en/project/learn/project-guides
  - /en/project/learn/project-members/index
  - Send SMS and email to project members: /en/mobile/send-email-sms
  - Send a document to project members (as mailing): /en/project/learn/project-members/create-mailing
language: en
---
...
| <i class="ph ph-link" aria-label="Chain"></i> | Links | Activities, sales, projects, documents, or websites connected to the project. |
...
![Click on the Links field to go to all connecting links -app-screen][img3]

### Tips

* Tap a linked item (such as person, activity, document) to open it.
* In the **Project members** list, each contact shows a person-type icon: green for you, blue for a colleague, grey for an external contact.
<ListOfTips />

[img1]: /media/loc/en/mobile/project.png
[img2]: /media/loc/en/mobile/mobile-crm-project-projectmember-internal-external.png
[img3]: /media/loc/en/mobile/mobile-crm-project-links.png
