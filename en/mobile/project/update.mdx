...
keywords: ['edit project', 'add project member', 'remove project member', 'change status', 'next status', 'previous status', 'project phase']
author: digitaldiina
date: 06.10.2026
so_version: 11.1
content_type: howto
...
related:
  - Create project (in Mobile CRM): /en/mobile/project/create
  - Delete a project (in SuperOffice CRM): /en/project/learn/delete
