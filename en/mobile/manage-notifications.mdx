...
tier: core
platform: mobile
redirect_from: /en/mobile/superoffice-mobile/manage-notifications
related:
  - Notification settings - full list of options: /en/mobile/settings#notifications
  - Request notifications: /en/mobile/request/index#notifications
language: en
---
