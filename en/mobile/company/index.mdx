...
related:
  - Create contact: /en/mobile/company/create
  - Copy company info to local address book: /en/mobile/contact/copy-to-contact-list
...
* In the **Contacts** list, each contact shows a person-type icon: green for you, blue for a colleague, grey for an external contact.
<ListOfTips />
