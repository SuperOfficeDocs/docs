...
related:
  ...
  - Update request properties: /en/mobile/request/update
  - Reply or add comment: /en/mobile/request/respond#reply
  - Forward a request: /en/mobile/request/respond#forward
  - Introduction to request management: /en/request/learn/index
  - Request relations: /en/request/learn/request-relations
language: en
---
...
Requests can be linked to each other, for example as parent and child, or as related items.

In the **Related requests** section, each linked request shows its relation type, ID, and title. Tap an entry to open it.

<Note>
[Add, edit, or delete][7] request relations in SuperOffice CRM.
</Note>

![Request with related requests shown as hierarchy or side-by-side -app-screen][img6]
![Screen shows all the related requests to the current request -app-screen][img7]

## Summarize a request (AI Lab pilot program)

1. Open the request.
1. In the **Summarize** section, tap **Generate**.
1. Read the summary of the conversation.

![Request shows the summarize section -app-screen][img8]

[6]: /en/mobile/settings
[7]: /en/request/learn/request-relations
...
[img6]: /media/loc/en/mobile/mobile-crm-request-with-related-requests.png
[img7]: /media/loc/en/mobile/mobile-crm-request-all-related-requests-screen.png
[img8]: /media/loc/en/mobile/mobile-crm-request-summarize.png
