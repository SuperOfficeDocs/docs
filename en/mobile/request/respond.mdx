...
sidebarTitle: "Respond to requests"
...
redirect_from:
  ...
  - /en/mobile/superoffice-mobile/request/respond
related:
  - /en/mobile/request/update
  - Create reply template (in SuperOffice CRM): /en/knowledge-base/learn/reply-templates/create
  - Create FAQ entry (in SuperOffice CRM): /en/knowledge-base/learn/faq/create
language: en
---
...
## Reply / reply all <i class="ph ph-arrow-bend-up-left" aria-hidden="true"></i> {#reply}
...
1. Open the request and find the message.
1. Tap the message and select **Reply**.
1. Choose which contacts (internal or external) get the reply.
1. Write your message and tap **Send**.

![Request reply to a single message -app-screen][img6]
...
## Forward <i class="ph ph-arrow-bend-up-right" aria-label="Forward"></i> {#forward}
...
## Call customer <i class="ph ph-phone" aria-hidden="true"></i> {#call}
...
[1]: ../../request/learn/forward
[3]: ../../knowledge-base/learn/reply-templates/index
[4]: ../../knowledge-base/learn/faq/index
...
[img6]: /media/loc/en/mobile/mobile-crm-request-message-single-reply.png
