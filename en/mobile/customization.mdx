...
keywords: ['shown in Mobile CRM', 'mobile', 'pocket', 'CRMScript']
author: digitaldiina
date: 06.10.2026
so_version: 11.1
...
related:
  - About CRMScript: /en/automation/crmscript/overview/index
  - Create trigger script: /en/automation/trigger/create-trigger-script
  - Add custom task: /en/automation/trigger/reference/index
  - Tutorial - how to use dialogs in triggers: /en/automation/crmscript/tutorials/using-dialogs-in-triggers
language: en
---
