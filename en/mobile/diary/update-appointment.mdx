...
keywords: ['diary', 'appointment', 'meeting']
author: digitaldiina
date: 09.18.2026
so_version: 11.1.16
content_type: howto
...
If this is a [repeating follow-up][1], only the current instance of it is updated. Future instances remain unchanged.

## Add a voice note

1. Open the follow-up and tap **Edit**.
1. In **Agenda** or **Internal notes**, tap the **Task** icon (<i class="ph ph-dots-three-circle-vertical" aria-hidden="true"></i>) and select **Add voice note**.
1. Record your note, then tap **Stop**.
1. Check the text. Filler words and punctuation are cleaned up automatically.
1. Tap **Save**.

![Task menu on the Agenda screen showing the Add voice note option -app-screen][img1]
...
* **Long press:** Press and hold the follow-up in a list, then select **Complete**.
...
[1]: ./create-appointment#repeat

[img1]: /media/loc/en/mobile/mobile-appointment-add-voice-note.png
