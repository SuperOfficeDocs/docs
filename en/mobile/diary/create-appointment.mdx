...
related:
  ...
  - Desktop: /en/diary/learn/recurrence/create
language: en
---
...
You can turn a follow-up into a recurring series without leaving Mobile CRM, the same way recurring follow-ups already work in the desktop and web client.
...
<Note>
Mobile CRM offers a fixed set of frequencies rather than the desktop client's full custom pattern builder, and every series must be bounded by an end date or a number of repeats.
</Note>
