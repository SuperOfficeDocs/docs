...
description: "Ticket status values: Open, Closed, Inactive, Deleted, Connected and Spam."
generated: true
content_type: reference
envir: online
---

Ticket status values: Open, Closed, Inactive, Deleted, Connected and Spam.

Implemented by the `SuperOffice.CRM.Lists.TicketStatusProvider` class.
