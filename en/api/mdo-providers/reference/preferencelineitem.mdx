...
Consider using the `CreateAdditionalInfo` method to avoid coding formatting dependencies.
...
Implemented by the `SuperOffice.CRM.Lists.PreferenceLineItemProvider` class.
