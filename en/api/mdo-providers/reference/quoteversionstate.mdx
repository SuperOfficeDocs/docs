...
description: List provider for the QuoteVersionState enum
generated: true
...
List provider for the [QuoteVersionState](/en/api/reference/webapi/SuperOffice.WebApi.Data.QuoteVersionState) enum
