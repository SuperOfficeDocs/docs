...
sidebarTitle: "Contact Person Passive"
...
```cs
var listProvider = ClassFactory.CreateRequired<SuperOffice.CRM.Lists.ISoListProviderFactory>().Create("relationssearchlistprovidercontactpersonpassive", forceFlatList: true);
