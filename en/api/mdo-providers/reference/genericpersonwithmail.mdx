...
description: "List of persons with mail. Supports Selection(any type), project and associate. Uses an inner provider `PersonWithMailListProvider`."
generated: true
...
Uses an inner provider `PersonWithMailListProvider`.

Implemented by the `SuperOffice.CRM.Lists.GenericPersonWithMailListProvider` class.
