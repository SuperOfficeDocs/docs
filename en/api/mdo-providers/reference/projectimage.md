...
Implemented by the `ProjectImageProvider` class.
...
```cs
var listProvider = ClassFactory.CreateRequired<SuperOffice.CRM.Lists.ISoListProviderFactory>().Create("projectimage", forceFlatList: true);
