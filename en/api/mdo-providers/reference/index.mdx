...
| [Allpersonwithassociatesearch](./allpersonwithassociatesearch) |Provides the same baseline functionality as AllPersonListSearchProvider, but additionally adds the associateId of the person to the extrainf|
...
| [Appointmenttask](./appointmenttask) |MDO list provider for the task list of the AppointmentDialog. This list extends the basic TaskRow wit|
...
| [Eventhandlertype](./eventhandlertype) |Screen trigger event types: members of [EventHandlerType](/en/api/reference/webapi/SuperOffice.WebApi.Data.EventHandlerType) enum.|
...
| [Marketing_freetextsearch](./marketing_freetextsearch) |Freetext search across the three real tables backing Marketing entities (mailings, forms, emai|
...
| [Quotelinestatus](./quotelinestatus) |Hard-coded list of values for the QuoteLine.Status field, see [QuoteStatus](/en/api/reference/webapi/SuperOffice.WebApi.Data.QuoteStatus) enum.|
...
| [Quoteversionstate](./quoteversionstate) |List provider for the [QuoteVersionState](/en/api/reference/webapi/SuperOffice.WebApi.Data.QuoteVersionState) enum|
...
| [Saleprobability](./saleprobability) |MDO list provider for the probability list of the Sale dialog. This list extends the basic ProbRow list with a leadin|
