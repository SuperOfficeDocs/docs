...
description: "MDO list provider for the source list of the Sale dialog. This list extends the basic `SourceRow` list with icons"
generated: true
...
This list extends the basic `SourceRow` list with icons

Implemented by the `SuperOffice.CRM.Lists.SaleSource` class.
