...
Implemented by the `FaqReplyTemplateFavouriteListProvider` class.
...
```cs
var listProvider = ClassFactory.CreateRequired<SuperOffice.CRM.Lists.ISoListProviderFactory>().Create("faqreplytemplatefavourite", forceFlatList: true);
