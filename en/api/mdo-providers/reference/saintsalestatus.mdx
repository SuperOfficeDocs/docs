...
description: "This SoList provider generates the sale status list for the Saint criteria. This is a simple, hard-coded list corresponding to the status field of the `Sale` table."
generated: true
...
to the status field of the `Sale` table.

Implemented by the `SuperOffice.CRM.ArchiveLists.SaintSaleStatusProvider` class.
