...
description: "Returns associates with their email addresses in the format \"Full Name &lt;email&gt;\". Associates without an e-mail address are returned as \"Full Name\"."
generated: true
content_type: reference
envir: online
---

Returns associates with their email addresses in the format "Full Name &lt;email&gt;".
Associates without an e-mail address are returned as "Full Name".

Deleted associates are not returned unless requested using the additional_info "get_deleted=true" parameter.

Implemented by the `SuperOffice.CRM.Lists.AssociateWithMailProvider` class.
