...
Implemented by the `VisibleForListProvider` class.
...
```cs
var listProvider = ClassFactory.CreateRequired<SuperOffice.CRM.Lists.ISoListProviderFactory>().Create("visiblefor", forceFlatList: true);
