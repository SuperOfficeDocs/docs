...
sidebarTitle: "Document Appointment Passive"
keywords: ['mdoprovider mdo provider relationssearchlistproviderdocumentappointmentpassive']
...
Implemented by the `RelationsSearchListProvider` class.
...
```cs
var listProvider = ClassFactory.CreateRequired<SuperOffice.CRM.Lists.ISoListProviderFactory>().Create("relationssearchlistproviderdocumentappointmentpassive", forceFlatList: true);
