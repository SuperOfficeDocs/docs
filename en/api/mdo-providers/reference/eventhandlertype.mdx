...
description: Screen trigger event types - members of EventHandlerType enum.
generated: true
...
Screen trigger event types: members of [EventHandlerType](/en/api/reference/webapi/SuperOffice.WebApi.Data.EventHandlerType) enum.
