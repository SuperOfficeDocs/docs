...
description: "List of persons with mail. Supports Selection(any type), project and associate. Uses an inner provider `PersonListGenericContactProjectProvider`."
generated: true
...
Uses an inner provider `PersonListGenericContactProjectProvider`.

Implemented by the `SuperOffice.CRM.Lists.GenericPersonListProvider` class.
