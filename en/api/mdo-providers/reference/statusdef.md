...
Implemented by the `StatusDefProvider` class.
...
```cs
var listProvider = ClassFactory.CreateRequired<SuperOffice.CRM.Lists.ISoListProviderFactory>().Create("statusdef", forceFlatList: true);
