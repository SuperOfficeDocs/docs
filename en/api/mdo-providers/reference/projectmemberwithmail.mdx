...
description: "List of project members fetched based on provided criteria Output is in format: \"Person Full Name &lt;person@mail.com&gt;\""
generated: true
content_type: reference
envir: online
---

List of project members fetched based on provided criteria
Output is in format: "Person Full Name &lt;person@mail.com&gt;"

Implemented by the `SuperOffice.CRM.Lists.ProjectMemberWithMailListProvider` class.
