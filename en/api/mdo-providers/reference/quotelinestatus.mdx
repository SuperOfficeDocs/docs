...
description: Hard-coded list of values for the QuoteLine.Status field, see QuoteStatus enum.
generated: true
...
Hard-coded list of values for the QuoteLine.Status field, see [QuoteStatus](/en/api/reference/webapi/SuperOffice.WebApi.Data.QuoteStatus) enum.
