...
Implemented by the `QuoteAlternativeProvider` class.
...
```cs
var listProvider = ClassFactory.CreateRequired<SuperOffice.CRM.Lists.ISoListProviderFactory>().Create("quotealternatives", forceFlatList: true);
