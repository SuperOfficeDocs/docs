...
Use the [UserPreferenceStrings](/en/api/reference/webapi/SuperOffice.WebApi.Data.UserPreferenceStrings) class to avoid (mis)coding preference section and key names as strings.
...
|-----|-----|------|
|Preference section name, optionally followed by ';'-separated options: excludesystemwide to exclude preferences that belong in the System Settings gui; crmgui and/or admingui to restrict to preferences that have any of the named GUI access flags (default: both)| |Functions|
