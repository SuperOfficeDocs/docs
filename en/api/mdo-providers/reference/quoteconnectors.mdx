...
Implementation relies on the `QuoteConnectorProvider` archivelist, and simply reformats its data

Implemented by the `SuperOffice.CRM.Lists.QuoteConnectors` class.
