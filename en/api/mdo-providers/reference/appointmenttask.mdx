...
description: "MDO list provider for the task list of the AppointmentDialog. This list extends the basic `TaskRow` with specialized icons based on the `TaskType`."
generated: true
content_type: reference
envir: online
---

MDO list provider for the task list of the AppointmentDialog. This list extends the basic `TaskRow` with
specialized icons based on the `TaskType`.

Implemented by the `SuperOffice.CRM.Lists.AppointmentTaskProvider` class.
