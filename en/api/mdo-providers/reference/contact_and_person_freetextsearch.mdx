...
* Name = Person or PersonContact or ContactPerson
* AddContact = true or false - add a contact item for person items
* ExpandContact = TRUE or false - add all persons for a contact items
* SkipRetired = TRUE or false - skip retired persons
* ContactId = 123 - boost persons belonging to contact id in results rank
...
Implemented by the `SuperOffice.CRM.Lists.ContactAndPersonListFreetextSearchProvider` class.
