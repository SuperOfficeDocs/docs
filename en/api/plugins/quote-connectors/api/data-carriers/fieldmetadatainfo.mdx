...
The GUI will use this info to build the user interface controls. The call to the ERP Connector's [`GetConfigurationFields`](../iquoteconnector#get-configuration-fields) method returns a list of fields and field types. The Admin client builds a dialog with these fields.
...
[img1]: /media/loc/en/api/plugins/image031.jpg
