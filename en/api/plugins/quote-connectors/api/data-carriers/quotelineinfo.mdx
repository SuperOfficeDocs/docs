...
import Rights from "../includes/rights.md";
import QuoteExtrafield from "./includes/quote-extrafield.md";
...
[img1]: /media/loc/en/api/plugins/image029.jpg
[img2]: /media/loc/en/api/plugins/image030.jpg
