...
[0]: /en/api/plugins/quote-connectors/online-quote-connectors/index
[1]: /en/developer-portal/create-app/sync-app
[2]: /en/developer-portal/create-app/config/update-endpoints
[3]: /en/erp/admin/add-connection
[4]: /en/api/plugins/quote-connectors/set-up#pluginresponseinfo-testconnection--dictionarystring-string-connectiondata-connectiondata-
...
[img1]: /media/loc/en/api/plugins/interfaces.png
[img2]: /media/loc/en/api/plugins/quotedatabase.png
[img3]: /media/loc/en/api/tutorials/image001-1.png
