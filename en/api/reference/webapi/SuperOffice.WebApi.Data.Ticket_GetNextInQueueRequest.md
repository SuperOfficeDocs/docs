...
```csharp
public class Ticket_GetNextInQueueRequest
```
...
### <a id="SuperOffice_WebApi_Data_Ticket_GetNextInQueueRequest__ctor"></a> Ticket\_GetNextInQueueRequest\(\)

```csharp
public Ticket_GetNextInQueueRequest()
```
