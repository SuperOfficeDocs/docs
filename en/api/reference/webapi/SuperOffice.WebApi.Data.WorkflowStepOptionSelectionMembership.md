...
```csharp
public class WorkflowStepOptionSelectionMembership : WorkflowStepOptionBase
```
...
### <a id="SuperOffice_WebApi_Data_WorkflowStepOptionSelectionMembership__ctor"></a> WorkflowStepOptionSelectionMembership\(\)

Default constructor - defaults any enum props to 0.

```csharp
public WorkflowStepOptionSelectionMembership()
```

## Properties

### <a id="SuperOffice_WebApi_Data_WorkflowStepOptionSelectionMembership_SelectionId"></a> SelectionId
