...
```csharp
public class User_CreateUserGroupRequest
```
...
### <a id="SuperOffice_WebApi_Data_User_CreateUserGroupRequest__ctor"></a> User\_CreateUserGroupRequest\(\)

```csharp
public User_CreateUserGroupRequest()
```
