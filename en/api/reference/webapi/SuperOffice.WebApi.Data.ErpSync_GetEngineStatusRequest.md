...
```csharp
public class ErpSync_GetEngineStatusRequest
```
...
### <a id="SuperOffice_WebApi_Data_ErpSync_GetEngineStatusRequest__ctor"></a> ErpSync\_GetEngineStatusRequest\(\)

```csharp
public ErpSync_GetEngineStatusRequest()
```
