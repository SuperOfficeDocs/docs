...
```csharp
public class EMail_CacheFolderListRequest
```
...
### <a id="SuperOffice_WebApi_Data_EMail_CacheFolderListRequest__ctor"></a> EMail\_CacheFolderListRequest\(\)

```csharp
public EMail_CacheFolderListRequest()
```
