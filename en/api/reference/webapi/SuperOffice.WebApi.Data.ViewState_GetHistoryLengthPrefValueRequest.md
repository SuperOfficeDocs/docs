...
```csharp
public class ViewState_GetHistoryLengthPrefValueRequest
```
...
### <a id="SuperOffice_WebApi_Data_ViewState_GetHistoryLengthPrefValueRequest__ctor"></a> ViewState\_GetHistoryLengthPrefValueRequest\(\)

```csharp
public ViewState_GetHistoryLengthPrefValueRequest()
```
