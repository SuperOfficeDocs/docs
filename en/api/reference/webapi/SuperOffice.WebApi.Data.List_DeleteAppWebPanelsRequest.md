...
```csharp
public class List_DeleteAppWebPanelsRequest
```
...
### <a id="SuperOffice_WebApi_Data_List_DeleteAppWebPanelsRequest__ctor"></a> List\_DeleteAppWebPanelsRequest\(\)

```csharp
public List_DeleteAppWebPanelsRequest()
```
