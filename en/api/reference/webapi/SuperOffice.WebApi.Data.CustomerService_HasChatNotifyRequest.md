...
```csharp
public class CustomerService_HasChatNotifyRequest
```
...
### <a id="SuperOffice_WebApi_Data_CustomerService_HasChatNotifyRequest__ctor"></a> CustomerService\_HasChatNotifyRequest\(\)

```csharp
public CustomerService_HasChatNotifyRequest()
```
