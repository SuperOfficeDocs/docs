...
```csharp
public class TimeZone_UpdateTimeZoneDataRequest
```
...
### <a id="SuperOffice_WebApi_Data_TimeZone_UpdateTimeZoneDataRequest__ctor"></a> TimeZone\_UpdateTimeZoneDataRequest\(\)

```csharp
public TimeZone_UpdateTimeZoneDataRequest()
```
