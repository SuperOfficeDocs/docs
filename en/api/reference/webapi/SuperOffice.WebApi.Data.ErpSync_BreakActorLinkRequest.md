...
```csharp
public class ErpSync_BreakActorLinkRequest
```
...
### <a id="SuperOffice_WebApi_Data_ErpSync_BreakActorLinkRequest__ctor"></a> ErpSync\_BreakActorLinkRequest\(\)

```csharp
public ErpSync_BreakActorLinkRequest()
```

## Properties

### <a id="SuperOffice_WebApi_Data_ErpSync_BreakActorLinkRequest_CrmActorType"></a> CrmActorType
...
### <a id="SuperOffice_WebApi_Data_ErpSync_BreakActorLinkRequest_ErpConnectionId"></a> ErpConnectionId
