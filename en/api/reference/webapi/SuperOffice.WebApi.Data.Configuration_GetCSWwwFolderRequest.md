...
```csharp
public class Configuration_GetCSWwwFolderRequest
```
...
### <a id="SuperOffice_WebApi_Data_Configuration_GetCSWwwFolderRequest__ctor"></a> Configuration\_GetCSWwwFolderRequest\(\)

```csharp
public Configuration_GetCSWwwFolderRequest()
```
