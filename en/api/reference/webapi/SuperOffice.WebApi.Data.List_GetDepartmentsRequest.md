...
```csharp
public class List_GetDepartmentsRequest
```
...
### <a id="SuperOffice_WebApi_Data_List_GetDepartmentsRequest__ctor"></a> List\_GetDepartmentsRequest\(\)

```csharp
public List_GetDepartmentsRequest()
```
