...
```csharp
public class Diagnostics_ResyncUsersRequest
```
...
### <a id="SuperOffice_WebApi_Data_Diagnostics_ResyncUsersRequest__ctor"></a> Diagnostics\_ResyncUsersRequest\(\)

```csharp
public Diagnostics_ResyncUsersRequest()
```
