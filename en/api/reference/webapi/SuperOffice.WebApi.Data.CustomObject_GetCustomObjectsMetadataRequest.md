...
```csharp
public class CustomObject_GetCustomObjectsMetadataRequest
```
...
### <a id="SuperOffice_WebApi_Data_CustomObject_GetCustomObjectsMetadataRequest__ctor"></a> CustomObject\_GetCustomObjectsMetadataRequest\(\)

```csharp
public CustomObject_GetCustomObjectsMetadataRequest()
```
