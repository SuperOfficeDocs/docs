...
```csharp
public class EMail_GetEMailAsStreamRequest
```
...
### <a id="SuperOffice_WebApi_Data_EMail_GetEMailAsStreamRequest__ctor"></a> EMail\_GetEMailAsStreamRequest\(\)

```csharp
public EMail_GetEMailAsStreamRequest()
```

## Properties

### <a id="SuperOffice_WebApi_Data_EMail_GetEMailAsStreamRequest_ConnectionInfo"></a> ConnectionInfo
...
### <a id="SuperOffice_WebApi_Data_EMail_GetEMailAsStreamRequest_StripAttachments"></a> StripAttachments
