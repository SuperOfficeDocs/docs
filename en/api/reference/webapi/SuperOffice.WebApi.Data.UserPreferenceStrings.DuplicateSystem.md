...
```csharp
public static class UserPreferenceStrings.DuplicateSystem
```
...
### <a id="SuperOffice_WebApi_Data_UserPreferenceStrings_DuplicateSystem_Section"></a> Section

Section heading

```csharp
public const string Section = "DuplicateSystem"
```
