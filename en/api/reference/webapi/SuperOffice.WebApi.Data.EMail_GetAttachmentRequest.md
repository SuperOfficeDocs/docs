...
```csharp
public class EMail_GetAttachmentRequest
```
...
### <a id="SuperOffice_WebApi_Data_EMail_GetAttachmentRequest__ctor"></a> EMail\_GetAttachmentRequest\(\)

```csharp
public EMail_GetAttachmentRequest()
```

## Properties

### <a id="SuperOffice_WebApi_Data_EMail_GetAttachmentRequest_AttachmentId"></a> AttachmentId
...
### <a id="SuperOffice_WebApi_Data_EMail_GetAttachmentRequest_ConnectionInfo"></a> ConnectionInfo
