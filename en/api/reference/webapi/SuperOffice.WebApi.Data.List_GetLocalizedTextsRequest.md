...
```csharp
public class List_GetLocalizedTextsRequest
```
...
### <a id="SuperOffice_WebApi_Data_List_GetLocalizedTextsRequest__ctor"></a> List\_GetLocalizedTextsRequest\(\)

```csharp
public List_GetLocalizedTextsRequest()
```
