...
```csharp
public static class UserPreferenceStrings.Targets
```
...
### <a id="SuperOffice_WebApi_Data_UserPreferenceStrings_Targets_Section"></a> Section

```csharp
public const string Section = "Targets"
```
...
### <a id="SuperOffice_WebApi_Data_UserPreferenceStrings_Targets_TargetPeriod"></a> TargetPeriod
