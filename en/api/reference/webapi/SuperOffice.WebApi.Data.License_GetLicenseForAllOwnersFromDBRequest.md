...
```csharp
public class License_GetLicenseForAllOwnersFromDBRequest
```
...
### <a id="SuperOffice_WebApi_Data_License_GetLicenseForAllOwnersFromDBRequest__ctor"></a> License\_GetLicenseForAllOwnersFromDBRequest\(\)

```csharp
public License_GetLicenseForAllOwnersFromDBRequest()
```
