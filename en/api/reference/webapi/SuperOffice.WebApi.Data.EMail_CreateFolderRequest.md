...
```csharp
public class EMail_CreateFolderRequest
```
...
### <a id="SuperOffice_WebApi_Data_EMail_CreateFolderRequest__ctor"></a> EMail\_CreateFolderRequest\(\)

```csharp
public EMail_CreateFolderRequest()
```

## Properties

### <a id="SuperOffice_WebApi_Data_EMail_CreateFolderRequest_ConnectionInfo"></a> ConnectionInfo
