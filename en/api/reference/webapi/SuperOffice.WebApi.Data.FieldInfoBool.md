# <a id="SuperOffice_WebApi_Data_FieldInfoBool"></a> Class FieldInfoBool
...
```csharp
public class FieldInfoBool : FieldInfoBase
```
...
### <a id="SuperOffice_WebApi_Data_FieldInfoBool__ctor"></a> FieldInfoBool\(\)

Default constructor - defaults any enum props to 0.

```csharp
public FieldInfoBool()
```

## Properties

### <a id="SuperOffice_WebApi_Data_FieldInfoBool_DefaultValue"></a> DefaultValue
