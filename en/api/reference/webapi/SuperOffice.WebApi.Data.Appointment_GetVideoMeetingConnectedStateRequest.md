...
```csharp
public class Appointment_GetVideoMeetingConnectedStateRequest
```
...
### <a id="SuperOffice_WebApi_Data_Appointment_GetVideoMeetingConnectedStateRequest__ctor"></a> Appointment\_GetVideoMeetingConnectedStateRequest\(\)

```csharp
public Appointment_GetVideoMeetingConnectedStateRequest()
```
