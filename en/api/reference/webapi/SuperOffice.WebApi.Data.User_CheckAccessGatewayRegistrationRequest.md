...
```csharp
public class User_CheckAccessGatewayRegistrationRequest
```
...
### <a id="SuperOffice_WebApi_Data_User_CheckAccessGatewayRegistrationRequest__ctor"></a> User\_CheckAccessGatewayRegistrationRequest\(\)

```csharp
public User_CheckAccessGatewayRegistrationRequest()
```
