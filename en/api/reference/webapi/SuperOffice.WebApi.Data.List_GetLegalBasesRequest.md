...
```csharp
public class List_GetLegalBasesRequest
```
...
### <a id="SuperOffice_WebApi_Data_List_GetLegalBasesRequest__ctor"></a> List\_GetLegalBasesRequest\(\)

```csharp
public List_GetLegalBasesRequest()
```
