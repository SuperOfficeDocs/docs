...
```csharp
public class License_GetCentralLicenseRequest
```
...
### <a id="SuperOffice_WebApi_Data_License_GetCentralLicenseRequest__ctor"></a> License\_GetCentralLicenseRequest\(\)

```csharp
public License_GetCentralLicenseRequest()
```
