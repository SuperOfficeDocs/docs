...
```csharp
public class UserDefinedFieldInfo_ClearCachesRequest
```
...
### <a id="SuperOffice_WebApi_Data_UserDefinedFieldInfo_ClearCachesRequest__ctor"></a> UserDefinedFieldInfo\_ClearCachesRequest\(\)

```csharp
public UserDefinedFieldInfo_ClearCachesRequest()
```
