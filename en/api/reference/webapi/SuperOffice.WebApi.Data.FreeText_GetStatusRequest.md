...
```csharp
public class FreeText_GetStatusRequest
```
...
### <a id="SuperOffice_WebApi_Data_FreeText_GetStatusRequest__ctor"></a> FreeText\_GetStatusRequest\(\)

```csharp
public FreeText_GetStatusRequest()
```
