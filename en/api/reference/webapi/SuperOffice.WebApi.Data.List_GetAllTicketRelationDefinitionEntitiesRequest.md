...
```csharp
public class List_GetAllTicketRelationDefinitionEntitiesRequest
```
...
### <a id="SuperOffice_WebApi_Data_List_GetAllTicketRelationDefinitionEntitiesRequest__ctor"></a> List\_GetAllTicketRelationDefinitionEntitiesRequest\(\)

```csharp
public List_GetAllTicketRelationDefinitionEntitiesRequest()
```
