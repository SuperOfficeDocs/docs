...
```csharp
public class Archive_GetActivityFilterRequest
```
...
### <a id="SuperOffice_WebApi_Data_Archive_GetActivityFilterRequest__ctor"></a> Archive\_GetActivityFilterRequest\(\)

```csharp
public Archive_GetActivityFilterRequest()
```
