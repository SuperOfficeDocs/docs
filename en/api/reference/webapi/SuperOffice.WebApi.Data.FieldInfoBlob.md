# <a id="SuperOffice_WebApi_Data_FieldInfoBlob"></a> Class FieldInfoBlob
...
```csharp
public class FieldInfoBlob : FieldInfoBase
```
...
### <a id="SuperOffice_WebApi_Data_FieldInfoBlob__ctor"></a> FieldInfoBlob\(\)

Default constructor - defaults any enum props to 0.

```csharp
public FieldInfoBlob()
```
