# <a id="SuperOffice_WebApi_Data_FieldInfoInt"></a> Class FieldInfoInt
...
```csharp
public class FieldInfoInt : FieldInfoBase
```
...
### <a id="SuperOffice_WebApi_Data_FieldInfoInt__ctor"></a> FieldInfoInt\(\)
...
### <a id="SuperOffice_WebApi_Data_FieldInfoInt_DefaultValue"></a> DefaultValue
