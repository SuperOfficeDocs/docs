# <a id="SuperOffice_WebApi_Data_FieldInfoAttachment"></a> Class FieldInfoAttachment
...
```csharp
public class FieldInfoAttachment : FieldInfoBase
```
...
### <a id="SuperOffice_WebApi_Data_FieldInfoAttachment__ctor"></a> FieldInfoAttachment\(\)

Default constructor - defaults any enum props to 0.

```csharp
public FieldInfoAttachment()
```

## Properties

### <a id="SuperOffice_WebApi_Data_FieldInfoAttachment_DefaultValue"></a> DefaultValue
