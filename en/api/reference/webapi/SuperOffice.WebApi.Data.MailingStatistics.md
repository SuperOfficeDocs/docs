# <a id="SuperOffice_WebApi_Data_MailingStatistics"></a> Class MailingStatistics
...
```csharp
public class MailingStatistics : Carrier
```
...
### <a id="SuperOffice_WebApi_Data_MailingStatistics__ctor"></a> MailingStatistics\(\)
