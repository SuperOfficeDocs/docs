...
### AIAgent\(HttpClient\) {#SuperOffice_WebApi_Agents_AIAgent__ctor_System_Net_Http_HttpClient_}
...
### AIAgent\(WebApiOptions, HttpClient\) {#SuperOffice_WebApi_Agents_AIAgent__ctor_SuperOffice_WebApi_WebApiOptions_System_Net_Http_HttpClient_}
...
### AnalyzeBizCardImageAsync\(byte\[\], bool, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_AnalyzeBizCardImageAsync_System_Byte___System_Boolean_SuperOffice_WebApi_RequestOptions_}
...
### AnalyzeBizCardTextAsync\(string, bool, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_AnalyzeBizCardTextAsync_System_String_System_Boolean_SuperOffice_WebApi_RequestOptions_}
...
### AnswerAcceptedAsync\(string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_AnswerAcceptedAsync_System_String_SuperOffice_WebApi_RequestOptions_}
...
### AnswerAsync\(string, string, RagType, int, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_AnswerAsync_System_String_System_String_SuperOffice_WebApi_Data_RagType_System_Int32_SuperOffice_WebApi_RequestOptions_}
...
### AnswerFeedbackAsync\(string, bool, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_AnswerFeedbackAsync_System_String_System_Boolean_SuperOffice_WebApi_RequestOptions_}
...
### AnswerUsingContextAsync\(string, string, RagContextIds, RagType, int, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_AnswerUsingContextAsync_System_String_System_String_SuperOffice_WebApi_Data_RagContextIds_SuperOffice_WebApi_Data_RagType_System_Int32_SuperOffice_WebApi_RequestOptions_}
...
### CancelIndexingAsync\(string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_CancelIndexingAsync_System_String_SuperOffice_WebApi_RequestOptions_}
...
### ClearChatbotTurnsAsync\(string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_ClearChatbotTurnsAsync_System_String_SuperOffice_WebApi_RequestOptions_}
...
### CreateDefaultCopilotDataSourceEntityAsync\(RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_CreateDefaultCopilotDataSourceEntityAsync_SuperOffice_WebApi_RequestOptions_}
...
### CreateDefaultCopilotEntityAsync\(RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_CreateDefaultCopilotEntityAsync_SuperOffice_WebApi_RequestOptions_}
...
### CreateTextForAppointmentAsync\(AppointmentEntity, string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_CreateTextForAppointmentAsync_SuperOffice_WebApi_Data_AppointmentEntity_System_String_SuperOffice_WebApi_RequestOptions_}
...
### DeleteCopilotDataSourceEntityAsync\(int, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_DeleteCopilotDataSourceEntityAsync_System_Int32_SuperOffice_WebApi_RequestOptions_}
...
### DeleteCopilotEntityAsync\(int, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_DeleteCopilotEntityAsync_System_Int32_SuperOffice_WebApi_RequestOptions_}
...
### DetectLanguageAsync\(string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_DetectLanguageAsync_System_String_SuperOffice_WebApi_RequestOptions_}
...
### DetectSentimentAsync\(string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_DetectSentimentAsync_System_String_SuperOffice_WebApi_RequestOptions_}
...
### ExpandTextAsync\(string, int, string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_ExpandTextAsync_System_String_System_Int32_System_String_SuperOffice_WebApi_RequestOptions_}
...
### GetChatbotPromptSuggestionsAsync\(string, string, int, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_GetChatbotPromptSuggestionsAsync_System_String_System_String_System_Int32_SuperOffice_WebApi_RequestOptions_}
...
### GetChatbotResponseAsync\(string, string, string, string, ChatbotTurn\[\], string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_GetChatbotResponseAsync_System_String_System_String_System_String_System_String_SuperOffice_WebApi_Data_ChatbotTurn___System_String_SuperOffice_WebApi_RequestOptions_}
...
### GetChatbotTurnsAsync\(string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_GetChatbotTurnsAsync_System_String_SuperOffice_WebApi_RequestOptions_}
...
### GetCopilotDataSourceEntityAsync\(int, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_GetCopilotDataSourceEntityAsync_System_Int32_SuperOffice_WebApi_RequestOptions_}
...
### GetCopilotEntityAsync\(int, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_GetCopilotEntityAsync_System_Int32_SuperOffice_WebApi_RequestOptions_}
...
### GetFirstFormDesignCssFromImageAsync\(byte\[\], string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_GetFirstFormDesignCssFromImageAsync_System_Byte___System_String_SuperOffice_WebApi_RequestOptions_}
...
### GetFirstFormDesignCssFromUrlAsync\(string, string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_GetFirstFormDesignCssFromUrlAsync_System_String_System_String_SuperOffice_WebApi_RequestOptions_}
...
### GetFormDesignCssFromImageAsync\(byte\[\], string\[\], RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_GetFormDesignCssFromImageAsync_System_Byte___System_String___SuperOffice_WebApi_RequestOptions_}
...
### GetFormDesignCssFromUrlAsync\(string, string\[\], RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_GetFormDesignCssFromUrlAsync_System_String_System_String___SuperOffice_WebApi_RequestOptions_}
...
### GetFormDesignFromImageAsync\(byte\[\], RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_GetFormDesignFromImageAsync_System_Byte___SuperOffice_WebApi_RequestOptions_}
...
### GetFormDesignFromUrlAsync\(string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_GetFormDesignFromUrlAsync_System_String_SuperOffice_WebApi_RequestOptions_}
...
### GetIndexingStatusAsync\(string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_GetIndexingStatusAsync_System_String_SuperOffice_WebApi_RequestOptions_}
...
### GetNextFormDesignCssAsync\(string, string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_GetNextFormDesignCssAsync_System_String_System_String_SuperOffice_WebApi_RequestOptions_}
...
### GetSummarizeContactPromptAsync\(int, int, string, string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_GetSummarizeContactPromptAsync_System_Int32_System_Int32_System_String_System_String_SuperOffice_WebApi_RequestOptions_}
...
### GetSummarizeSalePromptAsync\(int, int, string, string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_GetSummarizeSalePromptAsync_System_Int32_System_Int32_System_String_System_String_SuperOffice_WebApi_RequestOptions_}
...
### GetSummarizeTicketPromptAsync\(int, int, string, string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_GetSummarizeTicketPromptAsync_System_Int32_System_Int32_System_String_System_String_SuperOffice_WebApi_RequestOptions_}
...
### GetTrainingStatusAsync\(RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_GetTrainingStatusAsync_SuperOffice_WebApi_RequestOptions_}
...
### GuessCategoryAsync\(int, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_GuessCategoryAsync_System_Int32_SuperOffice_WebApi_RequestOptions_}
...
### ParseQueryIntoRestrictionsAsync\(string, string, NaturalLanguageSearch, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_ParseQueryIntoRestrictionsAsync_System_String_System_String_SuperOffice_WebApi_Data_NaturalLanguageSearch_SuperOffice_WebApi_RequestOptions_}
...
### RemovePhotoBackgroundAsync\(byte\[\], string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_RemovePhotoBackgroundAsync_System_Byte___System_String_SuperOffice_WebApi_RequestOptions_}
...
### RephraseTextAsync\(string, AiTextStyle, string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_RephraseTextAsync_System_String_SuperOffice_WebApi_Data_AiTextStyle_System_String_SuperOffice_WebApi_RequestOptions_}
...
### SaveCopilotDataSourceEntityAsync\(CopilotDataSourceEntity, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_SaveCopilotDataSourceEntityAsync_SuperOffice_WebApi_Data_CopilotDataSourceEntity_SuperOffice_WebApi_RequestOptions_}
...
### SaveCopilotEntityAsync\(CopilotEntity, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_SaveCopilotEntityAsync_SuperOffice_WebApi_Data_CopilotEntity_SuperOffice_WebApi_RequestOptions_}
...
### SearchAsync\(string, string, RagType, int, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_SearchAsync_System_String_System_String_SuperOffice_WebApi_Data_RagType_System_Int32_SuperOffice_WebApi_RequestOptions_}
...
### StartRagIndexingAsync\(string, string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_StartRagIndexingAsync_System_String_System_String_SuperOffice_WebApi_RequestOptions_}
...
### SummarizeContactAsync\(int, int, string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_SummarizeContactAsync_System_Int32_System_Int32_System_String_SuperOffice_WebApi_RequestOptions_}
...
### SummarizeSaleAsync\(int, int, string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_SummarizeSaleAsync_System_Int32_System_Int32_System_String_SuperOffice_WebApi_RequestOptions_}
...
### SummarizeTextAsync\(string, int, string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_SummarizeTextAsync_System_String_System_Int32_System_String_SuperOffice_WebApi_RequestOptions_}
...
### SummarizeTicketAsync\(int, int, string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_SummarizeTicketAsync_System_Int32_System_Int32_System_String_SuperOffice_WebApi_RequestOptions_}
...
### TrainCategoryGuesserAsync\(int, int, int, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_TrainCategoryGuesserAsync_System_Int32_System_Int32_System_Int32_SuperOffice_WebApi_RequestOptions_}
...
### TranslateAsync\(string, string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_TranslateAsync_System_String_System_String_SuperOffice_WebApi_RequestOptions_}
...
### TranslateEntityAsync\(string, int, string, RequestOptions\) {#SuperOffice_WebApi_Agents_AIAgent_TranslateEntityAsync_System_String_System_Int32_System_String_SuperOffice_WebApi_RequestOptions_}
