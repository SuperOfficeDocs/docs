...
```csharp
public class List_SaveFromListNameRequest
```
...
### <a id="SuperOffice_WebApi_Data_List_SaveFromListNameRequest__ctor"></a> List\_SaveFromListNameRequest\(\)

```csharp
public List_SaveFromListNameRequest()
```

## Properties

### <a id="SuperOffice_WebApi_Data_List_SaveFromListNameRequest_Id"></a> Id
...
### <a id="SuperOffice_WebApi_Data_List_SaveFromListNameRequest_Item"></a> Item
