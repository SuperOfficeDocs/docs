...
```csharp
public class Contact_DeleteExpiredRequest
```
...
### <a id="SuperOffice_WebApi_Data_Contact_DeleteExpiredRequest__ctor"></a> Contact\_DeleteExpiredRequest\(\)

```csharp
public Contact_DeleteExpiredRequest()
```
