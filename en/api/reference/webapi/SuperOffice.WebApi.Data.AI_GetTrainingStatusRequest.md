...
```csharp
public class AI_GetTrainingStatusRequest
```
...
### <a id="SuperOffice_WebApi_Data_AI_GetTrainingStatusRequest__ctor"></a> AI\_GetTrainingStatusRequest\(\)

```csharp
public AI_GetTrainingStatusRequest()
```
