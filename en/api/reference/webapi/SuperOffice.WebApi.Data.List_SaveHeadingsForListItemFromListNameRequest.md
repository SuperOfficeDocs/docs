...
```csharp
public class List_SaveHeadingsForListItemFromListNameRequest
```
...
### <a id="SuperOffice_WebApi_Data_List_SaveHeadingsForListItemFromListNameRequest__ctor"></a> List\_SaveHeadingsForListItemFromListNameRequest\(\)

```csharp
public List_SaveHeadingsForListItemFromListNameRequest()
```

## Properties

### <a id="SuperOffice_WebApi_Data_List_SaveHeadingsForListItemFromListNameRequest_Headings"></a> Headings

```csharp
public SelectableMDOListItem[] Headings { get; set; }
```
...
### <a id="SuperOffice_WebApi_Data_List_SaveHeadingsForListItemFromListNameRequest_UdListDefinitionName"></a> UdListDefinitionName
