...
```csharp
public class License_GetUserLicensesMDOListRequest
```
...
### <a id="SuperOffice_WebApi_Data_License_GetUserLicensesMDOListRequest__ctor"></a> License\_GetUserLicensesMDOListRequest\(\)

```csharp
public License_GetUserLicensesMDOListRequest()
```
