# <a id="SuperOffice_WebApi_Data_WorkflowStepOptionProjectMembership"></a> Class WorkflowStepOptionProjectMembership
...
```csharp
public class WorkflowStepOptionProjectMembership : WorkflowStepOptionBase
```
...
### <a id="SuperOffice_WebApi_Data_WorkflowStepOptionProjectMembership__ctor"></a> WorkflowStepOptionProjectMembership\(\)

Default constructor - defaults any enum props to 0.

```csharp
public WorkflowStepOptionProjectMembership()
```

## Properties

### <a id="SuperOffice_WebApi_Data_WorkflowStepOptionProjectMembership_ProjectId"></a> ProjectId
