...
```csharp
public class EMail_GetCurrentAccountIdRequest
```
...
### <a id="SuperOffice_WebApi_Data_EMail_GetCurrentAccountIdRequest__ctor"></a> EMail\_GetCurrentAccountIdRequest\(\)

```csharp
public EMail_GetCurrentAccountIdRequest()
```
