...
```csharp
public class Quote_GetInUseQuoteLineConfigurationsRequest
```
...
### <a id="SuperOffice_WebApi_Data_Quote_GetInUseQuoteLineConfigurationsRequest__ctor"></a> Quote\_GetInUseQuoteLineConfigurationsRequest\(\)

```csharp
public Quote_GetInUseQuoteLineConfigurationsRequest()
```
