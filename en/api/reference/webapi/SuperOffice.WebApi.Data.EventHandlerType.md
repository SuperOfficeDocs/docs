# <a id="SuperOffice_WebApi_Data_EventHandlerType"></a> Enum EventHandlerType
...
`SalesAfterSaveApproveQuote = 1114` 
...
`SalesAfterSaveCustomObject = 1117` 

1117: SalesAfterSaveCustomObject
...
`SalesBeforeSaveApproveQuote = 1014` 
...
`SalesBeforeSaveCustomObject = 1018` 

1018: SalesBeforeSaveCustomObject
...
`SalesBeforeSaveTicket = 1016` 

1016: SalesBeforeSaveTicket



`SalesLoadCustomObject = 1017` 

1017: SalesLoadCustomObject



`SalesLoadTicket = 1020` 

1020: SalesLoadTicket



`SalesLoadTicketMessage = 1021` 

1021: SalesLoadTicketMessage



`SalesSplitTicket = 1019` 

1019: SalesSplitTicket
