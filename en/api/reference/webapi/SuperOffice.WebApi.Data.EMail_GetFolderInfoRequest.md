...
```csharp
public class EMail_GetFolderInfoRequest
```
...
### <a id="SuperOffice_WebApi_Data_EMail_GetFolderInfoRequest__ctor"></a> EMail\_GetFolderInfoRequest\(\)

```csharp
public EMail_GetFolderInfoRequest()
```

## Properties

### <a id="SuperOffice_WebApi_Data_EMail_GetFolderInfoRequest_ConnectionInfo"></a> ConnectionInfo
