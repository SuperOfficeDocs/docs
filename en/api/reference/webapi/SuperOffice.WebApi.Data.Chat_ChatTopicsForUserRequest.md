...
```csharp
public class Chat_ChatTopicsForUserRequest
```
...
### <a id="SuperOffice_WebApi_Data_Chat_ChatTopicsForUserRequest__ctor"></a> Chat\_ChatTopicsForUserRequest\(\)

```csharp
public Chat_ChatTopicsForUserRequest()
```
