...
* The [page builder framework](../../../ui/web-app/index) used in CRM.web. This means the config files for the framework and the many components and interfaces that the PageBuilder uses.
