...
keywords: ['certificate', 'PKI', 'trust type', 'PeerTrust', 'SuperIdTokenHandler']
...
[2]: /en/api/authentication/online/validate-security-tokens
[3]: /en/api/authentication/online/troubleshooting/index
[4]: /en/api/authentication/online/certificates/configure
[5]: /downloads/api/superofficeonlinecertificates.zip
[6]: /en/api/authentication/online/certificates/override-resolver

[img1]: /media/loc/en/api/authentication/certificateheirarchy.png
