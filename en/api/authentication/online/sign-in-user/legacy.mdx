...
title: How to authenticate an application user with SuperOffice legacy federated authentication
sidebarTitle: "Legacy federated authentication"
description: How to authenticate an application user with SuperOffice legacy federated authentication
keywords: ['authenticate app user', 'authentication token', 'SAML']
