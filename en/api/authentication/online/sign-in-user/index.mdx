---
title: How to authenticate an application user (front-channel)
sidebarTitle: "Authenticate a user (front-channel)"
uid: auth_user_oidc
...
[1]: /en/api/authentication/online/sign-in-user/implicit-flow
[2]: /en/developer-portal/getting-started/index#terminology
[3]: /en/developer-portal/create-app/config/redirects
[4]: /en/developer-portal/getting-started/app-envir
[5]: /en/api/authentication/online/validate-security-tokens
[6]: /en/api/authentication/online/sign-in-user/auth-code-flow
[7]: /en/api/authentication/online/which-flow-to-use
[8]: /en/api/authentication/online/sign-in-user/hybrid-flow
[9]: /en/api/authentication/online/sign-in-user/native-apps
...
[img1]: /media/loc/en/api/authentication/oauth-code-flow.png
