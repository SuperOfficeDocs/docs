...
<Frame>
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/Tyzm6H50DC8"
    title=""
    frameborder="0"
...
[img3]: /media/loc/en/api/authentication/create-application-server-to-server.png
