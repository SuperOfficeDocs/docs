---
title: SuperOffice Online OAuth 2.0 and OpenID Connect
sidebarTitle: "OAuth 2.0 and OpenID Connect"
uid: webapi_auth_online
description: WebAPI authentication CRM Online; introduction to OAuth 2.0 and OpenID Connect
author: AnthonyYates
date: 05.05.2025
keywords: ['authentication', 'OIDC', 'claim', 'terminology', 'ID token']
...
import ImplicitHybridDeprecated from "./snippets/implicit-hybrid-deprecated.mdx";
...
[2]: /en/api/authentication/online/auth-application/index
[3]: /en/developer-portal/create-app/index
[4]: https://jwt.io/
[5]: /en/developer-portal/provisioning/get-consent
[6]: /en/api/authentication/online/troubleshooting/iframe-idp-auth
[7]: /en/api/authentication/online/api
[8]: /en/api/authentication/online/validate-security-tokens
[9]: /en/api/authentication/online/sign-in-user/auth-code-flow
[10]: /en/api/authentication/online/sign-in-user/implicit-flow
[11]: /en/api/authentication/online/sign-in-user/hybrid-flow
[12]: /en/developer-portal/index
[13]: https://dev.superoffice.com/register

[img3]: /media/loc/en/api/authentication/keyplayers.jpg
