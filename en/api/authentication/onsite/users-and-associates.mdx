...
[1]: ../../../database/tables/ownercontactlink
[2]: ./config-anonymous-user

[img1]: /media/loc/en/api/authentication/assoc-table.png
[img2]: /media/loc/en/api/authentication/usergrouplink-diag.png
[img3]: /media/loc/en/api/authentication/usergroup.png
[img4]: /media/loc/en/api/authentication/usergrouplink.png
[img5]: /media/loc/en/api/authentication/associate-links.png
[img6]: /media/loc/en/api/authentication/assoc-resources.png
