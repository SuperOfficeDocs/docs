---
title: NetServer web service custom proxies
...
[1]: ../../../reference/soap/index

[img5]: /media/loc/en/api/authentication/services-authenticate-soapui.png
[img6]: /media/loc/en/api/authentication/services-authenticate-fiddler.png
