...
date: 11.05.2021
so_version: 11
keywords: ['udef', 'user-defined field', 'custom field', 'API', 'SyncRoot', 'GetUDFInfo', 'SetUDFValue', 'UDFSearch', 'GetUDFColumnID', 'GetUDFData']
...
```csharp UDFHelper Class and UDFInfo struct
using System;
using SuperOffice;
