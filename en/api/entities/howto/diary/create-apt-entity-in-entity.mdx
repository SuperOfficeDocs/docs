...
import CreateEntityOptions from "../../../snippets/create-entity-options.md";
...
using(SoSession mySession = SoSession.Authenticate("sam", "sam"))
{
  ...
  //Set Default Values to the created Appointment
