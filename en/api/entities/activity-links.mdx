...
[1]: ../../database/tables/relationdefinition
[2]: ../../database/tables/relations
[4]: ../../database/tables/relationtarget

[img1]: ../../../media/loc/en/sale/sale-apt-link.png
[img2]: /media/loc/en/api/entities/links-appointment-record.png
[img3]: /media/loc/en/api/entities/links-relations.png
[img4]: /media/loc/en/api/entities/links-reldeflist.png
[img5]: /media/loc/en/api/entities/links-reldef.png
[img6]: /media/loc/en/api/entities/link-diagram.png
