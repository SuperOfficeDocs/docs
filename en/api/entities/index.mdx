...
date: 11.16.2021
so_version: 11
keywords: ['data access', 'entity', 'RDB']
...
[1]: https://github.com/SuperOfficeDocs/superoffice-docs/blob/main/docs/en/api/rows/index.md
[2]: /en/api/overview/netserver
[3]: https://github.com/SuperOfficeDocs/superoffice-docs/blob/main/docs/en/api/rows/index.md#tableinfo-and-fieldinfo
