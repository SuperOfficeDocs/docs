...
author: Tony Yates
date: 12.02.2021
keywords: ['NetServer', 'getting started', 'integration', 'scripting', 'web services', 'entities', 'OSQL', 'extensibility', 'architecture']
content_type: concept
deployment: online, onsite
platform: web, win, service
---

import AutomationIntro from "../../automation/snippets/automation-intro.md";
...
SuperOffice Sales, SuperOffice Service and SuperOffice Mobile are examples of clients that use NetServer. All applications listed in the [SuperOffice App Store][19] do too.
...
* **[Archive providers][4]** and **[MDO Providers][29]**: provide read-only search capabilities.
...
Online tenants share application file sets across all customers on that environment. Therefore, any compiled assemblies that are exposed to one installation would inadvertently expose those same customizations across all shared tenants.
...
[3]: /en/automation/crmscript/overview/index
[4]: /en/api/archive-providers/index
[5]: /en/api/web-services/index
[6]: /en/onsite/integrate/web-client/index
[7]: /en/online/integrate/index
[8]: /en/api/reference/restful/index
[9]: /en/automation/webhook/index
[11]: /en/api/plugins/erp-connectors/index
[12]: /en/api/plugins/quote-connectors/index
[13]: /en/api/authentication/index
[14]: /en/automation/overview#languages
[15]: /en/api/web-services/endpoints/index
[16]: https://github.com/SuperOfficeDocs/superoffice-docs/blob/main/docs/en/automation/netserver-scripting/index.md
[17]: https://github.com/SuperOfficeDocs/superoffice-docs/blob/main/docs/en/api/osql/index.md
[18]: /en/api/entities/index
[19]: https://online.superoffice.com/appstore
[20]: /en/admin/user-preferences/index
[21]: /en/automation/trigger/create-trigger-script
[22]: /en/automation/trigger/create-trigger-macro
[23]: /en/custom-objects/index
[24]: /en/customization/web-panels/admin/index
[25]: /en/ui/blogic/custom-screens/index
[28]: /en/api/archive-providers/index
[29]: /en/api/mdo-providers/reference/index
[30]: /en/custom-objects/learn/extra-table
[31]: /en/mobile/index
[32]: /en/api/overview/netserver#domain-level-apis-netserver-core
[33]: /en/onsite/web-config/services
[34]: /en/automation/webhook/dev/index
[35]: https://github.com/SuperOfficeDocs/superoffice-docs/blob/main/docs/en/api/plugins/document/soarc-document-plugin.md
[36]: https://github.com/SuperOfficeDocs/superoffice-docs/blob/main/docs/en/api/plugins/sentry/index.md
[38]: /en/api/lists/index
[40]: https://zapier.com/apps/superofficecrm/integrations

[img1]: /media/loc/en/api/overview/web-client-custom-code.png
[img2]: /media/loc/en/api/overview/extensibility-complexity.png
[img3]: /media/loc/en/api/overview/netserver-components-overview.png
[img4]: /media/loc/en/api/overview/superoffice-api-architecture.png
[img5]: /media/loc/en/api/overview/integration-points.png
