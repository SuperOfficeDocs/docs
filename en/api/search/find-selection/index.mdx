...
[2]: /en/api/archive-providers/reference/appointmentdynamicselectionv2
[3]: /en/api/archive-providers/reference/contactpersondynamicselectionv2
[4]: /en/api/search/find-selection/typical-search
[5]: /en/api/search/find-selection/populate-selectable-columns
[6]: /en/api/search/find-selection/date-range-as-criteria
[7]: /en/api/search/find-selection/how-to-search#get-sr-find
[8]: /en/api/search/find-selection/how-to-search#get-data-source
[9]: /en/api/search/find-selection/how-to-search

[img1]: /media/loc/en/api/search/client-header-find.png
[img2]: /media/loc/en/api/search/selection-find-panel.png
[img3]: /media/loc/en/api/search/selection-search-panel.png
[img4]: /media/loc/en/api/search/selection-criteria-group-conceptual.png
[img5]: /media/loc/en/api/search/selection-criteria-groups-conceptual.png
