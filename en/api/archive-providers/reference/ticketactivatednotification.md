...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.TicketActivatedNotificationSubProvider` inside NetServer's SODatabase assembly.
