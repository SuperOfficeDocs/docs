...
```http!
GET /api/v1/archive/SubPersonContactDynamicSelectionSingleCriteriaGroup?$select=personExtra/x_person_timespan,personSourceRelation/supportLanguage,personTargetRelation/kanaFirstName,personTargetRelation/createdByForm,personAssociate/contactDepartment
