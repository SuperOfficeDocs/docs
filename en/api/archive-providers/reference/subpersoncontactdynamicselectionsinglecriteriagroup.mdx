...
```http!
GET /api/v1/archive/SubPersonContactDynamicSelectionSingleCriteriaGroup?$select=personCountry,personUpdatedBy,personTargetRelation/personUpdatedBy,postAddress/line3,consentSourceEmarketing
