...
```http!
GET /api/v1/archive/SubPersonContactDynamicSelectionSingleCriteriaGroup?$select=activeErpLinks,personAppointment/associate/usergroup,phone/formattedNumber,sale/associate/assocType,workflowInstance/workflowInstanceWaitUntil
