...
```http!
GET /api/v1/archive/SubPersonContactDynamicSelectionSingleCriteriaGroup?$select=birthYear,forceCompany,personAddress/addressId,personTargetRelation/personHasInterests,personAssociate/mrMrs
