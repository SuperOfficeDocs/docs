...
```http!
GET /api/v1/archive/QuoteLineShadowStaticSelectionV2?$select=quoteAlternativeId,registeredByFullName,alternative/version/quote/sale/person/fullName,alternative/version/quote/sale/contact/streetAddress/county,alternative/version/quote/sale/contact/contactAssociate/ejDisplayName
