...
```http!
GET /api/v1/archive/EmailFlowInstances?$select=emailFlow/workflowAssociate/fullName,person/email/emailLastSent,person/email/emailHasBounced,person/personAssociate/assocName,contact/updatedByFullName
