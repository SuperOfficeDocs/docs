...
```http!
GET /api/v1/archive/EmailFlowInstances?$select=workflowInstanceLastCommunicationStatus,emailFlow/workflowAssociate/personEmail,person/correspondingAssociate/contactCategory
