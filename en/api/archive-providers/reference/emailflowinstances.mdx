...
```http!
GET /api/v1/archive/EmailFlowInstances?$select=person/retired,person/supportAssociateFullName,person/personAssociate/mrMrs,contact/email/emailDescription,contact/contactAssociate/credentialDisplayValue
