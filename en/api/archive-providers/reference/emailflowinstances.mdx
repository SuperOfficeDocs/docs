...
description: "Archive of Email flow Instances. Lists all email flow Instances"
...
```http!
GET /api/v1/archive/EmailFlowInstances?$select=contact/activeErpLinks,contact/postAddress/state,person/correspondingAssociate/credentialDisplayValue,person/personExtra/x_person_boolean,workflowInstanceWaitUntil
