...
```http!
GET /api/v1/archive/FindContact?$select=hasInterests,streetAddress/zip,contactAssociate/lastName,contactAssociate/usergroup,contactExtra/x_contact_datetime
