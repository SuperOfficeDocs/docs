...
```http!
GET /api/v1/archive/FindContact?$select=contactExtra/x_contact_contact,appointment/associate/personEmail,firstName,personPager/description,correspondingAssociate/contactName
