...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=activeErpLinks,document/text,projectMember/correspondingAssociate/usergroupId,projectMember/restrictionAddress/wgs84longitude,updatedDate
