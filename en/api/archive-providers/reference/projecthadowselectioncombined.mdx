...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=sale/stageId,appointment/userGroup,appointment/updatedBy,appointment/associate/simultaneousEjUser,projectMember/mrMrs
