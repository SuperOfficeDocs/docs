...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=projectAssociate/title,projectAssociate/contactFullName,sale/associate/simultaneousEjUser,appointment/recordTypeText,document/personId
