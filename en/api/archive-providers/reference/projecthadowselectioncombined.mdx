...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=sale/saleCycle,appointment/type,projectMember/projectMemberId,projectMember/personAssociate/otherGroups,projectMember/contactFax/description
