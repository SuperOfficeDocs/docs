...
description: QuoteLine selection archive with OR-able selection groups. Each group is represented with the QuoteLineSelectionDynamicProviderSingleCriteriaGroup.
...
QuoteLine selection archive with OR-able selection groups. Each group is represented with the [QuoteLineSelectionDynamicProviderSingleCriteriaGroup](./quotelinedynamicselectionsinglecriteriagroup).
...
```http!
GET /api/v1/archive/QuoteLineDynamicSelectionV2?$select=alternative/version/paymentType,alternative/version/extraField1,alternative/version/quote/sale/time,alternative/version/quote/sale/person/whenUpdatedByWorkflow,alternative/version/quote/sale/contact/postAddress/city
