...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=document/subject,projectMember/function,projectMember/restrictionAddress/state,projectMember/stop
