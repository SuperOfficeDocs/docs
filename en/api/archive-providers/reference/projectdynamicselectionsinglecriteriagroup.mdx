...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=type,projectPublish/publishedTo,sale/description,sale/associate/locationAddress,document/registeredDate
