...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=sale/probPercent,sale/associate/simultaneousEjUser,document/associate/portraitThumbnail,projectMember/personDirectPhone/description,projectMember/correspondingAssociate/portraitThumbnail
