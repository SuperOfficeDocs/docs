...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=timeToReply,createdBy/firstName,person/personAddress/addressId,contact/contactAssociate/contactCategory,contact/contactUdef/SuperOffice:6
