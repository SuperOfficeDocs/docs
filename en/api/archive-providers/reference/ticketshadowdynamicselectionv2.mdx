...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=activated,createdBy/mrMrs,person/personAssociate/personEmail,project/projectPublish/publishedTo,title
