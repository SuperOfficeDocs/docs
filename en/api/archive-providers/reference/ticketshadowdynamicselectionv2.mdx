...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=ownedBy/contactName,person/hasInfoText,person/birthYear,person/legalBaseStore,contact/searchPhone/formattedNumber
