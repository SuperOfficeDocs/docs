...
description: Ticket shadow selection archive with OR-able selection groups. Each group is represented with the TicketShadowSelectionDynamicProviderSingleCriteriaGroup.
...
Ticket shadow selection archive with OR-able selection groups. Each group is represented with the [TicketShadowSelectionDynamicProviderSingleCriteriaGroup](./ticketshadowdynamicselectionsinglecriteriagroup).
...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=createdBy/lastName,person/personUdef/SuperOffice:3,person/personAssociate/portraitThumbnail,person/consentSourceEmarketing,sale/associate/fullName
