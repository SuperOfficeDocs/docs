...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.SaleShadowSelectionDynamicProvider` inside NetServer's SODatabase assembly.
