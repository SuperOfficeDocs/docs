...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.QuoteLineShadowSelectionStaticProviderV2` inside NetServer's SODatabase assembly.
