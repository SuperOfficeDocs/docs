---
title: OtherUsers
description: Concrete provider for 'Other' Users - System and Anonymous user accounts. See UsersProviderBase for
...
```http!
GET /api/v1/archive/OtherUsers?$select=associateDbId,superoffice_ten-marketing,role
