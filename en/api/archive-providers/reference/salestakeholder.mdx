...
```http!
GET /api/v1/archive/SaleStakeholder?$select=person/email/emailLastBounce,person/personUrl/URLAddress,person/restrictionAddress/line3,person/personUdef/SuperOffice:1,person/isMailingRecipient
