...
```http!
GET /api/v1/archive/SaleStakeholder?$select=comment,contact/email/emailHasBounced,person/correspondingAssociate/title,person/personExtra/x_person_contact_relation,salesRoleId
