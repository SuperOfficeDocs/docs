...
```http!
GET /api/v1/archive/SaleStakeholder?$select=person/personExtra/y_rental/x_amount,contact/streetAddress/line2,contact/contactAssociate/isActive,contact/contactAssociate/isLocation
