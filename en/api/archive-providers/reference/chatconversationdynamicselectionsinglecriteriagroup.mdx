...
```http!
GET /api/v1/archive/ChatConversationDynamicSelectionSingleCriteriaGroup?$select=person/birthMonth,contact/department,person/personAddress/formattedMultiLineAddress
