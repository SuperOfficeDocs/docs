...
```http!
GET /api/v1/archive/ChatConversationDynamicSelectionSingleCriteriaGroup?$select=person/personAssociate/isLocation,person/legalBaseEmarketing,person/personAddress/formattedMultiLineAddress
