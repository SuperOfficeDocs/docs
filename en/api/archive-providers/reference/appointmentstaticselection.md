...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.AppointmentSelectionStaticProvider` inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=contact/category,contact/restrictionAddress/wgs84latitude,contact/restrictionAddress/wgs84longitude,person/isProjectMember,person/personPrivate/formattedNumber
