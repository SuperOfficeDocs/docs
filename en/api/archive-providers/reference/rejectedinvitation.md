...
A rejected invitation is one that has been rejected or deleted by you, and is not overdue by more than one day.
...
```http!
GET /api/v1/archive/RejectedInvitation?$select=getAllRows,project/projectAssociate/assocType,sale/saleNumber,sale/hasStakeholders
