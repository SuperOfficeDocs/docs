...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.SaleSelectionDynamicProvider` inside NetServer's SODatabase assembly.
