...
This provider, like the [LinksProvider](./links), offers two alternative ways of accessing
...
```http!
GET /api/v1/archive/Participants?$select=hasCompany,fullNameWithContact,ticketPriority
