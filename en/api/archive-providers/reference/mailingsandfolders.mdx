...
```http!
GET /api/v1/archive/MailingsAndFolders?$select=mailingFolderId,mailingAddr/contact/registeredByFullName,mailingAddr/contact/postAddress/wgs84longitude,mailingAddr/contact/contactExtra/x_contact_integer,mailingAddr/person/firstName
