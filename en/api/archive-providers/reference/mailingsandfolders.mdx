...
```http!
GET /api/v1/archive/MailingsAndFolders?$select=name,sortName,mailingAddr/contact/SaintStatus2,mailingAddr/person/correspondingAssociate/contactDepartment,mailingAddr/person/correspondingAssociate/ejUserId
