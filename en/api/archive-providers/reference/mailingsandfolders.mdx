...
[EmailFlowsAndFoldersProvider](./emailflowsandfolders).
...
```http!
GET /api/v1/archive/MailingsAndFolders?$select=mailingAddr/person/personAssociate/contactName,mailingAddr/person/correspondingAssociate/contactId,emailFlow/workflowDefinitionStatus,project/projectUdef/SuperOffice:5,project/projectUdef/SuperOffice:6
