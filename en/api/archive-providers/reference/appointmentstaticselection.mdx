...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=updatedDate,contact/registeredByFullName,contact/contactExtra/x_contact_hidden_integer,sale/associate/ejStatus
