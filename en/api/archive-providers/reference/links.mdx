...
```http!
GET /api/v1/archive/Links?$select=contact/companyCategoryRank,contact/updatedByFullName,contact/restrictionAddress/line2,contact/contactAssociate/locationAddress,contact/NumberOfTicketsInPeriod
