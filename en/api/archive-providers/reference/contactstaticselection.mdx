...
```http!
GET /api/v1/archive/ContactStaticSelection?$select=contactAssociate/simultaneousEjUser,contactInterestIds,sourceRelation/updatedDate,sale/soldReason,appointment/text
