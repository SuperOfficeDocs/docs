...
```http!
GET /api/v1/archive/ContactStaticSelection?$select=postAddress/line2,targetRelation/associateId,targetRelation/registeredBy,sale/associate/credentialDisplayValue,appointment/projectId
