...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=url/URLAddress,NumberOfTickets,appointment/associate/associateDbId,appointment/associate/role,birthMonth
