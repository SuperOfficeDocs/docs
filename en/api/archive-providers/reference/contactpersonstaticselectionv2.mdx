...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=registeredByFullName,contactAssociate/personId,sale/sale/description,document/documentPublish/publishedFrom,hasStoreConsent
