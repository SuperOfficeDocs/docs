...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=targetRelation/business,sale/associate/title,appointment/intention,appointment/cautionWarning,personSourceRelation/fullName
