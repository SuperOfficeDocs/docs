...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=activeErpLinks,document/name,personSourceRelation/personCategory,request/ownedBy/contactCategory,withdrawnStoreConsent
