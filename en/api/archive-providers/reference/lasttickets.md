...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.LastTicketsProvider` inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/LastTickets?$select=ticketId,lastChanged,person/personAddress/wgs84longitude,contact/country,contact/orgnr
