...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.SaintContactProviderWithRestrictionGroupSupport` inside NetServer's SODatabase assembly.
