...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=person/personAssociate/firstName,person/personAssociate/assocName,contact/number,contact/searchPhone/description,appointment/associateId
