...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=saleType,person/restrictionAddress/wgs84longitude,person/personUdef/SuperOffice:8,document/associate/firstName,document/associate/assocName
