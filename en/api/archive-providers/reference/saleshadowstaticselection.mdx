...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=saleId,person/updatedByWorkflow,person/personDirectPhone/description,person/personMobilePhone/description,person/personAddress/city
