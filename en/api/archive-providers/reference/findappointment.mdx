...
```http!
GET /api/v1/archive/FindAppointment?$select=person/personBusiness,person/personAssociate/contactCategory,person/correspondingAssociate/isActiveText,project/updatedDate,project/hasGuide
