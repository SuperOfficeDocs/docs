...
```http!
GET /api/v1/archive/FindAppointment?$select=contactId,contact/contactAssociate/isActive,contact/saintActivityType,person/correspondingAssociate/mrMrs,person/correspondingAssociate/ejDisplayName
