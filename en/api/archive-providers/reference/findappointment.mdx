...
```http!
GET /api/v1/archive/FindAppointment?$select=contact/streetAddress/line3,person/personBusiness,person/correspondingAssociate/isActive,project/name,project/projectAssociate/isActiveText
