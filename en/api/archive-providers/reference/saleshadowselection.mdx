...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=userGroup,person/personPrivate/description,person/restrictionAddress/city,person/personExtra/x_person_request_relation,contact/contactAssociate/contactCategory
