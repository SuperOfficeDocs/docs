...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=credited,person/kanaFirstName,contact/contactUdef/SuperOffice:10,appointment/date,project/updatedByFullName
