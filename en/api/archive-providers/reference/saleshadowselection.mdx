...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=person/kanaFirstName,person/personAddress/line3,person/personExtra/x_person_contact_relation,contact/contactSource,contact/contactExtra/x_contact_time
