...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=createdBy/associateDbId,person/personCountry,person/retired,person/personAssociate/ejUserId,contact/contactAssociate/simultaneousEjUser
