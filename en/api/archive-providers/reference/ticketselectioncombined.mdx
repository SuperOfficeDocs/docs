...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=person/personExtra/x_person_integer,person/personAssociate/userName,contact/email/emailAddress,contact/NumberOfNotCompletedSales,sale/who
