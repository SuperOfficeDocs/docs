...
```http!
GET /api/v1/archive/QuoteLineSelectionV2?$select=getNoRows,PriceUnitSubscriptionUnit,alternative/version/quote/sale/person/portraitThumbnail,alternative/version/quote/sale/person/personAssociate/usergroupId,alternative/version/quote/sale/contact/email/emailBounceCount
