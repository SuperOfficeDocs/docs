...
```http!
GET /api/v1/archive/MailingsShadowStaticSelectionV2?$select=mailingAddr/contact/hasInfoText,mailingAddr/contact/code,mailingAddr/contact/streetAddress/city,mailingAddr/contact/contactAssociate/contactFullName,mailingAddr/person/associateType
