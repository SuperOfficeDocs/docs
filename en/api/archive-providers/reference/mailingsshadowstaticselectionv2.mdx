...
```http!
GET /api/v1/archive/MailingsShadowStaticSelectionV2?$select=mailingAddr/contact/postAddress/wgs84latitude,mailingAddr/person/personExtra/x_person_category_relation,mailingAddr/person/hasStoreConsent,associate/otherGroups,project/projectId
