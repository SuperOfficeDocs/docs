...
```http!
GET /api/v1/archive/AssignResponseInvitation?$select=contact/mainContact,contact/contactAssociate/assocType,person/personCountryId,person/personAssociate/contactFullName,person/correspondingAssociate/ejUserId
