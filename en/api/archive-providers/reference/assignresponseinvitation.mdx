...
```http!
GET /api/v1/archive/AssignResponseInvitation?$select=contact/contactExtra/x_contact_request_relation,person/personMobilePhone/formattedNumber,person/restrictionAddress/county,person/personUdef/SuperOffice:3,appointmentUdef/SuperOffice:7
