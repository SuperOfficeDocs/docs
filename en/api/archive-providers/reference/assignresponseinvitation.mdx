...
```http!
GET /api/v1/archive/AssignResponseInvitation?$select=contact/contactDeleted,contact/postAddress/formattedMultiLineAddress,contact/streetAddress/line2,contact/contactAssociate/firstName,sale/date
