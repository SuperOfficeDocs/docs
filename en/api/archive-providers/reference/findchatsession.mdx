...
```http!
GET /api/v1/archive/FindChatSession?$select=person/rank,person/personAssociateId,person/correspondingAssociate/credentialType,contact/associateId,contact/number
