...
```http!
GET /api/v1/archive/FindChatSession?$select=agent,contact/contactNoMail,person/correspondingAssociate/ejUserId,person/personExtra/x_person_category_relation,whenStarted
