...
```http!
GET /api/v1/archive/FindChatSession?$select=contact/restrictionAddress/wgs84longitude,contact/NumberOfTicketsInPeriod,person/personAddress/formattedMultiLineAddress
