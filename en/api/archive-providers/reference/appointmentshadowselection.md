...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.AppointmentShadowSelectionProvider` inside NetServer's SODatabase assembly.
