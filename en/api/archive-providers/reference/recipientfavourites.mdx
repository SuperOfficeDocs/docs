...
```http!
GET /api/v1/archive/recipientfavourites?$select=activeErpLinks,correspondingAssociate/personEmail,personAssociate/firstName,personUdef/SuperOffice:1,withdrawnStoreConsent
