...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.FormSubmissionSelectionDynamicProviderSingleCriteriaGroup` inside NetServer's SODatabase assembly.
