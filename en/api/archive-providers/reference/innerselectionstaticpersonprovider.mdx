...
```http!
GET /api/v1/archive/InnerSelectionStaticPersonProvider?$select=getAllRows,isProjectMember,personSourceRelation/position,personSourceRelation/kanaFirstName,personTargetRelation/rank
