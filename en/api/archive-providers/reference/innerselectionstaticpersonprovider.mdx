...
```http!
GET /api/v1/archive/InnerSelectionStaticPersonProvider?$select=activeErpLinks,personAppointment/associate/contactFullName,personSourceRelation/personId,projectMembers/status,withdrawnStoreConsent
