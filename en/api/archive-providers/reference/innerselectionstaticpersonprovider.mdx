...
```http!
GET /api/v1/archive/InnerSelectionStaticPersonProvider?$select=personAssociateId,personTargetRelation/personRegisteredDate,correspondingAssociate/contactFullName,contactAssociate/title,contactAssociate/otherGroups
