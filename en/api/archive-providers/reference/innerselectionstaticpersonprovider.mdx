...
```http!
GET /api/v1/archive/InnerSelectionStaticPersonProvider?$select=updatedByWorkflow,selectionId,personExtra/x_person_request_relation,personSourceRelation/supportAssociateFullName,correspondingAssociate/firstName
