...
```http!
GET /api/v1/archive/OwnerContacts?$select=activeErpLinks,contactSupportAssociate/associateDbId,contactSupportPerson/personExtra/x_person_priority_relation,contactUdef/SuperOffice:8,url/URLDescription
