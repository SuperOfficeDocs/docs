...
```http!
GET /api/v1/archive/QuoteLineDynamicSelection?$select=totalPrice,alternative/version/quote/sale/person/supportLanguage,alternative/version/quote/sale/contact/contactPhone/description,alternative/version/quote/sale/associate/assocTooltip,alternative/version/quote/sale/project/NumberOfNotCompletedSalesInPeriod
