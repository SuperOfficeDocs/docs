...
```http!
GET /api/v1/archive/QuoteLineDynamicSelection?$select=alternative/version/quote/sale/text,alternative/version/quote/sale/projectId,alternative/version/quote/sale/person/personExtra/x_person_boolean,alternative/version/quote/sale/contact/contactSource,alternative/version/quote/sale/contact/searchPhone/formattedNumber
