...
```http!
GET /api/v1/archive/QuoteLineDynamicSelection?$select=alternative/version/expiration,alternative/version/deliveryTerms,alternative/version/quote/sale/description,alternative/version/quote/sale/person/personAssociate/ejUserId,alternative/version/quote/sale/contact/business
