...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.AppointmentSelectionStaticProviderV2` inside NetServer's SODatabase assembly.
