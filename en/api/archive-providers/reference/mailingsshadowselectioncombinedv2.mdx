...
```http!
GET /api/v1/archive/MailingsShadowSelectionCombinedV2?$select=mailingTypeId,mailingAddr/contact/contactAssociate/personId,mailingAddr/contact/contactAssociate/assocType,mailingAddr/contact/contactExtra/x_contact_longtext,mailingAddr/contact/contactExtra/x_contact_short_dropdown
