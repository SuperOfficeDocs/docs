...
```http!
GET /api/v1/archive/MailingsShadowSelectionCombinedV2?$select=mailingAddr/contact/contactFax/description,mailingAddr/contact/NumberOfActivitiesInPeriod,mailingAddr/person/personUdef/SuperOffice:7,mailingAddr/person/personExtra/x_person_datetime,mailingAddr/person/personAssociate/contactId
