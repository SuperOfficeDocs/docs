...
```http!
GET /api/v1/archive/MailingsShadowSelectionCombinedV2?$select=mailingAddr/contact/contactAssociate/simultaneousEjUser,mailingAddr/contact/SaintStatus2,mailingAddr/person/email/emailLastBounce,mailingAddr/person/correspondingAssociate/contactFullName,project/associateId
