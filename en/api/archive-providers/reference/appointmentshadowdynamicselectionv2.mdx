...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionV2?$select=alarm,contact/postAddress/county,person/personAssociate/usergroupId,project/projectPublish/isPublished,who
