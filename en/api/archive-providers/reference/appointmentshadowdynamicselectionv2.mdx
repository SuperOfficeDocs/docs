...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionV2?$select=appointmentPublish/publishedFrom,contact/orgnr,contact/email/emailHasBounced,person/personCategoryRank,person/correspondingAssociate/ejDisplayName
