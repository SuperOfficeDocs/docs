...
description: Appointment shadow selection archive with OR-able selection groups. Each group is represented with the AppointmentShadowSelectionDynamicProviderSingleCriteriaGroup.
...
Appointment shadow selection archive with OR-able selection groups. Each group is represented with the [AppointmentShadowSelectionDynamicProviderSingleCriteriaGroup](./appointmentshadowdynamicselectionsinglecriteriagroup).
...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionV2?$select=appointmentId,contact/streetAddress/city,contact/contactAssociate/ejUserId,person/personPrivate/description,person/restrictionAddress/formattedAddress
