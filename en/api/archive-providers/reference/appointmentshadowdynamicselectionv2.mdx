...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionV2?$select=rowKind,contact/deletedDate,contact/NumberOfNotCompletedTicketsInPeriod,person/leadstatusRank,person/personUdef/SuperOffice:8
