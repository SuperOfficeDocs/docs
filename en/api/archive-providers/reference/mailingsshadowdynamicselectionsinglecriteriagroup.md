...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.MailingsShadowSelectionDynamicProviderSingleCriteriaGroup` inside NetServer's SODatabase assembly.
