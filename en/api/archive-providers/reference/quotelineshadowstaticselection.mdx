...
```http!
GET /api/v1/archive/QuoteLineShadowStaticSelection?$select=PriceUnitSubscriptionQuantityUnit,alternative/version/quote/sale/contact/contactExtra/x_contact_date,alternative/version/quote/sale/person/isProjectMember,alternative/version/quote/sale/project/icon,vatInfo
