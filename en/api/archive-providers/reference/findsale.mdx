...
```http!
GET /api/v1/archive/FindSale?$select=text,originalStage,contact/contactAssociate/contactFullName,contact/saintActivityType,appointment/associate/middleName
