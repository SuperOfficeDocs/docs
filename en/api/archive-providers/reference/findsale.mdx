...
```http!
GET /api/v1/archive/FindSale?$select=activeErpLinks,document/associate/contactCategory,person/ticketPriority,saleStakeholder/contact/email/emailLastBounce,who
