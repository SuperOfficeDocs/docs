...
```http!
GET /api/v1/archive/RejectedInvitation?$select=contact/contactId,person/position,person/personExtra/y_car/id,appointmentUdef/SuperOffice:5,sale/registeredByFullName
