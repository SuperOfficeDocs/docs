...
```http!
GET /api/v1/archive/RejectedInvitation?$select=associateId,contact/postAddress/wgs84longitude,person/personAddress/line3,person/personAssociate/fullName,project/projectAssociate/isActive
