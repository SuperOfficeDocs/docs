...
```http!
GET /api/v1/archive/ChatConversationShadowSelectionCombinedV2?$select=associate/contactId,associate/portraitThumbnail,person/restrictionAddress/state,person/personAssociate/associateDbId,person/correspondingAssociate/lastName
