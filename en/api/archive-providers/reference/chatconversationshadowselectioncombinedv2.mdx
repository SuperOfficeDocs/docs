...
```http!
GET /api/v1/archive/ChatConversationShadowSelectionCombinedV2?$select=associate/role,contact/categoryGroup,contact/contactFax/formattedNumber,contact/restrictionAddress/line3,contact/contactAssociate/fullName
