...
```http!
GET /api/v1/archive/ChatConversationShadowSelectionCombinedV2?$select=person/personUdef/SuperOffice:8,person/personAssociate/contactId,person/legalBaseStore,contact/contactFax/formattedNumber
