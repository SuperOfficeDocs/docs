...
```http!
GET /api/v1/archive/SaleStaticSelection?$select=person/email/emailId,person/personExtra/x_person_user_relation,person/hasStoreConsent,contact/contactAssociate/personEmail,document/associate/assocType
