...
```http!
GET /api/v1/archive/SaleStaticSelection?$select=updatedDate,person/personAssociateFullName,person/personPrivate/formattedNumber,person/personAddress/zip,contact/postAddress/city
