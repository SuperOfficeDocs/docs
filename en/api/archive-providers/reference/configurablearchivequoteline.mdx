...
```http!
GET /api/v1/archive/ConfigurableArchiveQuoteLine?$select=PriceUnitSubscriptionQuantityUnit,alternative/version/quote/sale/contact/contactExtra/x_contact_contact_relation,alternative/version/quote/sale/person/hasEmarketingConsent,alternative/version/quote/sale/project/description,vatInfo
