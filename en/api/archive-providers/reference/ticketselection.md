...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.TicketSelectionProvider` inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/TicketSelection?$select=deadline,createdBy/associateDbId,createdBy/role,person/birthMonth,person/restrictionAddress/addressId
