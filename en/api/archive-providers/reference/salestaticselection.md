...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.SaleSelectionStaticProvider` inside NetServer's SODatabase assembly.
