...
```http!
GET /api/v1/archive/ChatSession?$select=getNoRows,registeredDate,chatTopic/chatTopicId,person/personUdef/SuperOffice:1,person/personExtra/x_person_hidden_integer
