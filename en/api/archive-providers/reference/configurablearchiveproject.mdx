...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=activeErpLinks,document/text,projectMember/correspondingAssociate/usergroup,projectMember/restrictionAddress/line3,updatedDate
