...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=NumberOfNotCompletedSalesInPeriod,sale/reopenDate,appointment/duration,projectMember/personAssociate/portraitThumbnail,projectMember/hasStoreConsent
