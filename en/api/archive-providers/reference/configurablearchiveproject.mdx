...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=projectMember/registered,projectMember/personRegisteredByFullName,projectMember/personInterestIds,projectMember/personAssociate/portraitThumbnail,projectMember/categoryGroup
