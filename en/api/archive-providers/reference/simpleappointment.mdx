...
```http!
GET /api/v1/archive/SimpleAppointment?$select=alarm,contact/postAddress/county,person/personAssociate/usergroupId,project/projectPublish/isPublished,who
