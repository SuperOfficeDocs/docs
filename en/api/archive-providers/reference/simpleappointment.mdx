...
```http!
GET /api/v1/archive/SimpleAppointment?$select=userGroup,contact/contactAssociate/contactDepartment,contact/NumberOfNotCompletedSalesInPeriod,associate/contactDepartment
