...
```http!
GET /api/v1/archive/SimpleAppointment?$select=contact/contactUdef/SuperOffice:9,contact/contactUdef/SuperOffice:11,person/personAddress/wgs84longitude,person/correspondingAssociate/ejDisplayName,project/projectUdef/SuperOffice:9
