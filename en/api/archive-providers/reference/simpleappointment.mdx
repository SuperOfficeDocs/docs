...
```http!
GET /api/v1/archive/SimpleAppointment?$select=contact/contactAssociate/isActive,person/personUdef/SuperOffice:11,project/status,project/nextMilestone,project/projectEvent/hasSignOff
