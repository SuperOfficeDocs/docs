...
```http!
GET /api/v1/archive/SelectionSelectionV2?$select=associateId,registeredByFullName,selectionAssociate/ejDisplayName,selectionAssociate/portraitThumbnail,visibleFor
