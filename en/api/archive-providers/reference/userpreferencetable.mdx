...
description: Archive provider for preferences that live in the <b>userpreference</b> table. MappedPreferenceProvider for those that
...
Archive provider for preferences that live in the <b>userpreference</b> table. [MappedPreferenceProvider](./mappedpreferences) for those that
