...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=saleStatus,salePublish/publishedFrom,person/leadStatus,person/personAddress/city,person/personAssociate/firstName
