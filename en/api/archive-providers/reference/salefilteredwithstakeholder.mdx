...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=isStakeholderSale,reopenDate,person/hasInfoText,person/personDirectFax/formattedNumber,person/email/emailDescription
