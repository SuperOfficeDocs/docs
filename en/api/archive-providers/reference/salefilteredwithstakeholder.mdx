...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=activeErpLinks,person/email/emailLastSent,project/updatedBy,saleStakeholder/contact/streetAddress/zip,who
