...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=originalStage,stalledComment,person/personCountryId,person/personAddress/wgs84longitude,person/personAssociate/lastName
