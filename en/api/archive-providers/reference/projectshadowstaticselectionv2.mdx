...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=document/registeredDate,projectMember/personExtra/x_person_float,projectMember/personAssociate/locationAddress
