...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=getAllRows,sale/originalStage,sale/salePublish/isPublished,sale/saleUdef/SuperOffice:8,appointment/updatedBy
