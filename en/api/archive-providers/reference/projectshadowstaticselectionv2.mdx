...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=activeErpLinks,document/text,projectMember/correspondingAssociate/usergroupId,projectMember/restrictionAddress/wgs84longitude,updatedDate
