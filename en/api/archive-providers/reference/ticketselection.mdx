...
```http!
GET /api/v1/archive/TicketSelection?$select=person/personAssociate/usergroup,contact/contactAssociate/ejStatus,contact/contactUdef/SuperOffice:2,sale/saleTypeCategory
