...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.TicketSelectionProvider">SuperOffice.CRM.ArchiveLists.Archive.TicketSelectionProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/TicketSelection?$select=timeSpentInternally,createdBy/personId,createdBy/otherGroups,contact/streetAddress/formattedAddress,contact/contactAssociate/portraitThumbnail
