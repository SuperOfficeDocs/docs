...
```http!
GET /api/v1/archive/TicketSelection?$select=person/hasInterests,person/personUpdatedDate,person/supportAssociateFullName,contact/orgnr,sale/associate/locationAddress
