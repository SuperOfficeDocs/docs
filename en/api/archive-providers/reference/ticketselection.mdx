...
```http!
GET /api/v1/archive/TicketSelection?$select=activated,createdBy/personEmail,person/personAssociate/portraitThumbnail,project/projectUdef/SuperOffice:10,title
