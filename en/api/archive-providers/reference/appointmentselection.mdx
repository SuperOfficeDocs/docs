...
```http!
GET /api/v1/archive/AppointmentSelection?$select=contact/number,contact/streetAddress/line3,contact/contactExtra/x_contact_short_dropdown,contact/contactExtra/y_organization/x_name,person/position
