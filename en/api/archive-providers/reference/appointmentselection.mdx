...
```http!
GET /api/v1/archive/AppointmentSelection?$select=contact/activeErpLinks,contact/streetAddress/addressId,contact/streetAddress/state,person/correspondingAssociate/fullName,project/projectAssociate/usergroup
