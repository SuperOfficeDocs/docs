...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=streetAddress/county,sourceRelation/countryId,sale/originalStage,sale/salePublish/publishedTo,sale/associate/role
