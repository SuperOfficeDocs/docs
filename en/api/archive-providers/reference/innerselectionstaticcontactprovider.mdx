...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=contactSource,sale/associate/userName,document/associate/personId,fullName,isMailingRecipient
