...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=contact/number,person/personCountry,person/personExtra/x_person_category_relation,project/nextMilestone,project/projectAssociate/assocType
