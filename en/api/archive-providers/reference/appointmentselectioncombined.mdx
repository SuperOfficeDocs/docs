...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=alarm,contact/postAddress/line1,person/personAssociateId,project/projectPublish/publishedTo,who
