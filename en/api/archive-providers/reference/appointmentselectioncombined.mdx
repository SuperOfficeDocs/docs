...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=contact/updatedDate,contact/activeErpLinks,contact/contactAssociate/simultaneousEjUser,person/personAssociateId,project/name
