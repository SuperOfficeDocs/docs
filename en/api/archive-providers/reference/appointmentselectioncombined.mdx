...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=text,appointmentPublish/isPublished,contact/searchPhone/formattedNumber,contact/contactAssociate/portraitThumbnail,contact/contactUdef/SuperOffice:9
