...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=person/correspondingAssociate/contactDepartment,contact/postAddress/formattedMultiLineAddress,contact/contactInterestIds,associate/associateDbId,associate/role
