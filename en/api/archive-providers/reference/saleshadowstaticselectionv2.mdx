...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=person/personUdef/SuperOffice:3,project/projectAssociate/assocName,saleStakeholder/person/middleName,saleStakeholder/person/personUpdatedBy,quote/quoteId
