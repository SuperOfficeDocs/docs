...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=activeErpLinks,document/associate/contactDepartment,person/updatedByWorkflow,saleStakeholder/contact/hasInfoText,who
