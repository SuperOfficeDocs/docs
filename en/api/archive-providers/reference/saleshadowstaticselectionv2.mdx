...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=nextDueDate,soldReason,person/useAsMailingAddress,person/correspondingAssociate/personEmail,saleStakeholder/person/lastName
