...
```http!
GET /api/v1/archive/Activity?$select=alarm,contact/postAddress/wgs84latitude,person/personAssociate/locationAddress,project/projectEvent/hasSignOn,yourref
