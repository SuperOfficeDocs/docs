...
```http!
GET /api/v1/archive/ContactSelection?$select=contactDeleted,contactFax/description,contactUdef/SuperOffice:8,contactExtra/x_contact_contact_relation,sale/associate/ejStatus
