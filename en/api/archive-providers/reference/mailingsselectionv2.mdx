...
```http!
GET /api/v1/archive/MailingsSelectionV2?$select=mailingAddr/contact/contactAssociate/usergroup,mailingAddr/contact/NumberOfNotCompletedSalesInPeriod,mailingAddr/contact/LastCompletedTicket,mailingAddr/person/contactId,mailingAddr/person/supportAssociate
