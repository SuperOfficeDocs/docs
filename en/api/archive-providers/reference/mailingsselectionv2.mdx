...
```http!
GET /api/v1/archive/MailingsSelectionV2?$select=mailingAddr/contact/updatedBy,mailingAddr/person/personRegisteredDate,mailingAddr/person/personExtra/x_person_hidden_integer,mailingAddr/person/personAssociate/isLocation,mailingAddr/person/correspondingAssociate/ejDisplayName
