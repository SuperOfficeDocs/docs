...
```http!
GET /api/v1/archive/MailingsSelectionV2?$select=mailingAddr/person/personUdef/SuperOffice:5,project/projectAssociate/assocTooltip,project/projectUdef/SuperOffice:8
