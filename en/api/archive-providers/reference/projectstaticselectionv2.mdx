...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=appointment/isFree,document/userGroup,document/documentId,projectMember/projectId,projectMember/email/emailProtocol
