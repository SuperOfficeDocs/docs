...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=document/who,projectMember/middleName,projectMember/hasCompany,projectMember/personAddress/line2,projectMember/personUdef/SuperOffice:8
