...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=projectAssociate/credentialType,appointment/saleId,appointment/associate/fullName,projectMember/contactPhone/formattedNumber,projectMember/contactExtra/x_contact_short_dropdown
