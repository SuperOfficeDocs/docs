...
```http!
GET /api/v1/archive/AssociateProjectStaticSelection?$select=activeErpLinks,project/infoText,projectAssociate/fullName,projectAssociate/usergroupId,updatedDate
