...
```http!
GET /api/v1/archive/ChatConversationShadowStaticSelectionV2?$select=person/personAddress/wgs84latitude,contact/contactAssociate/isActive,contact/NumberOfTicketsInPeriod
