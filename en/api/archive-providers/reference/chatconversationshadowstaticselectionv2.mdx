...
```http!
GET /api/v1/archive/ChatConversationShadowStaticSelectionV2?$select=agent,contact/contactPhone/description,person/correspondingAssociate/fullName,person/personExtra/x_person_datetime,whenStarted
