...
```http!
GET /api/v1/archive/ChatConversationShadowStaticSelectionV2?$select=person/personHasInterests,person/personAssociate/personId,contact/contactAssociate/contactId
