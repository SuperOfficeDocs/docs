...
```http!
GET /api/v1/archive/ChatConversationShadowStaticSelectionV2?$select=personId,associate/assocTooltip,person/personAssociate/credentialType,person/withdrawnEmarketingConsent,contact/updatedBy
