...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=updatedByFullName,projectEvent/hasSignOff,projectAssociate/usergroupId,appointment/appointmentPublish/publishedBy,projectMember/personUdef/SuperOffice:3
