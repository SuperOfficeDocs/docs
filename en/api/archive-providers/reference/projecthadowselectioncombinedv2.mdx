...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=appointment/rawType,document/documentId,projectMember/kanaLastName,projectMember/personInfo/textId,projectMember/personExtra/y_rental/x_start
