...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=sale/salePublish/isPublished,appointment/appointment/description,appointment/appointment/agenda,document/time,document/associate/usergroupId
