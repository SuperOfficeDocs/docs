...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=activeErpLinks,sale/userGroup,sale/visibleFor,sale/associate/contactFullName,sale/associate/assocTooltip
