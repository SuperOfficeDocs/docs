...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=appointment/completed,appointment/associate/isActiveText,document/saleId,document/subject,projectMember/postAddress/city
