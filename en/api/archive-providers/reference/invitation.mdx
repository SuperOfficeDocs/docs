...
```http!
GET /api/v1/archive/Invitation?$select=recordType,person/restrictionAddress/formattedMultiLineAddress,person/personExtra/x_person_date,project/status,project/description
