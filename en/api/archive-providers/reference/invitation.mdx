...
```http!
GET /api/v1/archive/Invitation?$select=saleId,excludeParticipants,person/leadstatusRank,person/personExtra/x_person_longtext,person/correspondingAssociate/locationAddress
