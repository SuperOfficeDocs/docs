...
```http!
GET /api/v1/archive/SaintPerson?$select=contactAssociate/usergroupId,contactAssociate/ejDisplayName,sale/registeredDate,sale/stageName,appointment/updatedDate
