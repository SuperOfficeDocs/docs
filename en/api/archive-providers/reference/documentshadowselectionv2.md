...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=contact/email/emailAddress,contact/restrictionAddress/formattedAddress,contact/contactAssociate/userName,project/saintIntention,associate/contactDepartment
