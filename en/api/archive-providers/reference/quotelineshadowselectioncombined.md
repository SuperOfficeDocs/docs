...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.QuoteLineShadowSelectionCombinedProvider` inside NetServer's SODatabase assembly.
