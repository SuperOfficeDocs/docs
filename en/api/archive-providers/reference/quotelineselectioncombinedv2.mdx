...
```http!
GET /api/v1/archive/QuoteLineSelectionCombinedV2?$select=alternative/erpDiscountPercent,alternative/discountPercent,alternative/vat,alternative/version/quote/sale/person/personAssociateId,alternative/version/quote/sale/contact/number
