...
```http!
GET /api/v1/archive/QuoteLineSelectionCombinedV2?$select=productCategoryKey,alternative/version/quote/sale/associate/userName,alternative/version/quote/sale/project/icon
