...
```http!
GET /api/v1/archive/QuoteLineSelectionCombinedV2?$select=alternative/status,alternative/version/approvalRegisteredBy,alternative/version/quote/sale/personId,alternative/version/quote/sale/projectId,alternative/version/quote/sale/contact/postAddress/addressId
