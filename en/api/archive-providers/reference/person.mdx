...
```http!
GET /api/v1/archive/Person?$select=associateType,personAssociate/ejStatus,personSourceRelation/isProjectMember,projectMembers/projectUdef/SuperOffice:4,withdrawnStoreConsent
