...
```http!
GET /api/v1/archive/Person?$select=personContact/postAddress/formattedAddress,personContact/streetAddress/city,personContact/contactAssociate/contactId,request/realTimeSpentQueue,request/content
