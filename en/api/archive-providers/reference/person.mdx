...
```http!
GET /api/v1/archive/Person?$select=hasCompany,personSourceRelation/whenUpdatedByWorkflow,correspondingAssociate/ejUserId,personContact/postAddress/formattedMultiLineAddress,personContact/contactAssociate/ejDisplayName
