...
```http!
GET /api/v1/archive/SimpleTicket?$select=person/personUpdatedByFullName,person/personRegisteredByFullName,contact/contactExtra/x_contact_timespan,sale/completed,sale/hasStakeholders
