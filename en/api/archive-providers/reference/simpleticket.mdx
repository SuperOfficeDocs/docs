...
```http!
GET /api/v1/archive/SimpleTicket?$select=ownedBy/ejUserId,person/personExtra/x_person_contact_relation,contact/contactAssociate/middleName,contact/contactUdef/SuperOffice:9,sale/updatedDate
