...
```http!
GET /api/v1/archive/AppointmentShadowSelection?$select=rawStatus,person/personUdef/SuperOffice:8,person/correspondingAssociate/usergroup,project/projectUdef/SuperOffice:9,sale/registeredDate
