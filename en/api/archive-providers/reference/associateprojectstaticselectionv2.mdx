...
```http!
GET /api/v1/archive/AssociateProjectStaticSelectionV2?$select=activeErpLinks,project/infoText,projectAssociate/fullName,projectAssociate/usergroupId,updatedDate
