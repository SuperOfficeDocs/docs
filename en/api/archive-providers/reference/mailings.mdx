...
```http!
GET /api/v1/archive/Mailings?$select=mailingAddr/contact/contactAssociate/isActive,mailingAddr/contact/contactAssociate/userName,mailingAddr/person/position,mailingAddr/person/personActiveErpLinks,mailingAddr/person/leadstatusRank
