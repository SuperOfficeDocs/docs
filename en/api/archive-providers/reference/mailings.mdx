...
```http!
GET /api/v1/archive/Mailings?$select=mailingAddr/contact/contactAssociate/isLocation,mailingAddr/contact/LastDoByTicket,mailingAddr/person/personCategoryRank
