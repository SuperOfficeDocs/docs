---
title: "Relation"
description: "Data provider class for the 'Relation' archive under the company card. This class combines output from the up to eight basic sub-providers (CC, PC, PP and CP plus their reversed cousins) into one data stream."
...
```http!
GET /api/v1/archive/Relation?$select=assocName,source/contactUdef/SuperOffice:2,source/supportAssociate,target/fullName,usergroupId
