...
```http!
GET /api/v1/archive/Relation?$select=target/postAddress/line3,target/contactAssociate/otherGroups,target/contactUdef/SuperOffice:4,credentialType,target/leadStatus
