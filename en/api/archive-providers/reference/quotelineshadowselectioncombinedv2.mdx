...
```http!
GET /api/v1/archive/QuoteLineShadowSelectionCombinedV2?$select=registeredByFullName,alternative/extraField1,alternative/version/state,alternative/version/quote/sale/currencyId,alternative/version/quote/sale/activeErpLinks
