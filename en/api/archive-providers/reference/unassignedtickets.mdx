...
```http!
GET /api/v1/archive/UnassignedTickets?$select=person/searchPhone/formattedNumber,person/restrictionAddress/line1,person/personExtra/x_person_request_relation,person/correspondingAssociate/isActive,extra/x_ticket_time
