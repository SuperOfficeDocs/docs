...
```http!
GET /api/v1/archive/UnassignedTickets?$select=createdBy/contactId,person/personAssociate/role,person/personAssociate/simultaneousEjUser,person/correspondingAssociate/usergroupId,contact/searchPhone/formattedNumber
