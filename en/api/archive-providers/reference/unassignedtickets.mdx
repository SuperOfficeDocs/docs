...
```http!
GET /api/v1/archive/UnassignedTickets?$select=ownedBy/contactFullName,ownedBy/userName,person/correspondingAssociate/middleName,contact/phone/formattedNumber,contact/postAddress/addressId
