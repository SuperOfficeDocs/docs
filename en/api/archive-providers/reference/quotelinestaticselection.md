...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.QuoteLineSelectionStaticProvider` inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/QuoteLineStaticSelection?$select=targetRecordId,alternative/version/quote/sale/stageName,alternative/version/quote/sale/sale/textId,alternative/version/quote/sale/person/personExtra/y_rental/x_contact,alternative/version/quote/sale/contact/contactSource
