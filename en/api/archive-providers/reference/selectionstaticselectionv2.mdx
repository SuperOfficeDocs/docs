...
```http!
GET /api/v1/archive/SelectionStaticSelectionV2?$select=associateId,registeredBy,selectionAssociate/ejDisplayName,selectionAssociate/portraitThumbnail,visibleFor
