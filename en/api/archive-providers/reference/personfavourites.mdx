...
```http!
GET /api/v1/archive/personfavourites?$select=activeErpLinks,correspondingAssociate/personEmail,personAssociate/firstName,personUdef/SuperOffice:1,withdrawnStoreConsent
