...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.SaleGuideAppointmentProvider` inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/SaleGuideAppointment?$select=appointmentInstance/visibleFor,appointmentInstance/person/personPager/description,appointmentInstance/person/personUrl/URLDescription,appointmentInstance/person/personAssociate/middleName,appointmentInstance/project/projectAssociate/usergroup
