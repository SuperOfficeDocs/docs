...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=contactAssociate/contactCategory,sale/icon,document/recordTypeText,document/documentUdef/SuperOffice:4,personMobilePhone/description
