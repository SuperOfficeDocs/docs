...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=registeredBy,contactUdef/SuperOffice:6,targetRelation/restrictionContactId,sale/associate/portraitThumbnail,document/associate/usergroup
