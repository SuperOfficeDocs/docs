...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=business,postAddress/line2,restrictionAddress/formattedAddress,sale/probPercent,document/isMail
