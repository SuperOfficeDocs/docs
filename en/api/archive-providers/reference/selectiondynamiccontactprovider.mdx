...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=activeErpLinks,document/documentUdef/SuperOffice:7,personSourceRelation/mrMrs,request/ownedBy/lastName,workflowInstance/workflowInstanceWaitUntil
