...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=rawStatus,completedDate,contact/contactPhone/formattedNumber,contact/contactAssociate/usergroupId,contact/contactExtra/x_contact_timespan
