...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=contactId,endDate,contact/contactAssociate/fullName,person/personHasInterests,person/personActiveErpLinks
