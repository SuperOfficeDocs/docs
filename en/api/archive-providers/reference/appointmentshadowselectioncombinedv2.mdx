...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=contact/orgnr,contact/postAddress/zip,contact/contactExtra/x_contact_dropdown,person/personUdef/SuperOffice:3,person/personAssociate/lastName
