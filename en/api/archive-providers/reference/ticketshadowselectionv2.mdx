...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=person/personActiveErpLinks,person/updatedByWorkflow,person/personExtra/x_person_date,contact/contactAssociate/isActive,contact/LastSale
