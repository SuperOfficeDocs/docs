...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=person/personId,person/personUrl/URLAddress,contact/contactUdef/SuperOffice:3,extra/x_ticket_datetime,project/projectAssociate/usergroupId
