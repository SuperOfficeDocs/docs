...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=person/personId,person/hasInfoText,person/personActiveErpLinks,person/personAddress/county,person/personExtra/x_person_contact_relation
