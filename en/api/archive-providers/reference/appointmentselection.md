...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.AppointmentSelectionProvider` inside NetServer's SODatabase assembly.
