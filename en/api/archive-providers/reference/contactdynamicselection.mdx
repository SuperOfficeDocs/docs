...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=activeErpLinks,document/documentUdef/SuperOffice:8,personSourceRelation/personActiveErpLinks,request/ownedBy/locationAddress,workflowInstance/workflowInstanceWaitUntil
