...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=contactAssociate/ejUserId,contactAssociate/isActiveText,targetRelation/registeredDate,sale/visibleFor,appointment/who
