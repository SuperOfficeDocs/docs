...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=contactAssociate/lastName,appointment/createdByWorkflow,kanaFirstName,kanaLastName,personRegisteredBy
