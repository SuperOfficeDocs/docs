...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.SaleFilteredWithStakeholderProvider` inside NetServer's SODatabase assembly.
