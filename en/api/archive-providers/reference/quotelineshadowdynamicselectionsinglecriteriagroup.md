...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.QuoteLineShadowSelectionDynamicProviderSingleCriteriaGroup` inside NetServer's SODatabase assembly.
