...
```http!
GET /api/v1/archive/SystemEvents?$select=SystemEvent_id,registered_associate_id/assocType,registered_associate_id/ejUserId,registered_associate_id/personEmail,updatedCount
