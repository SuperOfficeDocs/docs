...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.MailingsShadowSelectionStaticProviderV2` inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/MailingsShadowStaticSelectionV2?$select=mailingAddr/contact/streetAddress/zip,mailingAddr/contact/contactAssociate/contactFullName,mailingAddr/person/personExtra/y_rental/x_start,mailingAddr/person/personAssociate/contactName,associate/isActiveText
