...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionSingleCriteriaGroup?$select=person/withdrawnEmarketingConsent,project/projectAssociate/contactCategory,appointment/internalNotesHtml
