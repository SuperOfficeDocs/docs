...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionSingleCriteriaGroup?$select=alarm,contact/postAddress/county,person/personAssociate/usergroupId,project/projectPublish/isPublished,who
