...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionSingleCriteriaGroup?$select=contact/NumberOfNotCompletedActivities,person/firstName,person/personExtra/x_person_date,person/isMailingRecipient,project/registeredByFullName
