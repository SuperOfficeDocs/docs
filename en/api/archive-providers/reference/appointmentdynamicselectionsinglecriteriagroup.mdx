...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionSingleCriteriaGroup?$select=date,contact/registeredDate,contact/deletedDate,contact/contactAssociate/assocTooltip,person/personUrl/URLAddress
