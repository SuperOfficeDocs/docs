...
```http!
GET /api/v1/archive/ChatConversationDynamicSelectionV2?$select=person/restrictionAddress/line3,person/personUdef/SuperOffice:1,person/personAssociate/personId,contact/contactExtra/x_contact_default_integer
