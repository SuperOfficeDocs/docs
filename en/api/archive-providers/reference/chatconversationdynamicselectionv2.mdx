...
```http!
GET /api/v1/archive/ChatConversationDynamicSelectionV2?$select=person/personAssociate/usergroup,person/personAddress/formattedAddress,person/personAssociate/isActiveText
