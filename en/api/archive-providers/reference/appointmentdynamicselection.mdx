...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=contact/url/URLAddress,contact/contactAssociate/lastName,contact/saintAmountClass,person/personExtra/x_person_boolean,person/personAssociate/ejUserId
