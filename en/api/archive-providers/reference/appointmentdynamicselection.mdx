...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=registeredBy,contact/streetAddress/line1,contact/streetAddress/formattedMultiLineAddress,contact/contactAssociate/credentialDisplayValue,person/associateType
