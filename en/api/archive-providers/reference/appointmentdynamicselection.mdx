...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=contact/business,contact/LastDoBySale,person/personAddress/addressId,sale/saleUdef/SuperOffice:7
