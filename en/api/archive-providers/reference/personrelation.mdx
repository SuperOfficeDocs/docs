...
```http!
GET /api/v1/archive/PersonRelation?$select=source/contactSource,target/email/emailBounceCount,target/restrictionAddress/wgs84latitude,target/contactExtra/x_contact_time,source/postAddress/formattedMultiLineAddress
