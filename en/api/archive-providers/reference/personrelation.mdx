...
```http!
GET /api/v1/archive/PersonRelation?$select=relationDefinitionId,source/stop,target/email/emailAddress,target/contactUdef/SuperOffice:5,target/SaintStatus2
