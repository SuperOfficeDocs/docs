...
```http!
GET /api/v1/archive/SelectionSelectionCombinedV2?$select=associateId,registeredBy,selectionAssociate/ejDisplayName,selectionAssociate/portraitThumbnail,visibleFor
