...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=realTimeSpentQueue,person/personAssociate/locationAddress,contact/contactAssociate/credentialType,project/projectUrl/URLDescription
