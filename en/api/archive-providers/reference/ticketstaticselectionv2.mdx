...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=person/middleName,person/updatedByWorkflow,person/personUdef/SuperOffice:5,person/personExtra/x_person_request_relation,person/personAssociate/assocName
