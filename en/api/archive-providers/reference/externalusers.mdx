---
title: "ExternalUsers"
description: "Concrete provider for External Users - our customer, vendors etc (Audience, eJournal Customer Care Centre). See `UsersProviderBase` for the actual functionality of the provider."
...
Concrete provider for External Users - our customer, vendors etc (Audience, eJournal Customer Care Centre). See `UsersProviderBase` for
...
```http!
GET /api/v1/archive/ExternalUsers?$select=assocName,contactDepartment,isActive,personEmail,userplan
