---
title: ExternalUsers
description: Concrete provider for External Users - our customer, vendors etc (Audience, eJournal Customer Care Centre). See UsersProviderBase for
...
```http!
GET /api/v1/archive/ExternalUsers?$select=assocTooltip,title,usergroupId
