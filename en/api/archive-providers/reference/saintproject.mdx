...
```http!
GET /api/v1/archive/SaintProject?$select=activeErpLinks,document/time,projectMember/correspondingAssociate/simultaneousEjUser,projectMember/restrictionAddress/line2,updatedDate
