...
```http!
GET /api/v1/archive/SaintProject?$select=hasInfoText,appointment/associate/contactDepartment,appointment/associate/ejUserId,projectMember/personAddress/wgs84latitude,projectMember/personExtra/x_person_shorttext_list
