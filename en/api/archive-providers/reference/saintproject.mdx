...
```http!
GET /api/v1/archive/SaintProject?$select=nextMilestone,appointment/updatedDate,projectMember/position,projectMember/correspondingAssociate/isActiveText,projectMember/contactAssociate/isActive
