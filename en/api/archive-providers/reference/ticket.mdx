...
```http!
GET /api/v1/archive/Ticket?$select=person/personUdef/SuperOffice:8,person/personExtra/x_person_datetime,person/personExtra/x_person_boolean,contact/postAddress/addressId,contact/saintIntention
