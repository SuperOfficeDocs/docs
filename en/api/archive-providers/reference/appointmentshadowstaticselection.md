...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.AppointmentShadowSelectionStaticProvider` inside NetServer's SODatabase assembly.
