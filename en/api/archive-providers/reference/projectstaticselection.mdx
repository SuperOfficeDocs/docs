...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=projectAssociate/lastName,sale/competitor,appointment/appointmentId,projectMember/mrMrs,projectMember/updatedByWorkflow
