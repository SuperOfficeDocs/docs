...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=status,sale/associate/credentialType,appointment/associate/fullName,appointment/associate/isActiveText,projectMember/personDeletedDate
