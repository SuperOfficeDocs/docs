...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=document/who,projectMember/middleName,projectMember/hasCompany,projectMember/personAddress/line2,projectMember/personUdef/SuperOffice:8
