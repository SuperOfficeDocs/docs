...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=sale/registeredByFullName,appointment/associate/usergroup,appointment/associate/locationAddress,projectMember/restrictionAddress/line1,projectMember/correspondingAssociate/ejDisplayName
