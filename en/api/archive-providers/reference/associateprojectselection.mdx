...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=projectUdef/SuperOffice:5,sale/associate/otherGroups,appointment/associate/contactFullName,projectMember/textId,projectMember/personNumber
