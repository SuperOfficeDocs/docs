...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=activeErpLinks,document/type,projectMember/correspondingAssociate/title,projectMember/restrictionAddress/state,updatedDate
