...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=sale/saleUdef/SuperOffice:4,appointment/associate/usergroup,document/time,projectMember/rank,projectMember/personExtra/y_rental/x_amount
