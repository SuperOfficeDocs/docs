...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=saintTicketCategory,appointment/priority,document/associate/credentialDisplayValue,projectMember/personCategoryGroup,projectMember/isStakeholder
