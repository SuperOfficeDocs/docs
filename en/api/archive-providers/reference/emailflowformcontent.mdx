...
description: "Email flow form content. Lists all email flow form content"
...
```http!
GET /api/v1/archive/EmailFlowFormContent?$select=emailFlow/emailFlowId,emailFlow/thumbnail,emailFlow/workflowId,formId,updatedDate
