...
```http!
GET /api/v1/archive/selectionfavourites?$select=associateId,memberCount,selectionAssociate/credentialType,selectionAssociate/portraitThumbnail,visibleFor
