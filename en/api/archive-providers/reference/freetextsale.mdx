...
```http!
GET /api/v1/archive/FreetextSale?$select=person/personInfo/infoText,person/personExtra/x_person_boolean,person/personAssociate/simultaneousEjUser,contact/deletedDate,contact/searchPhone/formattedNumber
