...
```http!
GET /api/v1/archive/FreetextSale?$select=person/personId,person/hasInfoText,project/projectAssociate/contactName,project/projectUdef/SuperOffice:7,saleStakeholder/person/personAssociateId
