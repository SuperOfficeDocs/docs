...
```http!
GET /api/v1/archive/FreetextSale?$select=person/personAssociate/contactFullName,person/personAssociate/isLocation,contact/postAddress/county,contact/contactExtra/x_contact_shorttext,project/projectAssociate/simultaneousEjUser
