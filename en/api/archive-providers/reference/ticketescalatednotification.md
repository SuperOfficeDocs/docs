...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.TicketEscalatedNotificationSubProvider` inside NetServer's SODatabase assembly.
