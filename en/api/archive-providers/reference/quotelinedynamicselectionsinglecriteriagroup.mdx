...
```http!
GET /api/v1/archive/QuoteLineDynamicSelectionSingleCriteriaGroup?$select=alternative/version/deliveryType,alternative/version/extraField3,alternative/version/quote/sale/recordType,alternative/version/quote/sale/person/phone/formattedNumber,alternative/version/quote/sale/contact/postAddress/state
