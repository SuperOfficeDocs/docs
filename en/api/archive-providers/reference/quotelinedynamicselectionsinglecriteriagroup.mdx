...
```http!
GET /api/v1/archive/QuoteLineDynamicSelectionSingleCriteriaGroup?$select=alternative/version/quote/sale/person/restrictionAddress/line1,alternative/version/quote/sale/project/projectUdef/SuperOffice:6,alternative/version/quote/sale/person/personAddress/zip
