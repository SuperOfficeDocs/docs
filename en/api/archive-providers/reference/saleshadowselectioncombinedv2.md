...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.SaleShadowSelectionCombinedProviderV2` inside NetServer's SODatabase assembly.
