...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionV2?$select=contact/restrictionAddress/city,person/restrictionAddress/zip,person/correspondingAssociate/firstName
