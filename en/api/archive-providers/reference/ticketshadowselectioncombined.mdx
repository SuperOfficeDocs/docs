...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=ticketPriority/name,person/personAssociate/ejUserId,person/personAssociate/isActive,contact/contactPhone/description,sale/associate/assocType
