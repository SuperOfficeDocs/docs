...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=person/lastName,person/restrictionAddress/formattedMultiLineAddress,person/personExtra/x_person_float,person/withdrawnStoreConsent,contact/companyCategoryRank
