...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=activated,createdBy/personEmail,person/personAssociate/portraitThumbnail,project/projectUdef/SuperOffice:10,title
