...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=person/personDeletedDate,person/personDirectPhone/formattedNumber,contact/contactExtra/x_contact_date,sale/associate/personEmail,project/saintTicketCategory
