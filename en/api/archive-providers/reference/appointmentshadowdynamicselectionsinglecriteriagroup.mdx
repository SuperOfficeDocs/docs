...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionSingleCriteriaGroup?$select=contact/contactExtra/x_contact_contact,project/projectAssociate/usergroup,project/NumberOfActivitiesInPeriod,sale/amountWeightedInBaseCurrency,sale/saleCycle
