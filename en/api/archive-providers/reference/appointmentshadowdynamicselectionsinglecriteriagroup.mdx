...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionSingleCriteriaGroup?$select=appointmentPublish/isPublished,contact/contactDeleted,contact/contactUdef/SuperOffice:1,contact/saintAmountClass,person/personBusiness
