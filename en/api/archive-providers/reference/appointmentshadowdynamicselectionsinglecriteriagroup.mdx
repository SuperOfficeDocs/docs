...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionSingleCriteriaGroup?$select=alarm,contact/postAddress/county,person/personAssociate/usergroupId,project/projectPublish/isPublished,who
