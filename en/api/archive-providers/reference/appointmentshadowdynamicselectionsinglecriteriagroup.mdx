...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionSingleCriteriaGroup?$select=contact/email/emailLastBounce,contact/streetAddress/city,contact/SaintStatus1,person/birthdate,project/projectAssociate/portraitThumbnail
