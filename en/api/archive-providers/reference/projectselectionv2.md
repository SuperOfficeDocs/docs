...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.ProjectSelectionProviderV2` inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=projectAssociate/fullName,projectAssociate/associateDbId,projectAssociate/simultaneousEjUser,sale/associate/lastName,document/updatedDate
