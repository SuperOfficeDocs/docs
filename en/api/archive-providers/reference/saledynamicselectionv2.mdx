...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=activeErpLinks,document/associate/contactCategory,person/title,saleStakeholder/contact/email/emailLastBounce,who
