...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=selectionId,contact/contactAssociate/usergroupId,appointment/date,appointment/associate/userName,document/associate/role
