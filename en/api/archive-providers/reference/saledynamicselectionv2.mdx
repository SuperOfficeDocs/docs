...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=credited,person/personCategory,person/personBusiness,person/phone/formattedNumber,person/personAssociate/assocName
