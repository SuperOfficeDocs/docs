...
```http!
GET /api/v1/archive/FindContactWithoutPhoneAddressEmail?$select=postAddress/line1,contactExtra/x_contact_longtext,contactExtra/x_contact_boolean,sale/soldReason,appointment/appointmentPublish/publishedTo
