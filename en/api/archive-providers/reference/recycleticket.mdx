...
```http!
GET /api/v1/archive/RecycleTicket?$select=readByOwner,person/personCategory,person/personExtra/y_rental/x_contact,person/withdrawnStoreConsent,extra/y_equipment/x_name
