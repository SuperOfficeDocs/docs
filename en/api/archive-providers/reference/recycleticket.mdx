...
```http!
GET /api/v1/archive/RecycleTicket?$select=getNoRows,person/lastName,person/personActiveErpLinks,person/personUdef/SuperOffice:8,person/correspondingAssociate/isActiveText
