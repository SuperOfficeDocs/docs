...
```http!
GET /api/v1/archive/RecycleTicket?$select=createdByWorkflow,ownedBy/ejStatus,person/personPrivate/description,person/personAssociate/assocName,contact/postAddress/formattedMultiLineAddress
