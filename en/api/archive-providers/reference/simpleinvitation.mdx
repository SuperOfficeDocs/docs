...
```http!
GET /api/v1/archive/SimpleInvitation?$select=appointmentPublish/publishedFrom,contact/contactAssociate/contactCategory,contact/LastDoByActivity,person/useAsMailingAddress,person/personBusiness
