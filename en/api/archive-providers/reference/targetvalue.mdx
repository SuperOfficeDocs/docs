...
```http!
GET /api/v1/archive/TargetValue?$select=associate/assocName,contact/contactExtra/x_contact_hidden_integer,contact/contactSupportPerson/personExtra/x_person_category_relation,contact/country,targetYear
