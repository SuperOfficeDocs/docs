...
```http!
GET /api/v1/archive/TargetValue?$select=associate/title,associate/contactDepartment,contact/contactAssociate/simultaneousEjUser,contact/contactSupportPerson/withdrawnEmarketingConsent,contact/saintSaleStatus
