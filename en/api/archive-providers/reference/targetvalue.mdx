...
```http!
GET /api/v1/archive/TargetValue?$select=associate/isActive,contact/category,contact/activeErpLinks,contact/contactSupportAssociate/usergroup,contact/contactSupportPerson/personExtra/x_person_boolean
