...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=projectUrl/URLDescription,projectAssociate/locationAddress,sale/saleNumber,appointment/associate/personEmail,document/associate/locationAddress
