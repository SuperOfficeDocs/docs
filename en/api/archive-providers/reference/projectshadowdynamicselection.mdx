...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=completed,sale/saleNumber,appointment/saleId,appointment/excludeParticipants,projectMember/hasInfoText
