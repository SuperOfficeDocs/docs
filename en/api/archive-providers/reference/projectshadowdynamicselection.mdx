...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=sale/lossReason,sale/reopenDate,sale/associate/usergroup,sale/associate/assocName,projectMember/personNoMail
