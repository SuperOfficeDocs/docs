...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=activeErpLinks,document/type,projectMember/correspondingAssociate/title,projectMember/restrictionAddress/line3,updatedDate
