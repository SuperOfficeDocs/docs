...
```http!
GET /api/v1/archive/simpleshipment?$select=mailingAddr/contact/contactUdef/SuperOffice:10,mailingAddr/person/email/emailId,mailingAddr/person/personAssociate/portraitThumbnail,emailFlow/workflowCompletedCount,project/activeErpLinks
