...
```http!
GET /api/v1/archive/simpleshipment?$select=mailingAddr/contact/contactExtra/x_contact_date,mailingAddr/contact/LastDoByActivity,mailingAddr/contact/NumberOfNotCompletedSales,mailingAddr/person/personBusiness,associate/userName
