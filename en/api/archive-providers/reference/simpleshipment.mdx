...
```http!
GET /api/v1/archive/simpleshipment?$select=associate/assocName,mailingAddr/contact/contactExtra/x_contact_datetime,mailingAddr/person/email/emailLastBounce,mailingAddr/person/position,updatedDate
