...
```http!
GET /api/v1/archive/simpleshipment?$select=mailingAddr/contact/restrictionAddress/line2,mailingAddr/contact/NumberOfActivities,mailingAddr/contact/saintSaleStatus,mailingAddr/person/personRegisteredByFullName,project/projectAssociate/assocName
