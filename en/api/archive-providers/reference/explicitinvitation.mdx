...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=cautionWarning,contact/contactExtra/x_contact_float,person/personExtra/x_person_hidden_integer,person/personAssociate/title,person/correspondingAssociate/middleName
