...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=icon,endDate,contact/email/emailLastBounce,contact/restrictionAddress/wgs84latitude,contact/contactAssociate/ejUserId
