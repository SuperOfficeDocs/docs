...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=intention,contact/registeredBy,contact/postAddress/line1,person/personDeletedDate,project/projectAssociate/ejUserId
