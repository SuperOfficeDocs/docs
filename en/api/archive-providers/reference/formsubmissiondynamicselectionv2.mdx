...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=associate/assocName,contact/contactSource,person/correspondingAssociate/ejUserId,person/personExtra/x_person_appointment_relation,updatedDate
