...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=associate/contactDepartment,person/personUdef/SuperOffice:6,person/personAssociate/credentialType
