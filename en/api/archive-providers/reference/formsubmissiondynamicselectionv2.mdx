...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=person/updatedByWorkflow,person/personDirectFax/description,person/personExtra/x_person_float,person/personExtra/y_rental/x_start
