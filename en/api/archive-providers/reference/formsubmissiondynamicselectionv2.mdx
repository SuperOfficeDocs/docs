...
description: FormSubmission selection archive with OR-able selection groups. Each group is represented with the FormSubmissionSelectionDynamicProviderSingleCriteriaGroup.
...
FormSubmission selection archive with OR-able selection groups. Each group is represented with the [FormSubmissionSelectionDynamicProviderSingleCriteriaGroup](./formsubmissiondynamicselectionsinglecriteriagroup).
...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=person/personPager/description,person/personUdef/SuperOffice:1,person/personAssociate/middleName,person/personAssociate/locationAddress,contact/url/URLDescription
