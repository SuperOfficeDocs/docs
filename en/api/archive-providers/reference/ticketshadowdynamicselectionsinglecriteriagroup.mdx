...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=firstReadByUser,closedAt,ownedBy/userName,person/personAddress/city,person/personAssociate/assocType
