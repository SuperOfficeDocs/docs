...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=activated,createdBy/mrMrs,person/personAssociate/mrMrs,project/projectPublish/publishedFrom,title
