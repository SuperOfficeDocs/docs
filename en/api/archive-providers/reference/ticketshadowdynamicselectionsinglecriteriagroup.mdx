...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=createdBy/title,createdBy/credentialType,person/restrictionAddress/city,person/personUdef/SuperOffice:9,person/correspondingAssociate/userName
