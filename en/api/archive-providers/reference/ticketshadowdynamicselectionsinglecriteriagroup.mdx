...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=person/correspondingAssociate/contactFullName,person/consentSourceStore,contact/LastActivity,sale/personId,sale/associate/userName
