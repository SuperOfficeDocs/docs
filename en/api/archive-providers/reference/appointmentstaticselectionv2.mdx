...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=isMilestone,contact/contactAssociate/isActiveText,person/personNoMail,person/phone/formattedNumber,person/personPrivate/description
