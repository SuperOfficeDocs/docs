...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=updatedDate,contact/registeredByFullName,contact/contactExtra/x_contact_hidden_integer,sale/associate/ejStatus
