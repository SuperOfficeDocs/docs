...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=contact/updatedByFullName,contact/postAddress/formattedMultiLineAddress,person/personAddress/county,person/personAssociate/personId,person/personAssociate/contactName
