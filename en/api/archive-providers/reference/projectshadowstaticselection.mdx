...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=getAllRows,sale/originalStage,sale/salePublish/isPublished,sale/saleUdef/SuperOffice:8,appointment/updatedBy
