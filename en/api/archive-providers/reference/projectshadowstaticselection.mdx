...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=activeErpLinks,document/text,projectMember/correspondingAssociate/usergroupId,projectMember/restrictionAddress/wgs84longitude,updatedDate
