...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=projectAssociate/role,LastCompletedSale,sale/stage,document/associate/ejUserId,projectMember/personAssociate/usergroup
