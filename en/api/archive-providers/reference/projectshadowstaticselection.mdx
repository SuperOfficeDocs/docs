...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=sale/recordType,appointment/associate/personId,document/associate/ejStatus,projectMember/personCategory,projectMember/personInfo/infoText
