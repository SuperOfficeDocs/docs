...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=person/personUdef/SuperOffice:7,person/personAssociate/contactCategory,associate/ejStatus,document/updatedDate,project/projectUdef/SuperOffice:5
