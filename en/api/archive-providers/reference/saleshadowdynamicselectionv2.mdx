...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=activeErpLinks,document/associate/contactCategory,person/title,saleStakeholder/contact/email/emailLastBounce,who
