...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=date,contact/postAddress/county,contact/contactAssociate/associateDbId,appointment/booking,project/icon
