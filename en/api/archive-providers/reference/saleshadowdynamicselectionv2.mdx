...
description: Sale shadow selection archive with OR-able selection groups. Each group is represented with the SaleShadowSelectionDynamicProviderSingleCriteriaGroup.
...
Sale shadow selection archive with OR-able selection groups. Each group is represented with the [SaleShadowSelectionDynamicProviderSingleCriteriaGroup](./saleshadowdynamicselectionsinglecriteriagroup).
...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=saleId,stage,person/restrictionAddress/formattedMultiLineAddress,person/correspondingAssociate/firstName,contact/restrictionAddress/city
