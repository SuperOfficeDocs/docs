...
```http!
GET /api/v1/archive/DocumentQuoteLineInnerData?$select=alternative/version/quote/sale/associate/assocType,alternative/version/status,alternative/version/quote/sale/registeredByFullName
