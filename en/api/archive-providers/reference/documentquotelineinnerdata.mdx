...
```http!
GET /api/v1/archive/DocumentQuoteLineInnerData?$select=PriceUnitSubscriptionQuantityUnit,alternative/version/quote/connection/erpConnection/connector/url,alternative/version/quote/sale/associate/title,alternative/version/quote/sale/stage,vatInfo
