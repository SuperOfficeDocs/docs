...
```http!
GET /api/v1/archive/MailingsStaticSelectionV2?$select=mailingAddr/contact/restrictionAddress/line3,mailingAddr/person/kanaFirstName,project/projectPublish/isPublished,project/projectUdef/SuperOffice:4,selectionId
