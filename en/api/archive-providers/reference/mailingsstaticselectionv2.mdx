...
```http!
GET /api/v1/archive/MailingsStaticSelectionV2?$select=mailingAddr/contact/contactAssociate/title,mailingAddr/person/personMobilePhone/description,associate/isActive,associate/isLocation,project/projectAssociate/locationAddress
