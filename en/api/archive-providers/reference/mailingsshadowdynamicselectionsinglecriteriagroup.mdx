...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionSingleCriteriaGroup?$select=mailingAddr/contact/contactAssociate/ejDisplayName,mailingAddr/person/personPrivate/description,mailingAddr/person/email/emailAddress,mailingAddr/person/personAssociate/associateDbId,mailingAddr/person/correspondingAssociate/contactId
