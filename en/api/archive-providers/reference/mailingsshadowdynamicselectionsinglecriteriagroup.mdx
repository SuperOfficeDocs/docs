...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionSingleCriteriaGroup?$select=mailingSelectionId,mailingAddr/contact/searchPhone/formattedNumber,mailingAddr/person/correspondingAssociate/title,emailFlow/registeredBy
