...
```http!
GET /api/v1/archive/LinksSales?$select=person/personUpdatedBy,contact/contactUdef/SuperOffice:7,project/projectAssociate/assocName,project/projectAssociate/isActiveText,saleStakeholder/person/hasInfoText
