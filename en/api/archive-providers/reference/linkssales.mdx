...
```http!
GET /api/v1/archive/LinksSales?$select=person/personSource,contact/email/emailDescription,associate/portraitThumbnail,project/projectUrl/URLAddress,saleStakeholder/contact/streetAddress/line3
