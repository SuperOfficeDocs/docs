...
```http!
GET /api/v1/archive/LinksSales?$select=person/personExtra/y_rental/x_amount,contact/name,saleStakeholder/person/personAssociate/personId,saleStakeholder/person/personAssociate/portraitThumbnail,saleStakeholder/person/personAssociate/locationAddress
