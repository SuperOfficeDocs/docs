...
```http!
GET /api/v1/archive/FindProject?$select=appointment/createdByWorkflow,appointment/appointmentPublish/publishedFrom,document/completed,document/documentUdef/SuperOffice:3,projectMember/email/emailLastBounce
