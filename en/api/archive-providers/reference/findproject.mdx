...
```http!
GET /api/v1/archive/FindProject?$select=sale/stalledComment,appointment/associate/usergroup,document/completed,projectMember/projectMemberId,projectMember/personRegisteredDate
