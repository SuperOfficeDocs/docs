...
```http!
GET /api/v1/archive/SelectionDynamicSelectionSingleCriteriaGroup?$select=associateId,registeredBy,selectionAssociate/ejDisplayName,selectionAssociate/portraitThumbnail,visibleFor
