...
```http!
GET /api/v1/archive/FormSubmissionShadowStaticSelectionV2?$select=associate/isActiveText,person/firstName,person/email/emailLastBounce,person/withdrawnStoreConsent,contact/NumberOfNotCompletedActivities
