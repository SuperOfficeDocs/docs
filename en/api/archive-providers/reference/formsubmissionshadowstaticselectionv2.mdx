...
```http!
GET /api/v1/archive/FormSubmissionShadowStaticSelectionV2?$select=person/personUpdatedDate,person/correspondingAssociate/ejStatus,contact/NumberOfActivitiesInPeriod
