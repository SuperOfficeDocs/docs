...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.TicketSelectionCombinedProvider` inside NetServer's SODatabase assembly.
