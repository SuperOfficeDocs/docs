...
```http!
GET /api/v1/archive/ChatConversationStaticSelectionV2?$select=person/rank,person/personAssociate/contactDepartment,person/personAssociate/assocType,person/correspondingAssociate/role,contact/contactAssociate/locationAddress
