...
```http!
GET /api/v1/archive/ChatConversationStaticSelectionV2?$select=getNoRows,registeredDate,chatTopic/chatTopicId,person/personUdef/SuperOffice:1,person/personExtra/x_person_hidden_integer
