...
```http!
GET /api/v1/archive/Contact?$select=activeErpLinks,contactSupportAssociate/associateDbId,contactSupportPerson/personExtra/x_person_priority_relation,contactUdef/SuperOffice:7,url/URLDescription
