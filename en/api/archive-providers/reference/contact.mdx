...
```http!
GET /api/v1/archive/Contact?$select=contactAssociate/firstName,contactSupportPerson/personUdef/SuperOffice:3,NumberOfNotCompletedActivities,NumberOfTicketsInPeriod,saintSaleStatus
