...
```http!
GET /api/v1/archive/FormSubmissionSelectionV2?$select=person/searchPhone/formattedNumber,person/personAssociate/lastName,person/personAssociate/assocTooltip,person/personAssociate/isLocation,person/correspondingAssociate/contactCategory
