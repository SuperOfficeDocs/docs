...
```http!
GET /api/v1/archive/LastTickets?$select=person/correspondingAssociate/ejUserId,contact/department,contact/contactAssociate/contactCategory,contact/contactAssociate/assocTooltip,project/text
