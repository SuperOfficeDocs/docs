...
```http!
GET /api/v1/archive/LastTickets?$select=person/leadstatusRank,person/correspondingAssociate/lastName,contact/streetAddress/addressId,sale/associate/firstName,sale/associate/contactName
