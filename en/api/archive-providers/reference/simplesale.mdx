...
```http!
GET /api/v1/archive/SimpleSale?$select=person/restrictionAddress/formattedAddress,contact/companyCategoryRank,contact/contactAssociate/simultaneousEjUser,associate/credentialType,project/projectAssociate/contactCategory
