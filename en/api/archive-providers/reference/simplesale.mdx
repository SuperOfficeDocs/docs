...
```http!
GET /api/v1/archive/SimpleSale?$select=person/leadstatusRank,person/correspondingAssociate/ejDisplayName,contact/contactExtra/y_organization/x_name,associate/associateDbId,associate/locationAddress
