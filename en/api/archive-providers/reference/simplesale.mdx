...
```http!
GET /api/v1/archive/SimpleSale?$select=person/personExtra/x_person_date,person/hasEmarketingConsent,contact/contactExtra/x_contact_contact,project/projectAssociate/usergroup
