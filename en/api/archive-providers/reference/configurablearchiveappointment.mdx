...
```http!
GET /api/v1/archive/ConfigurableArchiveAppointment?$select=contact/contactAssociate/usergroup,contact/contactAssociate/contactFullName,person/hasInterests,person/personActiveErpLinks,person/personAddress/wgs84latitude
