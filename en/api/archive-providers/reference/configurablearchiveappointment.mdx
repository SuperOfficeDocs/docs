...
```http!
GET /api/v1/archive/ConfigurableArchiveAppointment?$select=isMilestone,contact/contactSource,contact/LastDoBySale,person/correspondingAssociate/contactId,person/legalBaseEmarketing
