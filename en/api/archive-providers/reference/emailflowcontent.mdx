...
```http!
GET /api/v1/archive/EmailFlowContent?$select=registeredDate,emailFlow/emailFlowId,emailFlow/overrideConsentSubscription,shipment/emailFlow/workflowEnrolledCount,shipment/project/projectAssociate/usergroupId
