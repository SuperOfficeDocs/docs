...
description: "Archive of Email flow content. Lists all email flow content"
...
|formFolderId| *None* |Hierarchy ID: Foreign key to hierarchy table|  |
...
|shipment/mailingConfiguration| *None* |Type: Display the type of the mailing|  |
...
|shipment/scheduledAt| *None* |Scheduled at: Scheduled at|  |
...
```http!
GET /api/v1/archive/EmailFlowContent?$select=contentDescription,shipment/emailFlow/workflowAssociate/assocType,shipment/mailingSentCount,shipment/project/projectAssociate/title,updatedDate
