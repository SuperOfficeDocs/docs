...
```http!
GET /api/v1/archive/EmailFlowContent?$select=shipment/emailFlow/emailFlowId,shipment/emailFlow/startOnlyOnce,shipment/emailFlow/workflowAssociate/personEmail
