...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.SaleGuideDocumentProvider` inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/SaleGuideDocument?$select=completed,documentInstance/contact/searchPhone/description,documentInstance/person/personDirectPhone/formattedNumber,documentInstance/project/projectUdef/SuperOffice:8,text
