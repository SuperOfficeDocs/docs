...
```http!
GET /api/v1/archive/SaintContact?$select=restrictionAddress/city,contactExtra/x_contact_integer,sourceRelation/restrictionContactId,sale/createdByWorkflow,appointment/associate/portraitThumbnail
