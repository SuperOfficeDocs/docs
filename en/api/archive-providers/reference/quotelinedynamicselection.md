...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.QuoteLineSelectionDynamicProvider` inside NetServer's SODatabase assembly.
