---
title: "EventHandler"
description: "Archive of Event handlers - triggers - used by the web api and partners. Lists all triggers in screenchooser table with screenType &gt;= 100."
...
```http!
GET /api/v1/archive/EventHandler?$select=enabled,path,registeredDate,uniqueIdentifier,updatedDate
