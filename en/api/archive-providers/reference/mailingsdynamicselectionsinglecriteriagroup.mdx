...
```http!
GET /api/v1/archive/MailingsDynamicSelectionSingleCriteriaGroup?$select=mailingFolderId,mailingAddr/contact/contactSource,mailingAddr/contact/postAddress/formattedMultiLineAddress,mailingAddr/contact/contactExtra/x_contact_default_integer,mailingAddr/person/middleName
