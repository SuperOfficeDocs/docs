...
```http!
GET /api/v1/archive/MailingsDynamicSelectionSingleCriteriaGroup?$select=mailingAddr/contact/contactAssociate/contactCategory,mailingAddr/contact/contactExtra/x_contact_request_relation,mailingAddr/person/useAsMailingAddress,mailingAddr/person/correspondingAssociate/credentialDisplayValue,associate/assocTooltip
