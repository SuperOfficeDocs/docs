...
```http!
GET /api/v1/archive/MailingsDynamicSelectionSingleCriteriaGroup?$select=mailingSelectionId,mailingSimpleStatus,mailingAddr/contact/saintAmountClass,mailingAddr/person/correspondingAssociate/usergroupId,mailingAddr/person/correspondingAssociate/ejDisplayName
