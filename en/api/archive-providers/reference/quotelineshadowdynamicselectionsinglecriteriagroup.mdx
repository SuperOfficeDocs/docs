...
```http!
GET /api/v1/archive/QuoteLineShadowDynamicSelectionSingleCriteriaGroup?$select=updatedDate,alternative/quoteAlternativeId,alternative/earningAmount,alternative/version/quote/sale/currencyId,alternative/version/quote/sale/lossReason
