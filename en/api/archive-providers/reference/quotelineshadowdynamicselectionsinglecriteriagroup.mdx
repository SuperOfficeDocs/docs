...
```http!
GET /api/v1/archive/QuoteLineShadowDynamicSelectionSingleCriteriaGroup?$select=alternative/earningAmount,alternative/version/quote/sale/person/personAddress/formattedAddress,alternative/version/quote/sale/person/legalBaseStore,alternative/version/quote/sale/contact/contactExtra/x_contact_short_dropdown,alternative/version/quote/sale/contact/LastCompletedTicket
