...
```http!
GET /api/v1/archive/QuoteLineShadowDynamicSelectionSingleCriteriaGroup?$select=alternative/version/quote/sale/person/restrictionAddress/wgs84longitude,alternative/version/quote/sale/contact/contactAssociate/portraitThumbnail,alternative/version/quote/sale/project/projectAssociate/personId,alternative/version/quote/connection/erpConnection/registeredDate
