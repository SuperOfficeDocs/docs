...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=recurrenceRuleId,contact/category,contact/contactAssociate/contactId,contact/SaintStatus1,person/birthdate
