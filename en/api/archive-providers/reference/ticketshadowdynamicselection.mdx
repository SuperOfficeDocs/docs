...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=activated,createdBy/mrMrs,person/personAssociate/personEmail,project/projectPublish/publishedTo,title
