...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=person/restrictionAddress/line3,person/restrictionAddress/county,person/correspondingAssociate/personEmail,contact/contactAssociate/isLocation
