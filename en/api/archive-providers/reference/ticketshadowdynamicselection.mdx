...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=person/birthYear,person/personExtra/y_rental/x_contact,contact/restrictionAddress/zip,contact/contactAssociate/contactId,contact/contactAssociate/ejStatus
