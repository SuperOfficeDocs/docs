...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=activated,createdBy/mrMrs,person/personAssociate/personEmail,project/projectPublish/publishedTo,title
