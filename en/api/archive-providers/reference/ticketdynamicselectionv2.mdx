...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=createdBy/personId,ownedBy/credentialType,ticketPriority/ticketPriorityId,person/supportLanguage,person/personAssociate/contactDepartment
