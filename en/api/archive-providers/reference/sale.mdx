...
[ActivityArchiveProvider](./activity), which mixes sales, appointments, tasks and documents.
...
```http!
GET /api/v1/archive/Sale?$select=person/personSource,person/email/emailId,person/personExtra/x_person_shorttext,person/correspondingAssociate/assocName,person/correspondingAssociate/isActive
