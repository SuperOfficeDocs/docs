---
title: "Sale"
description: "Archive provider for Sale type activities. This provider can be used on its own, or can form part of the `ActivityArchiveProvider`, which mixes sales, appointments, tasks and documents."
...
`ActivityArchiveProvider`, which mixes sales, appointments, tasks and documents.
...
```http!
GET /api/v1/archive/Sale?$select=activeErpLinks,person/firstName,project/updatedByFullName,saleStakeholder/contact/streetAddress/zip,who
