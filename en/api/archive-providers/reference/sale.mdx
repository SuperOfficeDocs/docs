...
```http!
GET /api/v1/archive/Sale?$select=probPercent,saleType,person/personExtra/y_rental/x_end,contact/NumberOfActivities,saleStakeholder/contact/contactAssociate/isLocation
