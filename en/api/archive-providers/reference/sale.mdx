...
```http!
GET /api/v1/archive/Sale?$select=person/personCountryId,person/correspondingAssociate/portraitThumbnail,contact/activeErpLinks,contact/email/emailId,contact/LastCompletedSale
