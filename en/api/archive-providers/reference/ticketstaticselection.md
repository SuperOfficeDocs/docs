...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.TicketSelectionStaticProvider` inside NetServer's SODatabase assembly.
