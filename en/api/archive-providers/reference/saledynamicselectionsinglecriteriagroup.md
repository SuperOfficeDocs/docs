...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.SaleSelectionDynamicProviderSingleCriteriaGroup` inside NetServer's SODatabase assembly.
