...
```http!
GET /api/v1/archive/FindAppointment?$select=contact/restrictionAddress/line2,contact/contactUdef/SuperOffice:11,contact/contactExtra/x_contact_integer,contact/contactExtra/x_contact_contact,person/personCategoryGroup
