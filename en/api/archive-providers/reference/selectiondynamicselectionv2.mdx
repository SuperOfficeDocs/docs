...
```http!
GET /api/v1/archive/SelectionDynamicSelectionV2?$select=associateId,registeredBy,selectionAssociate/credentialType,selectionAssociate/personEmail,visibleFor
