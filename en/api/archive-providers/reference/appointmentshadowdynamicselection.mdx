...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=createdByWorkflow,contact/registeredDate,contact/contactAssociate/isLocation,contact/SaintStatus2,person/personCategoryGroup
