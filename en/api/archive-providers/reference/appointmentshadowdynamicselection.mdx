...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=contact/contactExtra/x_contact_longtext,contact/saintAmountClass,person/personPrivate/description,person/correspondingAssociate/title,project/startDate
