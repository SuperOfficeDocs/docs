...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=selectionId,personId,registeredByFullName,contact/email/emailAddress,person/personAddress/wgs84latitude
