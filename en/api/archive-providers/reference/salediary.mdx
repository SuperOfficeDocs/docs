...
```http!
GET /api/v1/archive/SaleDiary?$select=salePublish/isPublished,person/personAssociate/contactDepartment,person/personAssociate/assocName,person/correspondingAssociate/assocType,project/number
