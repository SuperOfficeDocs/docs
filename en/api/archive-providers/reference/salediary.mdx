...
```http!
GET /api/v1/archive/SaleDiary?$select=soldReason,person/correspondingAssociate/ejUserId,person/correspondingAssociate/portraitThumbnail,contact/postAddress/line2,contact/restrictionAddress/formattedAddress
