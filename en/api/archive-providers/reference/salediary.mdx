...
```http!
GET /api/v1/archive/SaleDiary?$select=person/birthDay,person/personPager/formattedNumber,person/correspondingAssociate/mrMrs,project/LastSale,saleStakeholder/person/leadstatusRank
