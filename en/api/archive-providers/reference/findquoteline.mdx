...
```http!
GET /api/v1/archive/FindQuoteLine?$select=quoteLineThumbnail,alternative/totalPrice,alternative/version/quote/sale/person/restrictionAddress/county,alternative/version/quote/sale/person/personExtra/x_person_appointment_relation,alternative/version/quote/sale/person/withdrawnEmarketingConsent
