...
```http!
GET /api/v1/archive/FindQuoteLine?$select=alternative/version/quote/sale/person/personUdef/SuperOffice:3,alternative/version/quote/sale/person/personAssociate/fullName,alternative/version/quote/connection/erpConnection/connector/updatedDate
