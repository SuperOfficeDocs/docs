...
```http!
GET /api/v1/archive/DummySelectionContact?$select=activeErpLinks,contactAssociate/lastName,document/registeredBy,sale/registeredByFullName,url/URLDescription
