...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.QuoteLineShadowSelectionProvider` inside NetServer's SODatabase assembly.
