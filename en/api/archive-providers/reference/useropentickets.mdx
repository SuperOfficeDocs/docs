...
```http!
GET /api/v1/archive/UserOpenTickets?$select=has_attachment,person/portraitThumbnail,person/personAssociate/associateDbId,person/personAssociate/isLocation,person/correspondingAssociate/otherGroups
