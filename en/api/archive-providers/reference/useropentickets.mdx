...
```http!
GET /api/v1/archive/UserOpenTickets?$select=readStatus,ownedBy/title,person/correspondingAssociate/associateDbId,person/correspondingAssociate/ejStatus,contact/registeredDate
