...
```http!
GET /api/v1/archive/UserOpenTickets?$select=person/personExtra/x_person_longtext,person/personExtra/x_person_shorttext_list,person/personAssociate/fullName,person/correspondingAssociate/assocName,contact/contactUdef/SuperOffice:5
