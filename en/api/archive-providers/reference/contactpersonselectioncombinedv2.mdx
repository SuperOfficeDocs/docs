...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=contactPhone/description,sale/associate/contactName,appointment/booking,document/personId,isProjectMember
