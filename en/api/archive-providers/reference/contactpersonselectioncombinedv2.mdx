...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=activeErpLinks,document/name,personSourceRelation/personCategory,request/ownedBy/contactCategory,withdrawnStoreConsent
