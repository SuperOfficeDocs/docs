...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=contactExtra/x_contact_float,sale/sale/textId,appointment/duration,personCategoryGroup,request/projectId
