...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=email/emailBounceCount,sale/text,sale/createdByWorkflow,sale/associate/ejUserId,sale/associate/isActiveText
