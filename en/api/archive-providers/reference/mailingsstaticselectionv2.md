...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.MailingsSelectionStaticProviderV2` inside NetServer's SODatabase assembly.
