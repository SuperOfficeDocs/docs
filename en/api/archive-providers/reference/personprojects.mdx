...
```http!
GET /api/v1/archive/PersonProjects?$select=activeErpLinks,projectAssociate/associateDbId,projectAssociate/personEmail,projectUdef/SuperOffice:2,updatedDate
