...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.SaleShadowSelectionProvider` inside NetServer's SODatabase assembly.
