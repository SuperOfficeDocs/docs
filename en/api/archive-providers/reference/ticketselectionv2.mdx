...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=createdBy/role,ownedBy/contactFullName,person/personPrivate/description,person/personAddress/county,person/withdrawnEmarketingConsent
