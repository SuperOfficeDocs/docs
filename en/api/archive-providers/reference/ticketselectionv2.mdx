...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=person/restrictionAddress/city,person/restrictionAddress/zip,person/correspondingAssociate/isLocation,contact/contactUdef/SuperOffice:1
