...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=numberOfMessages,createdBy/isLocation,ownedBy/assocTooltip,person/restrictionAddress/state,contact/restrictionAddress/wgs84latitude
