...
```http!
GET /api/v1/archive/ProjectActivity?$select=mailingAddr/contact/email/emailHasBounced,mailingAddr/contact/contactInterestIds,mailingAddr/person/personUpdatedBy,mailingAddr/person/personCategory,mailingAddr/person/personCategoryGroup
