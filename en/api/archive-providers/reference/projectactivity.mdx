...
```http!
GET /api/v1/archive/ProjectActivity?$select=contact/activeErpLinks,contact/postAddress/addressId,contact/restrictionAddress/zip,contact/contactUdef/SuperOffice:11,person/personAssociate/credentialType
