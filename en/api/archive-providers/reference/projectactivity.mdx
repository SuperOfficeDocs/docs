...
```http!
GET /api/v1/archive/ProjectActivity?$select=mailingAddr/contact/registeredDate,mailingAddr/contact/contactAssociate/firstName,mailingAddr/person/birthdate,mailingAddr/person/supportAssociate,mailingAddr/person/personExtra/x_person_shorttext
