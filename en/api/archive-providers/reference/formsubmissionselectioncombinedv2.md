...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.FormSubmissionSelectionCombinedProviderV2` inside NetServer's SODatabase assembly.
