...
```http!
GET /api/v1/archive/MailingsShadowSelectionV2?$select=emailFlow/workflowAssociate/fullName,project/projectUrl/URLAddress,project/projectAssociate/portraitThumbnail
