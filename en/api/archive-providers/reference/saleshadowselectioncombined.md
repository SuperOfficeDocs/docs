...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.SaleShadowSelectionCombinedProvider` inside NetServer's SODatabase assembly.
