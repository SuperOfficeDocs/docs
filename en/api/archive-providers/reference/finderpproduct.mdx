...
QuoteConnectorAttribute name, then that custom provider is called.
...
From quoteAlternativeId or quoteId the currency of the sale will be derived and added as a [ArchiveRestrictionInfo](/en/api/reference/webapi/SuperOffice.WebApi.Data.ArchiveRestrictionInfo) to the search provider. The restriction name will be 'currencyName'
