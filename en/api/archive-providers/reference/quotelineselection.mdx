...
```http!
GET /api/v1/archive/QuoteLineSelection?$select=vatAmount,alternative/version/quote/sale/person/mrMrs,alternative/version/quote/sale/person/personPager/formattedNumber,alternative/version/quote/sale/associate/lastName,alternative/version/quote/sale/saleUdef/SuperOffice:7
