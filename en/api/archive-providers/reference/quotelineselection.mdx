...
```http!
GET /api/v1/archive/QuoteLineSelection?$select=alternative/erpDiscountPercent,alternative/extraField1,alternative/version/quote/sale/person/personExtra/y_rental/x_contact,alternative/version/quote/sale/person/correspondingAssociate/mrMrs,alternative/version/quote/sale/contact/stop
