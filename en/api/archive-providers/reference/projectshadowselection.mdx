...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=projectPublish/isPublished,projectAssociate/lastName,sale/stageRank,appointment/booking,appointment/associate/associateDbId
