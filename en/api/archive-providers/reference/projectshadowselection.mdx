...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=updatedByFullName,saintDirection,document/associate/contactDepartment,projectMember/correspondingAssociate/firstName,projectMember/country
