...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=projectAssociate/personId,projectAssociate/assocName,sale/source,appointment/appointmentId,appointment/associate/simultaneousEjUser
