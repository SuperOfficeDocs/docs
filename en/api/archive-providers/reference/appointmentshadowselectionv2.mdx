...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=contact/business,contact/NumberOfNotCompletedActivitiesInPeriod,person/hasInterests,person/personAddress/addressId,project/projectAssociate/usergroupId
