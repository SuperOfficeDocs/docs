...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=contact/nameDepartment,contact/updatedByFullName,contact/contactAssociate/middleName,person/email/emailLastSent,person/personExtra/y_rental/x_end
