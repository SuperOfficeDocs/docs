...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=alarm,contact/postAddress/line1,person/personAssociateId,project/projectPublish/publishedTo,who
