...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=personId,registeredDate,person/personRegisteredDate,person/restrictionAddress/wgs84latitude,project/number
