...
```http!
GET /api/v1/archive/SaleGuideAppointment?$select=saleId,suggestedItemId,instanceItemId,appointmentInstance/person/personExtra/y_rental/id,appointmentInstance/person/personAssociate/lastName
