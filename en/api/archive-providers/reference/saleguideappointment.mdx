...
```http!
GET /api/v1/archive/SaleGuideAppointment?$select=appointmentInstance/contact/postAddress/addressId,appointmentInstance/person/correspondingAssociate/isLocation,appointmentInstance/appointmentUdef/SuperOffice:8,appointmentInstance/project/projectUrl/URLDescription,appointmentInstance/project/NumberOfActivitiesInPeriod
