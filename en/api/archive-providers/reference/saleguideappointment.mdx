...
|appointmentInstance/excludeParticipants|bool|Exclude attendees: Don't show all participant meetings|  |
...
```http!
GET /api/v1/archive/SaleGuideAppointment?$select=appointmentInstance/contact/streetAddress/state,appointmentInstance/contact/LastSale,appointmentInstance/person/personPrivate/description,appointmentInstance/person/restrictionAddress/addressId,appointmentInstance/project/SaintStatus3
