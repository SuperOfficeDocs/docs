...
```http!
GET /api/v1/archive/MailingsShadowSelectionV2?$select=associate/assocName,mailingAddr/contact/contactExtra/x_contact_default_integer,mailingAddr/person/firstName,mailingAddr/person/restrictionAddress/county,updatedDate
