...
```http!
GET /api/v1/archive/MailingsShadowSelectionV2?$select=mailingOpenRate,mailingAddr/contact/updatedBy,mailingAddr/contact/restrictionAddress/addressId,mailingAddr/contact/saintAmountClass,mailingAddr/person/firstName
