...
```http!
GET /api/v1/archive/MailingsShadowSelectionV2?$select=mailingType,mailingAddr/contact/contactNoMail,mailingAddr/contact/contactUdef/SuperOffice:2,mailingAddr/person/personAssociate/ejDisplayName,mailingAddr/person/isMailingRecipient
