...
```http!
GET /api/v1/archive/MailingsShadowSelectionV2?$select=mailingAddr/contact/streetAddress/formattedMultiLineAddress,mailingAddr/person/personDirectFax/description,mailingAddr/person/restrictionAddress/wgs84latitude,mailingAddr/person/restrictionAddress/formattedMultiLineAddress,mailingAddr/person/personExtra/x_person_request_relation
