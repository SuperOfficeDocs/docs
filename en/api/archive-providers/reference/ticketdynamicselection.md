...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.TicketSelectionDynamicProvider` inside NetServer's SODatabase assembly.
