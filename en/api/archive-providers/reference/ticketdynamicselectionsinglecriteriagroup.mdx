...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=getNoRows,ownedBy/fullName,person/personInterestIds,person/personExtra/x_person_category_relation,person/personAssociate/isLocation
