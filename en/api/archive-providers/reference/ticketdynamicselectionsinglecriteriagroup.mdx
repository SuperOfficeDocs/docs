...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=readStatus,createdBy/role,ownedBy/credentialDisplayValue,person/title,person/birthdate
