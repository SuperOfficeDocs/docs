...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=activated,createdBy/mrMrs,person/personAssociate/mrMrs,project/projectPublish/publishedFrom,title
