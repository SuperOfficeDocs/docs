...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=ownedBy/ejStatus,person/personAssociate/fullName,contact/contactExtra/x_contact_dropdown,contact/NumberOfNotCompletedSalesInPeriod,sale/associate/fullName
