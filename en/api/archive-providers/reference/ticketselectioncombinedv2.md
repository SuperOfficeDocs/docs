...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.TicketSelectionCombinedProviderV2` inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=numberOfMessages,person/email/emailLastSent,person/personAssociate/ejDisplayName,contact/searchPhone/description,contact/contactAssociate/contactId
