...
```http!
GET /api/v1/archive/QuoteLineShadowSelectionV2?$select=alternative/version/quote/sale/person/birthDay,alternative/version/quote/sale/person/personRegisteredByFullName,alternative/version/quote/sale/person/personUrl/URLDescription,alternative/version/quote/sale/contact/categoryGroup,alternative/version/quote/sale/contact/streetAddress/state
