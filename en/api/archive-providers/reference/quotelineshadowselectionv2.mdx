...
```http!
GET /api/v1/archive/QuoteLineShadowSelectionV2?$select=subscriptionUnit,alternative/version/quote/sale/registeredBy,alternative/version/quote/sale/contact/NumberOfNotCompletedTicketsInPeriod,alternative/version/quote/sale/project/projectAssociate/ejDisplayName
