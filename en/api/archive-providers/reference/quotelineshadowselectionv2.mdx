...
```http!
GET /api/v1/archive/QuoteLineShadowSelectionV2?$select=totalPriceIncVAT,totalPriceWithAlternativeDiscount,alternative/version/quote/sale/person/personExtra/x_person_date,alternative/version/quote/sale/contact/streetAddress/zip,alternative/version/quote/sale/contact/saintTicketCategory
