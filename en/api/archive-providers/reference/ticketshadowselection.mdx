...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=readByCustomer,person/ticketPriority,contact/email/emailProtocol,contact/streetAddress/line2,contact/restrictionAddress/formattedAddress
