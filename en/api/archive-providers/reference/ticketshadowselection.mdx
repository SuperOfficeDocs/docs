...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=createdBy/personId,person/contactId,person/personCategoryGroup,person/personAssociate/title,person/personAssociate/assocName
