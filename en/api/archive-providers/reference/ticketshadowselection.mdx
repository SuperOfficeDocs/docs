...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=createdBy/credentialDisplayValue,person/personUdef/SuperOffice:8,person/correspondingAssociate/contactName,sale/associate/ejUserId,project/projectAssociate/title
