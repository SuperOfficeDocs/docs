...
```http!
GET /api/v1/archive/EmailFlowEmailContent?$select=shipment/mailingType,shipment/project/nextMilestone,shipment/project/activeErpLinks,shipment/project/project/infoText
