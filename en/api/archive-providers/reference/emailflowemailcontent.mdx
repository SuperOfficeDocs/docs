...
```http!
GET /api/v1/archive/EmailFlowEmailContent?$select=registeredDate,emailFlow/emailFlowId,emailFlow/overrideConsentSubscription,shipment/emailFlow/workflowDefinitionStatusId,shipment/project/projectAssociate/contactName
