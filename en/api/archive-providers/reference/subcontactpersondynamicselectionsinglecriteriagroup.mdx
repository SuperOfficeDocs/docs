...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=email/emailLastBounce,sale/saleUdef/SuperOffice:8,appointment/duration,appointment/visibleFor,appointment/associate/assocType
