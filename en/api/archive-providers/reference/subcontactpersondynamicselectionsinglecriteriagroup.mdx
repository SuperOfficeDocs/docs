...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=contactExtra/x_contact_contact_relation,appointment/rawType,document/associate/contactDepartment,birthMonth,personAssociate/lastName
