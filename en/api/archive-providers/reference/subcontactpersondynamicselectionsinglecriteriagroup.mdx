...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=postAddress/formattedMultiLineAddress,contactUdef/SuperOffice:11,NumberOfSales,targetRelation/hasInfoText,targetRelation/csRelation
