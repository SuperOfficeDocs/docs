...
keywords: TicketShadowDynamicSelectionV2 archive provider
generated: true
...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.TicketShadowSelectionDynamicProviderV2` inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=person/personAssociateId,sale/earning,sale/daysInStage,sale/associate/credentialDisplayValue,sale/saleUdef/SuperOffice:7
