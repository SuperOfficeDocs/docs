...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.MailingsProviderBase` inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/Mailings?$select=mailingSimpleStatus,mailingAddr/contact/contactAssociate/usergroupId,mailingAddr/person/personExtra/x_person_shorttext_list,associate/usergroup
