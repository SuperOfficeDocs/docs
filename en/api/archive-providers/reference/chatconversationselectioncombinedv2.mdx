...
```http!
GET /api/v1/archive/ChatConversationSelectionCombinedV2?$select=person/personAssociate/contactFullName,person/restrictionAddress/line1,person/personAssociate/userName
