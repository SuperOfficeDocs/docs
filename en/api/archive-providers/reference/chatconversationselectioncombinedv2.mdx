...
```http!
GET /api/v1/archive/ChatConversationSelectionCombinedV2?$select=person/personId,person/email/emailAddress,person/personAddress/zip,contact/business,contact/postAddress/state
