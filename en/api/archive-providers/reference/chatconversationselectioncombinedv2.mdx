...
```http!
GET /api/v1/archive/ChatConversationSelectionCombinedV2?$select=person/birthDay,person/personPager/formattedNumber,person/personUdef/SuperOffice:1,person/personAssociate/credentialType,person/correspondingAssociate/usergroupId
