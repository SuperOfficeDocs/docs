...
```http!
GET /api/v1/archive/CancelledInvitation?$select=project/projectAssociate/fullName,project/projectAssociate/title,sale/updatedBy,sale/updatedDate,sale/visibleFor
