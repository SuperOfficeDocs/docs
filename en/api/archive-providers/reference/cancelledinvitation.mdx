...
```http!
GET /api/v1/archive/CancelledInvitation?$select=contact/name,person/personInterestIds,project/projectUdef/SuperOffice:9,sale/registeredByFullName,sale/associate/middleName
