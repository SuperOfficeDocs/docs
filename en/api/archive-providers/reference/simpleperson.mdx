...
```http!
GET /api/v1/archive/SimplePerson?$select=contactId,ticketPriority,personAddress/formattedMultiLineAddress,personTargetRelation/isStakeholder,personTargetRelation/who
