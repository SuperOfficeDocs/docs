...
```http!
GET /api/v1/archive/SimplePerson?$select=restrictionAddress/addressId,personSourceRelation/personRegisteredByFullName,personContact/category,personContact/streetAddress/wgs84latitude,projectMembers/registeredByFullName
