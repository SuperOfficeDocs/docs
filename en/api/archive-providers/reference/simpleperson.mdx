...
```http!
GET /api/v1/archive/SimplePerson?$select=personAddress/addressId,restrictionAddress/line1,personExtra/x_person_integer,personContact/restrictionAddress/formattedAddress,projectMembers/NumberOfNotCompletedActivities
