...
```http!
GET /api/v1/archive/SimplePerson?$select=associateType,personContact/contactAssociate/ejStatus,personContact/restrictionAddress/line2,projectMembers/projectAssociate/assocTooltip,withdrawnStoreConsent
