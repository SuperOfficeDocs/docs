...
```http!
GET /api/v1/archive/FreetextPerson?$select=personAddress/zip,personUdef/SuperOffice:11,personSourceRelation/title,personTargetRelation/birthDay,personContact/categoryGroup
