...
```http!
GET /api/v1/archive/FreetextPerson?$select=personAddress/addressId,restrictionAddress/line1,personSourceRelation/personNoMail,personTargetRelation/restrictionContactId,correspondingAssociate/contactFullName
