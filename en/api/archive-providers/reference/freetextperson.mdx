...
```http!
GET /api/v1/archive/FreetextPerson?$select=personAssociateId,restrictionAddress/wgs84latitude,personExtra/x_person_longtext,personContact/department,personContact/contactSupportAssociate/isActive
