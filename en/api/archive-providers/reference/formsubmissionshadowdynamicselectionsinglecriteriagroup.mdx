...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionSingleCriteriaGroup?$select=person/correspondingAssociate/title,contact/contactDeleted,contact/saintSaleStatus
