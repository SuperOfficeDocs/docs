...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionSingleCriteriaGroup?$select=associate/assocName,contact/contactSource,person/correspondingAssociate/ejStatus,person/personDirectPhone/formattedNumber,updatedDate
