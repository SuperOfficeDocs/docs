...
```http!
GET /api/v1/archive/LinksAppointments?$select=location,contact/restrictionAddress/line2,contact/NumberOfActivities,contact/saintActivityType,person/personExtra/y_rental/x_amount
