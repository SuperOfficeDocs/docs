...
```http!
GET /api/v1/archive/LinksAppointments?$select=appointmentPublish/isPublished,person/personRegisteredByFullName,person/restrictionAddress/wgs84latitude,person/personUdef/SuperOffice:7,person/correspondingAssociate/isActiveText
