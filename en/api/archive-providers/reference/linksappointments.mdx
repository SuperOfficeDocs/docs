...
```http!
GET /api/v1/archive/LinksAppointments?$select=contact/restrictionAddress/state,contact/LastActivity,contact/saintTicketCategory,person/personUpdatedBy,person/createdByForm
