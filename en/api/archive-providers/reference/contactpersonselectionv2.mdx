...
```http!
GET /api/v1/archive/ContactPersonSelectionV2?$select=rowKind,email/emailDescription,targetRelation/updatedDate,sale/saleUdef/SuperOffice:6,personTargetRelation/supportAssociate
