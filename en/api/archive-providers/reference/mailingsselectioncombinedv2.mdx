...
```http!
GET /api/v1/archive/MailingsSelectionCombinedV2?$select=contactId,mailingAddr/contact/contactExtra/x_contact_default_integer,mailingAddr/person/restrictionAddress/zip,mailingAddr/person/personAssociate/role,mailingAddr/person/withdrawnStoreConsent
