...
```http!
GET /api/v1/archive/MailingsSelectionCombinedV2?$select=mailingAddr/contact/contactId,mailingAddr/contact/searchPhone/description,mailingAddr/contact/streetAddress/formattedAddress,mailingAddr/contact/streetAddress/formattedMultiLineAddress,mailingAddr/contact/contactExtra/x_contact_integer
