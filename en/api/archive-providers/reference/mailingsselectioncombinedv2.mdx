...
```http!
GET /api/v1/archive/MailingsSelectionCombinedV2?$select=mailingSelectionId,mailingAddr/contact/postAddress/line2,emailFlow/workflowAssociate/contactCategory,project/projectUdef/SuperOffice:2,project/LastSale
