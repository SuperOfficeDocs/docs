...
```http!
GET /api/v1/archive/ChatConversationShadowDynamicSelectionSingleCriteriaGroup?$select=person/correspondingAssociate/credentialDisplayValue,contact/contactAssociate/firstName,person/personAddress/formattedMultiLineAddress
