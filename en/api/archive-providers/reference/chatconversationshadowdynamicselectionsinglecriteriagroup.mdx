...
```http!
GET /api/v1/archive/ChatConversationShadowDynamicSelectionSingleCriteriaGroup?$select=person/phone/formattedNumber,contact/email/emailBounceCount,contact/LastCompletedSale
