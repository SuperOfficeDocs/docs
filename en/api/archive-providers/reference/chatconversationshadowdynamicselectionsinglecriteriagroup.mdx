...
```http!
GET /api/v1/archive/ChatConversationShadowDynamicSelectionSingleCriteriaGroup?$select=contact/url/URLDescription,contact/contactAssociate/mrMrs,person/personAddress/formattedMultiLineAddress
