...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=person/personCountryId,person/supportLanguage,person/personExtra/x_person_request_relation,appointment/userGroup,appointment/completedDate
