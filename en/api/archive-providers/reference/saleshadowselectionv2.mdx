...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=activeErpLinks,document/associate/contactDepartment,person/updatedByWorkflow,saleStakeholder/contact/hasInfoText,who
