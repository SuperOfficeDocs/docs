...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=person/personPrivate/description,appointment/appointmentPublish/publishedBy,saleStakeholder/person/personAssociate/contactCategory,saleStakeholder/person/personAssociate/ejStatus,saleStakeholder/person/correspondingAssociate/credentialDisplayValue
