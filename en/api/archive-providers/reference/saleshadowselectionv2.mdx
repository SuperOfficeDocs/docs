...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=person/portraitThumbnail,person/personAssociate/userName,contact/contactAssociate/credentialType,contact/contactExtra/x_contact_default_integer,contact/contactExtra/x_contact_request_relation
