...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=activated,createdBy/personEmail,person/personAssociate/portraitThumbnail,project/projectUdef/SuperOffice:10,title
