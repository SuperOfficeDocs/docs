...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=realTimeSpentInternally,realTimeToClose,person/personAssociate/mrMrs,contact/contactAssociate/usergroupId,contact/contactAssociate/simultaneousEjUser
