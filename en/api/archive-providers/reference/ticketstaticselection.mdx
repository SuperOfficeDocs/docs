...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=ticketPriority/name,person/personAssociate/fullName,person/personAssociate/contactFullName,person/personAssociate/ejDisplayName,contact/contactFax/description
