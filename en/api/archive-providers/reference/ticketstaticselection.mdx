...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=realTimeSpentQueue,person/personAssociate/locationAddress,contact/contactAssociate/credentialType,project/projectUrl/URLDescription
