...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.RelatedTicketsProvider">SuperOffice.CRM.ArchiveLists.RelatedTicketsProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/RelatedTickets?$select=person/personAssociate/isLocation,person/withdrawnEmarketingConsent,contact/contactExtra/y_organization/x_name,sale/saleUdef/SuperOffice:8
