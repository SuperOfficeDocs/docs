...
```http!
GET /api/v1/archive/RelatedTickets?$select=createdByWorkflow,person/personUdef/SuperOffice:11,contact/activeErpLinks,contact/contactAssociate/isActive,sale/stageId
