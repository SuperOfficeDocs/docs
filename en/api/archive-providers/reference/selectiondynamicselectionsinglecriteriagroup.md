...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.SelectionSelectionDynamicProviderSingleCriteriaGroup` inside NetServer's SODatabase assembly.
