...
[ActivityArchiveProvider](./activity), which mixes Appointments, appointments, tasks and documents.
...
```http!
GET /api/v1/archive/ChecklistAppointment?$select=updatedByFullName,contact/postAddress/wgs84longitude,contact/saintActivityType,person/personAssociate/title,sale/associate/personId
