...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.DiaryActivityArchiveProvider` inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/DiaryActivity?$select=alarm,contact/postAddress/wgs84latitude,person/personAssociate/locationAddress,project/projectEvent/hasSignOn,yourref
