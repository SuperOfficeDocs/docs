...
```http!
GET /api/v1/archive/QuoteLineShadowDynamicSelection?$select=alternative/version/quote/sale/updatedDate,alternative/version/quote/sale/hasStakeholders,alternative/version/quote/sale/person/personExtra/x_person_request_relation,alternative/version/quote/sale/contact/email/emailProtocol,alternative/version/quote/sale/contact/postAddress/line3
