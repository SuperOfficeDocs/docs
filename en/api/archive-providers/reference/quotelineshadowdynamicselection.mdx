...
```http!
GET /api/v1/archive/QuoteLineShadowDynamicSelection?$select=alternative/vat,alternative/version/quote/sale/person/personAddress/wgs84latitude,alternative/version/quote/sale/person/withdrawnEmarketingConsent,alternative/version/quote/sale/contact/contactExtra/x_contact_timespan,alternative/version/quote/sale/contact/NumberOfNotCompletedTicketsInPeriod
