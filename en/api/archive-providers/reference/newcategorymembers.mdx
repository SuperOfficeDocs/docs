...
description: "Archive of NewCategoryMember - used by the web api. Lists new CategoryMembers added through restriction."
...
```http!
GET /api/v1/archive/NewCategoryMembers?$select=assocName,contactName,isActive,personEmail,weight
