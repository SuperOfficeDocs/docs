...
```http!
GET /api/v1/archive/BookingResponseInvitation?$select=joinVideomeetUrl,contact/streetAddress/wgs84longitude,person/personRegisteredBy,project/projectAssociate/isActiveText
