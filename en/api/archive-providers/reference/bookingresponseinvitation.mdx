...
or BookingmentDeclined). They also have to be not overdue, i.e., activedate
...
```http!
GET /api/v1/archive/BookingResponseInvitation?$select=contact/contactUdef/SuperOffice:3,contact/NumberOfNotCompletedTickets,contact/LastTicket,person/hasInterests,person/ticketPriority
