...
```http!
GET /api/v1/archive/BookingResponseInvitation?$select=type,contactId,contact/contactUdef/SuperOffice:7,contact/saintSaleStatus,person/personHasInterests
