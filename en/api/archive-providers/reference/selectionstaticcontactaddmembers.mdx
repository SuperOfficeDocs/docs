...
then contacts that have the Xstop property set to a nonzero
...
then contacts that have the Nomailing property set to a nonzero
...
IncludePersonType enumeration (parsing
