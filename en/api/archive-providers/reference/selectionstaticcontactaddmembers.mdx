...
```http!
GET /api/v1/archive/SelectionStaticContactAddMembers?$select=LastActivity,targetRelation/stop,personAssociate/personId,request/extra/x_ticket_time,projectMembers/LastDoByActivity
