...
```http!
GET /api/v1/archive/SelectionStaticContactAddMembers?$select=contactSource,postAddress/formattedAddress,NumberOfActivitiesInPeriod,sourceRelation/country,sale/associate/usergroupId
