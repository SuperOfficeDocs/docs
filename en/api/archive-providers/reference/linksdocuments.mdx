...
```http!
GET /api/v1/archive/LinksDocuments?$select=associate/assocName,contact/restrictionAddress/zip,person/personCategory,project/projectPublish/publishedTo,yourref
