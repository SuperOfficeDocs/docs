...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=type,description,projectAssociate/ejUserId,sale/associate/contactFullName,document/associate/ejDisplayName
