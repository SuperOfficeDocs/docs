...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=sale/competitor,sale/saleTypeCategory,sale/associate/contactFullName,sale/associate/assocType,projectMember/birthdate
