...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=number,projectUdef/SuperOffice:4,sale/associate/usergroupId,appointment/icon,appointment/excludeParticipants
