...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=earningPercent,person/personUpdatedDate,person/personDirectPhone/description,person/correspondingAssociate/ejDisplayName,contact/restrictionAddress/formattedMultiLineAddress
