...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=contactId,person/personHasInterests,contact/contactAssociate/lastName,contact/contactAssociate/middleName,project/projectAssociate/contactId
