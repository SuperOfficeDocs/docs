...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=stage,person/birthYear,person/personCategoryGroup,person/personUdef/SuperOffice:6,contact/code
