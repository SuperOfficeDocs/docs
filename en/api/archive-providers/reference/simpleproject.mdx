...
```http!
GET /api/v1/archive/SimpleProject?$select=activeErpLinks,projectAssociate/contactCategory,projectAssociate/portraitThumbnail,projectUdef/SuperOffice:3,updatedDate
