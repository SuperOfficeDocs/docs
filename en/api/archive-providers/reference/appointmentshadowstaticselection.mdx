...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=person/personSource,person/restrictionAddress/line2,person/personExtra/x_person_date,person/correspondingAssociate/lastName,project/projectAssociate/mrMrs
