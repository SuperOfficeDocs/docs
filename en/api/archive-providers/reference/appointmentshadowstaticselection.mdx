...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=contact/business,contact/NumberOfNotCompletedActivitiesInPeriod,person/hasInterests,person/personAddress/addressId,project/projectAssociate/usergroupId
