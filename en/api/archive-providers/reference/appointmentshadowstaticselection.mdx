...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=time,contact/country,contact/streetAddress/city,person/correspondingAssociate/ejStatus,person/correspondingAssociate/personEmail
