...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionV2?$select=associate/assocName,mailingAddr/contact/contactExtra/x_contact_datetime,mailingAddr/person/email/emailLastBounce,mailingAddr/person/rank,updatedDate
