...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionV2?$select=mailingAddr/contact/streetAddress/city,mailingAddr/person/personPrivate/description,emailFlow/mediumThumbnail,emailFlow/workflowAssociate/ejUserId,emailFlow/workflowAssociate/locationAddress
