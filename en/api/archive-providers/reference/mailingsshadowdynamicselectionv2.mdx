...
description: Mailings shadow selection archive with OR-able selection groups. Each group is represented with the MailingsShadowSelectionDynamicProviderSingleCriteriaGroup.
...
Mailings shadow selection archive with OR-able selection groups. Each group is represented with the [MailingsShadowSelectionDynamicProviderSingleCriteriaGroup](./mailingsshadowdynamicselectionsinglecriteriagroup).
...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionV2?$select=mailingAddr/contact/url/URLDescription,mailingAddr/contact/NumberOfNotCompletedActivities,mailingAddr/contact/SaintStatus1,mailingAddr/person/correspondingAssociate/assocName,mailingAddr/person/correspondingAssociate/ejDisplayName
