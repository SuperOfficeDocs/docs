...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=person/personUpdatedByFullName,person/personRegisteredDate,person/personAssociateId,person/personAddress/wgs84longitude,contact/streetAddress/line2
