...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=realTimeSpentQueue,timeToReply,createdBy/fullName,ownedBy/mrMrs,contact/contactAssociate/userName
