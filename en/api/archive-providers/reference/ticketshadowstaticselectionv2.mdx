...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=personId,person/personUpdatedByFullName,contact/contactUdef/SuperOffice:11,sale/userGroup,sale/description
