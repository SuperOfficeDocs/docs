...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.AppointmentSelectionDynamicProvider` inside NetServer's SODatabase assembly.
