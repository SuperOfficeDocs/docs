...
keywords: AssociateProjectSelectionV2 archive provider
generated: true
...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.AssociateProjectSelectionProviderV2` inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=associateId,projectEvent/eventDate,sale/completed,document/associate/fullName,document/associate/contactName
