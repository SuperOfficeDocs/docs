...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=type,associate/ejUserId,person/personAssociateId,person/personPrivate/description,person/personDirectFax/formattedNumber
