...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=person/birthMonth,person/personPager/formattedNumber,person/restrictionAddress/zip,person/personExtra/x_person_float,person/personAssociate/lastName
