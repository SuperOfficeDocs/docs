...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=associate/assocName,contact/contactUdef/SuperOffice:1,person/correspondingAssociate/firstName,person/personExtra/x_person_category_relation,updatedDate
