...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=person/personAssociate/contactId,person/personAssociate/locationAddress,contact/contactId
