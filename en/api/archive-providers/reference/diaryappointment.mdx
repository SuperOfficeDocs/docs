...
```http!
GET /api/v1/archive/DiaryAppointment?$select=contact/restrictionAddress/wgs84longitude,contact/contactAssociate/personId,person/personAssociateFullName,associate/title
