...
```http!
GET /api/v1/archive/DiaryAppointment?$select=contact/nameDepartment,contact/email/emailAddress,contact/LastDoBySale,contact/saintTicketCategory,person/personAssociate/contactName
