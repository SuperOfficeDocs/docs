...
```http!
GET /api/v1/archive/DiaryAppointment?$select=contact/contactAssociate/role,contact/contactUdef/SuperOffice:4,person/fullName,person/supportAssociate,person/personExtra/x_person_category_relation
