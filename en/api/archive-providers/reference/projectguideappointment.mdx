...
```http!
GET /api/v1/archive/ProjectGuideAppointment?$select=appointmentInstance/contact/contactAssociate/credentialDisplayValue,appointmentInstance/contact/contactUdef/SuperOffice:1,appointmentInstance/project/projectEvent/isExternalEvent
