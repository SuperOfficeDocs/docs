...
```http!
GET /api/v1/archive/ProjectGuideAppointment?$select=appointmentInstance/contactId,appointmentInstance/cautionWarning,appointmentInstance/joinVideomeetUrl,appointmentInstance/contact/nameDepartment,appointmentInstance/contact/NumberOfNotCompletedSales
