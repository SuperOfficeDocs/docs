...
```http!
GET /api/v1/archive/ProjectGuideAppointment?$select=appointmentInstance/visibleFor,appointmentInstance/contact/contactDeleted,appointmentInstance/contact/contactAssociate/isLocation,appointmentInstance/person/birthdate,appointmentInstance/project/LastCompletedActivity
