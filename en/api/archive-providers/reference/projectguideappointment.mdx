...
```http!
GET /api/v1/archive/ProjectGuideAppointment?$select=appointmentInstance/alarm,appointmentInstance/contact/postAddress/state,appointmentInstance/person/personDirectFax/formattedNumber,appointmentInstance/project/projectUdef/SuperOffice:8,text
