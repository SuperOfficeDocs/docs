...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.TicketFavouriteUpdatedNotificationSubProvider` inside NetServer's SODatabase assembly.
