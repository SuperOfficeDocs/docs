...
```http!
GET /api/v1/archive/FavouriteTickets?$select=title,ownedBy/isActiveText,person/personAddress/wgs84longitude,person/personUdef/SuperOffice:5,person/personUdef/SuperOffice:7
