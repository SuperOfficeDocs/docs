...
```http!
GET /api/v1/archive/FavouriteTickets?$select=categoryFullName,person/portraitThumbnail,person/restrictionAddress/zip,contact/streetAddress/wgs84latitude,contact/restrictionAddress/formattedMultiLineAddress
