...
```http!
GET /api/v1/archive/FavouriteTickets?$select=createdBy/associateDbId,ownedBy/role,ownedBy/userName,person/birthMonth,person/personAddress/wgs84longitude
