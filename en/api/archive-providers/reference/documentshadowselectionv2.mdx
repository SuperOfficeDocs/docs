...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.DocumentShadowSelectionProviderV2` inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=associate/assocName,contact/searchPhone/description,person/personDirectFax/description,project/projectUdef/SuperOffice:2,yourref
