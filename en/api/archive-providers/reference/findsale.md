...
```http!
GET /api/v1/archive/FindSale?$select=salePublish/isPublished,person/personAssociate/locationAddress,person/hasEmarketingConsent,contact/NumberOfSalesInPeriod,contact/NumberOfTickets
