...
```http!
GET /api/v1/archive/ProjectMember?$select=person/personExtra/x_person_timespan,person/legalBaseEmarketing,contact/contactAssociate/contactName,contact/contactExtra/x_contact_float
