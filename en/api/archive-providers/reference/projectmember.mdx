...
```http!
GET /api/v1/archive/ProjectMember?$select=hasInfoText,project/project/infoText,person/personInfo/textId,person/personExtra/y_rental/y_equipment/x_name,contact/contactAssociate/ejStatus
