...
```http!
GET /api/v1/archive/ProjectMember?$select=project/projectUdef/SuperOffice:3,person/personAddress/wgs84longitude,person/restrictionAddress/line1,person/personExtra/x_person_shorttext,person/correspondingAssociate/role
