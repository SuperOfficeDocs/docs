...
```http!
GET /api/v1/archive/ConsentPurpose?$select=consentPerson/person/personExtra/y_rental/y_equipment/x_name,consentPerson/person/personRegisteredBy,consentPerson/person/personDirectPhone/description
