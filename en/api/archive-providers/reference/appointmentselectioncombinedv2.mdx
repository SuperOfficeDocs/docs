...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=contact/email/emailAddress,contact/LastActivity,person/portraitThumbnail,person/personAssociate/contactCategory,sale/associate/usergroup
