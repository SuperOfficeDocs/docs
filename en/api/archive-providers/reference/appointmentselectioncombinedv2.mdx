...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=contact/code,person/isStakeholder,person/personUrl/URLDescription,project/saintAmountClass,project/saintActivityType
