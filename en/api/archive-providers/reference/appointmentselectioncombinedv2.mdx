...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=projectId,rawStatus,cautionWarning,contact/streetAddress/wgs84longitude,contact/contactAssociate/lastName
