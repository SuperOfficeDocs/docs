...
This class instantiates a `DiaryAppointmentProvider` and a `ChecklistAppointmentProvider` as
...
```http!
GET /api/v1/archive/Appointment?$select=alarm,contact/postAddress/county,person/personAssociate/usergroup,project/projectId,who
