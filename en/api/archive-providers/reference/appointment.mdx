...
```http!
GET /api/v1/archive/Appointment?$select=contact/contactAssociate/firstName,contact/contactAssociate/fullName,contact/saintDirection,person/personExtra/x_person_shorttext,person/personAssociate/ejDisplayName
