...
```http!
GET /api/v1/archive/EmailAddress?$select=activeErpLinks,contactSupportPerson/consentSourceStore,contactUdef/SuperOffice:4,personContact/restrictionAddress/zip,who
