...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.AppointmentSelectionCombinedProvider` inside NetServer's SODatabase assembly.
