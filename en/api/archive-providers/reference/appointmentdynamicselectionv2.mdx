...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=alarm,contact/postAddress/county,person/personAssociate/usergroupId,project/projectPublish/isPublished,who
