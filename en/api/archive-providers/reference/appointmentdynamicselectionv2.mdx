...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=person/correspondingAssociate/contactName,person/correspondingAssociate/ejUserId,project/projectAssociate/ejUserId,project/projectAssociate/userName,sale/associate/title
