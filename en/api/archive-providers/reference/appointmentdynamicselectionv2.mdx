...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=person/personCountryId,person/birthdate,person/personUdef/SuperOffice:11,person/consentSourceEmarketing,project/associateId
