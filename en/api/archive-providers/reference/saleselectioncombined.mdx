...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=activeErpLinks,document/associate/contactDepartment,person/updatedByWorkflow,saleStakeholder/contact/hasInfoText,who
