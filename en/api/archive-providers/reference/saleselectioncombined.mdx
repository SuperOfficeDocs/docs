...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=person/restrictionAddress/wgs84longitude,person/personUdef/SuperOffice:7,contact/activeErpLinks,contact/postAddress/state,contact/contactAssociate/simultaneousEjUser
