...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=appointment/recordType,document/documentUdef/SuperOffice:5,project/projectUdef/SuperOffice:4,saleStakeholder/person/personDirectPhone/formattedNumber,saleStakeholder/person/correspondingAssociate/personId
