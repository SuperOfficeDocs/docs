...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=person/personAddress/addressId,person/consentSourceStore,contact/contactAssociate/contactId,contact/contactAssociate/credentialDisplayValue,contact/contactUdef/SuperOffice:13
