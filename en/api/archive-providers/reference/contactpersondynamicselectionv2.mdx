...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionV2?$select=activeErpLinks,document/type,personTargetRelation/isStakeholder,sale/associate/contactCategory,workflowInstance/workflowInstanceWaitUntil
