...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionV2?$select=streetAddress/zip,restrictionAddress/line1,NumberOfNotCompletedSales,NumberOfNotCompletedSalesInPeriod,sale/associate/contactId
