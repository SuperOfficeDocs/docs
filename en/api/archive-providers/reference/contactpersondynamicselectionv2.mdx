...
description: Contact + Person selection archive with OR-able selection groups. Each group is represented with the SaleSelectionDynamicProviderSingleCriteriaGroup.
...
Contact + Person selection archive with OR-able selection groups. Each group is represented with the [SaleSelectionDynamicProviderSingleCriteriaGroup](./saledynamicselectionsinglecriteriagroup).
...
|sale/quote/version/alternative/quoteline/totalCost|decimal|Total cost| x |
...
|sale/quote/version/alternative/quoteline/productCategoryKey|listExternal|Product category: The category the product is defined in| x |
|sale/quote/version/alternative/quoteline/productFamilyKey|listExternal|Product family: The family the product is defined in| x |
|sale/quote/version/alternative/quoteline/productTypeKey|listExternal|Product type: The type of product| x |
...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionV2?$select=sourceRelation/forceCompany,targetRelation/deletedDate,sale/associate/personId,appointment/location,appointment/appointmentUdef/SuperOffice:7
