...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.TicketShadowSelectionStaticProvider` inside NetServer's SODatabase assembly.
