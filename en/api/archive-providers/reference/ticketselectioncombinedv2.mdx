...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=person/personExtra/x_person_integer,person/personAssociate/userName,contact/email/emailAddress,contact/NumberOfNotCompletedSales,sale/who
