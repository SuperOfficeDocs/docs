...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=createdBy/assocTooltip,person/mrMrs,person/personNumber,contact/contactSource,contact/contactAssociate/contactDepartment
