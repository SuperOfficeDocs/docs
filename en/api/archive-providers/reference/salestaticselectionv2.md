...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.SaleSelectionStaticProviderV2` inside NetServer's SODatabase assembly.
