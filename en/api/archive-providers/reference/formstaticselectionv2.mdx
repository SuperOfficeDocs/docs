...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.FormSelectionStaticProviderV2">SuperOffice.CRM.ArchiveLists.Archive.FormSelectionStaticProviderV2</see> inside NetServer's SODatabase assembly.
...
<see cref="T:SuperOffice.CRM.Entities.SelectionTypeStore" /> stays empty, as it does for mailings).
