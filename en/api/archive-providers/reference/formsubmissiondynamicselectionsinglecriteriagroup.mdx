...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=associate/contactCategory,person/associateType,person/personRegisteredDate,person/email/emailLastSent,person/personUrl/URLDescription
