...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=person/personDirectFax/description,person/personUdef/SuperOffice:3,person/personAssociate/contactId,person/correspondingAssociate/firstName,contact/contactAssociate/lastName
