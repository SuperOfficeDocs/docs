...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=person/personAssociateId,person/personAssociate/isActiveText,person/restrictionAddress/county
