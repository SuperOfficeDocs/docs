...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=associate/assocName,contact/contactSource,person/correspondingAssociate/ejStatus,person/personDirectPhone/formattedNumber,updatedDate
