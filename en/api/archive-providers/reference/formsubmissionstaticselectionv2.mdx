...
```http!
GET /api/v1/archive/FormSubmissionStaticSelectionV2?$select=formSubmissionId,associate/title,associate/portraitThumbnail,person/personExtra/x_person_boolean,contact/contactExtra/x_contact_shorttext
