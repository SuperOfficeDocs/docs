...
```http!
GET /api/v1/archive/FormSubmissionStaticSelectionV2?$select=personId,person/supportAssociate,person/restrictionAddress/wgs84latitude,person/personAssociate/contactName,person/correspondingAssociate/credentialType
