...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.AssignmentPersonNotificationSubProvider` inside NetServer's SODatabase assembly.
