...
```http!
GET /api/v1/archive/ContactSelection?$select=contactAssociate/firstName,sourceRelation/contactId,targetRelation/country,sale/associate/credentialDisplayValue,appointment/associate/lastName
