...
```http!
GET /api/v1/archive/ContactSelection?$select=activeErpLinks,document/documentUdef/SuperOffice:8,personSourceRelation/mrMrs,request/ownedBy/lastName,workflowInstance/workflowInstanceWaitUntil
