...
```http!
GET /api/v1/archive/ContactSelection?$select=updatedByFullName,contactAssociate/simultaneousEjUser,contactUdef/SuperOffice:11,targetRelation/deletedDate,appointment/invitedPersonId
