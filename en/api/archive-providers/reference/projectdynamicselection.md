...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.ProjectSelectionDynamicProvider` inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=hasInfoText,projectMember/contactAssociate/isLocation,appointment/appointmentUdef/SuperOffice:1
