...
```http!
GET /api/v1/archive/ExternalPersons?$select=associateType,personAppointment/registeredDate,personTargetRelation/hasCompany,request/createdAt,withdrawnStoreConsent
