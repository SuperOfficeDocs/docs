...
```http!
GET /api/v1/archive/ExternalPersons?$select=correspondingAssociate/mrMrs,correspondingAssociate/personEmail,request/readByCustomer,request/createdBy/personEmail,projectMembers/projectAssociate/assocName
