...
```http!
GET /api/v1/archive/ExternalPersons?$select=hasCompany,personUrl/URLAddress,personTargetRelation/hasInterests,personTargetRelation/kanaFirstName,request/saleId
