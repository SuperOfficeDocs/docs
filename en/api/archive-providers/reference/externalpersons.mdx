...
```http!
GET /api/v1/archive/ExternalPersons?$select=contactId,personNumber,personCountryId,personTargetRelation/personAssociateFullName,personTargetRelation/isProjectMember
