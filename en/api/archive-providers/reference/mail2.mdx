...
```http!
GET /api/v1/archive/Mail2?$select=accountAssociate/assocName,contact/contactPhone/description,person/correspondingAssociate/credentialType,person/personExtra/x_person_appointment_relation,updatedDate
