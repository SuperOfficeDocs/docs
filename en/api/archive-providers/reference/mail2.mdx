...
```http!
GET /api/v1/archive/Mail2?$select=person/personDirectPhone/formattedNumber,person/personAssociate/isLocation,contact/email/emailHasBounced,contact/restrictionAddress/line1,contact/restrictionAddress/county
