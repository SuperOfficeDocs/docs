...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionSingleCriteriaGroup?$select=activeErpLinks,document/time,projectMember/correspondingAssociate/simultaneousEjUser,projectMember/restrictionAddress/line2,updatedDate
