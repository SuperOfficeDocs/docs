...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionSingleCriteriaGroup?$select=projectAssociate/associateDbId,sale/type,appointment/appointmentUdef/SuperOffice:3,projectMember/email/emailAddress,projectMember/personExtra/x_person_time
