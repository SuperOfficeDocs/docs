...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionSingleCriteriaGroup?$select=projectUdef/SuperOffice:3,appointment/appointmentUdef/SuperOffice:7,appointment/associate/ejUserId,document/snum,projectMember/correspondingAssociate/mrMrs
