...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionSingleCriteriaGroup?$select=projectAssociate/personEmail,sale/associate/otherGroups,appointment/appointmentId,projectMember/restrictionAddress/line3,projectMember/restrictionAddress/zip
