...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=person/personNumber,person/personExtra/x_person_hidden_integer,contact/contactAssociate/locationAddress,associate/ejStatus,project/projectUdef/SuperOffice:7
