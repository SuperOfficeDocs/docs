...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=heading,person/personHasInterests,person/hasStoreConsent,associate/firstName,appointment/priority
