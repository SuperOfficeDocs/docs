...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=updatedDate,person/personAddress/formattedAddress,saleStakeholder/person/personDeletedDate,saleStakeholder/person/hasStoreConsent,saleStakeholder/contact/contactAssociate/isLocation
