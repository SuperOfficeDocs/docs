...
```http!
GET /api/v1/archive/FreetextAppointment?$select=contact/categoryGroup,person/email/emailId,person/restrictionAddress/formattedAddress,project/NumberOfSalesInPeriod,sale/associate/firstName
