...
```http!
GET /api/v1/archive/FreetextAppointment?$select=saleId,contact/email/emailAddress,contact/contactAssociate/assocTooltip,contact/NumberOfNotCompletedActivities,person/useAsMailingAddress
