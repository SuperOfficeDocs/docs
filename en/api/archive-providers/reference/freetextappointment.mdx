...
```http!
GET /api/v1/archive/FreetextAppointment?$select=searchwords,isFree,visibleFor,contact/contactUdef/SuperOffice:7,person/correspondingAssociate/associateDbId
