...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=person/birthYear,contact/contactExtra/x_contact_longtext,contact/saintActivityType,associate/lastName,appointment/updatedDate
