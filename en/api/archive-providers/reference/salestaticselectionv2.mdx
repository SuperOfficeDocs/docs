...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=soldReason,person/restrictionAddress/county,person/personExtra/x_person_timespan,contact/NumberOfNotCompletedActivities,contact/LastSale
