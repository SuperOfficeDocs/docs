...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=person/personAssociate/assocName,appointment/alarm,appointment/associate/isActive,document/associate/locationAddress,saleStakeholder/salesRoleId
