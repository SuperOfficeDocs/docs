...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionSingleCriteriaGroup?$select=activeErpLinks,document/type,personTargetRelation/isProjectMember,sale/associate/contactCategory,workflowInstance/workflowInstanceWaitUntil
