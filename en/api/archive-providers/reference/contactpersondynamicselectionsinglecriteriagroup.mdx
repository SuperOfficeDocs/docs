...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionSingleCriteriaGroup?$select=who,contactAssociate/userName,saintSaleStatus,targetRelation/personContactRelation,sale/daysInStage
