...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionSingleCriteriaGroup?$select=appointment/appointmentUdef/SuperOffice:3,document/associate/lastName,projectMembers/NumberOfNotCompletedSales,workflowInstance/updatedDate,chatSession/firstMessage
