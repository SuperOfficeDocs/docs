...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionSingleCriteriaGroup?$select=restrictionAddress/state,contactAssociate/assocTooltip,NumberOfNotCompletedSalesInPeriod,saintTicketStatus,targetRelation/companyCategoryRank
