...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=sale/who,appointment/alarm,projectMember/personInterestIds,projectMember/personExtra/y_rental/x_amount,projectMember/personAssociate/mrMrs
