...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=saintSaleStatus,sale/saleType,sale/associate/assocTooltip,appointment/registeredBy,projectMember/personNoMail
