...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=activeErpLinks,document/type,projectMember/correspondingAssociate/title,projectMember/restrictionAddress/line3,updatedDate
