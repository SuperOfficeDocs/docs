...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=updatedByFullName,sale/associate/personId,appointment/registeredBy,document/visibleFor,projectMember/personAssociate/ejDisplayName
