...
```http!
GET /api/v1/archive/FreetextTicket?$select=origin,person/hasInterests,person/personUdef/SuperOffice:10,contact/contactAssociate/assocName,project/projectAssociate/contactId
