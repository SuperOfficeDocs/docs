...
```http!
GET /api/v1/archive/QuoteLineStaticSelection?$select=alternative/discountPercent,alternative/version/quote/registeredDate,alternative/version/quote/sale/stageId,alternative/version/quote/sale/person/useAsMailingAddress,alternative/version/quote/sale/person/correspondingAssociate/userName
