...
```http!
GET /api/v1/archive/QuoteLineStaticSelection?$select=alternative/quoteAlternativeId,alternative/version/quote/sale/contact/contactAssociate/associateDbId,alternative/version/quote/sale/contact/SaintStatus2,alternative/version/quote/sale/associate/credentialType
