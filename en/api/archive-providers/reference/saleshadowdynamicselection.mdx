...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=saleNumber,person/personActiveErpLinks,person/personCategory,person/personInfo/textId,person/correspondingAssociate/lastName
