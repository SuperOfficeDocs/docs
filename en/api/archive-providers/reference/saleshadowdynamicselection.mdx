...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=person/personAssociate/personEmail,person/correspondingAssociate/middleName,contact/categoryGroup,contact/streetAddress/line3,appointment/excludeParticipants
