...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=person/personExtra/x_person_priority_relation,contact/contactAssociate/contactDepartment,contact/contactUdef/SuperOffice:6,appointment/icon,appointment/joinVideomeetUrl
