...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=activeErpLinks,document/associate/contactCategory,person/title,saleStakeholder/contact/email/emailLastBounce,who
