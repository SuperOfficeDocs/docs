...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=amount,associate/firstName,document/associate/isLocation,saleStakeholder/person/leadStatus,saleStakeholder/person/consentSourceEmarketing
