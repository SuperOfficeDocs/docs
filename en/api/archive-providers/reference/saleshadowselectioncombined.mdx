...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=person/email/emailId,person/personAssociate/mrMrs,associate/mrMrs,associate/associateDbId,associate/isLocation
