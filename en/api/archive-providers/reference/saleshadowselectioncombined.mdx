...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=salePublish/publishedBy,person/personExtra/x_person_contact_relation,person/correspondingAssociate/isActiveText,contact/contactAssociate/isActive,contact/contactExtra/x_contact_boolean
