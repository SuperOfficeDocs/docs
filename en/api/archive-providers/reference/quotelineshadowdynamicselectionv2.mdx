...
description: QuoteLine shadow selection archive with OR-able selection groups. Each group is represented with the QuoteLineShadowSelectionDynamicProviderSingleCriteriaGroup.
...
QuoteLine shadow selection archive with OR-able selection groups. Each group is represented with the [QuoteLineShadowSelectionDynamicProviderSingleCriteriaGroup](./quotelineshadowdynamicselectionsinglecriteriagroup).
...
```http!
GET /api/v1/archive/QuoteLineShadowDynamicSelectionV2?$select=alternative/version/quote/sale/person/personUdef/SuperOffice:3,alternative/version/quote/sale/person/personExtra/y_rental/x_start,alternative/version/quote/sale/person/withdrawnStoreConsent,alternative/version/quote/sale/project/projectUrl/URLDescription,alternative/version/quote/sale/project/NumberOfNotCompletedSalesInPeriod
