...
```http!
GET /api/v1/archive/QuoteLineShadowDynamicSelectionV2?$select=PriceUnitSubscriptionQuantityUnit,alternative/version/quote/sale/contact/contactExtra/x_contact_contact_relation,alternative/version/quote/sale/person/hasInfoText,alternative/version/quote/sale/project/endDate,vatInfo
