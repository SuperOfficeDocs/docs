...
```http!
GET /api/v1/archive/QuoteLineShadowDynamicSelectionV2?$select=url,alternative/version/quote/sale/saleNumber,alternative/version/quote/sale/person/personExtra/x_person_contact_relation,alternative/version/quote/sale/contact/contactUdef/SuperOffice:3,alternative/version/quote/sale/associate/ejStatus
