...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.QuoteLineShadowSelectionStaticProvider` inside NetServer's SODatabase assembly.
