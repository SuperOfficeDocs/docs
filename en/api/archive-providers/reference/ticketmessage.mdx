...
```http!
GET /api/v1/archive/TicketMessage?$select=messageId,ticket/createdBy/locationAddress,ticket/person/lastName,ticket/person/personExtra/x_person_shorttext_list,ticket/contact/contactFax/description
