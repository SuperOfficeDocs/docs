...
```http!
GET /api/v1/archive/TicketMessage?$select=author,ticket/contact/streetAddress/city,ticket/person/personAssociate/assocTooltip,ticket/project/projectId,timeSpent
