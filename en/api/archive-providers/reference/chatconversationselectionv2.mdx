...
```http!
GET /api/v1/archive/ChatConversationSelectionV2?$select=person/personUdef/SuperOffice:8,person/personExtra/x_person_timespan,contact/contactAssociate/ejDisplayName,contact/contactExtra/y_organization/x_name
