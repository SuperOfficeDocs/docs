...
```http!
GET /api/v1/archive/ChatConversationSelectionV2?$select=person/personExtra/x_person_priority_relation,contact/NumberOfTickets,person/restrictionAddress/line1
