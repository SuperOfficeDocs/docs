...
```http!
GET /api/v1/archive/ChatConversationSelectionV2?$select=person/personAssociate/role,person/correspondingAssociate/contactCategory,person/legalBaseEmarketing,person/consentSourceEmarketing
