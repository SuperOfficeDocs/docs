---
title: InternalUsers
description: Concrete provider for Internal Users - our own employees. See UsersProviderBase for
...
```http!
GET /api/v1/archive/InternalUsers?$select=getAllRows,contactId,usergroup
