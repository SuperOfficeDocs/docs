---
title: "InternalUsers"
description: "Concrete provider for Internal Users - our own employees. See `UsersProviderBase` for the actual functionality of the provider."
...
Concrete provider for Internal Users - our own employees. See `UsersProviderBase` for
...
```http!
GET /api/v1/archive/InternalUsers?$select=assocName,credentialDisplayValue,isLocation,superoffice_superlicense-no-selection,userplan
