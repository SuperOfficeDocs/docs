...
```http!
GET /api/v1/archive/ContactActivity?$select=person/whenUpdatedByWorkflow,person/personUdef/SuperOffice:4,contact/postAddress/city,contact/contactAssociate/simultaneousEjUser,contact/contactUdef/SuperOffice:7
