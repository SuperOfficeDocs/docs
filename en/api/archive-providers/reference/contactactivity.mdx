...
```http!
GET /api/v1/archive/ContactActivity?$select=updatedDate,person/personDirectFax/description,person/restrictionAddress/wgs84longitude,person/correspondingAssociate/ejDisplayName,contact/NumberOfTicketsInPeriod
