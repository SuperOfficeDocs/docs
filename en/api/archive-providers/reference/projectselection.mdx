...
```http!
GET /api/v1/archive/ProjectSelection?$select=activeErpLinks,document/type,projectMember/correspondingAssociate/title,projectMember/restrictionAddress/state,updatedDate
