...
```http!
GET /api/v1/archive/ProjectSelection?$select=appointment/appointment/titleHtml,appointment/appointment/internalNotesHtml,projectMember/personPrivate/description,projectMember/searchPhone/description,projectMember/personAddress/city
