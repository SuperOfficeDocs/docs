...
```http!
GET /api/v1/archive/ProjectSelection?$select=sale/salePublish/publishedBy,document/keywords,document/associate/fullName,document/associate/userName,projectMember/personUdef/SuperOffice:4
