...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=projectPublish/isPublished,projectAssociate/userName,sale/updatedBy,sale/associate/fullName,appointment/appointmentId
