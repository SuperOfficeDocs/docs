...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=sale/associate/usergroup,sale/associate/assocType,appointment/appointment/internalNotes,document/isReport
