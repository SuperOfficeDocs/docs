...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=projectAssociate/role,LastCompletedSale,sale/stage,document/associate/ejUserId,projectMember/personAssociate/usergroup
