...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=person/personAddress/county,person/restrictionAddress/wgs84longitude,person/personUdef/SuperOffice:2,person/personUdef/SuperOffice:5,appointmentUdef/SuperOffice:3
