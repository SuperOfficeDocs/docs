...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=person/personSource,person/restrictionAddress/line2,person/personExtra/x_person_date,person/correspondingAssociate/lastName,project/projectAssociate/mrMrs
