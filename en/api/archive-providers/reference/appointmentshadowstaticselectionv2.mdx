...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=time,contact/country,contact/streetAddress/city,person/correspondingAssociate/ejStatus,person/correspondingAssociate/personEmail
