...
```http!
GET /api/v1/archive/AssociateProjectDynamicSelectionV2?$select=activeErpLinks,project/textId,projectAssociate/firstName,projectAssociate/userName,updatedDate
