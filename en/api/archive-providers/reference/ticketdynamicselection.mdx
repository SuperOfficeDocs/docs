...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=person/personUdef/SuperOffice:3,person/personExtra/x_person_user_relation,person/personAssociate/isActive,person/subscription,contact/postAddress/county
