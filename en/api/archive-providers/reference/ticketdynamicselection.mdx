...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=person/personNoMail,person/birthYear,person/personUdef/SuperOffice:2,contact/contactExtra/x_contact_integer,sale/saleType
