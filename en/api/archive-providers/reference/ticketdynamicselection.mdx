...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=activated,createdBy/mrMrs,person/personAssociate/personEmail,project/projectPublish/publishedTo,title
