...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.ConfigurableArchiveQuoteLineProvider` inside NetServer's SODatabase assembly.
