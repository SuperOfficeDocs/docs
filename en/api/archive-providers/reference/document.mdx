---
title: "Document"
description: "Archive provider for Document type activities. This provider can be used on its own, or can form part of the `ActivityArchiveProvider`, which mixes Documents, appointments, tasks and documents."
...
`ActivityArchiveProvider`, which mixes Documents, appointments, tasks and documents.
...
```http!
GET /api/v1/archive/Document?$select=associate/assocName,contact/restrictionAddress/zip,person/personCategoryGroup,project/projectPublish/publishedTo,yourref
