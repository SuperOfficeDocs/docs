...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.AssignmentCompanyNotificationSubProvider">SuperOffice.CRM.ArchiveLists.AssignmentCompanyNotificationSubProvider</see> inside NetServer's SODatabase assembly.
