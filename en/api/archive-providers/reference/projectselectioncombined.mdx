...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=text,projectAssociate/portraitThumbnail,sale/reopenDate,document/mailMergeDraft,document/recordTypeText
