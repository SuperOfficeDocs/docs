...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=projectAssociate/userName,sale/amountInBaseCurrency,sale/associate/personEmail,appointment/joinVideomeetUrl,appointment/appointmentUdef/SuperOffice:4
