...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=projectAssociate/otherGroups,projectMember/birthMonth,projectMember/personUrl/URLDescription,projectMember/personExtra/x_person_user_relation,projectMember/streetAddress/zip
