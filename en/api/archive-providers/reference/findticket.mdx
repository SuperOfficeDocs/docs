...
```http!
GET /api/v1/archive/FindTicket?$select=person/personCategoryGroup,person/restrictionAddress/city,person/restrictionAddress/formattedMultiLineAddress,person/personAssociate/otherGroups,person/correspondingAssociate/isActiveText
