...
```http!
GET /api/v1/archive/FindTicket?$select=createdBy/contactId,person/hasInterests,person/personUdef/SuperOffice:1,contact/restrictionAddress/zip,sale/associate/usergroup
