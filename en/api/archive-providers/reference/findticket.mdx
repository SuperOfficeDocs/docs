...
```http!
GET /api/v1/archive/FindTicket?$select=timeToReply,person/personAssociate/personId,person/correspondingAssociate/contactName,contact/contactExtra/x_contact_float,sale/associate/userName
