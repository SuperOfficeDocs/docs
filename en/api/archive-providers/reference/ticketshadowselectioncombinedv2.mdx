...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=ticketPriority/name,person/personAssociate/ejUserId,person/personAssociate/isActive,contact/contactPhone/description,sale/associate/assocType
