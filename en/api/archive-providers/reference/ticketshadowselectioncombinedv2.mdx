...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=person/lastName,person/restrictionAddress/formattedMultiLineAddress,person/personExtra/x_person_float,person/withdrawnStoreConsent,contact/companyCategoryRank
