...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=activated,createdBy/personEmail,person/personAssociate/portraitThumbnail,project/projectUdef/SuperOffice:10,title
