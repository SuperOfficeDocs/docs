...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.AppointmentShadowSelectionDynamicProvider` inside NetServer's SODatabase assembly.
