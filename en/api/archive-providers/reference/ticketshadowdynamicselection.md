...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.TicketShadowSelectionDynamicProvider` inside NetServer's SODatabase assembly.
