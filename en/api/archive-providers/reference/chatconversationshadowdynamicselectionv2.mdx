...
```http!
GET /api/v1/archive/ChatConversationShadowDynamicSelectionV2?$select=person/whenUpdatedByWorkflow,contact/email/emailId,contact/NumberOfNotCompletedSalesInPeriod
