...
```http!
GET /api/v1/archive/ChatConversationShadowDynamicSelectionV2?$select=contact/restrictionAddress/formattedMultiLineAddress,contact/contactAssociate/contactId,person/personAddress/formattedAddress
