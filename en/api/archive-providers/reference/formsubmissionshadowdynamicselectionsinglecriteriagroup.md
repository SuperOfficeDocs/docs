...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.FormSubmissionShadowSelectionDynamicProviderSingleCriteriaGroup` inside NetServer's SODatabase assembly.
