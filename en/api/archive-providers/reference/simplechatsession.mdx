...
```http!
GET /api/v1/archive/SimpleChatSession?$select=associate/firstName,person/hasCompany,person/personAddress/formattedMultiLineAddress,person/correspondingAssociate/otherGroups,contact/contactPhone/description
