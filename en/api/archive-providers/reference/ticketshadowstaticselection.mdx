...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=person/personUdef/SuperOffice:3,person/personAssociate/middleName,contact/NumberOfActivitiesInPeriod,contact/saintTicketStatus,extra/x_ticket_shorttext_list
