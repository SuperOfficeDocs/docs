...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=person/personId,person/hasInfoText,person/personActiveErpLinks,person/personAddress/county,person/personExtra/x_person_contact_relation
