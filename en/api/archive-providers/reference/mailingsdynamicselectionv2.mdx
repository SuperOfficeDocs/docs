...
```http!
GET /api/v1/archive/MailingsDynamicSelectionV2?$select=recordTypeText,mailingAddr/contact/NumberOfNotCompletedTicketsInPeriod,mailingAddr/person/correspondingAssociate/lastName,project/number
