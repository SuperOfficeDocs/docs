...
description: Mailings selection archive with OR-able selection groups. Each group is represented with the MailingsSelectionDynamicProviderSingleCriteriaGroup.
...
Mailings selection archive with OR-able selection groups. Each group is represented with the [MailingsSelectionDynamicProviderSingleCriteriaGroup](./mailingsdynamicselectionsinglecriteriagroup).
...
```http!
GET /api/v1/archive/MailingsDynamicSelectionV2?$select=mailingAddr/mailingAddrId,mailingAddr/contact/updatedBy,mailingAddr/contact/contactAssociate/ejStatus,mailingAddr/person/supportAssociateFullName,mailingAddr/person/isProjectMember
