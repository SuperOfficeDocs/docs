...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.ProjectShadowSelectionProvider` inside NetServer's SODatabase assembly.
