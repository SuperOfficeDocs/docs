...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=sale/earning,sale/associate/assocType,document/associate/isActive,projectMember/phone/formattedNumber,projectMember/correspondingAssociate/isActive
