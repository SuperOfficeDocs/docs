...
Project selection archive with OR-able selection groups. Each group is represented with the [ProjectSelectionDynamicProviderSingleCriteriaGroup](./projectdynamicselectionsinglecriteriagroup).
...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=document/yourref,projectMember/personId,projectMember/restrictionAddress/city,projectMember/code
