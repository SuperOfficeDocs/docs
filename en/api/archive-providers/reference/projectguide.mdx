...
```http!
GET /api/v1/archive/ProjectGuide?$select=appointmentInstance/person/personAssociate/mrMrs,appointmentInstance/person/isMailingRecipient,appointmentInstance/sale/who,appointmentInstance/sale/associate/contactDepartment,appointmentInstance/sale/saleUdef/SuperOffice:4
