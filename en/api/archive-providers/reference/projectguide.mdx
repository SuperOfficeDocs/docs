...
```http!
GET /api/v1/archive/ProjectGuide?$select=appointmentInstance/contact/restrictionAddress/line3,appointmentInstance/contact/contactAssociate/contactFullName,appointmentInstance/contact/contactAssociate/assocName,appointmentInstance/contact/contactAssociate/ejUserId,appointmentInstance/contact/SaintStatus1
