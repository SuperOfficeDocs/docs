...
```http!
GET /api/v1/archive/ProjectGuide?$select=appointmentInstance/person/personUrl/URLAddress,appointmentInstance/person/personExtra/y_rental/x_end,appointmentInstance/person/personExtra/y_rental/y_equipment/x_name,appointmentInstance/person/personAssociate/usergroupId,appointmentInstance/person/personAssociate/isLocation
