...
```http!
GET /api/v1/archive/ProjectGuide?$select=appointmentInstance/alarm,appointmentInstance/person/personAssociateFullName,deleted,documentInstance/person/personExtra/x_person_boolean,text
