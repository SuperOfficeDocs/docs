...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=createdByWorkflow,contact/registeredByFullName,person/middleName,person/personUpdatedBy,person/supportLanguage
