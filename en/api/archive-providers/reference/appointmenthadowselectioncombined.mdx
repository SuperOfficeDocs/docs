...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=type,contact/contactAssociate/contactFullName,sale/hasQuote,sale/salePublish/publishedTo,sale/associate/ejUserId
