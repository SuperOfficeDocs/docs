...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=contact/email/emailBounceCount,contact/restrictionAddress/wgs84longitude,person/legalBaseStore,project/NumberOfSalesInPeriod
