...
```http!
GET /api/v1/archive/SimpleSelection?$select=associateId,registeredByFullName,selectionAssociate/credentialType,selectionAssociate/personEmail,visibleFor
