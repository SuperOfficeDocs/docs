...
```http!
GET /api/v1/archive/SaleSelection?$select=amountWeighted,person/personId,person/personExtra/x_person_appointment_relation,appointment/appointmentUdef/SuperOffice:3,appointment/associate/credentialType
