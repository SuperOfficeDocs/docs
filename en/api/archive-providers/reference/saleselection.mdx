...
```http!
GET /api/v1/archive/SaleSelection?$select=person/personUdef/SuperOffice:2,contact/LastDoByActivity,contact/SaintStatus2,appointment/appointmentId,appointment/rawType
