...
```http!
GET /api/v1/archive/SaleSelection?$select=person/retired,person/kanaLastName,person/personDirectPhone/description,person/personExtra/x_person_float,person/personAssociate/ejUserId
