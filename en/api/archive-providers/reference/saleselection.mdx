...
```http!
GET /api/v1/archive/SaleSelection?$select=activeErpLinks,document/associate/contactDepartment,person/updatedByWorkflow,saleStakeholder/contact/hasInfoText,who
