...
```http!
GET /api/v1/archive/FindContact?$select=postAddress/county,restrictionAddress/county,document/associate/contactFullName,document/associate/assocName,personEmail/emailBounceCount
