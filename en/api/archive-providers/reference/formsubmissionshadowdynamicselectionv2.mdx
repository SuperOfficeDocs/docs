...
description: FormSubmission shadow selection archive with OR-able selection groups. Each group is represented with the FormSubmissionShadowSelectionDynamicProviderSingleCriteriaGroup.
...
FormSubmission shadow selection archive with OR-able selection groups. Each group is represented with the [FormSubmissionShadowSelectionDynamicProviderSingleCriteriaGroup](./formsubmissionshadowdynamicselectionsinglecriteriagroup).
...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=date,associate/assocTooltip,person/supportAssociate,person/personMobilePhone/description,person/personPager/formattedNumber
