...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=person/email/emailHasBounced,person/restrictionAddress/line3,person/personAssociate/userName
