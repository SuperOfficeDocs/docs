...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=person/personAssociate/middleName,person/personAssociate/userName,person/consentSourceStore
