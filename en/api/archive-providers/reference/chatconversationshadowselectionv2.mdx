...
```http!
GET /api/v1/archive/ChatConversationShadowSelectionV2?$select=associate/contactId,associate/portraitThumbnail,person/restrictionAddress/state,person/personAssociate/associateDbId,person/correspondingAssociate/lastName
