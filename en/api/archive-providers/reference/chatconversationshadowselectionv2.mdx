...
```http!
GET /api/v1/archive/ChatConversationShadowSelectionV2?$select=agent,contact/contactPhone/description,person/correspondingAssociate/fullName,person/personExtra/x_person_datetime,whenStarted
