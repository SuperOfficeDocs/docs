...
```http!
GET /api/v1/archive/ChatConversationShadowSelectionV2?$select=contact/streetAddress/line1,contact/contactUdef/SuperOffice:10,person/restrictionAddress/line1
