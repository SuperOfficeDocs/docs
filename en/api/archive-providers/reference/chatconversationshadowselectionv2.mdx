...
```http!
GET /api/v1/archive/ChatConversationShadowSelectionV2?$select=person/personHasInterests,person/personAssociate/personId,contact/contactAssociate/contactId
