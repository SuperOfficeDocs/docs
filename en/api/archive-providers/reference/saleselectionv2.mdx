...
```http!
GET /api/v1/archive/SaleSelectionV2?$select=stakeholdersEnabled,person/birthMonth,person/whenUpdatedByWorkflow,person/personAddress/line2,person/personAssociate/firstName
