...
```http!
GET /api/v1/archive/SaleSelectionV2?$select=currencyId,stageId,person/email/emailProtocol,person/personExtra/x_person_priority_relation,contact/postAddress/line1
