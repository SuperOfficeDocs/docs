...
```http!
GET /api/v1/archive/SaleSelectionV2?$select=registeredByFullName,person/supportLanguage,person/personExtra/x_person_timespan,person/correspondingAssociate/lastName,person/consentSourceEmarketing
