...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.TicketShadowSelectionCombinedProvider` inside NetServer's SODatabase assembly.
