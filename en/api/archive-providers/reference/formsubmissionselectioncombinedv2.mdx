...
```http!
GET /api/v1/archive/FormSubmissionSelectionCombinedV2?$select=person/subscription,contact/contactAssociate/portraitThumbnail,contact/contactAssociate/locationAddress,contact/LastCompletedActivity
