...
```http!
GET /api/v1/archive/FormSubmissionSelectionCombinedV2?$select=person/createdByForm,person/searchPhone/description,person/personExtra/x_person_date,person/personExtra/y_rental/x_amount
