...
```http!
GET /api/v1/archive/FindContactWithoutPhoneAddressEmail?$select=categoryGroup,postAddress/addressId,streetAddress/city,saintActivityType,sale/updatedByFullName
