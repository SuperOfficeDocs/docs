...
```http!
GET /api/v1/archive/FindContactWithoutPhoneAddressEmail?$select=activeErpLinks,contactUdef/SuperOffice:12,personAddress/zip,sale/associate/role,withdrawnStoreConsent
