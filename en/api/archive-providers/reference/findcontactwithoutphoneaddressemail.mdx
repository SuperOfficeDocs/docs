...
```http!
GET /api/v1/archive/FindContactWithoutPhoneAddressEmail?$select=hasInterests,streetAddress/zip,contactAssociate/lastName,contactAssociate/usergroup,contactExtra/x_contact_datetime
