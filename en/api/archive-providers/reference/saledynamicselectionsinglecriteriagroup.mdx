...
```http!
GET /api/v1/archive/SaleDynamicSelectionSingleCriteriaGroup?$select=salePublish/publishedFrom,person/personRegisteredBy,person/personActiveErpLinks,person/personExtra/x_person_shorttext_list,contact/contactId
