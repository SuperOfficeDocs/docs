...
```http!
GET /api/v1/archive/SaleDynamicSelectionSingleCriteriaGroup?$select=activeErpLinks,document/associate/contactCategory,person/ticketPriority,saleStakeholder/contact/email/emailLastBounce,who
