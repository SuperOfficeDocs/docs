...
```http!
GET /api/v1/archive/SaleDynamicSelectionSingleCriteriaGroup?$select=person/personCountryId,person/personRegisteredByFullName,person/personInfo/infoText,person/correspondingAssociate/personId,associate/portraitThumbnail
