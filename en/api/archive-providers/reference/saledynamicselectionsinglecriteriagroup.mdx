...
```http!
GET /api/v1/archive/SaleDynamicSelectionSingleCriteriaGroup?$select=contact/contactAssociate/isActive,contact/contactInterestIds,contact/contactUdef/SuperOffice:8,saleUdef/SuperOffice:1,appointment/appointment/title
