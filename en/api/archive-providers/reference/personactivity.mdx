...
```http!
GET /api/v1/archive/PersonActivity?$select=associate/credentialDisplayValue,contact/restrictionAddress/formattedAddress,contact/contactAssociate/personEmail,project/text,sale/stage
