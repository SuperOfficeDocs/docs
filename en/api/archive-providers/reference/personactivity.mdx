...
```http!
GET /api/v1/archive/PersonActivity?$select=person/personAssociate/middleName,contact/updatedBy,mailingAddr/contact/postAddress/line2,mailingAddr/contact/contactUdef/SuperOffice:9,mailingAddr/contact/LastDoBySale
