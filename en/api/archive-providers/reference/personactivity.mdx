...
```http!
GET /api/v1/archive/PersonActivity?$select=person/personAssociate/personEmail,person/correspondingAssociate/fullName,person/correspondingAssociate/personId,contact/mainContact,contact/saintSaleStatus
