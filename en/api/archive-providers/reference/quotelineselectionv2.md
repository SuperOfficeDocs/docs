...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.QuoteLineSelectionProviderV2` inside NetServer's SODatabase assembly.
