...
```http!
GET /api/v1/archive/QuoteLineShadowSelection?$select=alternative/version/approvedText,alternative/version/quote/sale/recordType,alternative/version/quote/sale/person/birthdate,alternative/version/quote/sale/person/personAssociate/fullName,alternative/version/quote/sale/person/correspondingAssociate/assocName
