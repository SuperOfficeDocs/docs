...
```http!
GET /api/v1/archive/QuoteLineShadowSelection?$select=description,alternative/version/quote/sale/registeredDate,alternative/version/quote/sale/stakeholdersEnabled,alternative/version/quote/sale/daysInStage,alternative/version/quote/sale/person/title
