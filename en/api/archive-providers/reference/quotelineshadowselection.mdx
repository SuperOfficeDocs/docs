...
```http!
GET /api/v1/archive/QuoteLineShadowSelection?$select=alternative/version/description,alternative/version/quote/sale/person/personExtra/y_rental/y_equipment/x_name,alternative/version/quote/sale/contact/contactUdef/SuperOffice:2,alternative/version/quote/sale/project/projectUdef/SuperOffice:1,alternative/version/quote/connection/erpConnection/connector/updatedDate
