...
```http!
GET /api/v1/archive/AssociateProjectDynamicSelection?$select=activeErpLinks,project/textId,projectAssociate/firstName,projectAssociate/userName,updatedDate
