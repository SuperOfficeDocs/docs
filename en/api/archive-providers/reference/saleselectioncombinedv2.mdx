...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=person/personAssociate/simultaneousEjUser,contact/hasInterests,contact/postAddress/addressId,contact/contactExtra/x_contact_time,associate/usergroup
