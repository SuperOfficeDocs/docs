...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=nextDueDate,saleTypeCategory,person/leadstatusRank,person/personAddress/zip,person/restrictionAddress/formattedAddress
