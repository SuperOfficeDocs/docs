...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=saleUdef/SuperOffice:3,appointment/priority,project/projectAssociate/locationAddress,saleStakeholder/person/email/emailAddress,saleStakeholder/person/personUdef/SuperOffice:1
