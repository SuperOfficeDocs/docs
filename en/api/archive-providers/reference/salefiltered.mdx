...
```http!
GET /api/v1/archive/SaleFiltered?$select=nextDueDate,amountWeightedInBaseCurrency,person/personId,person/personRegisteredBy,person/restrictionAddress/formattedAddress
