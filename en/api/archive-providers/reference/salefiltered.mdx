...
```http!
GET /api/v1/archive/SaleFiltered?$select=person/personUrl/URLAddress,person/personAssociate/simultaneousEjUser,contact/contactNoMail,contact/email/emailLastSent,project/registeredDate
