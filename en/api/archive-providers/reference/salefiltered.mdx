...
```http!
GET /api/v1/archive/SaleFiltered?$select=person/personUpdatedBy,person/personRegisteredByFullName,person/personDeletedDate,person/personAssociate/credentialDisplayValue,person/hasEmarketingConsent
