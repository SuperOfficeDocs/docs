...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.RecycleContactsProvider` inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/RecycleContact?$select=LastCompletedTicket,saintAmountClass,streetAddress/addressId
