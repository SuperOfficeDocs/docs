...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=alarm,intention,contact/contactAssociate/usergroup,contact/contactUdef/SuperOffice:13,person/updatedByWorkflow
