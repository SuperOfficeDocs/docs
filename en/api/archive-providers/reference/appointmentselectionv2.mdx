...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=projectId,contact/url/URLAddress,contact/contactAssociate/lastName,contact/contactAssociate/middleName,person/personAssociate/mrMrs
