...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=completed,userGroup,endDate,contact/email/emailLastSent,person/personAddress/formattedMultiLineAddress
