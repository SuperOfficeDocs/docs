...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.TicketCustomMessageNotificationSubProvider` inside NetServer's SODatabase assembly.
