...
```http!
GET /api/v1/archive/ContactProjects?$select=activeErpLinks,projectAssociate/contactCategory,projectAssociate/portraitThumbnail,projectUdef/SuperOffice:3,updatedDate
