...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionV2?$select=projectUdef/SuperOffice:10,sale/salePublish/publishedTo,document/associate/middleName,projectMember/personDeletedDate,projectMember/email/emailAddress
