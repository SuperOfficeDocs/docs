...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionV2?$select=projectAssociate/otherGroups,sale/associate/isActiveText,appointment/registeredByFullName,projectMember/restrictionAddress/line1,projectMember/restrictionAddress/county
