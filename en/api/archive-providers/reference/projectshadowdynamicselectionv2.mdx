...
description: Project shadow selection archive with OR-able selection groups. Each group is represented with the ProjectShadowSelectionDynamicProviderSingleCriteriaGroup.
...
Project shadow selection archive with OR-able selection groups. Each group is represented with the [ProjectShadowSelectionDynamicProviderSingleCriteriaGroup](./projectshadowdynamicselectionsinglecriteriagroup).
...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionV2?$select=projectUdef/SuperOffice:1,appointment/appointmentUdef/SuperOffice:5,appointment/associate/assocTooltip,document/name,projectMember/correspondingAssociate/contactId
