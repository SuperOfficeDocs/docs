...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionV2?$select=activeErpLinks,document/type,projectMember/correspondingAssociate/title,projectMember/restrictionAddress/line3,updatedDate
