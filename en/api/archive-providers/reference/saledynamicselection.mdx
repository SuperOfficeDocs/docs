...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=stakeholdersEnabled,person/personHasInterests,person/personRegisteredByFullName,person/personAssociate/firstName,person/personAssociate/ejDisplayName
