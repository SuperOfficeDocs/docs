...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=person/updatedByWorkflow,contact/contactAssociate/contactId,associate/isActiveText,saleStakeholder/person/personRegisteredByFullName,saleStakeholder/person/personCategoryGroup
