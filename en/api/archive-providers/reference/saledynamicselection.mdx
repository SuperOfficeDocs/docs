...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=person/personPrivate/formattedNumber,person/personAddress/addressId,person/personUdef/SuperOffice:4,contact/postAddress/city,contact/contactExtra/x_contact_float
