...
```http!
GET /api/v1/archive/SaleGuide?$select=appointmentInstance/contact/postAddress/wgs84latitude,appointmentInstance/contact/restrictionAddress/formattedAddress,appointmentInstance/person/personCountry,appointmentInstance/person/personAssociate/ejDisplayName,appointmentInstance/person/correspondingAssociate/associateDbId
