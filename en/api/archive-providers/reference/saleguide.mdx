...
```http!
GET /api/v1/archive/SaleGuide?$select=appointmentInstance/contact/registeredDate,appointmentInstance/contact/email/emailDescription,appointmentInstance/person/personExtra/x_person_timespan,appointmentInstance/sale/soldReason,documentInstance/contact/restrictionAddress/wgs84longitude
