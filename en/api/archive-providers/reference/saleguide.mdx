...
```http!
GET /api/v1/archive/SaleGuide?$select=appointmentInstance/contact/contactExtra/x_contact_datetime,appointmentInstance/person/personAddress/county,appointmentInstance/person/legalBaseStore,appointmentInstance/person/consentSourceStore,appointmentInstance/sale/associate/portraitThumbnail
