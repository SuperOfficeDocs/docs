...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.QuoteLineSelectionCombinedProvider` inside NetServer's SODatabase assembly.
