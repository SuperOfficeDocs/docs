...
```http!
GET /api/v1/archive/ContactSelectionCombined?$select=selectionMemberId,saintTicketCategory,sourceRelation/associateId,sale/salePublish/publishedTo,sale/associate/contactDepartment
