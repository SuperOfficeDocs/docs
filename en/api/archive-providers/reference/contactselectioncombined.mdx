...
```http!
GET /api/v1/archive/ContactSelectionCombined?$select=email/emailLastSent,contactAssociate/fullName,contactExtra/x_contact_float,sale/hasGuide,appointment/associate/contactCategory
