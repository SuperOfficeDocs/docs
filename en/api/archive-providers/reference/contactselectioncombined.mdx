...
```http!
GET /api/v1/archive/ContactSelectionCombined?$select=activeErpLinks,document/name,personSourceRelation/personCategory,request/ownedBy/contactCategory,withdrawnStoreConsent
