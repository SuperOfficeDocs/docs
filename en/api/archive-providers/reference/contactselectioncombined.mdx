...
```http!
GET /api/v1/archive/ContactSelectionCombined?$select=personExtra/y_rental/x_end,personTargetRelation/birthMonth,personTargetRelation/personActiveErpLinks,request/priorityName,request/createdBy/usergroupId
