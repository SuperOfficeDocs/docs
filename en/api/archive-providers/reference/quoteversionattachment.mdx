...
```http!
GET /api/v1/archive/QuoteVersionAttachment?$select=associate/assocName,associate/middleName,documentPublish/publishedFrom,quoteVersionAttachmentId,yourref
