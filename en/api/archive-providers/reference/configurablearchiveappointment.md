...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.ConfigurableArchiveAppointmentProvider` inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/ConfigurableArchiveAppointment?$select=cautionWarning,createdByWorkflow,contact/streetAddress/formattedAddress,contact/contactAssociate/contactId,contact/contactExtra/x_contact_float
