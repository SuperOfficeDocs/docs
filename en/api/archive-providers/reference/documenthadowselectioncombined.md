...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=getNoRows,person/personActiveErpLinks,person/leadstatusRank,person/updatedByWorkflow,person/correspondingAssociate/contactName
