...
```http!
GET /api/v1/archive/TargetValueSub?$select=associate/simultaneousEjUser,contact/postAddress/line2,contact/contactAssociate/isLocation,contact/contactSupportPerson/personExtra/x_person_integer
