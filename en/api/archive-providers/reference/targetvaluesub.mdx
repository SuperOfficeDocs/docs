...
```http!
GET /api/v1/archive/TargetValueSub?$select=contact/email/emailBounceCount,contact/contactAssociate/personId,contact/contactSupportPerson/leadstatusRank,contact/contactSupportPerson/withdrawnEmarketingConsent,contact/contactUdef/SuperOffice:4
