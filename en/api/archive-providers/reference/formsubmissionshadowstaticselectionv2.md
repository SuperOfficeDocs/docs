...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.FormSubmissionShadowSelectionStaticProviderV2` inside NetServer's SODatabase assembly.
