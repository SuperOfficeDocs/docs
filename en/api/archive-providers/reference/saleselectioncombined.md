...
This provider name is implemented by the class `SuperOffice.CRM.ArchiveLists.Archive.SaleSelectionCombinedProvider` inside NetServer's SODatabase assembly.
