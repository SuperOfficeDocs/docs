...
[1]: ../../authentication/online/certificates/configure
[3]: ./partner-db-library
[4]: ./super-office-devnet-online-login
[5]: ./system-user-service-console
[6]: ./web-config
[9]: ./scenarios
[7]: ../../../developer-portal/getting-started/index#client-id
[8]: ../../../developer-portal/create-app/config/redirects
[2]: ../../../developer-portal/faq/run-website-on-iis-localhost
