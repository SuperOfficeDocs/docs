...
[1]: ../../authentication/online/auth-application/sign-system-user-token
[2]: ../../authentication/online/validate-security-tokens
[3]: ../../authentication/online/auth-application/index
[4]: ./system-user-service-console

[img1]: /media/loc/en/api/tutorials/systemusersigninprocess.png
