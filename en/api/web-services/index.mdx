...
[img1]: /media/loc/en/api/netserver-web-services.png
[img2]: /media/loc/en/api/sm-serviceinterfaces.png
[netserver-architecture]: /media/loc/en/api/netserver-architecture.png
[wsdl-all]: /media/loc/en/api/download-all-wsdls.png
[wsdl-single]: /media/loc/en/api/download-single-wsdls.png
[service-agent]: /media/loc/en/api/netserver-servce-agent.png
