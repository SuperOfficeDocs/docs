...
date: 03.28.2022
keywords: ['API', 'endpoints', 'proxy', 'NetServer', 'SOAP', 'REST', 'Agent', 'SuperOffice.CRM.Services', 'DTO', 'carrier']
...
import UsecForbiddenOnline from "../../../snippets/usec-forbidden-online.mdx";
...
[1]: /en/api/entities/index
[2]: /en/api/web-services/endpoints/soap/index
[3]: /en/api/overview/netserver
[4]: /en/onsite/web-config/webapi
[6]: https://www.nuget.org/packages/SuperOffice.NetServer.Services
[7]: /en/api/reference/restful/rest/index
[8]: /en/api/reference/restful/agent/index
[9]: /en/api/reference/webapi/index
[11]: https://www.nuget.org/packages/SuperOffice.WebApi
[12]: https://github.com/SuperOfficeDocs/superoffice-docs/blob/main/docs/en/api/reference/soap/index.md
[13]: /en/api/reference/restful/index
[14]: /en/api/web-services/endpoints/agents-webapi/index
[15]: /en/api/web-services/endpoints/rest-webapi/index
[16]: https://github.com/SuperOfficeDocs/superoffice-docs/blob/main/docs/en/api/reference/netserver/services/index.md
[17]: /downloads/api/Swagger-v1-REST.zip
[18]: /downloads/api/Swagger-v1-Agents.zip
[19]: /en/api/authentication/online/index

[img1]: /media/loc/en/api/web-services/netserver-web-services.png
[img2]: /media/loc/en/api/web-services/sm-serviceinterfaces.png
[netserver-architecture]: /media/loc/en/api/web-services/netserver-architecture.png
[wsdl-all]: /media/loc/en/api/web-services/download-all-wsdls.png
[wsdl-single]: /media/loc/en/api/web-services/download-single-wsdls.png
[service-agent]: /media/loc/en/api/web-services/netserver-servce-agent.png
