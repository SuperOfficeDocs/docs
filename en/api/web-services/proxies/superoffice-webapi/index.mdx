...
date: 11.24.2021
keywords: ['API', 'web services', 'proxy', 'WebApiOptions', 'RequestOptions', 'IAuthorization', 'async await']
content_type: howto
...
[1]: /en/api/web-services/proxies/superoffice-webapi/iauthorization
[2]: /en/api/web-services/proxies/built-in
