...
date: 12.03.2021
keywords: ['API', 'web services', 'WebAPI', 'SuperOffice.Service.dll', 'modes', 'DefaultMode']
content_type: howto
...
[4]: ../../reference/netserver/services/index

[img1]: /media/loc/en/api/web-services/image003-1.gif
[img2]: /media/loc/en/api/web-services/image004-2.gif
[img3]: /media/loc/en/api/web-services/servicedatapath-sm.png
