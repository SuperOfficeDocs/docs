---
title: NetServer web service proxies
uid: ws_proxies
description: Proxies
...
import WebapiClientIntro from "../../snippets/webapi-client-intro.md";
...
[1]: /en/api/web-services/proxies/built-in#locally
[2]: /en/api/web-services/proxies/built-in#remotely
[3]: /en/api/web-services/proxies/custom
[4]: /en/api/web-services/proxies/superoffice-webapi/iauthorization
[5]: /en/api/web-services/proxies/superoffice-webapi/index
[6]: https://www.nuget.org/packages/SuperOffice.NetServer.Services
[7]: /en/api/web-services/proxies/superoffice-webapi/systemuserclient
[8]: /en/api/authentication/online/auth-application/index
