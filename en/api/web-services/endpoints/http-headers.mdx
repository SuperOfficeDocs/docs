...
date: 12.02.2021
keywords: ['API', 'WebAPI', 'headers', 'Accept-Language', 'Content-Type', 'If-Modified-Since', 'If-Unmodified-Since', 'internationalization', 'SO-Language', 'SO-Culture', 'Accept', 'SO-TimeZone', 'includeTZOffset']
...
## Multiple languages {#accept-language}
...
## Modified or unmodified {#modified-unmodified}
...
### includeTZOffset {#includetzoffset}
