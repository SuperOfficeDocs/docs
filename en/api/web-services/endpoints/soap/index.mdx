...
keywords: ['web services', 'endpoints', 'Agents', 'Services88']
author: digitaldiina
date: 05.13.2026
so_version: 11
...
[5]: /downloads/api/wsdl.zip
[6]: /en/api/web-services/endpoints/rest-webapi/index
[7]: /en/api/web-services/proxies/index#soap-client-proxy
[8]: https://github.com/SuperOfficeDocs/superoffice-docs/blob/main/docs/en/api/reference/soap/index.md
[9]: https://www.nuget.org/packages/SuperOffice.NetServer.Services
[10]: https://github.com/SuperOfficeDocs/superoffice-docs/blob/main/docs/en/api/rows/index.md
[11]: /en/api/web-services/endpoints/rest-webapi/index
...
[wsdl-single]: /media/loc/en/api/web-services/download-all-wsdls.png
