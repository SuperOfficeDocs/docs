...
keywords: ['DeleteRow', 'DatabaseTable', 'TableRecord', 'extra table']
...
[1]: ../../../reference/restful/agent/databasetable_agent/delete-row
[2]: ../../../reference/restful/rest/tablerecord/delete-row
