...
date: 04.28.2024
so_version: 10
keywords: ['InsertRow', 'DatabaseTable', 'TableRecord', 'extra table']
content_type: howto
audience: api
...
[1]: ../../../reference/restful/agent/databasetable_agent/insert-row
[2]: ../../../reference/restful/rest/tablerecord/insert-row
