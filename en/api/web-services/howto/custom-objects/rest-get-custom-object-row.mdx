...
title: How to get (read) a row from a custom object
sidebarTitle: "Get a custom object row (REST)"
description: How to get (read) a row from a custom object via the REST APIs.
author: Eivind Fasting
date: 04.28.2024
so_version: 10
keywords: ['ReadRow', 'DatabaseTable', 'TableRecord', 'extra table']
content_type: howto
audience: api
...
[1]: ../../../reference/restful/agent/databasetable_agent/read-row
[2]: ../../../reference/restful/rest/tablerecord/read-row
