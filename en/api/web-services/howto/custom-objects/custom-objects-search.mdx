...
title: How to use custom objects to search for information
sidebarTitle: "Search using custom objects"
description: How to use custom objects to search for information
author: Eivind Fasting
date: 09.09.2024
so_version: 10
keywords: ['custom object', 'DatabaseTable', 'TableRecord', 'extra table']
content_type: howto
audience: api
...
[1]: ./rest-get-custom-object-row
[2]: ./rest-add-custom-object-row
[3]: ./rest-update-custom-object-row
[4]: ./rest-delete-custom-object-row
[5]: ../../../archive-providers/reference/dynamic
[6]: ../../../search/odata/dynamic-provider
[7]: ../../../search/odata/dynamic-provider#right-join-category-to-contact
[8]: ../../../archive-providers/reference/contact
[9]: ../../../../automation/crmscript/searchengine/index
