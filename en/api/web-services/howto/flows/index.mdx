---
uid: api-flows
title: Introduction to working with flows through the APIs
sidebarTitle: "Working with flows"
...
[1]: /en/marketing/flows/learn/index
[2]: /en/api/reference/restful/agent/workflow_agent/create-default-email-flow
[3]: /en/api/reference/restful/agent/workflow_agent/save-email-flow
[4]: /en/api/web-services/howto/flows/rest-create-default-email-flow
[5]: /en/api/web-services/howto/flows/rest-create-flow-trigger
[6]: /en/api/web-services/howto/flows/rest-create-flow-step
[7]: /en/api/web-services/howto/flows/rest-save-flow
