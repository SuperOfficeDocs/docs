...
keywords: ['PersonAgent', 'BLOBAgent', 'GetPersonImage']
author: digitaldiina
date: 07.06.2026
so_version: 12.1
content_type: howto
...
## Option 1: Agent methods {#agent-methods}
...
## Option 2: Batch and sized retrieval {#batch-and-sized-retrieval}
...
## Option 3: Archive provider {#archive-provider}
...
## Option 4: RESTful API {#restful-api}
