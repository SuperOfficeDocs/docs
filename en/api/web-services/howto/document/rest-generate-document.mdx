...
keywords: ['API', 'REST', 'api/v1/Document/', 'api/v1/Agents/Document/SaveDocumentEntity', 'SetDocumentStreamFromId', 'CreateNewPhysicalDocumentFromTemplate']
...
import NoteJavascripty from "../../../snippets/note-javascripty.mdx";
