...
[1]: /en/api/reference/webapi/SuperOffice.WebApi.Agents.BulkUpdateAgent
[2]: /en/api/bulk-operations/bulk-update/using-bulk-update
[3]: /en/api/bulk-operations/bulk-update/operations-and-values
[4]: /en/api/bulk-operations/bulk-update/entities-field-types
[5]: /en/api/bulk-operations/bulk-update/field-value-info
[6]: /en/api/bulk-operations/bulk-update/ns-core-examples

[img1]: /media/loc/en/api/bulk-operations/company-contacts-context-menu.png
[img2]: /media/loc/en/api/bulk-operations/bulk-update-dialog.png
