...
keywords: ['custom field', 'extra field']
author: Tony Yates
date: 05.11.2026
tier: core
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>
                <p>CustomerId,<br />TicketId,<br />UserId,<br />AttachmentId,<br />CategoryId,<br />PriorityId,<br />FaqEntryId,<br />SaleId,<br />ProjectId,<br />AppointmentId,<br />ContactCategoryId,<br />BusinessId,<br />ExtraTableId</p>
            </td>
