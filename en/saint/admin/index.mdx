...
keywords: ['activity monitor', 'status monitor']
...
userflow_index: true
related:
  - Set up a new status monitor: /en/saint/admin/set-up
  - Visualize statuses with images: /en/saint/admin/set-up#image
  - /en/saint/admin/counter-settings
  - Update, delete, and restore status monitors: /en/saint/admin/update
  - Regenerate status monitors and counters: /en/saint/admin/update#regen
language: en
---

import NoteReqSaint from "../../../snippets/license/note-req-saint.mdx";
...
## How SAINT stores counters and statuses {#database}
...
[5]: /en/saint/admin/counter-settings
[8]: /en/saint/admin/update#regen
[13]: /en/database/tables/countervalue
[14]: /en/database/tables/statusvalue
