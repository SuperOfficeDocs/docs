...
## Add criteria to a status {#criteria}
...
## Delete a status monitor {#delete}
...
## Restore a deleted status monitor {#restore}
...
## Regenerate statuses and counters \<i class="ph ph-arrow-circle-right" aria-hidden="true"\>\</i\> {#regen}
