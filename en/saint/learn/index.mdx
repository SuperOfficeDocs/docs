...
keywords: ['Sales Intelligence', 'activity monitor', 'status monitor']
...
boost: 1.5
related:
  - Set up activity monitors: /en/saint/admin/set-up
  - How SAINT stores counters and statuses: /en/saint/admin/index#database
  - Use status monitors in a dynamic selection: /en/search-options/selection/learn/create
language: en
---
...
### The View statuses dialog {#dialog}
...
[2]: /en/search-options/selection/learn/create
