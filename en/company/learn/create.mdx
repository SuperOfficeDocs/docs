...
When you enter a name in the **Company name** field, **Company Insight** shows matching companies from official business registries, such as Brreg (Norway), checked against your own country's registry by default.
...
<Note>
Company Insight requires [CRM Suite Growth][13] or above.
</Note>
