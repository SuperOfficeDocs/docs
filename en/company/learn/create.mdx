...
keywords: ['add interest', 'Interests tab', 'Company Insight']
...
related:
  - Add company as a favorite: /en/learn/basics/fav
  - Preferences dialog - default field values and list values: /en/learn/getting-started/preferences
language: en
---
...
When you enter a name in the **Company name** field, **Company Insight** shows matching companies from official business registries, such as Brreg (Norway), Virk (Denmark), Companies House (UK), and Zefix (Switzerland), checked against your own country's registry by default.

Select a match to preview its details, such as address, phone number, and website. Click **Save** to add the company with these details, or **Cancel** to keep entering the details manually.

This helps avoid manual copy-paste and reduces the risk of registering the wrong company or creating a duplicate.

<Note>
Company Insight requires CRM Suite Growth or above.
</Note>

![Selecting a company from Company Insight's suggested matches -screenshot][img3]

## Add interests {#interests-tab}
