...
userflow_index: true
related:
  - /en/email/admin/mailbox/create-mailbox
  - Delete mailboxes: /en/email/admin/mailbox/delete-mailbox
  - /en/email/admin/mailbox/create-email-filter
language: en
---
