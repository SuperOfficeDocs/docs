...
userflow_index: true
related:
  - Delete mailboxes: /en/email/admin/mailbox/delete-mailbox
  - /en/online/mail-services/curl/index
  - Create mailbox (onsite): https://help.superoffice.com/docs/11/en/email/admin/mailbox/create-mailbox.html
language: en
---
