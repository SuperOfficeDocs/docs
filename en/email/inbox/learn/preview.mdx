...
keywords: ['open email', 'preview', 'move email', 'mark as read', 'print', 'download', 'e-mail', 'SuperOffice Inbox']
author: digitaldiina
date: 18.09.2026
so_version: 12.2
content_type: howto
...
related:
  - /en/email/inbox/learn/manage-senders
  - Receive invitations: /en/email/inbox/learn/invitations
...
## Mark emails as read or unread {#mark-as-read}
...
## Download an email {#download}

Downloading an email saves a copy of the message, including any attachments, in a format you can open from Outlook or another email client.

1. Select a message in the inbox.
1. Click <i class="ph ph-dots-three-circle-vertical" aria-label="Task menu"></i> and select **Download**.

![Inbox shows Task menu with Download item -screenshot][img5]
