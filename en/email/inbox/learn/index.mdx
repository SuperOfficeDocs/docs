...
keywords: ['read email', 'send email', 'email client', 'email', 'e-mail']
author: digitaldiina
date: 09.24.2026
so_version: 12.5
...
boost: 1.5
related:
  - Overview of email clients: /en/email/learn/index
  - Set up your inbox and connect your email account: /en/email/inbox/learn/setup
  - Read and manage messages: /en/email/inbox/learn/preview
  - Send and reply to email: /en/email/inbox/learn/compose
  - Archive emails and attachments: /en/email/inbox/learn/archive
  - Create follow-ups from email: /en/email/inbox/learn/create-task
language: en
---
...
For a Microsoft 365 account, SuperOffice Inbox can connect using the modern Microsoft Graph interface instead of IMAP/SMTP. See [Set up SuperOffice Inbox][2] to choose a connection method.
...
[2]: /en/email/inbox/learn/setup
[3]: /en/email/inbox/learn/compose
