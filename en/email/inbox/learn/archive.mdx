...
keywords: ['Archive button', 'save email', 'save attachment', 'inbox', 'somail', 'document dialog', 'email attachment', 'incoming email', 'outgoing email']
...
## Archive an attachment {#attachment}
