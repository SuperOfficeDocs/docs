...
keywords: ['email setup', 'IMAP', 'email connection', 'app passwords']
...
* **Microsoft 365 users:** If your inbox connects fine but email won't send, ask your admin to enable **Authenticated SMTP** for your mailbox in the Microsoft 365 admin center. It's a setting Microsoft can disable by default.
