...
related:
  - Add a new dashboard: /en/dashboard/learn/create
  - Use dashboards to manage your sales pipeline: /en/dashboard/learn/show-sales-targets
language: en
---
...
### About selection-based tiles {#selection-chart}
...
## Rearrange or resize tiles {#move}
