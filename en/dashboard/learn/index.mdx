...
related:
  - Create a new dashboard or duplicate an existing one: /en/dashboard/learn/create
  - Edit dashboard settings: /en/dashboard/learn/update
  - Edit dashboard tiles: /en/dashboard/learn/working-with-tiles
  - Transfer a dashboard to an associate: /en/dashboard/learn/update#owner
language: en
---
...
### Configure quick filters (admin/owner) {#filter}
