...
## Add an email address to a new contact {#new-contact}
...
## Add an email address to an existing contact {#existing-contact}
...
[1]: ./archive-on-contact
[2]: ./archive-as-activity
