...
[img1]: /media/loc/en/integrations/mail-link/install-personal-settings-screenshot.png
[img2]: /media/loc/en/integrations/mail-link/install-local-settings-screenshot.png
[img3]: /media/loc/en/integrations/mail-link/install-outlook-ribbon-screenshot.png
[img4]: /media/loc/en/integrations/mail-link/install-advanced-settings-url-screenshot.png
[img5]: /media/loc/en/integrations/mail-link/install-test-connection-screenshot.png
[img6]: /media/loc/en/integrations/mail-link/install-browser-auth-screenshot.png
[img7]: /media/loc/en/integrations/mail-link/install-connection-succeeded-screenshot.png
