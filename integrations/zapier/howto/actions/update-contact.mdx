...
title: Update a SuperOffice CRM Contact action
sidebarTitle: "Update a SuperOffice CRM Contact"
...
platform: Zapier
related:
  - title: "Find Contact Action"
    href: "/integrations/zapier/howto/actions/search-contact"
...
1. Click on the **Action** step to set up app, event, and account:
    ...
    * In the **Action event** section, select **Update Contact**
...
[img4]: /media/loc/en/integrations/zapier/update-contact-action.png
[img5]: /media/loc/en/integrations/zapier/update-contact-window.png
[img6]: /media/loc/en/integrations/zapier/update-contact-output.png
