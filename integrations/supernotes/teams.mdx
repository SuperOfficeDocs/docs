...
Find answers to common questions about organizing workspace members into teams.
...
1. Choose a color for easy identification.
1. Click **Create**.
...
1. Click the three-dot menu next to a member.
1. Select **Make Team Lead**.
...
1. Click on the team to expand it.
1. Click **Add Member**.
1. Select a workspace member from the dropdown.
1. Choose their role (Member or Team Lead).
1. Click **Add**.
...
1. Enable **Share with Teams** toggle.
1. Save the prompt.
...
* [Summaries][3] - Meeting summaries and sharing
