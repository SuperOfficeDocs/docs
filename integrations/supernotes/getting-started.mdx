...
## How do I connect my calendar to SuperNotes? {#connect-calendar}
...
## How do I manually send SuperNotes to a meeting? {#send-manually}
...
## What are the meeting duration limits? {#meeting-duration-limits}
...
[3]: ./settings
[4]: ./workspaces
[5]: ./before-meeting#enable-for-selected-meeting
