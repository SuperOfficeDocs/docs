...
author: digitaldiina, Erik Lebiko
date: 01.12.2024
content_type: howto
...
## Step 1 - Create a SharePoint site in your Microsoft 365 SharePoint {#step-1}
...
## Step 2 - Create library for documents in SharePoint site {#step-2}
...
## Step 3 - Create library for templates in SharePoint site {#step-3}
...
[img3]: /media/loc/en/integrations/sharepoint-documents/recent.png
[img4]: /media/loc/en/integrations/sharepoint-documents/new-document-library.png
[img5]: /media/loc/en/integrations/sharepoint-documents/create-document-library-documents.png
[img6]: /media/loc/en/integrations/sharepoint-documents/create-document-library-templates.png
