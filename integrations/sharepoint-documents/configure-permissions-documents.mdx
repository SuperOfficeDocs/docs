...
related:
  - title: "How to set up SharePoint permissions for templates"
    href: "/integrations/sharepoint-documents/configure-permissions-templates"
...
[1]: /en/admin/user-management/add-associate
[2]: https://id.superoffice.com/identityprovider/register

[img1]: /media/loc/en/integrations/sharepoint-documents/so-sharepoint-home.png
[img2]: /media/loc/en/integrations/sharepoint-documents/advanced-permissions.png
[img3]: /media/loc/en/integrations/sharepoint-documents/share.png
[img4]: /media/loc/en/integrations/sharepoint-documents/review.png
