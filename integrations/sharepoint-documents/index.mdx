...
import ReqDataRights from "./includes/req-data-rights.md";
import ReqGeneral from "./includes/req-general.md";
import ReqUsage from "./includes/req-usage.md";
...
[2]: ./permissions-in-sharepoint
[3]: ./permissions-in-sharepoint#aad-service-account

[5]: ./set-up#step-1
[6]: ./set-up#step-2
[7]: ./set-up#step-3

[8]: ./configure-superoffice
[9]: ./configure-superoffice#apps
[10]: ./configure-superoffice#step-3

[11]: ./configure-permissions-documents
[12]: ./configure-permissions-templates#step-3a
[13]: ./configure-permissions-templates#step-3b
[14]: ./configure-permissions-templates#step-4
