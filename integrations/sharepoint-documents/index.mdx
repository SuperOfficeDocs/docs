...
import WarnSharingSettingsRequired from "./snippets/warn-sharing-settings-required.mdx";
...
### Visible for sharing settings

<WarnSharingSettingsRequired />
...
2. Set up Microsoft 365 SharePoint
    ...
    6. [Set up SharePoint document library permissions for *Documents*][11]
        ...
        <Warning>
        The SharePoint site must allow members, or users with Edit permissions, to share files and folders. If only site owners can share, *Visible for* restrictions can't be applied. See [Visible for sharing settings](#visible-for-sharing-settings) above for the full explanation.
        </Warning>
