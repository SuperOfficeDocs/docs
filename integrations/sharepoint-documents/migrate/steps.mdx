...
platform: web
related:
  - title: "About SharePoint Document migration"
    href: "/integrations/sharepoint-documents/migrate/index"
  - title: "Best practices"
    href: "/integrations/sharepoint-documents/migrate/best-practices"
  - title: "How to create a selection"
    href: "/en/search-options/selection/learn/create"
language: en
...
[4]: ./troubleshooting
[5]: ./best-practices
[6]: /en/search-options/selection/learn/create

[img2]: /media/loc/en/integrations/sharepoint-documents/migration-started.png
[img6]: /media/loc/en/integrations/sharepoint-documents/migrate-step-1.png
[img7]: /media/loc/en/integrations/sharepoint-documents/migrate-step-2.png
[img8]: /media/loc/en/integrations/sharepoint-documents/migrate-step-3.png
