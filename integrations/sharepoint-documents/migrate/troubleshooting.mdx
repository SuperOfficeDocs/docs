...
### To approve the app (system user) {#approve-app}
...
[img4]: /media/loc/en/integrations/sharepoint-documents/edit-legacy-document.png
[img9]: /media/loc/en/integrations/sharepoint-documents/authorize-app.png
