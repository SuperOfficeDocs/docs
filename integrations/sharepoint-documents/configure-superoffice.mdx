...
## Step 3 - Document properties {#step-3}
...
## Step 4 - Groups and access {#step-4}
...
* If you plan **NOT to use Visible for**, leave this cleared. Go to the next section.
* If you plan to **use Visible for** (or already do so), select this checkbox. Follow the next steps.

<Warning>
Before selecting this checkbox, verify your SharePoint site allows members, or users with Edit permissions, to share files and folders. If the site is set to **Only site owners can share files, folders, and the site**, SuperOffice cannot apply the *Visible for* restriction, and documents can become available to a broader audience than intended.

See [SharePoint sharing settings required for Visible for][3] for the required configuration.
</Warning>
...
### Apps for SuperOffice (system user) {#apps}
...
[1]: ./permissions-in-sharepoint
[2]: ./permissions-app
[3]: ./permissions-in-sharepoint#visible-for

[img2]: /media/loc/en/integrations/sharepoint-documents/template-location.png
[img3]: /media/loc/en/integrations/sharepoint-documents/compatibility-check.png
[img4]: /media/loc/en/integrations/sharepoint-documents/groups-and-access.png
[img5]: /media/loc/en/integrations/sharepoint-documents/transfer-document-properties.png
[img7]: /media/loc/en/integrations/sharepoint-documents/groups-and-access-ad.png
[img8]: /media/loc/en/integrations/sharepoint-documents/confirm.png
