...
author: digitaldiina, fbhub, schildea
date: 09.03.2026
...
* If you want to enable group access on SharePoint documents based on *Visible for* settings in SuperOffice.
  ...
  * The SharePoint site must allow members, or users with Edit permissions, to share files and folders. See [SharePoint sharing settings required for Visible for][4] for the required configuration.
