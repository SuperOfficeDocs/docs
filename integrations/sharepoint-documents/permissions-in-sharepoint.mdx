...
## SharePoint sharing settings required for Visible for {#visible-for}
...
If *Visible for* restrictions aren't applied even after this configuration, see the [troubleshooting guide][4].
...
[3]: #visible-for
[4]: /integrations/sharepoint-documents/troubleshooting#saving-a-document-with-visible-for-selected-fails-or-the-restriction-is-silently-not-applied
