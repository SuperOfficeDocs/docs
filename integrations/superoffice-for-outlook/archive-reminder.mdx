...
related:
  - /integrations/superoffice-for-outlook/settings
  - /integrations/superoffice-for-outlook/send-and-archive
  - Add CRM data to Outlook calendar events: /integrations/superoffice-for-outlook/add-crm-data-to-event
...
[1]: ./settings
[2]: ./settings#archive-reminder

[img1]: /media/loc/en/integrations/superoffice-for-outlook/outlook-email-archive-reminder-dialog.png
