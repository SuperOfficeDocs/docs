...
1. Op de volgende manieren kunt u naar het dialoogvenster **Nieuwe e-mail** gaan:
    ...
    * Vanaf het dialoogvenster Document
        ...
        <Note>
        U kunt op deze manier slechts één document tegelijk verzenden. Als u meerdere documenten tegelijk wilt verzenden, selecteert u de documenten op het sectietabblad **Activiteiten**.
        </Note>
