...
related:
  - /nl/diary/learn/change-completed-status
language: nl
---
...
<Tabs>
<Tab title="Met SuperOffice Web Tools">
...
<Tab title="Zonder SuperOffice Web Tools">
<Note>
...
### Beveiligingsvraag van de browser bij het openen van bestanden {#allow}
...
## Een document downloaden {#download}

Als u een document downloadt, wordt een kopie van het documentbestand op uw apparaat opgeslagen.

1. Klik op de knop **Taak** (<i class="ph ph-dots-three-circle-vertical" aria-hidden="true"></i>) in het **Document**-dialoogvenster.
2. Kies **Downloaden**.

![Download de e-mail of het document via de knop Taak -screenshot][img6]

<Tip>
U kunt een document ook rechtstreeks downloaden vanuit het [sectietabblad Activiteiten][4] door er met de rechtermuisknop op te klikken en **Downloaden** te kiezen.
</Tip>
