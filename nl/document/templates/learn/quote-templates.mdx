...
tier: starter
related:
  - Update offerte sjabloon: /nl/document/templates/admin/update-template
  - Handleiding: /nl/document/templates/admin/update-template
  - Samenvoegvelden referentie: /nl/document/templates/merge-fields/index
  - Sjabloonvariabele referentie: /nl/document/templates/variables/for-quote-line
  - System.Globalization.CultureInfo: https://docs.microsoft.com/en-us/dotnet/api/system.globalization.cultureinfo?view=net-5.0
  - Aspose (beheert documentgeneratie): http://www.aspose.com
language: nl
---
...
## Soorten offertesjablonen {#types}
...
### Structuur van samenvoegvelden {#structure}
...
## Gebruik van samenvoegvelden {#usage}
...
### Opmaak van numerieke en datumvelden {#culture}
