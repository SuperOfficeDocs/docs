...
userflow_index: true
related:
  - Replace existing template: /nl/document/templates/admin/update-template
language: nl
---
...
<Frame caption="Bekijk deze video of volg de onderstaande stappen om te leren hoe u een documentsjabloon kunt toevoegen">
  <iframe
    ...
    title="Bekijk deze video of volg de onderstaande stappen om te leren hoe u een documentsjabloon kunt toevoegen"
    frameborder="0"
