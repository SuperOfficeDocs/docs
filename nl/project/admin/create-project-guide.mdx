...
related:
  - /nl/project/admin/edit-project-guide
language: nl
---
...
## Statussen maken voor de projectgids {#create-stage}
...
## Een projecttype maken voor de projectgids {#create-type}
...
## Een projectgids maken {#create-guide}
...
## Een vervolgactiviteit toevoegen voor een status {#add-fo-status}
...
## Een document toevoegen voor een status {#add-doc-status}
