...
related:
  - Projecttypen toevoegen of bijwerken: /nl/project/admin/project-type
  - Een projectgids maken: /nl/project/admin/create-project-guide
  - Een projectgids bewerken: /nl/project/admin/edit-project-guide
  - Projectstatus wijzigen: /nl/project/learn/project-guides#change-status
language: nl
---
