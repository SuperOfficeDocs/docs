...
Wanneer u een naam invoert in het veld **Bedrijfsnaam**, toont **Company Insight** overeenkomende bedrijven uit officiële handelsregisters, zoals Brreg (Noorwegen), standaard gecontroleerd tegen het register van uw eigen land.
...
<Note>
Company Insight vereist [CRM Suite Growth][13] of hoger.
</Note>
