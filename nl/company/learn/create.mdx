...
keywords: ['nieuw bedrijf', 'bedrijf maken', 'bedrijfsinteresses', 'bedrijf', 'Company Insight']
...
related:
  - Record toevoegen als een favoriet: /nl/learn/basics/fav
  - Dialoogvenster Voorkeuren - standaardwaarden en lijstwaarden: /nl/learn/getting-started/preferences
language: nl
---
...
## Belangrijke velden en hun betekenis {#fields}
...
Wanneer u een naam invoert in het veld **Bedrijfsnaam**, toont **Company Insight** overeenkomende bedrijven uit officiële handelsregisters, zoals Brreg (Noorwegen), Virk (Denemarken), Companies House (Verenigd Koninkrijk) en Zefix (Zwitserland), standaard gecontroleerd tegen het register van uw eigen land.

Selecteer een overeenkomst om een voorbeeld van de gegevens te bekijken, zoals adres, telefoonnummer en website. Klik op **Opslaan** om het bedrijf met deze gegevens toe te voegen, of op **Annuleren** om de gegevens handmatig te blijven invoeren.

Dit helpt handmatig kopiëren en plakken te voorkomen en verkleint het risico om het verkeerde bedrijf te registreren of een duplicaat te maken.

<Note>
Company Insight vereist CRM Suite Growth of hoger.
</Note>

![Een bedrijf selecteren uit de voorgestelde overeenkomsten van Company Insight -screenshot][img3]
