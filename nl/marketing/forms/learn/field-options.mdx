...
* **Extra veld van het type selectievakje:** Een Booleaans extra veld (alleen ja/nee) dat kan worden ingesteld om aangevinkt of niet aangevinkt te beginnen wanneer het formulier wordt geladen. U vindt **Standaard aangevinkt** bij de veldinstellingen — dit staat standaard uit. Als het veld via een voorwaarde is gekoppeld aan [een gerelateerd veld][6], wordt de standaardstatus behandeld alsof de bezoeker deze zelf had ingesteld, zodat het gerelateerde veld bij het laden dienovereenkomstig wordt weergegeven of verborgen blijft.
...
* **Voorwaardelijke (gerelateerde) velden:** Keuzerondjes, selectievakjes, vervolgkeuzevelden en waarderingsvelden kunnen [een gerelateerd veld activeren][6] dat alleen wordt weergegeven wanneer een bepaalde optie of waarde is geselecteerd.
