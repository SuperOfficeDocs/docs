...
related:
  - title: "Stap verplaatsen, dupliceren of verwijderen"
    href: "/nl/marketing/flows/learn/update"
  - title: "Flowacties definieeren"
    href: "/nl/marketing/flows/learn/define-flow-actions"
  - title: "Flow opsplitsen"
    href: "/nl/marketing/flows/learn/split"
  - title: "Flow starten"
    href: "/nl/marketing/flows/learn/run-pause-end"
language: nl
---
...
## Veldinvulling voor de flow {#fields}
...
## Definieer triggers en filters {#trigger}
...
[1]: ./split
[3]: ./define-flow-actions
[4]: ./define-flow-actions#update
[5]: ./define-flow-actions#create
[10]: ./define-flow-actions#internal
[7]: ./index#success
[9]: ./step-settings
[8]: ../../learn/create-folder
[12]: ../../mailing/admin/add-domain
[13]: ../../../search-options/learn/search-criteria
[14]: ../../../search-options/selection/learn/index
