...
related:
  - AVG en privacy: /nl/security/privacy/learn/index
  - Privacyverklaring SuperOffice: https://www.superoffice.com/company/privacy/
language: nl
---
...
Wanneer u [uw doellijst maakt][1] voor uw volgende mailing, kunt u een selectie maken op basis van het abonnementstype dat u gaat gebruiken. Door dit te doen, voegt SuperOffice CRM alleen contactpersonen toe die "ja" hebben gezegd tegen dit type abonnement.

## Een abonnementstype kiezen
...
Nadat u uw mailingtype hebt toegevoegd, controleert SuperOffice CRM elke persoon die u als ontvanger toevoegt om te zien of ze u toestemming hebben gegeven om hen deze mailing te sturen.

In stap 4 van de mailingwizard, genaamd Ontvangers, kunt u precies zien wie u wel en wie u geen toestemming heeft gegeven. Wanneer de functie E-marketingprivacy is ingeschakeld, filtert SuperOffice CRM automatisch alle ontvangers uit die zich niet hebben aangemeld op basis van hun e-marketingtoestemming en actieve abonnementen.

<Tip>
U hebt wel een selectievakje om toestemming en abonnement te overschrijven, als de mailing erg belangrijk is om naar alle personen te verzenden.
</Tip>
...
![Selecteer de mailings die u wilt ontvangen op de pagina met abonnementsvoorkeuren. -screenshot][img4]

Uw klant heeft de controle over de mailings die ze ontvangen en u kunt ervoor zorgen dat u uw mailings alleen naar de mensen stuurt die geïnteresseerd zijn.
...
[1]: ./index
[3]: ../../../security/privacy/learn/send-privacy-confirmation-email
[5]: ../../tracked-links/learn/define-link-actions#interests
