...
## 1. UTM-gegevensoverdracht inschakelen {#enable}
...
## 2. Voeg het UTM-trackingscript toe aan je website {#script}
...
## 3. Maak campagnekoppelingen met UTM-parameters {#build-url}
...
## 4. Gebruik de koppeling in campagnes {#tag}
...
## 5. Publiceer het formulier correct {#publish}
...
## 6. Test en verifieer de installatie {#test}
...
## 7. Analyseer en visualiseer resultaten {#analyze}
