...
related:
  - Een nieuw dashboard toevoegen: /nl/dashboard/learn/create
  - Dashboards gebruiken om uw verkooppijplijn te beheren: /nl/search-options/selection/learn/howto/display-as-charts
language: nl
---

import ReqCore from "../../snippets/req-core.mdx";
...
### Over selectie-gebaseerde tegels {#selection-chart}
...
## Een tegel dupliceren of kopiëren {#copy}
...
## Tegels herschikken of formaat wijzigen {#move}
...
[8]: ../../admin/license/crm-suite
[3]: ./index#charts
[4]: ../../search-options/learn/search-criteria
