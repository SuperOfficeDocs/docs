...
related:
  - Een nieuw dashboard maken of een bestaand dupliceren: /nl/dashboard/learn/create
  - Een dashboard bewerken: /nl/dashboard/learn/update
  - Een dashboard overdragen aan een medewerker: /nl/dashboard/learn/update#owner
  - Tegels bewerken: /nl/dashboard/learn/working-with-tiles
language: nl
---
...
### Snelfilters configureren (admin/eigenaar) {#filter}
