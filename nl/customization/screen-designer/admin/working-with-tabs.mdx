...
import ScreenDesignerDanger from "../../../../snippets/udef-screen-designer-warning/nl-screen-designer-udef.mdx";
...
## Kop of scheidingslijn toevoegen {#label}
...
## Velden in kolommen groeperen {#columns}
