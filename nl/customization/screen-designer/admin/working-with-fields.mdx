...
userflow_index: true
related:
  - Wijzig het aantal kolommen op een tabblad: /nl/customization/screen-designer/admin/working-with-tabs#columns
  - Labels en scheidingslijnen toevoegen: /nl/customization/screen-designer/admin/working-with-tabs#label
  - Koppelingen en knoppen toevoegen: /nl/customization/screen-designer/admin/add-button
language: nl
---
