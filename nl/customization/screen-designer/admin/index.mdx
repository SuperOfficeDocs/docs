...
userflow_index: true
related:
  - /nl/customization/screen-designer/admin/add-layout
  - Opmaak bewerken (hoofdkaarten): /nl/customization/screen-designer/admin/edit-layout
  - /nl/customization/screen-designer/admin/working-with-fields
  - Werken met archieven (sectietabbladen): /nl/customization/screen-designer/admin/working-with-archives
language: nl
---
