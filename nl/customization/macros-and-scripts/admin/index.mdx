...
userflow_index: true
related:
  - Een script maken: /nl/customization/macros-and-scripts/admin/create-script
  - Een macro maken: /nl/customization/macros-and-scripts/admin/create-macro
  - Map maken: /nl/customization/macros-and-scripts/admin/create-script#folder
  - De CRMScript-taal leren: /en/automation/crmscript/overview/index
  - CRMScript API-referentie: /en/automation/crmscript/reference/index
language: nl
---
...
[2]: /nl/customization/macros-and-scripts/admin/trigger
[3]: /nl/customization/macros-and-scripts/admin/schedule-task
[4]: /en/automation/crmscript/debugging/built-in-debugger
[5]: /en/automation/crmscript/debugging/using-trace
[8]: /nl/customization/macros-and-scripts/admin/create-script
