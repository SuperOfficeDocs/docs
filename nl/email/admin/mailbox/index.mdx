...
userflow_index: true
related:
  - /nl/email/admin/mailbox/create-mailbox
  - Postbussen verwijderen: /nl/email/admin/mailbox/delete-mailbox
  - /nl/email/admin/mailbox/create-email-filter
language: nl
---
...
### Postvak IN voor e-mail {#email-in}
...
### Postvak UIT voor e-mail {#email-out}
...
### Geblokkeerde e-mail {#email-blocked}
