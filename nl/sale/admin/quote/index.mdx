...
userflow_index: true
related:
  - Een ERP-verbinding instellen: /nl/sale/admin/quote/set-up-quote-connector
  - Prijslijsten en producten toevoegen: /nl/sale/admin/quote/price-list-and-products
  - Productvenster aanpassen: /nl/sale/admin/quote/configure-product-fields
  - /nl/erp/admin/index
language: nl
---
...
## Tabbladen op het scherm Offerte/Synchroniseren {#tabs}
...
[1]: /nl/sale/admin/quote/set-up-quote-connector
[2]: /nl/sale/admin/quote/price-list-and-products
[3]: /nl/sale/admin/quote/configure-product-fields
[4]: /nl/erp/admin/index
[5]: /nl/sale/admin/sale-type
