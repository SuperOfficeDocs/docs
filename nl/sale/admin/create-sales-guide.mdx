...
## Fasen maken voor de verkoopgids {#create-stages}
...
## Een verkooptype maken voor de verkoopgids {#create-type}
...
## Een verkoopgids maken {#create-guide}
...
## Een vervolgactiviteit toevoegen voor een fase {#add-fo-stage}
...
## Een document toevoegen voor een fase {#add-doc-stage}
