...
related:
  ...
  - Offertedocument vervangen: /nl/sale/learn/quote/create-quote-document#replace
  - /nl/sale/learn/quote/place-order
  - Goedkeuringsregels configureren in Instellingen en onderhoud: /nl/sale/admin/sale-type#quote-fields
language: nl
---
...
## Moet de offerte worden goedgekeurd? {#approve}
...
## Een verzonden offerte bewerken {#versions}
