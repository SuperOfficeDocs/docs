...
related:
  - Verzoek splitsen: /nl/request/learn/split-request
  - /nl/request/learn/merge
  - /nl/learn/section-tabs/requests-tab
  - Bedrijfs- en persoonsrelaties: /nl/learn/basics/relations
  - Relatieregels (Instellingen en onderhoud): /nl/request/admin/relation-rules
language: nl
---
...
## Verzoekrelatie verwijderen {#delete}
