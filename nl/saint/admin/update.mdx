...
## Criteria toevoegen aan een status {#criteria}
...
## Een statusmonitoring verwijderen {#delete}
...
## Een verwijderde statusmonitoring herstellen {#restore}
...
## Statussen en tellers opnieuw genereren \<i class="ph ph-arrow-circle-right" aria-hidden="true"\>\</i\> {#regen}
