...
userflow_index: true
related:
  - title: "Statusbewaking bijwerken, verwijderen en herstellen"
    href: "/nl/saint/admin/update"
  - title: "Tellers en tellerinstellingen (periode)"
    href: "/nl/saint/admin/counter-settings"
  - title: "Statusbewaking en tellers regenereren"
    href: "/nl/saint/admin/update#regen"
language: nl
---
...
## Een afbeelding voor een status selecteren {#image}
