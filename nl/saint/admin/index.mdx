...
userflow_index: true
related:
  - Nieuwe statusmonitor instellen: /nl/saint/admin/set-up
  - Statussen visualiseren met afbeeldingen: /nl/saint/admin/set-up#image
  - /nl/saint/admin/counter-settings
  - Statusmonitors bijwerken, verwijderen en herstellen: /nl/saint/admin/update
  - Statusmonitors en tellers regenereren: /nl/saint/admin/update#regen
language: nl
---
...
## Hoe SAINT tellers en statussen opslaat {#database}
...
[5]: /nl/saint/admin/counter-settings
[8]: /nl/saint/admin/update#regen
