...
related:
  - Hoe een verzoek te maken: /nl/request/learn/create
  - Klantverzoeken beheren in SuperOffice CRM: /nl/request/learn/reply
  - Kolommen groeperen en totalen berekenen: /nl/learn/section-tabs/configure-columns#calculate
language: nl
---
...
## Overzicht van de kolommen in het tabblad Verzoeken {#columns}
