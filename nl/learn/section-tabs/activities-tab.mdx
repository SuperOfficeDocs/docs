...
keywords: ['sectietabblad Activiteiten', 'tabblad Activiteiten', 'sectietabblad', 'activiteiten', 'downloaden']
...
related:
  - Inleiding tot activiteiten: /nl/learn/basics/activity
  - Vervolgactiviteiten maken: /nl/diary/learn/create-follow-up
  - E-mails beantwoorden of doorsturen vanuit het sectietabblad Activiteiten: /nl/learn/section-tabs/send-email
  - Status Voltooid van een activiteit wijzigen: /nl/diary/learn/change-completed-status
  - Activiteiten in de activiteitenlijst verwijderen: /nl/learn/basics/activity
  - Activiteiten filteren: /nl/learn/section-tabs/filter
  - Kolommen groeperen en samenvatten: /nl/learn/section-tabs/configure-columns#calculate
language: nl
---
...
## Overzicht van de kolommen in het sectietabblad Activiteiten {#columns}
...
* **Een e-mail of document downloaden:** Zoek het item, klik met de rechtermuisknop en kies **Downloaden** om een kopie op uw apparaat op te slaan. Niet beschikbaar wanneer meerdere items zijn geselecteerd.

    ![Contextmenu op het sectietabblad Activiteiten voor Persoon -screenshot][img3]
