...
related:
  - Verwijderen van items in SuperOffice CRM: /nl/learn/basics/deleting-elements
  - Groepsinformatie in sectietabbladen: /nl/learn/section-tabs/index
  - Items toevoegen aan de lijst Algemeen - Relatie: /nl/admin/lists/specialized-lists#relation
  - Aangepaste velden in relaties: /nl/custom-objects/learn/extra-field#relation
language: nl
---
