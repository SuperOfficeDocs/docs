...
title: Meerdere records bijwerken (bulksgewijs bijwerken)
sidebarTitle: "Bulksgewijs bijwerken"
...
related:
  - Hoe vul ik voor veel personen in één keer de velden "Juridische basis", "Toestemmingsbron" en "Doel" in in SuperOffice CRM?: /en/security/privacy/learn/edit-legal-base#bulk
