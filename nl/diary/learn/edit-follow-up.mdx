...
title: Vervolgactiviteit bewerken
...
## De eindtijd van een vervolgactiviteit in de agenda wijzigen {#change-end}
...
## Herhalende vervolgactiviteit bewerken {#repeat}
...
## Vervolgactiviteit verwijderen via de agenda {#delete}
