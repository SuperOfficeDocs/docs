...
related:
  ...
  - /nl/search-options/selection/learn/create
  - Selecties bewerken en verwijderen: /nl/search-options/selection/learn/update
  - /nl/search-options/selection/learn/howto/index
  - Selecties weergeven als grafieken: /nl/search-options/selection/learn/howto/display-as-charts
language: nl
---
...
## Tabbladen in het scherm Selectie {#tabs}
...
### De lijst met leden filteren {#filter}
...
## Voorbeelden van hoe u selecties kunt gebruiken {#ex}
...
[3]: /nl/search-options/selection/learn/howto/display-as-charts
[6]: /nl/search-options/selection/learn/howto/export
[8]: /nl/search-options/selection/learn/howto/create-mailings
[4]: /nl/search-options/selection/learn/combine
[7]: /nl/search-options/selection/learn/add-remove-members-static
[9]: /nl/search-options/learn/search-criteria
[10]: /nl/learn/section-tabs/configure-columns#calculate
[12]: /nl/learn/section-tabs/filter
[16]: /nl/dashboard/learn/create
