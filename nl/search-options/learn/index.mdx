...
related:
  ...
  - /nl/learn/basics/history
  - Een zoekopdracht maken en opslaan als een selectie: /nl/search-options/selection/learn/create
  - Verbreed uw zoekopdracht met behulp van de OR-functie: /nl/search-options/learn/find-screen
language: nl
---
...
## De functie Snel zoeken gebruiken {#fastsearcher}
...
## Gebruik frequente zoekacties als uitgangspunt {#typical}
...
## Een zoekopdracht maken en opslaan als een selectie {#search-to-selection}
...
<Frame caption="Bekijk deze video of volg de onderstaande stappen om te zien hoe u een zoekopdracht kunt maken en deze kunt opslaan als een dynamische selectie">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/b1YsCcHwz-o"
    title="Bekijk deze video of volg de onderstaande stappen om te zien hoe u een zoekopdracht kunt maken en deze kunt opslaan als een dynamische selectie"
    frameborder="0"
...
[2]: /nl/search-options/learn/freetext-search
[3]: /nl/search-options/learn/in-navigator
[6]: /nl/search-options/learn/search-criteria
[8]: /nl/search-options/learn/in-dialogs
