...
related:
  - Taken uitvoeren: /nl/search-options/selection/learn/howto/index
  - Vrije-tekst zoekbewerking gebruiken: /nl/search-options/learn/freetext-search
  - Snel zoeken gebruiken: /nl/search-options/learn/in-navigator
  - De historielijst gebruiken: /nl/learn/basics/history
  - /nl/search-options/learn/search-criteria
language: nl
---

import ClearCriteria from "./snippets/clear-criteria.md";
import SelectField from "./snippets/select-field.md";
import RunSearch from "./snippets/run-search.md";
...
## Verbreed uw zoekopdracht met behulp van de OR-functie {#or}
...
<Frame caption="Bekijk deze video om te zien hoe u een zoekopdracht maakt met de OF-functie">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/Z-fSLJSdp2k"
    title="Bekijk deze video om te zien hoe u een zoekopdracht maakt met de OF-functie"
    frameborder="0"
...
## Werken met zoekresultaten {#results}
...
## Voorbeeld 1: zoeken naar winstgevende klanten {#ex1}
...
1. <SelectField />. Klik eerst op **Verkoop** (<i class="ph ph-currency-circle-dollar" aria-hidden="true"></i>) en vervolgens op **Bedrag**.
...
1. <SelectField />. Klik eerst op **Verkoop** en vervolgens op **Geregistreerde datum**.
...
## Voorbeeld 2: zoeken naar klanten in Denemarken waarvoor u verantwoordelijk bent {#ex2}
...
1. <SelectField />: Klik eerst op **Bedrijf** (<i class="ph ph-buildings" aria-hidden="true"></i>) en vervolgens op **Land**.
...
1. <SelectField />: Klik eerst op **Bedrijf** en vervolgens op **Onze contactpersoon**.
...
## Voorbeeld 3: zoeken naar verkochte verkopen {#ex3}
...
1. <SelectField />: Klik eerst op **Verkoop** en vervolgens op **Status**.
...
## Voorbeeld 4: zoeken naar projecten waaraan u het afgelopen jaar hebt deelgenomen {#ex4}
...
1. <ClearCriteria /> gevens te wissen.

1. Klik op **Toev.**

1. <SelectField />: Klik eerst op <i class="ph ph-user-circle" aria-hidden="true"></i> **Persoon** en vervolgens op **Achternaam**.
...
1. <SelectField />: Klik eerst op <i class="ph ph-clipboard-text" aria-hidden="true"></i> **Project** en vervolgens op **Datum vanaf**.
...
## Voorbeeld 5: zoeken naar ondernomen marketinginitiatieven {#ex5}
...
1. <SelectField />: Klik eerst op <i class="ph ph-calendar-blank" aria-hidden="true"></i> **Vervolgactiviteit** en vervolgens op **Intentie**.
...
1. <SelectField />. Klik eerst op **Vervolgactiviteit** en vervolgens op **Einddatum**.
...
[1]: ../../learn/getting-started/main-screen/buttons-in-menu-bar
[4]: ../../learn/getting-started/main-screen/side-panel
[2]: ./in-navigator
[3]: ./search-criteria
[7]: ../selection/learn/howto/index
[8]: ../selection/learn/create
[9]: ../selection/learn/add-remove-members-static
