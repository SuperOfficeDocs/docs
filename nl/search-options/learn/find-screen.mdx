...
1. <SelectField />
    ...
    . Klik eerst op **Verkoop** (<i class="ph ph-currency-circle-dollar" aria-hidden="true"></i>) en vervolgens op **Bedrag**.
...
1. <SelectField />
    ...
    . Klik eerst op **Verkoop** en vervolgens op **Geregistreerde datum**.
...
1. <SelectField />
    ...
    : Klik eerst op **Bedrijf** (<i class="ph ph-buildings" aria-hidden="true"></i>) en vervolgens op **Land**.
...
1. <SelectField />
    ...
    : Klik eerst op **Bedrijf** en vervolgens op **Onze contactpersoon**.
...
1. <SelectField />
    ...
    : Klik eerst op **Verkoop** en vervolgens op **Status**.
...
1. <SelectField />
    ...
    : Klik eerst op <i class="ph ph-user-circle" aria-hidden="true"></i> **Persoon** en vervolgens op **Achternaam**.
...
1. <SelectField />
    ...
    : Klik eerst op <i class="ph ph-clipboard-text" aria-hidden="true"></i> **Project** en vervolgens op **Datum vanaf**.
...
1. <SelectField />
    ...
    : Klik eerst op <i class="ph ph-calendar-blank" aria-hidden="true"></i> **Vervolgactiviteit** en vervolgens op **Intentie**.
...
1. <SelectField />
    ...
    . Klik eerst op **Vervolgactiviteit** en vervolgens op **Einddatum**.
