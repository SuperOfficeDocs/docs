...
sidebarTitle: "Gebruikersveld toevoegen"
...
userflow_index: true
related:
  - Velden plaatsen: /nl/custom-objects/admin/edit-udef-layout
  - Velden bewerken: /nl/custom-objects/admin/edit-udef
  - /nl/customization/screen-designer/admin/index
language: nl
---

import GotoFields from "./snippets/goto-fields.md";
import TableLegacyLanguageCodes from "../../globalization-and-localization/snippets/table-legacy-language-codes.md";
import UdefDanger from "../../../snippets/udef-screen-designer-warning/nl-udef-screen-designer.mdx";

<Frame caption="Bekijk deze video om erachter te komen hoe u uw eigen extra velden kunt maken in SuperOffice CRM (videolengte - 2:51)">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/SpeZVxpxeMM"
    title="Bekijk deze video om erachter te komen hoe u uw eigen extra velden kunt maken in SuperOffice CRM (videolengte - 2:51)"
    frameborder="0"
