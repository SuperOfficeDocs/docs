...
related:
  - /nl/custom-objects/admin/create-extra-table
  - /nl/custom-objects/admin/create-extra-field
  - Door gebruiker gedefinieerde velden: /nl/custom-objects/admin/add-udef
  - Gebruiker gedefinieerde chermen: /nl/ui/blogic/learn/index
  - Triggers toevoegen: /en/automation/trigger/create-trigger-script
language: nl
---
...
<Tab title="Nieuw (vanaf versie 10.3.4 pilot)">
