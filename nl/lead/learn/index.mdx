...
related:
  - /nl/lead/learn/work-with-leads
  - /nl/marketing/utm/learn/index
  - Leadbeheer instellen - in Instellingen en onderhoud: /nl/lead/admin/index
  - Bedrijfscategorieën configureren: /nl/lead/admin/add-company-category
  - Leadstatussen beheren: /nl/lead/admin/add-lead-status
...
## Categorieën voor potentiële klanten {#category}
