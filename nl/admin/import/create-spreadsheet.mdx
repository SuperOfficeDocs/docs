...
userflow_index: true
related:
  - Instellingen voor uw import kiezen: /nl/admin/import/settings
  - Contactpersonen importeren in SuperOffice CRM: /nl/admin/import/from-excel
  - Producten importeren in een prijslijst: /nl/admin/import/products-from-excel
language: nl
---
...
[Download de importsjabloon voor bedrijven en contactpersonen][1] [Excel spreadsheet, ZIP]
...
[Download de importsjabloon voor producten][2] [Excel spreadsheet, ZIP]
