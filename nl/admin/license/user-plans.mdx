...
sidebarTitle: "Gebruikersplannen"
...
userflow_index: true
related:
  - Hoe gebruikersplannen zijn opgebouwd: /en/admin/license/dev/user-plans
  - Nieuwe gebruiker toevoegen: /nl/admin/user-management/add-associate
  - Overzicht rollen: /nl/admin/user-management/role/index
language: nl
---
...
## Gebruikersplannen voor actieve gebruikers wijzigen {#change}
