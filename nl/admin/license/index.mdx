...
userflow_index: true
related:
  - title: "SuperOffice gebruikersplannen en abonnementen"
    href: "/nl/admin/license/user-plans"
  - title: "Licenties kopen activeren"
    href: "/nl/admin/license/activate"
  - title: "Licenties in eerdere versies van SuperOffice"
    href: "https://help.superoffice.com/Documentation/Help/EN/CRM/WebHelpAdmin/index.htm#t=chap03%2FCRM_and_licences.htm"
  - title: "Systeemgebeurtenissen"
    href: "https://help.superoffice.com/docs/11/nl/admin/onsite/add-system-event.html"
  - title: "Modulelicenties"
    href: "/en/admin/license/dev/module-licenses"
  - title: "Verborgen licenties"
    href: "/en/admin/license/dev/hidden-licenses"
  - title: "Technisch overzicht licenties"
    href: "/en/admin/license/dev/index"
language: nl
---
...
<Tabs>
<Tab title="Abonnementen op modulebasis">
