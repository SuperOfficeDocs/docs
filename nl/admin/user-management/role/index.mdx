...
userflow_index: true
related:
  - /nl/admin/user-management/role/create-role
  - Een rol bewerken: /nl/admin/user-management/role/update-role
  - /nl/admin/user-management/role/set-data-rights-for-role
language: nl
---
...
Via op rollen gebaseerde beveiliging in SuperOffice CRM kunt u rollen aanpassen voor verschillende niveaus binnen het bedrijf. De rollen bepalen de toegangsrechten die de verschillende gebruikers hebben in SuperOffice CRM.
...
[3]: /nl/admin/user-management/role/set-data-rights-for-role
[6]: /nl/admin/user-management/role/functional-rights
