...
title: Gegevensrechten voor een rol instellen
...
userflow_index: true
related:
  - Gegevensrechten: /nl/admin/user-management/role/functional-rights
  - Onsite-gegevensrechten: https://help.superoffice.com/docs/11/nl/admin/user-management/role/set-data-rights-for-role.html
language: nl
---
