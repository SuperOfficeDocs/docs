...
redirect_from: /nl/ai/configuration-ai/getting-started
userflow_index: true
related:
  - Hoe u een selectie maakt: /nl/search-options/selection/learn/create
  - Verzoekencategorisering: /nl/ai/learn/categorization
