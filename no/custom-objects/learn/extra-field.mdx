...
related:
  - Vis ekstrafelt på detaljfanen: /no/custom-objects/admin/show-extra-field-on-request-details
  - Opprett ekstrafelt: /no/custom-objects/admin/create-extra-field
language: no
---
...
### Relasjoner (fremmednøkler, FK) {#relation}
