...
related:
  - /no/diary/learn/change-completed-status
  - Stoppe repeterende oppfølginger: /no/diary/learn/recurrence/stop
  - Legg til kobling til dokument, salg, prosjekt eller nettsted: /no/learn/basics/links
language: no
---
...
## Endre sluttidspunktet for en oppfølging i dagboken {#change-end}
...
## Redigere repeterende oppfølging {#repeat}
...
## Slette oppfølging via dagboken {#delete}
