...
related:
  - Opprett en oppfølging: /no/diary/learn/create-follow-up
  - Lær mer om aktiviteter: /no/learn/basics/activity
language: no
---
...
| <i class="ph ph-chair" aria-label="Stol"></i> | Ressurs | Møterom, lokaler eller annet nødvendig utstyr. |
| <i class="ph ph-map-pin" aria-label="Pin"></i> | Sted | Lokasjon eller adresse der møtet finner sted. |
