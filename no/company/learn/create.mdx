...
keywords: ['opprett firma', 'legg til interesse', 'Interesser-fanen', 'firma', 'Company Insight']
...
## Forklaring av nøkkelfelter {#fields}
...
Når du skriver inn et navn i feltet **Firmanavn**, viser **Company Insight** samsvarende firmaer fra offisielle foretaksregistre, som Brreg (Norge), Virk (Danmark), Companies House (Storbritannia) og Zefix (Sveits), som standard sjekket mot registeret for ditt eget land.

Velg et treff for å forhåndsvise detaljene, som adresse, telefonnummer og webside. Klikk **Lagre** for å legge til firmaet med disse detaljene, eller **Avbryt** for å fortsette å skrive inn detaljene manuelt.

Dette hjelper deg med å unngå manuell klipp-og-lim, og reduserer risikoen for å registrere feil firma eller opprette et duplikat.

<Note>
Company Insight krever CRM Suite Growth eller høyere.
</Note>

![Velge et firma fra Company Insights foreslåtte treff -screenshot][img3]

## Legg til interesser {#interests-tab}
...
[3]: ../../learn/getting-started/preferences
[4]: ../../learn/basics/fav
