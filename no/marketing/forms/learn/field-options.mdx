...
* **Ekstrafelt av typen avmerkingsboks:** Et boolsk ekstrafelt (kun ja/nei) som kan settes til å starte merket eller umerket når skjemaet lastes inn. Finn **Merket av som standard** i feltets innstillinger — det er umerket som standard. Hvis feltet har [et relatert felt][6] knyttet via en betingelse, behandles standardmerkingen som om den besøkende selv hadde angitt den, slik at det relaterte feltet vises eller forblir skjult ved innlasting.
...
* **Betingede (relaterte) felt:** Alternativknapper, avmerkingsbokser, nedtrekksmenyer og vurderingsfelt kan [utløse et relatert felt][6] som bare vises når et bestemt alternativ eller en bestemt verdi er valgt.
