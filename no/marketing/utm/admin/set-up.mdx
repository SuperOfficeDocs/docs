...
## 1. Aktiver overføring av UTM-data {#enable}
...
## 2. Legg til UTM-sporingsskriptet på nettstedet ditt {#script}
...
## 3. Opprett kampanjekoblinger med UTM-parametere {#build-url}
...
## 4. Bruk koblingen i kampanjer {#tag}
...
## 5. Publiser skjemaet riktig {#publish}
...
## 6. Test og verifiser oppsettet {#test}
...
## 7. Analyser og visualiser resultater {#analyze}
