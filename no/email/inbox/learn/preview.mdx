...
keywords: ['åpne e-post', 'vise e-post', 'forhåndsvisning', 'flytte e-post', 'merk som lest', 'skriv ut', 'laste ned', 'e-post', 'e-postklient', 'SuperOffice-innboks']
...
related:
  ...
  - Motta invitasjoner: /no/email/inbox/learn/invitations
...
## Merke e-post som lest eller ulest {#mark-as-read}
...
## Laste ned en e-post {#download}

Når du laster ned en e-post, lagres en kopi av meldingen, inkludert eventuelle vedlegg, i et format du kan åpne fra Outlook eller en annen e-postklient.

1. Merk en melding i innboksen.
1. Klikk på <i class="ph ph-dots-three-circle-vertical" aria-label="Task menu"></i> og velg **Last ned**.

![Innboksen viser oppgavemenyen med elementet Last ned -screenshot][img5]
