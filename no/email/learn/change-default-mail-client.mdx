...
<Note>
Denne innstillingen gjelder ikke lenger når ny e-posttilkobling er tilgjengelig på systemet ditt. Fra da av styres det av innstillingen under **Personlige innstillinger** > **Preferanser** > **E-post** om nye e-poster og e-postadresser du klikker på, åpnes i ditt lokale e-postprogram.
</Note>
