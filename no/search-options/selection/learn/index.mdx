...
related:
  - Legg til post som favoritt: /no/learn/basics/fav
  - /no/search-options/selection/learn/create
  - Rediger eller slett utvalg: /no/search-options/selection/learn/update
  - /no/search-options/selection/learn/howto/index
  - Vis utvalg som diagrammer: /no/search-options/selection/learn/howto/display-as-charts
language: no
---
...
## Faner i Utvalg-skjermbildet {#tabs}
...
### Filtrere listen over medlemmer {#filter}
...
## Eksempler på hvordan du kan bruke utvalg {#ex}
...
[3]: /no/search-options/selection/learn/howto/display-as-charts
[6]: /no/search-options/selection/learn/howto/export
[8]: /no/search-options/selection/learn/howto/create-mailings
[4]: /no/search-options/selection/learn/combine
[7]: /no/search-options/selection/learn/add-remove-members-static
[9]: /no/search-options/learn/search-criteria
[10]: /no/learn/section-tabs/configure-columns#calculate
[12]: /no/learn/section-tabs/filter
[16]: /no/dashboard/learn/create
