...
5. <SelectField />
    ...
    Klikk først på **Salg** (<i class="ph ph-currency-circle-dollar" aria-hidden="true"></i>), og deretter på **Beløp**.
...
10. <SelectField />
    ...
    . Klikk først på **Salg**, og deretter **Registreringsdato**.
...
5. <SelectField />
    ...
    Klikk først på <i class="ph ph-buildings" aria-hidden="true"></i> **Firma**, og deretter på **Land**.
...
10. <SelectField />
    ...
    Klikk først på **Firma**, og deretter **Vår kontaktperson**.
...
5. <SelectField />
    ...
    Klikk først på **Salg**, og deretter på **Status**.
...
5. <SelectField />
    ...
    Klikk først på <i class="ph ph-user-circle" aria-hidden="true"></i> **Person**, og deretter på **Etternavn**.
...
10. <SelectField />
    ...
    Klikk først på <i class="ph ph-clipboard-text" aria-hidden="true"></i> **Prosjekt**, og deretter på **Fra-dato**.
...
5. <SelectField />
    ...
    Klikk først på <i class="ph ph-calendar-blank" aria-hidden="true"></i> **Oppfølging**, og deretter på **Hensikt**.
...
10. <SelectField />
    ...
    Klikk først på **Oppfølging**, og deretter på **Sluttdato**.
...
16. <SelectField />
    ...
    Klikk først på **Oppfølgingen**, og deretter på **Utført**.
