...
## Utvide søket ved hjelp av ELLER-funksjonen {#or}
...
<Frame caption="Se denne videoen for å lære hvordan du oppretter et søk ved hjelp av ELLER-funksjonen">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/Z-fSLJSdp2k"
    title="Se denne videoen for å lære hvordan du oppretter et søk ved hjelp av ELLER-funksjonen"
    frameborder="0"
...
## Jobbe med søkeresultater {#results}
...
## Eksempel 1: søk etter lønnsomme kunder {#ex1}
...
5. <SelectField /> Klikk først på **Salg** (<i class="ph ph-currency-circle-dollar" aria-hidden="true"></i>), og deretter på **Beløp**.
...
10. <SelectField />. Klikk først på **Salg**, og deretter **Registreringsdato**.
...
## Eksempel 2: søk etter kunder i Danmark som du er ansvarlig for {#ex2}
...
5. <SelectField /> Klikk først på <i class="ph ph-buildings" aria-hidden="true"></i> **Firma**, og deretter på **Land**.
...
10. <SelectField /> Klikk først på **Firma**, og deretter **Vår kontaktperson**.
...
## Eksempel 3: søk etter solgte (utførte) salg {#ex3}
...
5. <SelectField /> Klikk først på **Salg**, og deretter på **Status**.
...
## Eksempel 4: søk etter prosjekter du har deltatt i under det siste året {#ex4}
...
5. <SelectField /> Klikk først på <i class="ph ph-user-circle" aria-hidden="true"></i> **Person**, og deretter på **Etternavn**.
...
10. <SelectField /> Klikk først på <i class="ph ph-clipboard-text" aria-hidden="true"></i> **Prosjekt**, og deretter på **Fra-dato**.
...
## Eksempel 5: søk etter gjennomførte markedsføringsinitiativer {#ex5}
...
5. <SelectField /> Klikk først på <i class="ph ph-calendar-blank" aria-hidden="true"></i> **Oppfølging**, og deretter på **Hensikt**.
...
10. <SelectField /> Klikk først på **Oppfølging**, og deretter på **Sluttdato**.
...
16. <SelectField /> Klikk først på **Oppfølgingen**, og deretter på **Utført**.
