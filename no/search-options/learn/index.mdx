...
## Bruk vanlige søk som utgangspunkt {#typical}
...
## Opprett et søk og lagre det som et utvalg {#search-to-selection}
...
<Frame caption="Se denne videoen, eller følg trinnene nedenfor for å lære hvordan du kan opprette et søk og lagre det som et dynamisk utvalg">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/b1YsCcHwz-o"
    title="Se denne videoen, eller følg trinnene nedenfor for å lære hvordan du kan opprette et søk og lagre det som et dynamisk utvalg"
    frameborder="0"
...
[2]: /no/search-options/learn/freetext-search
[3]: /no/search-options/learn/in-navigator
[4]: /no/learn/basics/fav
[5]: /no/learn/basics/history
[6]: /no/search-options/learn/search-criteria
[7]: /no/search-options/selection/learn/create
[8]: /no/search-options/learn/in-dialogs
