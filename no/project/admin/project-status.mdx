...
related:
  - Legge til eller oppdatere prosjekttyper: /no/project/admin/project-type
  - Opprette en prosjektguide: /no/project/admin/create-project-guide
  - Redigere en prosjektguide: /no/project/admin/edit-project-guide
  - Flytte prosjekt til neste status: /no/project/learn/project-guides#change-status
language: no
---
