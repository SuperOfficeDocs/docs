...
related:
  - Redigere eller deaktivere en prosjektguide: /no/project/admin/edit-project-guide
language: no
---
...
## Opprett statuser for prosjektguiden {#create-stage}
...
## Opprett en prosjekttype for prosjektguiden {#create-type}
...
## Opprett en prosjektguide {#create-guide}
...
## Legg til en oppfølging for en status {#add-fo-status}
...
## Legg til et dokument for en status {#add-doc-status}
