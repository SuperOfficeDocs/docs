...
related:
  - Legge til et nytt dashbord: /no/dashboard/learn/create
  - Bruke dashbord til å administrere salgspipelinen din: /no/dashboard/learn/show-sales-targets
language: no
---
...
### Om figurer basert på utvalg {#selection-chart}
...
## Duplisere eller kopiere en figur {#copy}
...
## Flytte eller endre størrelse på figurer {#move}
