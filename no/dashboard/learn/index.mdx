...
related:
  - Opprette et nytt dashbord eller duplisere et eksisterende: /no/dashboard/learn/create
  - Redigere et dashbord: /no/dashboard/learn/update
  - Overføre et dashbord til en kollega: /no/dashboard/learn/update#owner
...
### Konfigurer hurtigfiltre (admin/eier) {#filter}
