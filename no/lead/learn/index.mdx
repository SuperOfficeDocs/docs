...
related:
  - /no/lead/learn/work-with-leads
  - /no/marketing/utm/learn/index
  - Konfigurer leadhåndtering - i Innstillinger og vedlikehold: /no/lead/admin/index
  - Konfigurer firmakategorier: /no/lead/admin/add-company-category
...
## Kategorier for potensielle kunder {#category}
