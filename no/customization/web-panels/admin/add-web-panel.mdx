...
userflow_index: true
related:
  - Legg til et oppgavemenyvalg: /no/customization/admin/add-items-to-task-menu
  - Grunnprogrammer og URL-parametere: /en/ui/blogic/url-parameters
language: no
---
...
### Bruke HTTP vs HTTPS-nettadresser {#https}
