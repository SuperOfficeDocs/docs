...
userflow_index: true
related:
  - Legg til layout: /no/customization/screen-designer/admin/add-layout
  - Rediger layout - hovedkort: /no/customization/screen-designer/admin/edit-layout
  - /no/customization/screen-designer/admin/working-with-fields
  - Arbeide med arkiver (detaljkort): /no/customization/screen-designer/admin/working-with-archives
language: no
---
