...
related:
  ...
  - Feilsøk skript: /en/automation/crmscript/debugging/built-in-debugger
  - Spor skript: /en/automation/crmscript/debugging/using-trace
language: no
---
...
## Egenskaper for makro-/skriptmappe {#folder}
