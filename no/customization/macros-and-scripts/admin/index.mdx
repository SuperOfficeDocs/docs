...
userflow_index: true
related:
  - Opprette et skript: /no/customization/macros-and-scripts/admin/create-script
  - Opprette en makro: /no/customization/macros-and-scripts/admin/create-macro
  - Opprette mappe: /no/customization/macros-and-scripts/admin/create-script#folder
  - Lær CRMScript-språket: /en/automation/crmscript/overview/index
  - CRMScript API-referanse: /en/automation/crmscript/reference/index
language: no
---
...
[2]: /no/customization/macros-and-scripts/admin/trigger
[3]: /no/customization/macros-and-scripts/admin/schedule-task
[4]: /en/automation/crmscript/debugging/built-in-debugger
[5]: /en/automation/crmscript/debugging/using-trace
[8]: /no/customization/macros-and-scripts/admin/create-script
