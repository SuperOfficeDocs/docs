...
## Nivåer for innstillinger av preferanser {#levels}
...
## Globale preferanser (for hele systemet) {#global}
...
## Preferanser-fane {#preferences-tab}
...
[1]: /no/admin/preferences/service-settings
[3]: /no/admin/preferences/update
[4]: /no/admin/preferences/update#personal
[5]: /no/admin/preferences/sms
[6]: /no/customer-center/admin/password-policy
[8]: /no/diary/learn/video-meetings
[9]: /no/document/library/learn/index
