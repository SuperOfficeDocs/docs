...
userflow_index: true
related:
  - SuperOffice-brukerplaner og abonnement: /no/admin/license/user-plans
  - Kjøpe og aktivere lisenser: /no/admin/license/activate
  - Lisenser i tidligere versjoner av SuperOffice: https://help.superoffice.com/Documentation/Help/EN/CRM/WebHelpAdmin/index.htm#t=chap03%2FCRM_and_licences.htm
  - Systemoperasjoner: https://help.superoffice.com/docs/11/no/admin/onsite/add-system-event.html
  - Modullisenser: /en/admin/license/dev/module-licenses
  - Skjulte lisenser: /en/admin/license/dev/hidden-licenses
  - Teknisk lisensoversikt: /en/admin/license/dev/index
language: no
---
...
<Tabs>
<Tab title="Modulbaserte abonnementer">
...
[16]: /no/admin/license/crm-suite
[1]: /no/admin/license/activate
[2]: /no/saint/learn/index
