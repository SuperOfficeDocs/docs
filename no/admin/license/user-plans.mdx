...
title: SuperOffice brukerplaner og abonnementer
...
userflow_index: true
related:
  - Slik er brukerplaner bygget opp: /en/admin/license/dev/user-plans
  - Legge til ny bruker: /no/admin/user-management/add-associate
  - Oversikt over roller: /no/admin/user-management/role/index
language: no
---
...
## Endre brukerplaner for aktive brukere {#change}
