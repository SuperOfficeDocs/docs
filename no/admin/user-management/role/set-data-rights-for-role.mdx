...
userflow_index: true
related:
  - Datarettigheter: /no/admin/user-management/role/functional-rights
  - Onsite-datarettigheter: https://help.superoffice.com/docs/11/no/admin/user-management/role/set-data-rights-for-role.html
language: no
---
