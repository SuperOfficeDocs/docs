...
userflow_index: true
related:
  - /no/admin/user-management/role/create-role
  - Redigere eller slette en rolle: /no/admin/user-management/role/update-role
...
Ved hjelp av rollebasert sikkerhet i SuperOffice CRM kan du skreddersy roller for ulike tilgangsnivåer i firmaet. Rollene styrer tilgangsrettighetene de ulike brukerne har i SuperOffice CRM.
...
[3]: /no/admin/user-management/role/set-data-rights-for-role
[6]: /no/admin/user-management/role/functional-rights
