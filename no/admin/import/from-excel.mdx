...
redirect_from: /no/admin/import/learn/import-from-excel
userflow_index: true
related:
  - /no/admin/import/settings
  - /no/admin/import/from-gmail
  - /no/admin/import/from-erp
language: no
---
...
import ConfigureImportSettings from "./snippets/configure-import-settings.md";
import StepConcentComment from "./snippets/step-concent-comment.md";
import StepPreviewImport from "./snippets/step-preview-import.md";
...
<Frame caption="Se denne videoen, eller følg trinnene nedenfor for å finne ut hvordan du importerer personene dine til SuperOffice CRM ved hjelp av importmalen vår (videolengde - 4.02)">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/dVkCfpOkNl8"
    title="Se denne videoen, eller følg trinnene nedenfor for å finne ut hvordan du importerer personene dine til SuperOffice CRM ved hjelp av importmalen vår (videolengde - 4.02)"
    frameborder="0"
