...
userflow_index: true
related:
  - Velge innstillinger for importen: /no/admin/import/settings
  - Importere personer til SuperOffice CRM: /no/admin/import/from-excel
  - Importere produkter til en prisliste: /no/admin/import/products-from-excel
language: no
---
...
[Last ned importmalen for firmaer og personer][1] [Excel spreadsheet, ZIP]
...
[Last ned importmalen for produkter][2] [Excel spreadsheet, ZIP]
