...
related:
  ...
  - Masseslette personer og firma fra utvalg: /no/security/privacy/learn/mass-delete
  - Finn og utvalg: /no/search-options/selection/learn/index
language: no
---
...
## Gjenopprette slettede firma og personer {#restore}
