...
related:
  - Slette elementer i SuperOffice CRM: /no/learn/basics/deleting-elements
  - Gruppere informasjon i detaljkort: /no/learn/section-tabs/index
  - Legge til forekomster på listen Generelt - Relasjon: /no/admin/lists/specialized-lists#relation
  - Tilpassede felt i relasjoner: /no/custom-objects/learn/extra-field#relation
language: no
---
