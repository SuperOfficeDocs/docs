...
title: Oppdatere flere poster (masseredigering)
...
related:
  - Hvordan fyller jeg ut feltene "Hjemmel", "Samtykkekilde" og "Formål" for mange personer i SuperOffice CRM samtidig?: /en/security/privacy/learn/edit-legal-base#bulk
  - Massesletting av personer og firmaer fra utvalg: /no/security/privacy/learn/mass-delete
language: no
---
...
## Søk og erstatt {#search-and-replace}
