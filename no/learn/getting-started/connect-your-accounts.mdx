...
Når du er tilkoblet, kan du også velge om nye e-poster du oppretter, og e-postadresser du klikker på, i stedet skal åpnes i ditt eget lokale e-postprogram, i stedet for i SuperOffices egen dialog. Aktiver dette under [Personlige innstillinger > Preferanser > E-post][2].
