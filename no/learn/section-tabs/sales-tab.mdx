...
related:
  - Hvordan legge til et salg: /no/sale/learn/create
  - Administrere interessenter i salg: /no/sale/learn/stakeholders/index
  - Filtrer aktiviteter og salg: /no/learn/section-tabs/filter
  - Grupper kolonner og oppsummer beløp: /no/learn/section-tabs/configure-columns#calculate
language: no
---
