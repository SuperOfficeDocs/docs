...
<Frame caption="Ved å konfigurere kolonner kan du tilpasse vist informasjon og arbeide med CRM-data slik du trenger. Lær hvordan du konfigurerer kolonner med denne videoen, eller følg trinnene nedenfor">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/IjlPSN-u0MA"
    title="Ved å konfigurere kolonner kan du tilpasse vist informasjon og arbeide med CRM-data slik du trenger. Lær hvordan du konfigurerer kolonner med denne videoen, eller følg trinnene nedenfor"
    frameborder="0"
