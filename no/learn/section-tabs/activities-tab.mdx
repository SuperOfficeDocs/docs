...
keywords: ['detaljkortet Aktiviteter', 'Aktiviteter-fanen', 'Aktivitetsfanen', 'detaljkort', 'aktivitetsarkiv', 'aktivitet', 'laste ned']
author: digitaldiina
date: 18.09.2026
so_version: 12.2
content_type: howto
...
related:
  - Introduksjon til aktiviteter: /no/learn/basics/activity
  - Opprett oppfølginger: /no/diary/learn/create-follow-up
  - Svar på eller videresend e-post fra Aktivitetsfanen: /no/learn/section-tabs/send-email
  - Endre utført-statusen for en aktivitet: /no/diary/learn/change-completed-status
  - Slett aktiviteter i aktivitetslisten: /no/learn/basics/activity
  - Filtrer aktiviteter: /no/learn/section-tabs/filter
  - Grupper kolonner og oppsummer: /no/learn/section-tabs/configure-columns#calculate
language: no
---
...
## Kolonneoversikt for detaljkortet Aktiviteter {#columns}
...
* **Last ned en e-post eller et dokument:** Finn elementet, høyreklikk, og velg **Last ned** for å lagre en kopi på enheten din. Ikke tilgjengelig når flere elementer er valgt.

    ![Kontekstmeny i detaljkortet Aktiviteter for Person -screenshot][img3]
