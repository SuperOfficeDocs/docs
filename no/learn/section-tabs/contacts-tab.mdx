...
related:
  - Opprett ny person: /no/contact/learn/create
  - Slett person: /no/contact/learn/delete
  - Konfigurer kolonner i detaljkort: /no/learn/section-tabs/configure-columns
language: no
---
...
## Kolonneoversikt for Personfanen {#columns}
