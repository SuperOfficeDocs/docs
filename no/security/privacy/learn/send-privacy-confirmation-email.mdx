...
related:
  - Rediger e-postbekreftelsen for personvern i Innstillinger og vedlikehold: /no/security/privacy/admin/edit-privacy-confirmation-email
language: no
---
...
<Frame caption="Denne videoen viser deg hvordan du oppretter et grunnleggende webskjema og legger det til på websiden din (videolengde - 7:49)">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/18m6Dx1t9wI"
    title="Denne videoen viser deg hvordan du oppretter et grunnleggende webskjema og legger det til på websiden din (videolengde - 7:49)"
    frameborder="0"
