...
redirect_from: /no/request/learn/priority/create
userflow_index: true
related:
  - title: "Opprett eskaleringsnivå"
...
## Prioritetsinnstillinger {#priority-settings}
...
## Alternativer for eskalering {#escalation-options}
