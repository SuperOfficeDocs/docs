...
userflow_index: true
related:
  - /no/request/admin/type/create
  - /no/request/admin/type/delete
  - /no/request/admin/relation-rules
language: no
---
...
[3]: /no/request/admin/priority/index
[4]: /no/request/admin/status/index
[5]: /no/knowledge-base/learn/reply-templates/index
