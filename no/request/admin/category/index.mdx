...
userflow_index: true
related:
  - Opprette kategorier: /no/request/admin/category/create
  - Slette kategorier: /no/request/admin/category/delete
  - /no/request/admin/next-in-queue
  - Prioriteter: /no/request/admin/priority/index
language: no
---
...
[3]: /no/admin/lists/index
[6]: /no/request/learn/tags
