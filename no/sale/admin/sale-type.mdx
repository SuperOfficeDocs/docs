...
userflow_index: true
related:
  - Legge til en salgsfase: /no/sale/admin/sale-stage
  - Opprette en salgsguide: /no/sale/admin/create-sales-guide
  - Redigere en salgsguide: /no/sale/admin/edit-sales-guide
...
## Forklaring av tilbudsfelt {#quote-fields}
...
<Tab title="Fanen Standardverdier">
...
## Gjenopprette en slettet salgstype {#restore}
...
[7]: ../../search-options/learn/find-screen
