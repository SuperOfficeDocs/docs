...
userflow_index: true
related:
  - Sette opp ERP-kobling: /no/sale/admin/quote/set-up-quote-connector
  - Legge til prislister og produkter: /no/sale/admin/quote/price-list-and-products
  - Tilpasse tilbudsbildet: /no/sale/admin/quote/configure-product-fields
  - Administrere ERP-synkronisering: /no/erp/admin/index
language: no
---
...
## Faner i Tilbud/Sync-bildet {#tabs}
...
[1]: /no/sale/admin/quote/set-up-quote-connector
[2]: /no/sale/admin/quote/price-list-and-products
[3]: /no/sale/admin/quote/configure-product-fields
[4]: /no/erp/admin/index
[5]: /no/sale/admin/sale-type
