...
language: no
redirect_from: /no/sale/learn/sales-guide/create
index: true
---
...
## Opprette faser for salgsguiden {#create-stages}
...
## Opprette en salgstype for salgsguiden {#create-type}
...
## Opprette en salgsguide {#create-guide}
...
## Legge til en oppfølging for en fase {#add-fo-stage}
...
## Legge til et dokument for en fase {#add-doc-stage}
...
[1]: ../../document/templates/variables/for-sales
[2]: ./sale-stage
[3]: ./sale-type
