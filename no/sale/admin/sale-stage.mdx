...
redirect_from:
  - /no/admin/lists/learn/sale-stage
  - /no/sale/learn/screen/sale-stage
userflow_index: true
related:
  - Legge til eller oppdatere salgstyper: /no/sale/admin/sale-type
  - Opprette en salgsguide: /no/sale/admin/create-sales-guide
  - Redigere en salgsguide: /no/sale/admin/edit-sales-guide
  - Følge opp salgsprosessen: /no/sale/learn/sales-guides#change-stage
language: no
---
