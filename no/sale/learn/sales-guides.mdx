...
related:
  - Introduksjon til salg: /no/sale/learn/index
  - Opprette et salg: /no/sale/learn/create
  - Arbeide med salgsguide: /no/sale/learn/tutorial
  - /no/sale/admin/create-sales-guide
  - /no/sale/admin/edit-sales-guide
language: no
---

import ReqCoreTransitionSales from "../../snippets/req-core-transition-sales.mdx";
