...
related:
  - title: "Legge til alternativer i et tilbud"
    href: "/no/sale/learn/quote/add-alternative"
  - title: "Opprette tilbudsdokument"
    href: "/no/sale/learn/quote/create-quote-document"
  - title: "Sende tilbud"
    href: "/no/sale/learn/quote/send"
  - title: "Lage ordre"
    href: "/no/sale/learn/quote/place-order"
  - title: "Sett opp produktene og prisene dine i Innstillinger og vedlikehold"
    href: "/no/sale/admin/quote/price-list-and-products"
language: no
---
...
## Kopiere et tilbud fra et annet salg {#copy}
...
## Legge til produkter i tilbudet {#add-products}
...
## Hvorfor vises advarsler eller feil? {#warning}
