...
related:
  ...
  - Bytte tilbudsdokument: /no/sale/learn/quote/create-quote-document#replace
  - /no/sale/learn/quote/place-order
  - Konfigurere regler for tilbudsgodkjenning i Innstillinger og vedlikehold: /no/sale/admin/sale-type#quote-fields
language: no
---
...
## Redigere sendt tilbud {#versions}
