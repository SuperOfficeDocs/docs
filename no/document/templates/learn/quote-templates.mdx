...
tier: starter
related:
  - Oppdater tilbudsmal: /no/document/templates/admin/update-template
  - Veiledning: /no/document/templates/admin/update-template
  - /no/document/templates/merge-fields/index
  - Malvariabelreferanse: /no/document/templates/variables/for-quote-line
...
## Typer tilbudsdokumentmaler {#types}
...
### Struktur av flettefelt {#structure}
...
### Formatering av numeriske og datofelt {#culture}
