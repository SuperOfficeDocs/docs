...
userflow_index: true
related:
  - Erstatte eksisterende mal: /no/document/templates/admin/update-template
language: no
---
...
<Frame caption="Se denne videoen, eller følg fremgangsmåten nedenfor for å finne ut hvordan du kan legge til en dokumentmal">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/FnhcmjP-TgE"
    title="Se denne videoen, eller følg fremgangsmåten nedenfor for å finne ut hvordan du kan legge til en dokumentmal"
    frameborder="0"
