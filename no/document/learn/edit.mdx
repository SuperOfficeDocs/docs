...
### Nettlesersikkerhetsspørsmål ved åpning av filer {#allow}
...
## Laste ned et dokument {#download}

Når du laster ned et dokument, lagres en kopi av dokumentfilen på enheten din.

1. Klikk på **Oppgave**-knappen (<i class="ph ph-dots-three-circle-vertical" aria-hidden="true"></i>) i **Dokument**-dialogen.
2. Velg **Last ned**.

![Last ned e-posten eller dokumentet fra Oppgave-knappen -screenshot][img6]

<Tip>
Du kan også laste ned et dokument direkte fra [detaljkortet Aktiviteter][5] ved å høyreklikke på det og velge **Last ned**.
</Tip>
...
[5]: ../../learn/section-tabs/activities-tab
