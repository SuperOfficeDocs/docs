...
redirect_from: /no/ai/configuration-ai/getting-started
userflow_index: true
related:
  - Hvordan opprette et utvalg: /no/search-options/selection/learn/create
  - Sakkategorisering: /no/ai/learn/categorization
