...
userflow_index: true
related:
  - Legge til Sync Connector og definere en ERP-tilkobling: /no/erp/admin/add-connection
  - Redigere en ERP-tilkobling: /no/erp/admin/update-connection
  - Konfigurere felttilordning og standardverdier: /no/erp/admin/configure
  - Angi synkroniseringsprioritet: /no/erp/admin/configure#priority
