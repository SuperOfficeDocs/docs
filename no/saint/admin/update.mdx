...
## Legge til kriterier til en status {#criteria}
...
## Slette en statusovervåking {#delete}
...
## Gjenopprette en slettet statusovervåking {#restore}
...
## Regenerere statuser og tellere \<i class="ph ph-arrow-circle-right" aria-hidden="true"\>\</i\> {#regen}
