...
## Hvordan SAINT lagrer tellere og statuser {#database}
...
[1]: /no/saint/admin/set-up
[2]: /no/saint/admin/set-up#image
[5]: /no/saint/admin/counter-settings
[7]: /no/saint/admin/update
[8]: /no/saint/admin/update#regen
