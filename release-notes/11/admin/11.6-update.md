...
In the [**Contact - Lead status** list][3], add the lead status values you wish to use (for example, statuses that are useful when qualifying a lead). These statuses are visible and actionable in the board view for contact selections.
...
[1]: ../marketing/11.6-update
[2]: ../../../docs/en/lead/admin/add-company-category
[3]: ../../../docs/en/lead/admin/add-lead-status
[4]: ../../../docs/en/marketing/utm/admin/set-up

[img1]: /media/loc/en/admin/admin-lists-gui-web-panel-reload.png
[img3]: /media/loc/en/admin/admin-pref-request-group-setting.png
[img4]: /media/loc/en/admin/admin-list-category-category-group-enable-lead-status.png
[img5]: /media/loc/en/admin/admin-lists-contact-lead-status.png
