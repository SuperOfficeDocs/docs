...
description: Settings and maintenance improvements in the SuperOffice 10.0.6 update, including Gmail contact import, Screen designer address fields, and security improvements.
...
import NewLanguages from "../includes/new-languages.md";
...
[img1]: /media/loc/en/release-notes/10.0/gmail-import-contacts.png
[img2]: /media/loc/en/release-notes/10.0/screen-designer-adr-expanded-mode.png
[img3]: /media/loc/en/release-notes/10.0/adr-expanded-off.png
[img4]: /media/loc/en/release-notes/10.0/adr-expanded-on.png
[img5]: /media/loc/en/release-notes/10.0/change-password-dialog.png
