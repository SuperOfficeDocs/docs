...
description: Core CRM improvements in the SuperOffice 10.0.6 update, including soft line charts on dashboards and five new UI languages.
...
## Languages - 5 new UI languages {#languages}
