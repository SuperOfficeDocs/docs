...
userflow_index: true
related:
  - /de/sale/admin/quote/configure-product-fields
  - /de/admin/import/products-from-excel
...
## Produkte zu einer Preisliste hinzufügen {#add-product}
...
## Produktbild hinzufügen oder ändern {#image}
...
## Produkte oder Preislisten deaktivieren {#deactivate}
