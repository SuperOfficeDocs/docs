...
userflow_index: true
related:
  - ERP-Verbindung einrichten: /de/sale/admin/quote/set-up-quote-connector
  - Produkte und Preislisten hinzufügen: /de/sale/admin/quote/price-list-and-products
  - Produktdialog anpassen: /de/sale/admin/quote/configure-product-fields
  - /de/erp/admin/index
language: de
---
...
## Registerkarten in der Ansicht Angebot/Sync {#tabs}
...
[1]: /de/sale/admin/quote/set-up-quote-connector
[2]: /de/sale/admin/quote/price-list-and-products
[3]: /de/sale/admin/quote/configure-product-fields
[4]: /de/erp/admin/index
[5]: /de/sale/admin/sale-type
