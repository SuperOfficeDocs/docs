...
userflow_index: true
related:
  - Verkaufsstufe hinzufügen: /de/sale/admin/sale-stage
  - Verkaufsleitfaden erstellen: /de/sale/admin/create-sales-guide
  - Verkaufsleitfaden bearbeiten: /de/sale/admin/edit-sales-guide
...
## Erklärung der Angebotsfelder {#quote-fields}
...
## Gelöschten Verkaufstyp wiederherstellen {#restore}
