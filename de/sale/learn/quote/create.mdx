...
related:
  - title: "Alternativen zum Angebot hinzufügen"
    href: "/de/sale/learn/quote/add-alternative"
  - title: "Angebotsdokument erstellen"
    href: "/de/sale/learn/quote/create-quote-document"
  - title: "Angebot senden"
    href: "/de/sale/learn/quote/send"
  - title: "Auftrag erstellen"
    href: "/de/sale/learn/quote/place-order"
  - title: "Produkte und Preise in Einstellungen und Verwaltung einrichten"
    href: "/de/sale/admin/quote/price-list-and-products"
language: de
---
...
## Angebot aus einem anderen Verkauf kopieren {#copy}
...
## Produkte zum Angebot hinzufügen {#add-products}
...
### Warum werden Warnungen oder Fehler angezeigt? {#warning}
