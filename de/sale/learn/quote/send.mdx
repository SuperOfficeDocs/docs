...
related:
  ...
  - Angebotsdokument ersetzen: /de/sale/learn/quote/create-quote-document#replace
  - /de/sale/learn/quote/place-order
  - Genehmigungsregeln konfigurieren in Einstellungen und Verwaltung: /de/sale/admin/sale-type#quote-fields
language: de
---
...
## Genehmigung erforderlich? {#approve}
...
## So senden Sie das Angebot {#send}
...
## Gesendetes Angebot bearbeiten {#versions}
