...
related:
  - Dashboard: /de/dashboard/learn/index
...
Alle Benutzer, die ihre Verkaufsleistung messen lassen, können auf den Status und Fortschritt ihres Verkaufsziels zugreifen, indem sie entsprechende [Kacheln im Dashboard][2] einrichten. Auf diese Weise erhalten sie einen sofortigen Live-Überblick über ihre Verkaufsleistung im Vergleich zu den festgelegten Verkaufszielen und können sich auf individuelle und gemeinsame Ziele konzentrieren.
...
[2]: /de/dashboard/learn/show-sales-targets
