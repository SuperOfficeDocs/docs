...
related:
  - /de/lead/learn/work-with-leads
  - /de/marketing/utm/learn/index
  - Lead-Management einrichten - in Einstellungen und Verwaltung: /de/lead/admin/index
  - Firma-Kategorien konfigurieren: /de/lead/admin/add-company-category
...
## Kategorien für potenzielle Kunden {#category}
