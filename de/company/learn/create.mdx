...
Wenn Sie einen Namen in das Feld **Firmenname** eingeben, zeigt **Company Insight** passende Firmen aus offiziellen Handelsregistern an, wie Brreg (Norwegen), standardmäßig abgeglichen mit dem Register Ihres eigenen Landes.
...
<Note>
Company Insight erfordert [CRM Suite Growth][13] oder höher.
</Note>
...
[13]: ../../admin/license/crm-suite#plans
