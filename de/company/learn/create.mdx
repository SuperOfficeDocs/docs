...
keywords: ['neue Firma', 'Firma erstellen', 'Duplikaterkennung', 'Interessen hinzufügen', 'Firmeninteressen', 'Firma', 'Company Insight']
...
related:
  - Datensatz als Favoriten hinzufügen: /de/learn/basics/fav
  - Voreinstellungen Dialogfenster - Standardwerte und Listenwerte: /de/learn/getting-started/preferences
language: de
---
...
## Wichtige Felder und deren Bedeutung {#fields}
...
Wenn Sie einen Namen in das Feld **Firmenname** eingeben, zeigt **Company Insight** passende Firmen aus offiziellen Handelsregistern an, wie Brreg (Norwegen), Virk (Dänemark), Companies House (Großbritannien) und Zefix (Schweiz), standardmäßig abgeglichen mit dem Register Ihres eigenen Landes.

Wählen Sie eine Übereinstimmung aus, um eine Vorschau der Details wie Adresse, Telefonnummer und Website anzuzeigen. Klicken Sie auf **Speichern**, um die Firma mit diesen Details hinzuzufügen, oder auf **Abbrechen**, um die Details weiterhin manuell einzugeben.

Dies hilft, manuelles Kopieren und Einfügen zu vermeiden, und verringert das Risiko, die falsche Firma zu registrieren oder ein Duplikat zu erstellen.

<Note>
Company Insight erfordert CRM Suite Growth oder höher.
</Note>

![Auswahl einer von Company Insight vorgeschlagenen Firma -screenshot][img3]

## Interessen hinzufügen {#interests-tab}
...
[img3]: ../../../media/loc/en/company/company-insight.png
