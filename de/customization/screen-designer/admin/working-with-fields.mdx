...
userflow_index: true
related:
  - Spaltenanzahl in einer Registerkarte ändern: /de/customization/screen-designer/admin/working-with-tabs#columns
  - Bezeichnungen und Trennelemente hinzufügen: /de/customization/screen-designer/admin/working-with-tabs#label
  - Links und Schaltflächen hinzufügen: /de/customization/screen-designer/admin/add-button
language: de
---
