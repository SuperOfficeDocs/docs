...
userflow_index: true
related:
  - /de/customization/screen-designer/admin/working-with-archives
language: de
---
...
1. Im Bildschirm **Kartenlayout bearbeiten** arbeiten Sie sich durch die Registerkarten der Ansicht.
    ...
    * [Die Anzahl der Spalten in einer Registerkarte ändern][5]

![Entfernen, hinzufügen und verschieben Sie die verschiedenen Felder im Layout -screenshot][img3]

## Speichern, veröffentlichen oder abbrechen {#save}
...
## Änderungen rückgängig machen {#undo-changes}
