...
userflow_index: true
related:
  - Über CRMScript: /en/automation/crmscript/index
  - Skripts debuggen: /en/automation/crmscript/debugging/built-in-debugger
  - Skripts verfolgen: /en/automation/crmscript/debugging/using-trace
language: de
---
...
## Eigenschaften des Makro-/Skriptordners {#folder}
