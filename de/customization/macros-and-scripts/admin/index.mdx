...
userflow_index: true
related:
  - Ein Skript erstellen: /de/customization/macros-and-scripts/admin/create-script
  - Ein Makro erstellen: /de/customization/macros-and-scripts/admin/create-macro
  - Ordner erstellen: /de/customization/macros-and-scripts/admin/create-script#folder
  - CRMScript-Sprache lernen: /en/automation/crmscript/overview/index
  - CRMScript-API-Referenz: /en/automation/crmscript/reference/index
language: de
---
...
[2]: /de/customization/macros-and-scripts/admin/trigger
[3]: /de/customization/macros-and-scripts/admin/schedule-task
[4]: /en/automation/crmscript/debugging/built-in-debugger
[5]: /en/automation/crmscript/debugging/using-trace
[8]: /de/customization/macros-and-scripts/admin/create-script
