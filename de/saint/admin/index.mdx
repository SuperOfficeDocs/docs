...
userflow_index: true
related:
  - Neue Statusüberwachung einrichten: /de/saint/admin/set-up
  - Status mit Bildern visualisieren: /de/saint/admin/set-up#image
  - /de/saint/admin/counter-settings
  - Statusüberwachungen aktualisieren, löschen und wiederherstellen: /de/saint/admin/update
  - Statusüberwachungen und Zähler regenerieren: /de/saint/admin/update#regen
language: de
---
...
## Wie SAINT Zähler und Status speichert {#database}
...
[5]: /de/saint/admin/counter-settings
[8]: /de/saint/admin/update#regen
