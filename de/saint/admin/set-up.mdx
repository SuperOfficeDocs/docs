...
userflow_index: true
related:
  - title: "Statusüberwachung aktualisieren, löschen und wiederherstellen"
    href: "/de/saint/admin/update"
  - title: "Zähler und Zählereinstellungen (Zeitraum)"
    href: "/de/saint/admin/counter-settings"
  - title: "Statusüberwachung und Zähler regenerieren"
    href: "/de/saint/admin/update#regen"
language: de
---
...
## Ein Bild für einen Status auswählen {#image}
...
[2]: ./update
[8]: ../../localization/learn/translate-fields
[9]: ../../document/templates/variables/index
