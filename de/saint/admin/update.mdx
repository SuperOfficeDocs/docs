...
import NoteReqSaint from "../../includes/note-req-saint.mdx";
...
## Kriterien zu einem Status hinzufügen {#criteria}
...
## Eine Statusüberwachung löschen {#delete}
...
## Eine gelöschte Statusüberwachung wiederherstellen {#restore}
...
## Statusangaben und Zähler regenerieren \<i class="ph ph-arrow-circle-right" aria-hidden="true"\>\</i\> {#regen}
