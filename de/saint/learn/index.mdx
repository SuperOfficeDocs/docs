...
related:
  - SAINT festlegen: /de/saint/admin/index
  - Wie SAINT Zähler und Status speichert: /de/saint/admin/index#database
  - Statuskontrollen in einer dynamischen Selektion verwenden: /de/search-options/selection/learn/create
language: de
---
...
### Dialogfeld Statuskontrollen anzeigen {#dialog}
...
[1]: /de/diary/learn/create-follow-up
