...
1. Sie befinden sich nun im Effekt-Dialog. Die Werkzeugleiste bietet Ihnen eine Vielzahl von Optionen, um Ihr Bild zu ändern und anzupassen.

    ![Klicken Sie auf die Schaltfläche Größe ändern, um die Größe Ihres Bildes zu ändern -screenshot][img6]

1. Klicken Sie auf die Schaltfläche **Größe ändern** (zweite von links), um die Größe Ihres Bildes anzupassen. Sie können die Breite und Höhe ändern, das Bildseitenverhältnis beibehalten und Prozentsätze anstelle von Pixeln verwenden.

1. Wenn Sie mit der neuen Größe Ihres Bildes zufrieden sind oder überprüfen möchten, wie es nach den vorgenommenen Änderungen in Ihrer E-Mail-Vorlage aussieht, können Sie auf **Speichern** klicken.
