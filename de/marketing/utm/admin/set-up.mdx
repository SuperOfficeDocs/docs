...
## 1. UTM-Datenübertragung aktivieren {#enable}
...
## 2. UTM-Tracking-Skript zur Website hinzufügen {#script}
...
## 3. Kampagnenlinks mit UTM-Parametern erstellen {#build-url}
...
## 4. Getaggte Links in Kampagnen verwenden {#tag}
...
## 5. Formular korrekt veröffentlichen {#publish}
...
## 6. Einrichtung testen und überprüfen {#test}
...
## 7. Ergebnisse analysieren und visualisieren {#analyze}
