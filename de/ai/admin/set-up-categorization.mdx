...
redirect_from: /de/ai/configuration-ai/getting-started
userflow_index: true
related:
  - Wie man eine Selektion erstellt: /de/search-options/selection/learn/create
  - Anfragenkategorisierung: /de/ai/learn/categorization
  - Andere AI-Dienste: /de/ai/learn/index
language: de
---
