...
keywords: ['KI', 'ChatGPT', 'OpenAI', 'Bing', 'Workspace Assist', 'Copilot']
...
Workspace Assist weiß nichts über Ihre Kundendaten und wird Ihnen Antworten mit Hilfe eines großen Sprachmodells (LLM) wie Bing von Microsoft oder ChatGPT von OpenAI geben.
