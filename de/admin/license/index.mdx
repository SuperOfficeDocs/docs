...
userflow_index: true
related:
  - SuperOffice-Benutzerpläne und Abonnements: /de/admin/license/user-plans
  - Lizenz kaufen und aktivieren: /de/admin/license/activate
  - Lizenzen in früheren Versionen von SuperOffice: https://help.superoffice.com/Documentation/Help/EN/CRM/WebHelpAdmin/index.htm#t=chap03%2FCRM_and_licences.htm
  - Systemereignisse: https://help.superoffice.com/docs/11/de/admin/onsite/add-system-event.html
  - Modullizenzen: /en/admin/license/dev/module-licenses
  - Versteckte Lizenzen: /en/admin/license/dev/hidden-licenses
  - Technische Lizenzübersicht: /en/admin/license/dev/index
language: de
---
...
<Tabs>
<Tab title="Modulbasierte Abonnements">
...
[16]: /de/admin/license/crm-suite
[1]: /de/admin/license/activate
[2]: /de/saint/learn/index
