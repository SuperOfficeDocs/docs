...
related:
  - title: "SuperOffice-Benutzerpläne und Abonnements"
    href: "/de/admin/license/user-plans"
  - title: "Lizenz kaufen und aktivieren"
    href: "/de/admin/license/activate"
  - title: "Lizenzen in früheren Versionen von SuperOffice"
  ...
  - title: "Systemereignisse"
    href: "https://help.superoffice.com/docs/11/de/admin/onsite/add-system-event.html"
  - title: "Modullizenzen"
    href: "/en/admin/license/dev/module-licenses"
  - title: "Versteckte Lizenzen"
    href: "/en/admin/license/dev/hidden-licenses"
  - title: "Technische Lizenzübersicht"
