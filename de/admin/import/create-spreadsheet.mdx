...
userflow_index: true
related:
  - Auswahl der Einstellungen für Ihren Import: /de/admin/import/settings
  - Import von Personen in SuperOffice CRM: /de/admin/import/from-excel
  - Import von Produkten in eine Preisliste: /de/admin/import/products-from-excel
language: de
---
...
[Laden Sie die Importvorlage für Firmen und Personen herunter][1] [Excel spreadsheet, ZIP]
...
[Laden Sie die Importvorlage für Produkte herunter][2] [Excel spreadsheet, ZIP]
