...
related:
  ...
  - Rolle bearbeiten oder löschen: /de/admin/user-management/role/update-role
  - /de/admin/user-management/role/set-data-rights-for-role
language: de
---

import NoteAnonReq from "../snippets/note-anon-req.mdx";
import LimStarter from "../../../snippets/lim-starter.mdx";

<NoteAnonReq />

Über die rollenbasierte Sicherheit in SuperOffice CRM können Sie für die verschiedenen Zugriffsebenen in der Firma Rollen festlegen. Die Rollen steuern die Zugriffsrechte der verschiedenen Benutzer in SuperOffice CRM.
...
[3]: /de/admin/user-management/role/set-data-rights-for-role
[6]: /de/admin/user-management/role/functional-rights
