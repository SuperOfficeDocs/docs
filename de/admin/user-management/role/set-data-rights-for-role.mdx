...
title: Datenrechte für eine Rolle festlegen
...
userflow_index: true
related:
  - Datenrechte: /de/admin/user-management/role/functional-rights
  - Onsite-Datenrechte: https://help.superoffice.com/docs/11/de/admin/user-management/role/set-data-rights-for-role.html
language: de
---
