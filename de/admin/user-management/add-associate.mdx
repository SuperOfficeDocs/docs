...
userflow_index: true
related:
  - Benutzer/Mitarbeiter bearbeiten: /de/admin/user-management/update-user
  - Onsite-Benutzerverwaltung: https://help.superoffice.com/docs/11/de/admin/user-management/add-associate.html
language: de
---
...
## Erklärung wichtiger Felder {#fields}
...
<Tab title="Die Registerkarte Lizenzen">
...
<Frame caption="(Dieses Video zeigt eine frühere Version von SuperOffice, daher kann das Design anders aussehen. Die Schritte sind dieselben.)">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/oLlfTrCAqCU"
    title="(Dieses Video zeigt eine frühere Version von SuperOffice, daher kann das Design anders aussehen. Die Schritte sind dieselben.)"
    frameborder="0"
