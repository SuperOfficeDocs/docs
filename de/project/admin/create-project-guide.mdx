...
related:
  - /de/project/admin/edit-project-guide
language: de
---
...
## Statuswerte für den Projektleitfaden erstellen {#create-stage}
...
## Projekttyp für den Projektleitfaden erstellen {#create-type}
...
## Projektleitfaden erstellen {#create-guide}
...
## Folgeaufgabe für einen Status hinzufügen {#add-fo-status}
...
## Dokument für einen Status hinzufügen {#add-doc-status}
