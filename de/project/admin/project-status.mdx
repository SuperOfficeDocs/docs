...
redirect_from:
  - /de/admin/lists/learn/project-status
  - /de/project/learn/screen/project-status-admin
related:
  - Projekttypen hinzufügen oder aktualisieren: /de/project/admin/project-type
  - Einen Projektleitfaden erstellen: /de/project/admin/create-project-guide
  - Einen Projektleitfaden bearbeiten: /de/project/admin/edit-project-guide
  - Projekt in den nächsten Status verschieben: /de/project/learn/project-guides#change-status
language: de
---
