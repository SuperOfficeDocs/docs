...
related:
  - Bearbeiten Sie die E-Mail der Datenschutzbestätigung unter Einstellungen und Verwaltung: /de/security/privacy/admin/edit-privacy-confirmation-email
language: de
---
...
<Frame caption="Dieses Video zeigt Ihnen, wie Sie ein einfaches Web-Formular erstellen und zu Ihrer Webseite hinzufügen (Videolänge - 7:49)">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/18m6Dx1t9wI"
    title="Dieses Video zeigt Ihnen, wie Sie ein einfaches Web-Formular erstellen und zu Ihrer Webseite hinzufügen (Videolänge - 7:49)"
    frameborder="0"
