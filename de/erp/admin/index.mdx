...
userflow_index: true
related:
  - Einen Sync Connector hinzufügen und eine ERP-Verbindung definieren: /de/erp/admin/add-connection
  - Eine ERP-Verbindung bearbeiten: /de/erp/admin/update-connection
  - Feldzuweisung und Standardwerte konfigurieren: /de/erp/admin/configure
  - Synchronisierungspriorität festlegen: /de/erp/admin/configure#priority
  - Import aus dem ERP-System: /de/admin/import/from-erp
language: de
---
