...
keywords: ['Dokument bearbeiten', 'Dokumenteigenschaften', 'Dokument', 'herunterladen']
author: digitaldiina
date: 18.09.2026
so_version: 12.2
content_type: howto
...
related:
  - Wie man den Status Abgeschlossen für eine Aktivität ändert: /de/diary/learn/change-completed-status
language: de
---

import WebtoolsOrSharepoint from "./snippets/webtools-or-sharepoint.md";
...
<Tabs>
<Tab title="Mit SuperOffice WebTools">
...
<Tab title="Ohne SuperOffice Web Tools">
<Note>
...
### Browser-Sicherheitsfrage beim Öffnen von Dateien {#allow}
...
## Dokument herunterladen {#download}

Beim Herunterladen eines Dokuments wird eine Kopie der Dokumentdatei auf Ihrem Gerät gespeichert.

1. Klicken Sie auf die Schaltfläche **Aufgabe** (<i class="ph ph-dots-three-circle-vertical" aria-hidden="true"></i>) im **Dokument**-Dialog.
2. Wählen Sie **Herunterladen**.

![E-Mail oder Dokument über die Schaltfläche Aufgabe herunterladen -screenshot][img6]

<Tip>
Sie können ein Dokument auch direkt über die [Bereichsregisterkarte Aktivitäten][4] herunterladen, indem Sie mit der rechten Maustaste darauf klicken und **Herunterladen** wählen.
</Tip>
...
[2]: ./create
[3]: ./create#fields
[4]: ../../learn/section-tabs/activities-tab
...
[img6]: ../../../media/loc/en/document/document-email-dialog-task-download.png
