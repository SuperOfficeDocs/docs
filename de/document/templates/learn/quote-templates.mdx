...
tier: starter
related:
  - Angebotsvorlage aktualisieren: /de/document/templates/admin/update-template
  - Tutorial: /de/document/templates/admin/update-template
  - /de/document/templates/merge-fields/index
  - Vorlagenvariablenreferenz: /de/document/templates/variables/for-quote-line
  - System.Globalization.CultureInfo: https://docs.microsoft.com/en-us/dotnet/api/system.globalization.cultureinfo?view=net-5.0
  - Aspose (verantwortlich für Dokumentenerstellung): http://www.aspose.com
language: de
---
...
## Typ des Angebotsdokumentvorlagen {#types}
...
### Struktur der Merge fields {#structure}
...
### Verwendung von Merge fields {#usage}
...
### Formatierung von numerischen und Datumsdaten {#culture}
