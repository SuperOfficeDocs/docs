...
related:
  - Folgeaufgabe: /de/diary/learn/follow-ups
  - /de/learn/basics/activity
  - Videokonferenz vom SuperOffice-Kalender erstellen: /de/diary/learn/video-meetings
language: de
---
...
### Wie Informationen eingegeben werden {#fields}
...
### Besprechung für einen Mitarbeiter erstellen {#associate}
...
## Folgeaufgabe in den Kalender kopieren {#copy}
