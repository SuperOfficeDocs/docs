...
related:
  - Ein neues Dashboard erstellen oder ein vorhandenes duplizieren: /de/dashboard/learn/create
  - Ein Dashboard bearbeiten: /de/dashboard/learn/update
  - Dashboard an einen Mitarbeiter übertragen: /de/dashboard/learn/update#owner
  - Kacheln bearbeiten: /de/dashboard/learn/working-with-tiles
language: de
---
...
### Schnellfilter konfigurieren (Admin/Eigentümer) {#filter}
