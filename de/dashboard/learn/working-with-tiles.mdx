...
related:
  ...
  - Verwenden Sie Dashboards, um Ihre Vertriebspipeline zu verwalten: /de/dashboard/learn/show-sales-targets
language: de
---
...
### Über selektionsbasierte Kacheln {#selection-chart}
...
## Eine Kachel duplizieren oder kopieren {#copy}
...
## Kacheln verschieben oder skalieren {#move}
