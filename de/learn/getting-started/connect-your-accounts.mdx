...
Nach dem Verbinden können Sie außerdem festlegen, ob neue E-Mails, die Sie erstellen, und E-Mail-Adressen, auf die Sie klicken, stattdessen in Ihrem eigenen lokalen E-Mail-Programm geöffnet werden statt im eigenen Dialog von SuperOffice. Aktivieren Sie dies unter [Persönliche Einstellungen > Einstellungen > E-Mail][2].
