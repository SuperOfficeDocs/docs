...
related:
  ...
  - Liste der Selektionsmitglieder filtern: /de/search-options/selection/learn/index#filter
language: de
---
...
<Frame caption="Lernen Sie in diesem kurzen Video, wie Sie durch die Konfiguration von Spalten Ansichten anpassen können oder lesen Sie die folgenden ">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/HYYI4ZCl4S4"
    title="Lernen Sie in diesem kurzen Video, wie Sie durch die Konfiguration von Spalten Ansichten anpassen können oder lesen Sie die folgenden "
    frameborder="0"
