...
keywords: ['Bereichsregisterkarte Aktivitäten', 'Bereichsregisterkarte', 'herunterladen']
...
related:
  - Einführung in Aktivitäten: /de/learn/basics/activity
  - Folgeaufgaben erstellen: /de/diary/learn/create-follow-up
  - E-Mails in der Bereichsregisterkarte Aktivitäten beantworten oder weiterleiten: /de/learn/section-tabs/send-email
  - Status der Fertigstellung einer Aktivität ändern: /de/diary/learn/change-completed-status
  - Aktivitäten in der Aktivitätenliste löschen: /de/learn/basics/activity
  - Aktivitäten filtern: /de/learn/section-tabs/filter
  - Spalten gruppieren und zusammenfassen: /de/learn/section-tabs/configure-columns#calculate
language: de
---
...
## Spaltenübersicht der Bereichsregisterkarte Aktivitäten {#columns}
...
* **E-Mail oder Dokument herunterladen:** Suchen Sie das Element, klicken Sie mit der rechten Maustaste darauf und wählen Sie **Herunterladen**, um eine Kopie auf Ihrem Gerät zu speichern. Nicht verfügbar, wenn mehrere Elemente ausgewählt sind.

    ![Kontextmenü in der Bereichsregisterkarte Aktivitäten für Person -screenshot][img3]
