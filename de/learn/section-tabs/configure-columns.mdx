...
related:
  - Gruppierte Listen: /de/learn/section-tabs/group
  - /de/learn/section-tabs/filter
...
<Frame caption="Durch die Konfiguration von Spalten können Sie die angezeigten Informationen anpassen und nach Ihrem Ermessen mit CRM-Daten arbeiten. Sehen Sie sich dieses Video an oder befolgen Sie die folgenden Schritte, um zu lernen, wie Sie Spalten konfigurieren">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/IjlPSN-u0MA"
    title="Durch die Konfiguration von Spalten können Sie die angezeigten Informationen anpassen und nach Ihrem Ermessen mit CRM-Daten arbeiten. Sehen Sie sich dieses Video an oder befolgen Sie die folgenden Schritte, um zu lernen, wie Sie Spalten konfigurieren"
    frameborder="0"
