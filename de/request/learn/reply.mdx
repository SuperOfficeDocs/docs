...
related:
  - Anfrage weiterleiten: /de/request/learn/forward
  - Anfrage schließen: /de/request/learn/close
  - Mitteilungen nachverfolgen: /de/request/learn/flag-message
  - Antwortvorlage erstellen: /de/knowledge-base/learn/reply-templates/index
  - /de/knowledge-base/learn/reply-templates/new-language
  - E-Mail-Signatur bearbeiten: /de/learn/getting-started/edit-email-signature
language: de
---
...
## Schnellantwort aus einer Vorschau {#quick-reply}

Beantworten Sie eine Anfrage direkt aus ihrer Vorschau, ohne sie vollständig zu öffnen.

1. Zeigen Sie eine Vorschau einer Anfrage aus einer Anfragenliste an.
1. Klicken Sie auf **Schnellantwort**.
1. Verfassen Sie Ihre Antwort im kompakten Editor.
1. Klicken Sie auf **Speichern**, um sie zu senden.

    ![Anfragenliste mit Vorschau zeigt Schnellantwort-Optionen -screenshot][img8]
...
<Tip>
Wenn Sie abbrechen oder eine andere Anfrage auswählen, während Ihre Schnellantwort noch ungesendeten Text enthält, werden Sie gefragt, bevor er verworfen wird.
</Tip>

**Schnellantwort** ist bei Anfragen, die als Spam markiert, gelöscht oder zusammengeführt wurden, nicht verfügbar.

## Antwortvorlagen einfügen {#reply-templ}
...
## Hinzufügen von FAQ-Einträgen {#faq}
...
## Frühere Nachricht einfügen {#insert-earlier-msg}
...
## Zeitaufwand nachverfolgen {#time-spent}
