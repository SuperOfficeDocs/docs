...
related:
  - Anfrage teilen: /de/request/learn/split-request
  - /de/request/learn/merge
  - /de/learn/section-tabs/requests-tab
  - Firmen- und Personenbeziehungen: /de/learn/basics/relations
  - Beziehungsregeln (Einstellungen und Verwaltung): /de/request/admin/relation-rules
language: de
---
...
## Anfragebeziehung hinzufügen {#add}
...
## Anfragebeziehung entfernen {#delete}
