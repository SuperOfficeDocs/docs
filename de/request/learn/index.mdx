---
uid: help-de-request
title: Anfragen und SuperOffice Service
...
related:
  ...
  - Anfrage übernehmen: /de/request/learn/accept
  - Antwort an Kunden senden: /de/request/learn/reply
  - Automatische Zuweisung von Anfragen: /de/request/learn/assign
  - 7 Tipps für einen erstklassigen Kundenservice mit SuperOffice Service - Blog: https://community.superoffice.com/en/learning/best-practices-tips/service/7-tips-to-provide-best-in-class-customer-service-with-superoffice-service/
language: de
---
...
Jede Kundenanfrage kann als Anfrage definiert werden. Diese reichen von Supportanfragen über Produkt- und Serviceanfragen bis hin zu Rechnungsanfragen. Ihr Ziel ist es, jede eingehende Anfrage so schnell, effizient und professionell wie möglich zu bearbeiten. Die Vorschau einer Anfrage aus einer Liste ermöglicht Ihnen außerdem, eine [Schnellantwort][28] zu senden, ohne die Liste zu verlassen, sodass Sie eine stark ausgelastete Warteschlange durcharbeiten können.

![Ansicht mit einer Liste nicht zugeordneter Anfragen und Vorschau -screenshot][img1]

## Wo finde ich Anfragen? {#open}
...
## Anfragenmanagement {#request-mgt}
...
## Ihr Verfügbarkeitsstatus {#available}
...
[1]: /de/request/learn/accept
[2]: /de/request/learn/reply
[3]: /de/request/learn/close
[4]: /de/request/learn/create
[5]: /de/request/learn/flag-message
[6]: /de/request/learn/assign
[7]: /de/request/learn/transfer
[8]: /de/request/learn/forward
[9]: /de/request/learn/edit-message
[10]: /de/request/learn/find
[11]: /de/request/learn/split-request
[12]: /de/search-options/learn/index
[16]: /de/request/learn/merge
[17]: /de/dashboard/learn/show-requests
[19]: /de/request/learn/split-message
[21]: /de/request/learn/request-relations
[22]: /de/request/learn/tags
[24]: /de/request/admin/priority/escalation-levels
[25]: /de/request/admin/category/index
[13]: /de/company/learn/index
[14]: /de/contact/learn/index
[15]: /de/learn/getting-started/edit-email-signature
[18]: /de/learn/basics/fav
[23]: /de/knowledge-base/learn/reply-templates/index
[26]: /de/admin/preferences/service-settings
[27]: /de/request/learn/spam
[28]: /de/request/learn/reply#quick-reply
