...
related:
  - Mehrere Datensätze aktualisieren (Massenaktualisierung): /de/learn/basics/bulk-update
  - Eine Selektion erstellen: /de/search-options/selection/learn/create
  - Bereichstab Anfragen: /de/learn/section-tabs/requests-tab
  - Anfragen finden: /de/request/learn/find
language: de
---
