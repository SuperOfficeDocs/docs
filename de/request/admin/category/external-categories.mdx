...
1. Gehen Sie zu Einstellungen und Verwaltung und wählen Sie <i class="ph ph-sliders-horizontal" aria-hidden="true"></i> **Optionen**.
...
1. Wählen Sie auf der Registerkarte **Kundensprachen** die Sprache aus, für die Sie Kategorien aktualisieren möchten.
1. Wählen Sie den gewünschten Kategorienamen unter **Externe Kategorien** aus.
1. Klicken Sie unten in der Ansicht **Externe Kategorie bearbeiten** auf die Schaltfläche **Löschen**.

    * Der Link zu der externen Kategorie von dieser Kundensprache wird gelöscht, jedoch nicht die Kategorie selbst.
