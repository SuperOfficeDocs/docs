...
userflow_index: true
related:
  - Kategorien erstellen: /de/request/admin/category/create
  - Kategorien löschen: /de/request/admin/category/delete
  - So richten Sie "Nächste Anfrage in der Warteschlange abrufen" ein: /de/request/admin/next-in-queue
  - Prioritäten: /de/request/admin/priority/index
language: de
---
...
[3]: /de/admin/lists/index
[6]: /de/request/learn/tags
