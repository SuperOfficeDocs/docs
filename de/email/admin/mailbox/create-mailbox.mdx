...
userflow_index: true
related:
  - Postfächer löschen: /de/email/admin/mailbox/delete-mailbox
  - E-Mail in Service und Marketing: /en/online/mail-services/curl/index
  - Postfach erstellen (vor Ort): https://help.superoffice.com/docs/11/de/email/admin/mailbox/create-mailbox.html
language: de
---
