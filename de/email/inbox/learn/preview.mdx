...
keywords: ['E-Mail öffnen', 'E-Mail anzeigen', 'Vorschau', 'E-Mail verschieben', 'als gelesen markieren', 'drucken', 'herunterladen', 'E-Mail', 'SuperOffice Inbox']
author: digitaldiina
date: 18.09.2026
so_version: 12.2
content_type: howto
...
related:
  - /de/email/inbox/learn/manage-senders
  - Einladungen empfangen: /de/email/inbox/learn/invitations
...
## E-Mails als gelesen oder ungelesen markieren {#mark-as-read}
...
## E-Mail in Ordner verschieben {#move}
...
## E-Mail herunterladen {#download}

Beim Herunterladen einer E-Mail wird eine Kopie der Nachricht, einschließlich eventueller Anhänge, in einem Format gespeichert, das Sie in Outlook oder einem anderen E-Mail-Programm öffnen können.

1. Wählen Sie eine Nachricht im Posteingang aus.
2. Klicken Sie auf <i class="ph ph-dots-three-circle-vertical" aria-label="Aufgabe"></i> und wählen Sie **Herunterladen**.

![Posteingang zeigt Aufgabenmenü mit dem Element Herunterladen -screenshot][img5]
