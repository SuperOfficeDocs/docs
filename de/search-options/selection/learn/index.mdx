...
related:
  ...
  - /de/search-options/selection/learn/create
  - Selektionen bearbeiten oder löschen: /de/search-options/selection/learn/update
  - /de/search-options/selection/learn/howto/index
  - Selektionen als Diagramme anzeigen: /de/search-options/selection/learn/howto/display-as-charts
language: de
---
...
## Registerkarten in der Ansicht Selektion {#tabs}
...
### Mitgliederliste filtern {#filter}
...
## Beispiele für die Verwendung von Selektionen {#ex}
...
[3]: /de/search-options/selection/learn/howto/display-as-charts
[6]: /de/search-options/selection/learn/howto/export
[8]: /de/search-options/selection/learn/howto/create-mailings
[4]: /de/search-options/selection/learn/combine
[7]: /de/search-options/selection/learn/add-remove-members-static
[9]: /de/search-options/learn/search-criteria
[10]: /de/learn/section-tabs/configure-columns#calculate
[12]: /de/learn/section-tabs/filter
[16]: /de/dashboard/learn/create
