...
1. <SelectField />
    ...
    . Klicken Sie zuerst auf **Verkauf** (<i class="ph ph-currency-circle-dollar" aria-hidden="true"></i>) und dann auf **Betrag**.
...
1. <SelectField />
    ...
    . Klicken Sie zuerst auf **Verkauf** und dann auf **Erfasstes Datum**.
...
1. <SelectField />
    ...
    : Klicken Sie zuerst auf **Firma** (<i class="ph ph-buildings" aria-hidden="true"></i>) und anschließend auf **Land**.
...
5. <SelectField />
    ...
    : Klicken Sie zuerst auf **Verkauf** und anschließend auf **Status**.
...
1. <SelectField />
    ...
    : Klicken Sie zuerst auf <i class="ph ph-user-circle" aria-hidden="true"></i> **Person** und anschließend auf **Nachname**.
...
1. <SelectField />
    ...
    : Klicken Sie zuerst auf <i class="ph ph-calendar-blank" aria-hidden="true"></i> **Folgeaufgabe** und anschließend auf **Zweck**.
...
1. <SelectField />
    ...
    . Klicken Sie zuerst auf **Folgeaufgabe** und anschließend auf **Enddatum**.
...
1. <SelectField />
    ...
    . Klicken Sie zuerst auf **Folgeaufgabe** und anschließend auf **Abgeschlossen**.
