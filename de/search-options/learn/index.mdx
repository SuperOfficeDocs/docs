...
## Schnellsuche verwenden {#fastsearcher}
...
* Sie können [in Dialogfeldern][8] mit den relevanten Feldern, wie z. B. den Dialogfeldern **Folgeaufgabe** und **Dokument**, nach Firmen, Personen, Verkäufen, Projekten und Selektionen suchen, um sie mit der Folgeaufgabe oder dem Dokument zu verknüpfen.
...
Verwenden Sie das Suchfeld für die [Volltextsuche][2] in der oberen rechten Ecke, um nach beliebigem Text zu suchen, den Benutzer in SuperOffice CRM eingegeben haben.
...
## Verwenden Sie typische Suchanfragen als Ausgangspunkt {#typical}
...
![Klicken Sie auf die Schaltfläche Suchen in der oberen Leiste und wählen Sie im Dropdown-Menü typische Suchanfragen aus -screenshot][img5]
...
## Suche erstellen und als Selektion speichern {#search-to-selection}
...
<Frame caption="Sehen Sie sich dieses Video an oder führen Sie die folgenden Schritte aus, um zu erfahren, wie Sie eine Suchanfrage erstellen und als dynamische Selektion speichern können">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/b1YsCcHwz-o"
    title="Sehen Sie sich dieses Video an oder führen Sie die folgenden Schritte aus, um zu erfahren, wie Sie eine Suchanfrage erstellen und als dynamische Selektion speichern können"
    frameborder="0"
...
[2]: /de/search-options/learn/freetext-search
[3]: /de/search-options/learn/in-navigator
[4]: /de/learn/basics/fav
[5]: /de/learn/basics/history
[6]: /de/search-options/learn/search-criteria
[7]: /de/search-options/selection/learn/create
[8]: /de/search-options/learn/in-dialogs
