...
related:
  - /de/custom-objects/admin/create-extra-table
  - /de/custom-objects/admin/create-extra-field
  - Benutzerdefinierte Felder: /de/custom-objects/admin/add-udef
  - Benutzerdefinierte Anziege: /de/ui/blogic/learn/index
  - Auslöser hinzufügen: /en/automation/trigger/create-trigger-script
language: de
---
...
<Tab title="Neu (ab Version 10.3.4 Pilot)">
