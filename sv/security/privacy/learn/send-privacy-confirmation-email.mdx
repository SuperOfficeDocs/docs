...
related:
  - Redigera bekräftelsen om personskydd i Inställningar och underhåll: /sv/security/privacy/admin/edit-privacy-confirmation-email
language: sv
---
...
<Frame caption="Den här videon visar hur du skapar ett grundläggande webbformulär och lägger till det på din webbsida">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/18m6Dx1t9wI"
    title="Den här videon visar hur du skapar ett grundläggande webbformulär och lägger till det på din webbsida"
    frameborder="0"
