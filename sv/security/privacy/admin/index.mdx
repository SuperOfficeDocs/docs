...
sidebarTitle: "Integritetsinställningar"
...
userflow_index: true
related:
  - Ladda ner vår mall "Förbered dig för GDPR": /downloads/prepare-for-the-gdpr-download-template-9.xlsx
  - Redigera e-postbekräftelsen om personskydd: /sv/security/privacy/admin/edit-privacy-confirmation-email
language: sv
---
