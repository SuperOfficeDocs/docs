...
keywords: ['redigera dokument', 'dokumentegenskaper', 'dokument', 'ladda ned']
author: digitaldiina
date: 18.09.2026
so_version: 12.2
content_type: howto
...
related:
  - Så ändrar du Slutförd-status för en aktivitet: /sv/diary/learn/change-completed-status
language: sv
---
...
### Webbläsarsäkerhetsfråga vid öppning av filer {#allow}
...
## Ladda ned ett dokument {#download}

När du laddar ned ett dokument sparas en kopia av dokumentfilen på din enhet.

1. Klicka på **Uppgift**-knappen (<i class="ph ph-dots-three-circle-vertical" aria-hidden="true"></i>) i **Dokument**-dialogen.
2. Välj **Ladda ned**.

![Ladda ned e-postmeddelandet eller dokumentet från Uppgift-knappen -screenshot][img6]

<Tip>
Du kan också ladda ned ett dokument direkt från [detaljkortet Aktiviteter][4] genom att högerklicka på det och välja **Ladda ned**.
</Tip>
