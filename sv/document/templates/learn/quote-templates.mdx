...
tier: starter
related:
  - Uppdatera offertmall: /sv/document/templates/admin/update-template
  - Handledning: /sv/document/templates/admin/update-template
  - Merge field-referens: /sv/document/templates/merge-fields/index
  - Mallvariabelreferens: /sv/document/templates/variables/for-quote-line
  - System.Globalization.CultureInfo: https://docs.microsoft.com/en-us/dotnet/api/system.globalization.cultureinfo?view=net-5.0
  - Aspose (hanterar dokumentgenerering): http://www.aspose.com
language: sv
---
...
## Typer av offertdokumentmallar {#types}
...
### Struktur av merge fields {#structure}
...
### Användning av merge fields {#usage}
...
### Formatering av numeriska och datumfält {#culture}
