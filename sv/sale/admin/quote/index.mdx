...
userflow_index: true
related:
  - Så här konfigurerar du en ERP-koppling: /sv/sale/admin/quote/set-up-quote-connector
  - Skapa prislistor och produkter: /sv/sale/admin/quote/price-list-and-products
  - Anpassa produktdialogen: /sv/sale/admin/quote/configure-product-fields
  - /sv/erp/admin/index
language: sv
---
...
## Flikar i skärmen Offert/Synk {#tabs}
...
[1]: /sv/sale/admin/quote/set-up-quote-connector
[2]: /sv/sale/admin/quote/price-list-and-products
[3]: /sv/sale/admin/quote/configure-product-fields
[4]: /sv/erp/admin/index
