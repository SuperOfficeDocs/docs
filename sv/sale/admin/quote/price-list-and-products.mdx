...
userflow_index: true
related:
  - Konfigurera fält i Lägg till/redigera produkt-dialogen: /sv/sale/admin/quote/configure-product-fields
  - /sv/admin/import/products-from-excel
  - Ställa in ERP-koppling: /sv/sale/admin/quote/set-up-quote-connector
language: sv
---
...
## Lägg till produkter i en prislista {#add-product}
...
## Lägg till eller ändra produktbild {#image}
...
## Inaktivera produkter eller prislistor {#deactivate}
