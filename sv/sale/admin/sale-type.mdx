...
userflow_index: true
related:
  - Lägg till en försäljningsfas: /sv/sale/admin/sale-stage
  - Skapa en säljguide: /sv/sale/admin/create-sales-guide
  - Redigera en säljguide: /sv/sale/admin/edit-sales-guide
...
## Offertfält förklarade {#quote-fields}
...
<Tab title="Fliken Standardvärden för offert">
...
## Återställ en borttagen försäljningstyp {#restore}
