...
## Skapa faser för säljguiden {#create-stages}
...
## Skapa en försäljningstyp för säljguiden {#create-type}
...
## Skapa en säljguide {#create-guide}
...
## Lägg till en händelse för en fas {#add-fo-stage}
...
## Lägg till ett dokument för en fas {#add-doc-stage}
