...
userflow_index: true
related:
  - Lägg till eller uppdatera försäljningstyper: /sv/sale/admin/sale-type
  - Skapa en säljguide: /sv/sale/admin/create-sales-guide
  - Redigera en säljguide: /sv/sale/admin/edit-sales-guide
  - Spåra försäljningsframsteg: /sv/sale/learn/sales-guides#change-stage
language: sv
---
