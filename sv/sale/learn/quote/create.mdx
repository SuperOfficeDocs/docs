...
related:
  - title: "Lägga till alternativ i en offert"
    href: "/sv/sale/learn/quote/add-alternative"
  - title: "Skapa ett offertdokument"
    href: "/sv/sale/learn/quote/create-quote-document"
  - title: "Skicka en offert"
    href: "/sv/sale/learn/quote/send"
  - title: "Skapa en order"
    href: "/sv/sale/learn/quote/place-order"
  - title: "Konfigurera dina produkter och priser i Inställningar och underhåll"
    href: "/sv/sale/admin/quote/price-list-and-products"
language: sv
---
...
## Kopiera en offert från en annan försäljning {#copy}
...
## Lägg till produkter i offerten {#add-products}
...
## Varför visas varningar eller fel? {#warning}
