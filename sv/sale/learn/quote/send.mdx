...
related:
  ...
  - Byt offertdokument: /sv/sale/learn/quote/create-quote-document#replace
  - Registrera en order: /sv/sale/learn/quote/place-order
  - Ställ in regler för offertgodkännande i Inställningar och underhåll: /sv/sale/admin/sale-type#quote-fields
language: sv
---
...
## Så här skickar du offerten {#send}
...
## Redigera en skickad offert {#versions}
