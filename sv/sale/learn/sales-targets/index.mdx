...
related:
  - Panel: /sv/dashboard/learn/index
  - Använda försäljningsmål i figurer: /sv/dashboard/learn/show-sales-targets
language: sv
---
...
Följande funktioner är endast tillgängliga med en **Sales Premium**-licens eller **Growth**-planen och **Sales Targets Unlimited**-tillägget, eller **Super**-planen:
...
[2]: /sv/dashboard/learn/show-sales-targets
