...
sidebarTitle: "Typ av försäljningsmål"
...
related:
  - Lägg till grupper och användare till ditt försäljningsmål: /sv/sale/learn/sales-targets/create
  - Använda försäljningsmål i dashboard-paneler: /sv/dashboard/learn/show-sales-targets
language: sv
---
...
<Note>
För att lägga till måltyper behöver du en **Sales Premium**-licens eller **Growth**-planen och **Sales Targets Unlimited**-tillägget, eller **Super**-planen.
</Note>
