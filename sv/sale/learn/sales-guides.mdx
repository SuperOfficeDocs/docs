...
related:
  - Introduktion till försäljning: /sv/sale/learn/index
  - Skapa en försäljning: /sv/sale/learn/create
  - Säljguide - handledning: /sv/sale/learn/tutorial
  - /sv/sale/admin/create-sales-guide
  - /sv/sale/admin/edit-sales-guide
language: sv
---
...
<Frame caption="Titta på den här videon för att se hur enkelt det är att arbeta med säljguider">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/IyETjAtn3po"
    title="Titta på den här videon för att se hur enkelt det är att arbeta med säljguider"
    frameborder="0"
...
## Detaljkortet Säljguide {#sales-guide-tab}
...
## Flytta till nästa fas {#change-stage}
