...
userflow_index: true
related:
  - Lägg till en Sync Connector och definiera en ERP-koppling: /sv/erp/admin/add-connection
  - Redigera en ERP-koppling: /sv/erp/admin/update-connection
  - Konfigurera fältkoppling och standardvärden: /sv/erp/admin/configure
  - Ange synkprioritet: /sv/erp/admin/configure#priority
