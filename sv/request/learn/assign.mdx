...
title: Automatiska tilldelningsmetoder för ärenden
sidebarTitle: "Automatisk tilldelning"
...
related:
  - Behandla ett ärende: /sv/request/learn/index
  - /sv/request/learn/create
  - Acceptera ett ärende: /sv/request/learn/accept
  - Be en annan ärendehandläggare om hjälp (överför): /sv/request/learn/transfer
  - /sv/request/admin/next-in-queue
  - Tillgänglighetsstatus: /sv/request/learn/index#available
language: sv
---
