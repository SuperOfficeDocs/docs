...
related:
  - Dela ärende: /sv/request/learn/split-request
  - Slå samman ärenden: /sv/request/learn/merge
  - Detaljkort för Ärenden: /sv/learn/section-tabs/requests-tab
  - Företags- och personrelationer: /sv/learn/basics/relations
  - Regler för relation (Inställningar och underhåll): /sv/request/admin/relation-rules
language: sv
---
