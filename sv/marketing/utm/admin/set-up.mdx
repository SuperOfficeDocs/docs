...
## 1. Aktivera överföring av UTM-data {#enable}
...
## 2. Lägg till UTM-spårningsskriptet på din webbplats {#script}
...
## 3. Skapa kampanjslänkar med UTM-parametrar {#build-url}
...
## 4. Använd länken i kampanjer {#tag}
...
## 5. Publicera formuläret korrekt {#publish}
...
## 6. Testa och verifiera inställningen {#test}
...
## 7. Analysera och visualisera resultat {#analyze}
