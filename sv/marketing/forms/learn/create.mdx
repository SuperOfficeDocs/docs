...
8. Du kan också redigera dessa inställningar (valfritt):
    ...
    * Om fälttypen stöder det kan du klicka på **Lägg till relaterat fält** på ett av dess alternativ eller värden för att lägga till ett villkorat fält. Se [Lägg till ett villkorat fält](#conditional) nedan.
...
### Lägg till ett villkorat fält {#conditional}

Visa bara besökarna de frågor som är relevanta för dem. Ett **villkorat fält** (även kallat ett relaterat fält) visar en följdfråga bara när ett tidigare svar gör den relevant, så att varje besökare bara ser det som är viktigt för dem, samtidigt som formuläret ändå samlar in de uppgifter som behövs från alla andra. Fältet **Contact - Country** kan till exempel visa fältet **Contact - Preferred language** bara när ett visst land har valts.
...
![Fält som stöder villkorade fält får märket Villkorad i fönstret Lägg till post -screenshot][img18]
