...
* **Villkorliga (relaterade) fält:** Alternativknappar, kryssrutor, listrutor och bedömningsfält kan [utlösa ett relaterat fält][6] som bara visas när ett visst alternativ eller värde har valts.
