...
related:
  - Lägg till eller uppdatera projekttyper: /sv/project/admin/project-type
  - Skapa en projektguide: /sv/project/admin/create-project-guide
  - Redigera en projektguide: /sv/project/admin/edit-project-guide
  - Flytta ett projekt till nästa status: /sv/project/learn/project-guides#change-status
language: sv
---
