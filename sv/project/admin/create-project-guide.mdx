...
related:
  - Redigera en projektguide: /sv/project/admin/edit-project-guide
language: sv
---
...
## Skapa statusar för projektguiden {#create-stage}
...
## Skapa en projekttyp för projektguiden {#create-type}
...
## Skapa en projektguide {#create-guide}
...
## Lägg till en händelse för en status {#add-fo-status}
...
## Lägg till ett dokument för en status {#add-doc-status}
