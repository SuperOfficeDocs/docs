...
related:
  - Introduktion till projekt: /sv/project/learn/index
  - /sv/project/learn/create
  - Redigera eller inaktivera en projektguide: /sv/project/learn/edit
language: sv
---
...
## Detaljkortet Projektguide {#project-guide-tab}
...
## Flytta till nästa status {#change-status}
