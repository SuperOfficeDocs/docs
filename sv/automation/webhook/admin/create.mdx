...
related:
  - title: "Webhooks-panel"
    href: "/sv/automation/webhook/admin/index"
  - title: "Registrera en webhook via API:et"
    href: "/en/automation/webhook/dev/register"
  - title: "Skapa ett CRMScript"
    href: "/sv/customization/macros-and-scripts/admin/create-script"
language: sv
---
