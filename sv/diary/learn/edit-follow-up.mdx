...
related:
  ...
  - Stoppa återkommande händelser: /sv/diary/learn/recurrence/stop
  - Lägg till länk till dokument, försäljning, projekt eller webbplats: /sv/learn/basics/links
language: sv
---
...
## Ändra sluttid för en händelse i Kalendern {#change-end}
...
## Redigera återkommande händelse {#repeat}
...
## Ta bort händelse i Kalendern {#delete}
