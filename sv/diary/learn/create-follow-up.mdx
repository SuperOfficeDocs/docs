...
related:
  - /sv/diary/learn/follow-ups
  - /sv/learn/basics/activity
  - Skapa ett videomöte från SuperOffice-kalendern: /sv/diary/learn/video-meetings
language: sv
---
...
## Skapa möte för en medarbetare {#associate}
...
## Kopiera en händelse till kalendern {#copy}
