...
related:
  - Läs mer om fliken Översikt: /sv/diary/learn/index#tabs
  - Skapa händelser för en annan medarbetare: /sv/diary/learn/create-follow-up#associate
language: sv
---
...
### Varför är Redigera-knappen grå? {#troubleshoot}
