...
userflow_index: true
related:
  - Ta bort brevlådor: /sv/email/admin/mailbox/delete-mailbox
  - E-post i Service och Marketing: /en/online/mail-services/curl/index
  - Skapa brevlåda (lokalt): https://help.superoffice.com/docs/11/sv/email/admin/mailbox/create-mailbox.html
language: sv
---
