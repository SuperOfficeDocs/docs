...
userflow_index: true
related:
  - Skapa e-postlådor: /sv/email/admin/mailbox/create-mailbox
  - Ta bort e-postlådor: /sv/email/admin/mailbox/delete-mailbox
  - /sv/email/admin/mailbox/create-email-filter
language: sv
---
...
### Blockerad e-post {#email-blocked}
