...
keywords: ['öppna e-post', 'visa e-post', 'förhandsgranska', 'flytta e-post', 'markera som läst', 'skriv ut', 'ladda ned', 'e-post', 'SuperOffice Inkorg', 'inkorg']
author: digitaldiina
date: 18.09.2026
so_version: 12.2
content_type: howto
...
related:
  ...
  - Ta emot inbjudningar: /sv/email/inbox/learn/invitations
...
## Markera e-post som läst eller oläst {#mark-as-read}
...
## Flytta e-post till en mapp {#move}
...
## Skriv ut ett e-postmeddelande {#print}
...
## Ladda ned ett e-postmeddelande {#download}

När du laddar ned ett e-postmeddelande sparas en kopia av meddelandet, inklusive eventuella bilagor, i ett format du kan öppna från Outlook eller en annan e-postklient.

1. Markera ett meddelande i inkorgen.
1. Klicka på <i class="ph ph-dots-three-circle-vertical" aria-label="Task menu"></i> och välj **Ladda ned**.

![Inkorgen visar Task-menyn med alternativet Ladda ned -screenshot][img5]
