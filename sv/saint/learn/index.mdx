...
related:
  - Konfigurera SAINT: /sv/saint/admin/index
  - Hur SAINT lagrar räknare och statusar: /sv/saint/admin/index#database
  - Använda statusövervakning i dynamiska urval: /sv/search-options/selection/learn/create
language: sv
---
...
### Dialogrutan Visa status {#dialog}
...
[1]: /sv/diary/learn/create-follow-up
