...
## Lägg till kriterier till en status {#criteria}
...
## Ta bort en statusövervakning {#delete}
...
## Återställ en borttagen statusövervakning {#restore}
...
## Regenerera statusar och räknare \<i class="ph ph-arrow-circle-right" aria-hidden="true"\>\</i\> {#regen}
