...
userflow_index: true
related:
  - Uppdatera, ta bort och återställ statusövervakning: /sv/saint/admin/update
  - Räknare och räknarinställningar (period): /sv/saint/admin/counter-settings
  - Regenerera statusövervakning och räknare: /sv/saint/admin/update#regen
language: sv
---
