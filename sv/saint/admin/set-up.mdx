...
userflow_index: true
related:
  - title: "Uppdatera, ta bort och återställ statusövervakning"
    href: "/sv/saint/admin/update"
  - title: "Räknare och räknarinställningar (period)"
    href: "/sv/saint/admin/counter-settings"
  - title: "Regenerera statusövervakning och räknare"
    href: "/sv/saint/admin/update#regen"
language: sv
---
...
## Välja en bild för en status {#image}
