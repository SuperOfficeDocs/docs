...
userflow_index: true
related:
  - Ställ in en ny statusövervakning: /sv/saint/admin/set-up
  - Visualisera statusar med bilder: /sv/saint/admin/set-up#image
  - /sv/saint/admin/counter-settings
  - Uppdatera, ta bort och återställa statusövervakningar: /sv/saint/admin/update
  - Regenerera statusövervakningar och räknare: /sv/saint/admin/update#regen
language: sv
---
...
## Hur SAINT lagrar räknare och statusar {#database}
...
[5]: /sv/saint/admin/counter-settings
[8]: /sv/saint/admin/update#regen
