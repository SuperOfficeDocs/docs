...
redirect_from: /sv/ai/configuration-ai/getting-started
userflow_index: true
related:
  - Hur du skapar ett urval: /sv/search-options/selection/learn/create
  - Ärendekategorisering: /sv/ai/learn/categorization
