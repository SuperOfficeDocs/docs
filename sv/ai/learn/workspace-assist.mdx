...
Workspace Assist vet ingenting om dina kunddata och kommer att ge dig svar med hjälp av en stor språkmodell (LLM) som Bing från Microsoft eller ChatGPT från OpenAI.
