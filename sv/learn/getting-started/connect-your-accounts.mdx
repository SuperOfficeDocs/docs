...
När du är ansluten kan du också välja om nya e-postmeddelanden du skapar, och e-postadresser du klickar på, i stället ska öppnas i ditt eget lokala e-postprogram, i stället för i SuperOffice egen dialogruta. Aktivera detta under [Personliga inställningar > Inställningar > E-post][2].
