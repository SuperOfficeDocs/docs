...
related:
  - Ta bort poster i SuperOffice CRM: /sv/learn/basics/deleting-elements
  - Gruppera informationen i detaljkort: /sv/learn/section-tabs/index
  - Lägga till poster i listan Allmänt - Relation: /sv/admin/lists/specialized-lists#relation
  - Anpassade fält i relationer: /sv/custom-objects/learn/extra-field#relation
language: sv
---
