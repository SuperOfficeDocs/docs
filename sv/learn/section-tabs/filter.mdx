...
related:
  ...
  - Filtrera listan över urvalsmedlemmar: /sv/search-options/selection/learn/index#filter
language: sv
---
...
<Frame caption="Lär dig hur du anpassar vyer genom att konfigurera kolumner med den här korta videon, eller läs instruktionerna nedan">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/HYYI4ZCl4S4"
    title="Lär dig hur du anpassar vyer genom att konfigurera kolumner med den här korta videon, eller läs instruktionerna nedan"
    frameborder="0"
