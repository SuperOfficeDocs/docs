...
keywords: ['Aktivitetsfliken', 'fliken Aktiviteter', 'detaljkortet Aktiviteter', 'detaljkort', 'aktivitetsarkiv', 'aktivitet', 'ladda ned']
...
related:
  - Introduktion till aktiviteter: /sv/learn/basics/activity
  - Skapa händelser: /sv/diary/learn/create-follow-up
  - Svara på eller vidarebefordra e-post från Aktivitetsfliken: /sv/learn/section-tabs/send-email
  - Ändra Slutförd-status för en aktivitet: /sv/diary/learn/change-completed-status
  - Ta bort aktiviteter i aktivitetslistan: /sv/learn/basics/activity
  - Filtrera aktiviteter: /sv/learn/section-tabs/filter
  - Gruppera kolumner och sammanfatta: /sv/learn/section-tabs/configure-columns#calculate
language: sv
---
...
## Kolumnöversikt i Aktivitetsfliken {#columns}
...
* **Ladda ned ett e-postmeddelande eller dokument:** Leta upp objektet, högerklicka och välj **Ladda ned** för att spara en kopia på din enhet. Inte tillgängligt när flera objekt är markerade.

    ![Snabbmeny i detaljkortet Aktiviteter för Kontakt -screenshot][img3]
