...
related:
  - Hur man lägger till en försäljning: /sv/sale/learn/create
  - Hantera intressenter i försäljning: /sv/sale/learn/stakeholders/index
  - Filtrera aktiviteter och försäljningar: /sv/learn/section-tabs/filter
  - Gruppera kolumner och sammanfatta belopp: /sv/learn/section-tabs/configure-columns#calculate
language: sv
---
...
## Kolumner i Försäljning-detaljkortet {#columns}
