...
related:
  - Lista över grupper: /sv/learn/section-tabs/group
  - /sv/learn/section-tabs/filter
...
<Frame caption="Genom att konfigurera kolumner kan du anpassa visad information och arbeta med CRM-data på det sätt du behöver. Lär dig hur du konfigurerar kolumner med den här videon eller följ stegen nedan">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/IjlPSN-u0MA"
    title="Genom att konfigurera kolumner kan du anpassa visad information och arbeta med CRM-data på det sätt du behöver. Lär dig hur du konfigurerar kolumner med den här videon eller följ stegen nedan"
    frameborder="0"
