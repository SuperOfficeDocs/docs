...
related:
  ...
  - Redigera eller skapa paneler: /sv/dashboard/learn/working-with-tiles
  - Paneler med leads och UTM-data: /sv/dashboard/learn/show-leads
  - Konfigurera försäljningsmål: /sv/sale/learn/sales-targets/create
  - Prognostisera din försäljning: /sv/sale/learn/forecasting
language: sv
---
