...
related:
  - title: "Redigera eller ta bort en dashboard"
    href: "/sv/dashboard/learn/update"
  - title: "Redigera dashboard-paneler"
    href: "/sv/dashboard/learn/working-with-tiles"
  - title: "Skapa ett urval"
    href: "/sv/search-options/selection/learn/create"
language: sv
---
...
<Frame caption="Titta på den här videon eller följ stegen nedan för att lära dig hur du skapar dashboards i SuperOffice CRM">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/W68M1IOke0Y"
    title="Titta på den här videon eller följ stegen nedan för att lära dig hur du skapar dashboards i SuperOffice CRM"
    frameborder="0"
...
## Dela eller fäst en dashboard {#pin}
