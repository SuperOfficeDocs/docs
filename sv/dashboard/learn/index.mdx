...
related:
  - Skapa ett nytt dashboard eller duplicera ett befintlig: /sv/dashboard/learn/create
  - Redigera ett dashboard: /sv/dashboard/learn/update
  - Överför ett dashboard till en medarbetare: /sv/dashboard/learn/update#owner
  - Redigera paneler: /sv/dashboard/learn/working-with-tiles
language: sv
---
...
### Konfigurera snabbfilter (admin/ägare) {#filter}
