...
related:
  ...
  - Använd dashboards för att hantera din säljpipeline: /sv/dashboard/learn/show-sales-targets
language: sv
---
...
### Om paneler baserade på urval {#selection-chart}
...
## Duplicera eller kopiera en panel {#copy}
...
## Ordna om eller ändra storlek på paneler {#move}
