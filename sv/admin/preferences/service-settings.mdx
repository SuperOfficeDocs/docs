...
title: Globala inställningar för Systeminställningar för SuperOffice Service
sidebarTitle: "Service-inställningar"
...
userflow_index: true
related:
  - Service-inställningar (lokalt): https://help.superoffice.com/docs/11/sv/admin/preferences/service-settings.html
language: sv
---
