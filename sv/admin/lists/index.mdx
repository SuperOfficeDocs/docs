...
related:
  - Speciallistor: /sv/admin/lists/specialized-lists
  - Lägga till användardefinierade listor: /sv/admin/lists/user-defined-lists
  - Lägga till en post: /sv/admin/lists/add-items
  - Redigera eller bort en post: /sv/admin/lists/update-items
language: sv
---
...
[1]: /sv/admin/lists/headings
[5]: /sv/admin/lists/user-defined-lists
[7]: /sv/admin/lists/user-group-filtering
[9]: /sv/admin/lists/restore
[10]: /sv/custom-objects/admin/edit-udef-layout
