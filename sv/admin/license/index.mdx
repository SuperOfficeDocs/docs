...
userflow_index: true
related:
  - SuperOffice användarplaner och abonnemang: /sv/admin/license/user-plans
  - Köp och aktivera licenser: /sv/admin/license/activate
  - Licenser i tidigare versioner av SuperOffice: https://help.superoffice.com/Documentation/Help/EN/CRM/WebHelpAdmin/index.htm#t=chap03%2FCRM_and_licences.htm
  - Systemhändelser: https://help.superoffice.com/docs/11/sv/admin/onsite/add-system-event.html
  - Modullicenser: /en/admin/license/dev/module-licenses
  - Dolda licenser: /en/admin/license/dev/hidden-licenses
  - Teknisk licensöversikt: /en/admin/license/dev/index
language: sv
---
...
<Tabs>
<Tab title="Modulbaserade prenumerationer">
...
[16]: /sv/admin/license/crm-suite
[1]: /sv/admin/license/activate
[2]: /sv/saint/learn/index
