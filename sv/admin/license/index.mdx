...
userflow_index: true
related:
  - title: "SuperOffice användarplaner och abonnemang"
    href: "/sv/admin/license/user-plans"
  - title: "Köp och aktivera licenser"
    href: "/sv/admin/license/activate"
  - title: "Licenser i tidigare versioner av SuperOffice"
  ...
  - title: "Systemhändelser"
    href: "https://help.superoffice.com/docs/11/sv/admin/onsite/add-system-event.html"
  - title: "Modullicenser"
    href: "/en/admin/license/dev/module-licenses"
  - title: "Dolda licenser"
    href: "/en/admin/license/dev/hidden-licenses"
  - title: "Teknisk licensöversikt"
