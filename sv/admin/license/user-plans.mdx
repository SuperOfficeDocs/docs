...
title: SuperOffice användarplaner och prenumerationer
sidebarTitle: "Användarplaner"
...
userflow_index: true
related:
  - Hur användarplaner är konstruerade: /en/admin/license/dev/user-plans
  - Lägg till ny användare: /sv/admin/user-management/add-associate
  - Rollöversikt: /sv/admin/user-management/role/index
language: sv
---
...
## Ändra användarplaner för aktiva användare {#change}
