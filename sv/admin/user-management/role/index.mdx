...
userflow_index: true
related:
  - /sv/admin/user-management/role/create-role
  - Redigera eller ta bort en roll: /sv/admin/user-management/role/update-role
  - /sv/admin/user-management/role/set-data-rights-for-role
language: sv
---
...
Genom att använda rollbaserad säkerhet i SuperOffice CRM kan du anpassa roller för olika åtkomstnivåer i företaget. Rollerna styr vilka behörigheter olika användare har i SuperOffice CRM.
...
[3]: /sv/admin/user-management/role/set-data-rights-for-role
[6]: /sv/admin/user-management/role/functional-rights
