...
title: Ange behörighet för roll
...
userflow_index: true
related:
  - Databehörigheter: /sv/admin/user-management/role/functional-rights
  - Onsite-databehörigheter: https://help.superoffice.com/docs/11/sv/admin/user-management/role/set-data-rights-for-role.html
language: sv
---
