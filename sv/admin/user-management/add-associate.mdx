...
userflow_index: true
related:
  - Redigera användare/medarbetare: /sv/admin/user-management/update-user
  - Onsite-användarhantering: https://help.superoffice.com/docs/11/sv/admin/user-management/add-associate.html
language: sv
---
...
<Frame caption="(Den här videon visar en tidigare version av SuperOffice, så designen kan se annorlunda ut. Stegen är desamma.)">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/oLlfTrCAqCU"
    title="(Den här videon visar en tidigare version av SuperOffice, så designen kan se annorlunda ut. Stegen är desamma.)"
    frameborder="0"
