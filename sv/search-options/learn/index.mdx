...
related:
  ...
  - /sv/learn/basics/history
  - Skapa en sökning och spara den som ett urval: /sv/search-options/selection/learn/create
  - Bredda din sökning med funktionen ELLER: /sv/search-options/learn/find-screen
language: sv
---
...
## Använda snabbsökning {#fastsearcher}
...
## Använd vanliga sökningar som utgångspunkt {#typical}
...
## Skapa en sökning och spara den som ett urval {#search-to-selection}
...
<Frame caption="Titta på den här videon eller följ stegen nedan om du vill lära dig hur du skapar en sökning och sparar den som ett dynamiskt urval">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/b1YsCcHwz-o"
    title="Titta på den här videon eller följ stegen nedan om du vill lära dig hur du skapar en sökning och sparar den som ett dynamiskt urval"
    frameborder="0"
...
[2]: /sv/search-options/learn/freetext-search
[3]: /sv/search-options/learn/in-navigator
[6]: /sv/search-options/learn/search-criteria
[8]: /sv/search-options/learn/in-dialogs
