...
## Bredda din sökning med funktionen ELLER {#or}
...
<Frame caption="Titta på den här videon om du vill lära dig hur du skapar en sökning med funktionen ELLER">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/Z-fSLJSdp2k"
    title="Titta på den här videon om du vill lära dig hur du skapar en sökning med funktionen ELLER"
    frameborder="0"
...
## Arbeta med sökresultat {#results}
...
## Exempel 1: söka efter lönsamma kunder {#ex1}
...
1. <SelectField />. Klicka först på **Försäljning** (<i class="ph ph-currency-circle-dollar" aria-hidden="true"></i>) och sedan **Belopp**.
...
1. <SelectField />. Klicka först på **Försäljning**, och sedan **Registreringsdatum**.
...
## Exempel 2: söka efter kunder i Danmark som du har ansvaret för {#ex2}
...
1. <SelectField />: Klicka först på **Företag** (<i class="ph ph-buildings" aria-hidden="true"></i>) och sedan **Land**.
...
## Exempel 3: söka efter sålda försäljningar {#ex3}
...
1. <SelectField />: Klicka först på **Försäljning** och sedan **Status**.
...
## Exempel 4: söka efter projekt du har deltagit i under det senaste året {#ex4}
...
1. <SelectField />: Klicka först på <i class="ph ph-user-circle" aria-hidden="true"></i> **Kontakt** och sedan **Efternamn**.
...
1. <SelectField />: Klicka först på <i class="ph ph-clipboard-text" aria-hidden="true"></i> **Projekt** och sedan **Från-datum**.
...
## Exempel 5: söka efter genomförda marknadsföringsåtgärder {#ex5}
...
1. <SelectField />: Klicka först på <i class="ph ph-calendar-blank" aria-hidden="true"></i> **Händelse** och sedan **Syfte**.
...
1. <SelectField />. Klicka först på **Händelse**, och sedan **Slutdatum**.
