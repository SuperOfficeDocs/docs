...
1. <SelectField />
    ...
    . Klicka först på **Försäljning** (<i class="ph ph-currency-circle-dollar" aria-hidden="true"></i>) och sedan **Belopp**.
...
1. <SelectField />
    ...
    . Klicka först på **Försäljning**, och sedan **Registreringsdatum**.
...
1. <SelectField />
    ...
    : Klicka först på **Företag** (<i class="ph ph-buildings" aria-hidden="true"></i>) och sedan **Land**.
...
1. <SelectField />
    ...
    : Klicka först på **Försäljning** och sedan **Status**.
...
1. <SelectField />
    ...
    : Klicka först på <i class="ph ph-user-circle" aria-hidden="true"></i> **Kontakt** och sedan **Efternamn**.
...
1. <SelectField />
    ...
    : Klicka först på <i class="ph ph-clipboard-text" aria-hidden="true"></i> **Projekt** och sedan **Från-datum**.
...
1. <SelectField />
    ...
    : Klicka först på <i class="ph ph-calendar-blank" aria-hidden="true"></i> **Händelse** och sedan **Syfte**.
...
1. <SelectField />
    ...
    . Klicka först på **Händelse**, och sedan **Slutdatum**.
