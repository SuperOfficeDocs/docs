...
related:
  - Lägg till en post som favorit: /sv/learn/basics/fav
  - /sv/search-options/selection/learn/create
  - Redigera och ta bort urval: /sv/search-options/selection/learn/update
  - /sv/search-options/selection/learn/howto/index
  - Visa urval som diagram: /sv/search-options/selection/learn/howto/display-as-charts
language: sv
---
...
### Filtrera listan med medlemmar {#filter}
...
## Exempel på hur du kan använda urval {#ex}
...
[3]: /sv/search-options/selection/learn/howto/display-as-charts
[6]: /sv/search-options/selection/learn/howto/export
[8]: /sv/search-options/selection/learn/howto/create-mailings
[4]: /sv/search-options/selection/learn/combine
[7]: /sv/search-options/selection/learn/add-remove-members-static
[9]: /sv/search-options/learn/search-criteria
[10]: /sv/learn/section-tabs/configure-columns#calculate
[12]: /sv/learn/section-tabs/filter
[16]: /sv/dashboard/learn/create
