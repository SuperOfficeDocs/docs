...
related:
  - /sv/search-options/selection/learn/copy-members-to
  - Utföra uppgifter för urval: /sv/learn/getting-started/index
language: sv
---
...
## Ta bort medlemmar med hjälp av sökkriterier {#remove}
