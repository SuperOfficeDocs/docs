...
keywords: ['skapa företag', 'företag', 'skapa företagskort', 'lägg till intressen', 'Company Insight']
...
## Viktiga fält förklarade {#fields}
...
När du anger ett namn i fältet **Företagsnamn** visar **Company Insight** matchande företag från officiella företagsregister, till exempel Brreg (Norge), som standard kontrollerat mot ditt eget lands register.

Välj en matchning för att förhandsgranska uppgifterna, till exempel adress, telefonnummer och webbsida. Klicka på **Spara** för att lägga till företaget med dessa uppgifter, eller **Avbryt** för att fortsätta ange uppgifterna manuellt.

Detta hjälper dig att undvika manuell kopiering och inklistring, och minskar risken för att registrera fel företag eller skapa en dubblett.

<Note>
Company Insight kräver [CRM Suite Growth][13] eller högre.
</Note>

![Välja ett företag från Company Insights föreslagna matchningar -screenshot][img3]

## Lägg till intressen {#interests-tab}
