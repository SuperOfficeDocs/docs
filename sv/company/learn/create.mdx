...
När du anger ett namn i fältet **Företagsnamn** visar **Company Insight** matchande företag från officiella företagsregister, till exempel Brreg (Norge), Virk (Danmark), Companies House (Storbritannien) och Zefix (Schweiz), som standard kontrollerat mot ditt eget lands register.
...
<Note>
Company Insight kräver CRM Suite Growth eller högre.
</Note>
