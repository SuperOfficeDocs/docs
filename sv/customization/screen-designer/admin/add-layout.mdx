...
userflow_index: true
related:
  - Hur konfigurerar jag vilken information användarna i vårt företag kan komma åt i SuperOffice CRM?: /sv/admin/user-management/role/index
  - Hur skapar jag en ny användargrupp i SuperOffice CRM?: /sv/admin/user-management/user-groups
  - Ta bort layout: /sv/customization/screen-designer/admin/edit-layout#delete
language: sv
---
