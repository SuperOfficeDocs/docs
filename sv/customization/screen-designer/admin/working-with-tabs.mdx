...
import ScreenDesignerDanger from "../../../../snippets/udef-screen-designer-warning/sv-screen-designer-udef.mdx";
...
## Lägg till rubrik eller avdelare {#label}
...
## Gruppera fält i kolumner {#columns}
