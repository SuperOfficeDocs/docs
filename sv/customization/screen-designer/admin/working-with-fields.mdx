...
userflow_index: true
related:
  - Ändra antalet kolumner i en flik: /sv/customization/screen-designer/admin/working-with-tabs#columns
  - Lägga till etiketter och avdelare: /sv/customization/screen-designer/admin/working-with-tabs#label
  - Lägga till länkar och knappar: /sv/customization/screen-designer/admin/add-button
language: sv
---
...
## Redigera fältinställningar {#settings}
