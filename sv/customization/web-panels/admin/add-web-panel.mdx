...
userflow_index: true
related:
  - Lägg till en post på uppgiftsmenyn: /sv/customization/admin/add-items-to-task-menu
  - Basprogram och URL-parametrar: /en/ui/blogic/url-parameters
language: sv
---
...
### Använda HTTP vs HTTPS-webbadresser {#https}
