...
userflow_index: true
related:
  - Om CRMScript: /en/automation/crmscript/index
  - Felsök skript: /en/automation/crmscript/debugging/built-in-debugger
  - Spåra skript: /en/automation/crmscript/debugging/using-trace
language: sv
---
...
## Egenskaper för makro- eller skriptmapp {#folder}
