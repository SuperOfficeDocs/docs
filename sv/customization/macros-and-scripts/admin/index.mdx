...
redirect_from:
  ...
  - /sv/automation/crmscript/learn/screen/index
  - /sv/automation/crmscript/learn/index
userflow_index: true
related:
  - Skapa skript: /sv/customization/macros-and-scripts/admin/create-script
  - Skapa makro: /sv/customization/macros-and-scripts/admin/create-macro
  - Skapa mapp: /sv/customization/macros-and-scripts/admin/create-script#folder
  - Lär dig CRMScript-språket: /en/automation/crmscript/overview/index
  - API-referens i CRMScript: /en/automation/crmscript/reference/index
language: sv
---
...
[2]: /sv/customization/macros-and-scripts/admin/trigger
[3]: /sv/customization/macros-and-scripts/admin/schedule-task
[4]: /en/automation/crmscript/debugging/built-in-debugger
[5]: /en/automation/crmscript/debugging/using-trace
[8]: /sv/customization/macros-and-scripts/admin/create-script
