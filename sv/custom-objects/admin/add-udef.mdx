...
userflow_index: true
related:
  - Placera fält: /sv/custom-objects/admin/edit-udef-layout
  - Redigera fält: /sv/custom-objects/admin/edit-udef
  - /sv/customization/screen-designer/admin/index
language: sv
---
...
import UdefDanger from "../../../snippets/udef-screen-designer-warning/sv-udef-screen-designer.mdx";
