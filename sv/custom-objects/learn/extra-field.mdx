...
related:
  - Visa extrafält på detaljfanen: /sv/custom-objects/admin/show-extra-field-on-request-details
  - Skapa extrafält: /sv/custom-objects/admin/create-extra-field
language: sv
---
...
### Relationer (förnyckel, FK) {#relation}
