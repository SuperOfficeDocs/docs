...
related:
  - Lägg till extratabeller: /sv/custom-objects/admin/create-extra-table
  - /sv/custom-objects/admin/create-extra-field
  - Användardefinierade fält: /sv/custom-objects/admin/add-udef
  - Anpassade skärmar: /sv/ui/blogic/learn/index
  - Lägg till utlösare: /en/automation/trigger/create-trigger-script
language: sv
---
...
<Tab title="Ny (från version 10.3.4 pilot)">
