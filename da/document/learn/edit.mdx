...
related:
  - /da/diary/learn/change-completed-status
language: da
---
...
<Tabs>
<Tab title="Med SuperOffice Web Tools">
...
<Tab title="Uden SuperOffice Web Tools">
<Note>
...
### Browser sikkerhedsspørgsmål ved åbning af filer {#allow}
...
## Download af et dokument {#download}

Når du downloader et dokument, gemmes en kopi af dokumentfilen på din enhed.

1. Klik på **Opgave**-knappen (<i class="ph ph-dots-three-circle-vertical" aria-hidden="true"></i>) i **Dokument**-dialogen.
2. Vælg **Download**.

![Download e-mailen eller dokumentet fra Opgave-knappen -screenshot][img6]

<Tip>
Du kan også downloade et dokument direkte fra [detaljekortet Aktiviteter][4] ved at højreklikke på det og vælge **Download**.
</Tip>
