...
tier: starter
related:
  - Opdater tilbudsskabelon: /da/document/templates/admin/update-template
  - Tutorial: /da/document/templates/admin/update-template
  - /da/document/templates/merge-fields/index
  - Skabelonvariabelreference: /da/document/templates/variables/for-quote-line
  - System.Globalization.CultureInfo: https://docs.microsoft.com/en-us/dotnet/api/system.globalization.cultureinfo?view=net-5.0
  - Aspose (håndterer dokumentgenerering): http://www.aspose.com
language: da
---
...
## Typer af tilbudsskabeloner {#types}
...
### Struktur af fletfelter {#structure}
...
### Formatering af numeriske og dato data {#culture}
