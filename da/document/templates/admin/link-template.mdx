...
userflow_index: true
related:
  - Erstat nuværende skabelon: /da/document/templates/admin/update-template
language: da
---
...
<Frame caption="Se denne video, eller følg nedenstående trin for at lære, hvordan du kan tilføje en dokumentskabelon">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/FnhcmjP-TgE"
    title="Se denne video, eller følg nedenstående trin for at lære, hvordan du kan tilføje en dokumentskabelon"
    frameborder="0"
