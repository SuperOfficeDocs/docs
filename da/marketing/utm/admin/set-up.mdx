...
## 1. Aktivér overførsel af UTM-data {#enable}
...
## 2. Tilføj UTM-sporingsscriptet til dit websted {#script}
...
## 3. Opret kampagnelinks med UTM-parametre {#build-url}
...
## 4. Anvend linket i dine kampagner {#tag}
...
## 5. Udgiv formularen korrekt {#publish}
...
## 6. Test og verificér opsætningen {#test}
...
## 7. Analyser og visualisér resultater {#analyze}
