...
related:
  - /da/marketing/forms/learn/view-statistics
  - /da/marketing/mailing/learn/view-statistics
language: da
---
...
<Frame caption="(Denne video viser en tidligere version af SuperOffice, så designet kan se anderledes ud. Trinnene er de samme.)">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/XtdkUwIXkww"
    title="(Denne video viser en tidligere version af SuperOffice, så designet kan se anderledes ud. Trinnene er de samme.)"
    frameborder="0"
