...
* **Ekstrafelt af typen afkrydsningsfelt:** Et boolesk ekstrafelt (kun ja/nej), der kan indstilles til at være markeret eller umarkeret, når formularen indlæses. Find **Marker som standard** i feltets indstillinger — det er umarkeret som standard. Hvis feltet har [et relateret felt][6] knyttet via en betingelse, behandles standardmarkeringen, som om den besøgende selv havde angivet den, så det relaterede felt vises eller forbliver skjult ved indlæsning.
...
* **Betingede (relaterede) felter:** Valgmulighedsknapper, afkrydsningsfelter, rullelister og bedømmelsesfelter kan [udløse et relateret felt][6], der kun vises, når en bestemt valgmulighed eller værdi er valgt.
