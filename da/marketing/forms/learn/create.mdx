...
related:
  - /da/marketing/forms/learn/publish
language: da
---
...
## Oprette formularer med flere sider {#multi-page}
...
## Udfyldning af formularfelter {#fields}
...
8. Du kan også redigere disse indstillinger (valgfrit):
    ...
    * Hvis felttypen understøtter det, kan du klikke på **Tilføj relateret felt** på en af dets valgmuligheder eller værdier for at tilføje et betinget felt. Se [Tilføj et betinget felt](#conditional) nedenfor.
...
### Tilføj et betinget felt {#conditional}

Vis kun besøgende de spørgsmål, der er relevante for dem. Et **betinget felt** (også kaldet et relateret felt) viser et opfølgende spørgsmål kun, når et tidligere svar gør det relevant, så hver besøgende kun ser det, der betyder noget for dem, mens formularen stadig indsamler de oplysninger, der er nødvendige fra alle andre. Et felt for **Contact - Country** kan for eksempel vise feltet **Contact - Preferred language**, når et bestemt land er valgt.

Dette fungerer på rullelister (herunder standardlistefelter), valgmulighedsknapper, afkrydsningsfelter, bedømmelsesfelter (stjerner, smileys, terninger eller tommelfingre), ekstrafelter af typen rulleliste eller boolsk, og interessefelter. Felttyper, der understøtter dette, har et **Betinget**-badge, når du tilføjer et nyt element, så du ikke behøver at tilføje feltet først for at finde ud af det.

![Felttyper, der understøtter betingede felter, har et Betinget-badge i vinduet Tilføj element -screenshot][img18]

1. Vælg den valgmulighed eller værdi på et felt, der understøtter det, som skal udløse det opfølgende spørgsmål.
1. Klik på **Tilføj relateret felt**.
1. [Tilføj og konfigurer det nye felt](#fields), som du ville gøre med et hvilket som helst andet felt.

Det overordnede felt får nu badget **Har relaterede felter**, og det relaterede felt vises indrykket under det, med et banner med en forklaring i almindeligt sprog (for eksempel "Dette felt vises, når **Contact - Country** er **Schweiz**"). Brug bannerets redigeringsikon til at ændre betingelsen, eller ikonet til at fjerne det relaterede felt. Hvis du vælger flere udløsende værdier, sammenkæder banneret dem med "eller". Bedømmelsesfelter viser et interval i stedet for en enkelt værdi.

![Et felt med et relateret felt og dets betingelsesbanner -screenshot][img19]

Du kan kæde relaterede felter flere niveauer i dybden (et spørgsmål kan udløse et opfølgende spørgsmål, som igen kan udløse et endnu dybere opfølgende spørgsmål), men hvert relateret felt styres af præcis én betingelse på ét felt.

<Note>
Et relateret felt er som standard skjult for den besøgende, vises øjeblikkeligt, når det udløsende svar gives, og forsvinder og ryddes, hvis svaret ændres. Et skjult felt er aldrig påkrævet, selv om det er markeret som obligatorisk, og skjulte svar medtages ikke i indsendelsen.
</Note>
...
#### Tilpasset styling {#custom-style}
