...
title: Indstillinger for Systemskabeloner
...
userflow_index: true
related:
  - Oversigt over svarskabeloner: /da/knowledge-base/learn/reply-templates/index
  - Oversigt over FAQ'er: /da/knowledge-base/learn/faq/index
language: da
---
...
Hvis du vil vælge en anden skabelon, skal du klikke på <i class="ph ph-caret-down" aria-label="Chevron"></i> for listeknappen ved siden af det aktuelle felt og vælge en skabeklon på den liste, der vises.
