...
related:
  - Videresend en sag: /da/request/learn/forward
  - Luk sag: /da/request/learn/close
  - /da/request/learn/flag-message
  - Opret svarskabelon: /da/knowledge-base/learn/reply-templates/index
  - Opret ny sprogversion af svarskabelon: /da/knowledge-base/learn/reply-templates/new-language
  - Rediger e-mail-signatur: /da/learn/getting-started/edit-email-signature
language: da
---
...
## Hurtigsvar fra en forhåndsvisning {#quick-reply}

Besvar en sag direkte fra dens forhåndsvisning uden at åbne den fuldt ud.

1. Forhåndsvis en sag fra en sagsliste.
1. Klik på **Hurtigsvar**.
1. Skriv dit svar i den kompakte editor.
1. Klik på **Gem** for at sende det.

    ![Sagsliste med forhåndsvisning viser hurtigsvar-muligheder -screenshot][img8]

Sagen opdateres, herunder dens status, på samme måde som ved et svar sendt fra den fulde sagsvisning, og listen opdateres automatisk.

<Tip>
Hvis du annullerer eller vælger en anden sag, mens dit hurtigsvar har utilsendt tekst, bliver du spurgt, før det kasseres.
</Tip>

**Hurtigsvar** er ikke tilgængelig på sager markeret som spam, slettet eller flettet.

## Indsæt svarskabeloner {#reply-templ}
...
## Indsæt tidligere meddelelse {#insert-earlier-msg}
