...
<Tip>
Hvis du annullerer eller vælger en anden sag, mens dit svar har utilsendt tekst, bliver du spurgt, før det kasseres.
</Tip>

Denne mulighed er ikke tilgængelig på sager markeret som spam, slettet eller flettet.
