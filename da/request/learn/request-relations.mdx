...
related:
  - Del sag: /da/request/learn/split-request
  - Slå sammen sager: /da/request/learn/merge
  - Detaljekort for Sager: /da/learn/section-tabs/requests-tab
  - Firma- og personrelationer: /da/learn/basics/relations
  - Relationsregler (Indstillinger og vedligeholdelse): /da/request/admin/relation-rules
language: da
---
