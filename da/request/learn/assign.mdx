...
title: Automatiske tildelingsmetoder for sager
...
related:
  - Behandl en sag: /da/request/learn/index
  - /da/request/learn/create
  - Acceptér en sag: /da/request/learn/accept
  - Bed en anden sagsbehandler om hjælp (overførsel): /da/request/learn/transfer
  - /da/request/admin/next-in-queue
  - Tilgængelighedsstatus: /da/request/learn/index#available
language: da
---
