...
related:
  ...
  - Stop gentagne opfølgninger: /da/diary/learn/recurrence/stop
  - Tilføj link til dokument, salg, projekt eller websted: /da/learn/basics/links
language: da
---
...
## Rediger sluttidspunkt for en opfølgning i Dagbogen {#change-end}
...
## Rediger gentagen opfølgning {#repeat}
...
## Slet en opfølgning i Dagbogen {#delete}
