...
userflow_index: true
related:
  - Opdater, slet og gendan statusovervågning: /da/saint/admin/update
  - Tællere og tællerindstillinger (periode): /da/saint/admin/counter-settings
  - Regenerer statusovervågning og tællere: /da/saint/admin/update#regen
language: da
---
