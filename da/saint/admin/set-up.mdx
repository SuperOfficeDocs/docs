...
userflow_index: true
related:
  - title: "Opdater, slet og gendan statusovervågning"
    href: "/da/saint/admin/update"
  - title: "Tællere og tællerindstillinger (periode)"
    href: "/da/saint/admin/counter-settings"
  - title: "Regenerer statusovervågning og tællere"
    href: "/da/saint/admin/update#regen"
language: da
---
...
## Valg af billede til status {#image}
