...
## Tilføj kriterier til en status {#criteria}
...
## Slet en statusovervågning {#delete}
...
## Gendan en slettet statusovervågning {#restore}
...
## Regenerer statusser og tællere \<i class="ph ph-arrow-circle-right" aria-hidden="true"\>\</i\> {#regen}
