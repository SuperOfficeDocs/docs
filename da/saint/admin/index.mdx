...
userflow_index: true
related:
  - Opsæt en ny statusovervågning: /da/saint/admin/set-up
  - Visualiser statusser med billeder: /da/saint/admin/set-up#image
  - /da/saint/admin/counter-settings
  - Opdater, slet og gendan statusovervågninger: /da/saint/admin/update
  - Regenerer statusovervågninger og tællere: /da/saint/admin/update#regen
language: da
---
...
## Hvordan SAINT gemmer tællere og statusser {#database}
...
[5]: /da/saint/admin/counter-settings
[8]: /da/saint/admin/update#regen
