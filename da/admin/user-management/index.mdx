...
userflow_index: true
related:
  - Administration af dine roller: /da/admin/user-management/role/index
  - Tilføj en ny bruger: /da/admin/user-management/add-associate
  - Opret brugergruppe: /da/admin/user-management/user-groups
  - Ændre brugerplaner for aktive brugere: /da/admin/license/user-plans#change
  - Aktivér og opdater licenser: /da/admin/license/activate
  - CRM Suite-planer: /da/admin/license/crm-suite
language: da
---
...
### Vores virksomheder {#our-companies}
...
[6]: /da/admin/user-management/role/index
[7]: /da/admin/user-management/role/functional-rights
[14]: /da/admin/adjusting-views
[15]: /da/admin/preferences/index
