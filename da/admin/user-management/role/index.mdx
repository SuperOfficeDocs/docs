...
userflow_index: true
related:
  - /da/admin/user-management/role/create-role
  - Rediger eller slet en rolle: /da/admin/user-management/role/update-role
  - /da/admin/user-management/role/set-data-rights-for-role
language: da
---
...
Ved hjælp af rollebaseret sikkerhed i SuperOffice CRM kan du brugerdefinere roller til forskellige adgangsniveauer i firmaet. Rollerne styrer de adgangsrettigheder, de forskellige brugere har i SuperOffice CRM.
...
[3]: /da/admin/user-management/role/set-data-rights-for-role
[6]: /da/admin/user-management/role/functional-rights
