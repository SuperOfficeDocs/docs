...
title: Globale præferencer for SuperOffice Service-systemindstillinger
sidebarTitle: "Service-indstillinger"
...
userflow_index: true
related:
  - Service-indstillinger (onsite): https://help.superoffice.com/docs/11/da/admin/preferences/service-settings.html
language: da
---
