...
userflow_index: true
related:
  - /da/admin/license/user-plans
  - Køb og aktivering af licenser: /da/admin/license/activate
  - Tidligere versioner af SuperOffice: https://help.superoffice.com/Documentation/Help/EN/CRM/WebHelpAdmin/index.htm#t=chap03%2FCRM_and_licences.htm
  - Systemhændelser: https://help.superoffice.com/docs/11/da/admin/onsite/add-system-event.html
  - Modullicenser: /en/admin/license/dev/module-licenses
  - Skjulte licenser: /en/admin/license/dev/hidden-licenses
  - Licens - teknisk oversigt: /en/admin/license/dev/index
language: da
---
...
<Tabs>
<Tab title="Modulbaserede abonnementer">
...
[16]: /da/admin/license/crm-suite
[1]: /da/admin/license/activate
[2]: /da/saint/learn/index
