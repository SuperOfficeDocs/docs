...
userflow_index: true
related:
  - Sådan opbygges brugerplaner: /en/admin/license/dev/user-plans
  - Tilføj ny bruger: /da/admin/user-management/add-associate
  - Oversigt over roller: /da/admin/user-management/role/index
language: da
---
...
## Ændring af brugerplaner for aktive brugere {#change}
