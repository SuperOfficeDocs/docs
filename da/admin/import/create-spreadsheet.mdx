...
userflow_index: true
related:
  - Valg af indstillinger for importen: /da/admin/import/settings
  - Importer af kontakter til SuperOffice CRM: /da/admin/import/from-excel
  - Importer af produkter til en prisliste: /da/admin/import/products-from-excel
language: da
---
...
[Download importskabelonen for firmaer og personer][1] [Excel spreadsheet, ZIP]
...
[Download importskabelonen for produkter][2] [Excel spreadsheet, ZIP]
