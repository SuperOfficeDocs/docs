...
userflow_index: true
related:
  - Tilpasning af privacy-lister: /da/security/privacy/admin/add-source
  - Tilpasning af dine salgslister: /da/sale/admin/sale-type
language: da
---

import SaveOrCancel from "./snippets/save-or-cancel.md";
...
<Frame caption="Se denne video for at få mere at vide om, hvordan du kan redigere forekomster i SuperOffice CRM (videoens længde - 2:05)">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/2fIAT0-EjX0"
    title="Se denne video for at få mere at vide om, hvordan du kan redigere forekomster i SuperOffice CRM (videoens længde - 2:05)"
    frameborder="0"
...
<Frame caption="Se denne video for at få at vide, hvordan du tilføjer og redigerer abonnementstyper (videoens længde - 2:00)">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/tBtLjFKnBj4"
    title="Se denne video for at få at vide, hvordan du tilføjer og redigerer abonnementstyper (videoens længde - 2:00)"
    frameborder="0"
    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
    referrerpolicy="strict-origin-when-cross-origin"
    allowfullscreen
...
## Sletning af foruddefinerede og brugerdefinerede forekomster {#delete}
