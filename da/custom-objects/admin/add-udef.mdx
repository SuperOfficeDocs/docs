...
userflow_index: true
related:
  - /da/custom-objects/admin/edit-udef-layout
  - Redigering af feltegenskaber: /da/custom-objects/admin/edit-udef
  - /da/customization/screen-designer/admin/index
language: da
---
...
import UdefDanger from "../../../snippets/udef-screen-designer-warning/da-udef-screen-designer.mdx";
