...
related:
  - /da/custom-objects/admin/create-extra-table
  - /da/custom-objects/admin/create-extra-field
  - Brugerdefinerede felter: /da/custom-objects/admin/add-udef
  - Custom screens: /da/ui/blogic/learn/index
  - Tilføj trigger: /en/automation/trigger/create-trigger-script
language: da
---
...
<Tab title="Ny (fra version 10.3.4 pilot)">
