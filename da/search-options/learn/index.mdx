...
related:
  ...
  - /da/learn/basics/history
  - Opret en søgning, og gem den som et udvalg: /da/search-options/selection/learn/create
  - Udvid din søgning ved hjælp af OR-funktionen: /da/search-options/learn/find-screen
language: da
---
...
## Brug af hurtigsøgning {#fastsearcher}
...
## Brug typiske søgninger som udgangspunkt {#typical}
...
## Opret en søgning, og gem den som et udvalg {#search-to-selection}
...
<Frame caption="Se denne video, eller følg trinnene nedenunder for at lære, hvordan du kan oprette en søgning og gemme den som et dynamisk udvalg">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/b1YsCcHwz-o"
    title="Se denne video, eller følg trinnene nedenunder for at lære, hvordan du kan oprette en søgning og gemme den som et dynamisk udvalg"
    frameborder="0"
...
[2]: /da/search-options/learn/freetext-search
[3]: /da/search-options/learn/in-navigator
[6]: /da/search-options/learn/search-criteria
[8]: /da/search-options/learn/in-dialogs
