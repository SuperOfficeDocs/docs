...
1. <SelectField />
    ...
    . Klik først på **Salg** (<i class="ph ph-currency-circle-dollar" aria-hidden="true"></i>) og derefter på **Beløb**.
...
1. <SelectField />
    ...
    , som vises. Klik først på **Salg** og derefter på **Registreret dato**.
...
1. <SelectField />
    ...
    : Klik først på **Firma** (<i class="ph ph-buildings" aria-hidden="true"></i>) og derefter på **Land**.
...
1. <SelectField />
    ...
    : Klik først på **Firma** og derefter på **Vores kontakt**.
...
1. <SelectField />
    ...
    : Klik først på **Salg** og derefter på **Status**.
...
1. <SelectField />
    ...
    : Klik først på <i class="ph ph-user-circle" aria-hidden="true"></i> **Person** og derefter på **Efternavn**.
...
1. <SelectField />
    ...
    : Klik først på <i class="ph ph-clipboard-text" aria-hidden="true"></i> **Projekt** og derefter på **Fra dato**.
...
1. <SelectField />
    ...
    : Klik først på <i class="ph ph-calendar-blank" aria-hidden="true"></i> **Opfølgning** og derefter på **Hensigt**.
...
1. <SelectField />
    ...
    . Klik først på **Opfølgning** og derefter på **Slutdato**.
...
1. <SelectField />
    ...
    . Klik først på **Opfølgning** og derefter på **Udført**.
