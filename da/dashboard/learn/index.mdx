...
related:
  - Opret et nyt dashboard eller dupliker et eksisterende: /da/dashboard/learn/create
  - Rediger et dashboard: /da/dashboard/learn/update
  - Overfør et dashboard til en medarbejder: /da/dashboard/learn/update#owner
  - Tilføj ruder / rediger layout: /da/dashboard/learn/working-with-tiles
language: da
---
...
### Konfigurer hurtigfiltre (admin/ejer) {#filter}
