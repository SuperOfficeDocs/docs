...
related:
  ...
  - Brug dashboards til at administrere din salgspipeline: /da/dashboard/learn/show-sales-targets
language: da
---
...
### Om udvalg-baserede ruder {#selection-chart}
...
## Duplikér eller kopier en rude {#copy}
...
## Flyt eller ændr størrelsen på ruder {#move}
