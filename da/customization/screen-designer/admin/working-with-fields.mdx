...
userflow_index: true
related:
  - Rediger antallet af kolonner under en fane: /da/customization/screen-designer/admin/working-with-tabs#columns
  - Tilføj etiketter og skilleelementer: /da/customization/screen-designer/admin/working-with-tabs#label
  - Tilføj links og knapper: /da/customization/screen-designer/admin/add-button
language: da
---
