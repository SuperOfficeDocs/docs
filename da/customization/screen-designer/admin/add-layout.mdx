...
userflow_index: true
related:
  - Hvordan konfigurerer jeg, hvilke oplysninger brugerne i vores firma kan få adgang til i SuperOffice CRM?: /da/admin/user-management/role/index
  - Hvordan opretter jeg en ny brugergruppe i SuperOffice CRM?: /da/admin/user-management/user-groups
  - Slet layout: /da/customization/screen-designer/admin/edit-layout#delete
language: da
---
