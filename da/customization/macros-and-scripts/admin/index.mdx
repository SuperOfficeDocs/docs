...
userflow_index: true
related:
  - Opret et script: /da/customization/macros-and-scripts/admin/create-script
  - Oprettelse af makro: /da/customization/macros-and-scripts/admin/create-macro
  - Oprettelse af mappe: /da/customization/macros-and-scripts/admin/create-script#folder
  - Lær CRMScript-sproget: /en/automation/crmscript/overview/index
...
[2]: /da/customization/macros-and-scripts/admin/trigger
[3]: /da/customization/macros-and-scripts/admin/schedule-task
[4]: /en/automation/crmscript/debugging/built-in-debugger
[5]: /en/automation/crmscript/debugging/using-trace
[8]: /da/customization/macros-and-scripts/admin/create-script
