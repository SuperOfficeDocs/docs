...
related:
  ...
  - Fejlfind scripts: /en/automation/crmscript/debugging/built-in-debugger
  - Spor scripts: /en/automation/crmscript/debugging/using-trace
language: da
---
...
## Makro/scriptmappe-egenskaber {#folder}
