...
userflow_index: true
related:
  - Tilføj et opgavemenupunkt: /da/customization/admin/add-items-to-task-menu
  - Basisprogrammer og URL-parametre: /da/ui/blogic/learn/extra-menus/index
language: da
---

import ReqAdmin from "../../../learn/snippets/req-admin.md";
import WebPanelsAndHttps from "../../snippets/web-panels-and-https.md";
...
### Brug af HTTP vs HTTPS URL'er {#https}
