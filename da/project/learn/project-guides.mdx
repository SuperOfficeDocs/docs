...
redirect_from:
  - /da/project/learn/project-guide/index
  - /da/project/learn/project-guide/project-guide-tab
  - /da/project/learn/project-guide/view-followups-and-documents
  - /da/project/learn/screen/project-guide-tab
related:
  - Introduktion til projekter: /da/project/learn/index
  - Opret et projekt: /da/project/learn/create
  - Rediger eller deaktiver en projektguide: /da/project/learn/edit
language: da
---
...
## Detaljekortet Projektguide {#project-guide-tab}
...
## Flyt til næste status {#change-status}
