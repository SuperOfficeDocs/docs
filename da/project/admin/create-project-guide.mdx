...
userflow_index: true
related:
  - /da/project/admin/edit-project-guide
language: da
---
...
## Opret statusser for projektguiden {#create-stage}
...
## Opret en projekttype til projektguiden {#create-type}
...
## Opret en projektguide {#create-guide}
...
## Tilføj en opfølgning for en status {#add-fo-status}
...
## Tilføj et dokument til en status {#add-doc-status}
