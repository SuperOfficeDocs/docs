...
userflow_index: true
related:
  - Sletning af e-mail-konti: /da/email/admin/mailbox/delete-mailbox
  - E-mail i Service og Marketing: /en/online/mail-services/curl/index
  - Opret e-mailkonto (onsite): https://help.superoffice.com/docs/11/da/email/admin/mailbox/create-mailbox.html
language: da
---
