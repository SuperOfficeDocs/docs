...
keywords: ['åbn e-mail', 'vis e-mail', 'forhåndsvisning', 'flyt e-mail', 'marker som læst', 'udskriv', 'download', 'e-mail', 'SuperOffice Indbakke']
...
related:
  - Administrér afsendere: /da/email/inbox/learn/manage-senders
  - Modtag invitationer: /da/email/inbox/learn/invitations
  - /da/email/inbox/learn/create-task
...
## Marker e-mails som læst eller ulæst {#mark-as-read}
...
## Download en e-mail {#download}

Når du downloader en e-mail, gemmes en kopi af meddelelsen, inklusive eventuelle vedhæftede filer, i et format, du kan åbne fra Outlook eller en anden e-mailklient.

1. Vælg en meddelelse i indbakken.
1. Klik på <i class="ph ph-dots-three-circle-vertical" aria-label="Handlingsmenu"></i>, og vælg **Download**.

![Indbakken viser handlingsmenuen med elementet Download -screenshot][img5]
