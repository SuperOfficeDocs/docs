...
related:
  - /da/lead/learn/work-with-leads
  - /da/marketing/utm/learn/index
  - Konfigurer leadhåndtering - i Indstillinger og vedligeholdelse: /da/lead/admin/index
  - Konfigurer firmakategorier - i Indstillinger og vedligeholdelse: /da/lead/admin/add-company-category
  - Administrér leadstatusser - i Indstillinger og vedligeholdelse: /da/lead/admin/add-lead-status
  - Automatiser leadkategorisering - i Indstillinger og vedligeholdelse: /da/lead/admin/category-automation
language: da
---
...
## Kategorier for potentielle kunder {#category}
...
[2]: /da/lead/admin/add-lead-status
