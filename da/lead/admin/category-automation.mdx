...
userflow_index: true
related:
  - Firmakategori og kategorigruppe: /da/lead/admin/add-company-category
  - Oversigt over leadhåndtering: /da/lead/learn/index
  - /da/lead/admin/add-lead-status
  - /da/sale/learn/update
  - /da/sale/learn/sales-guides
language: da
---
...
Automatisering af firmakategoriopdateringer hjælper med at reducere manuelt arbejde og sikrer, at dine data forbliver nøjagtige. Når [status for et salg][6] ændres, eller en [leadstatus][4] opdateres, kan det relaterede firma automatisk opdateres med den korrekte kategori.
...
|---|---|
| Opdater kategorien, når et salg er solgt | Opdaterer automatisk firmakategorien, når et salg er markeret som **Solgt**. |
| Opdater kategorien, når et salg er tabt | Opdaterer automatisk firmakategorien, når et salg er markeret som **Tabt**. |
...
| Opdater kategorien, når en leadstatus indstilles til | Opdaterer automatisk firmakategorien, når en kontakts leadstatus ændres til en bestemt værdi, såsom *Kvalificeret* eller *Diskvalificeret*. Kræver, at leadstatus er aktiveret for kategorien. |
...
1. Vælg fanen **Kategorisering af leads**. Denne skærm viser automatiseringsmulighederne.
...
1. Når du aktiverer en regel, vises yderligere muligheder:
...
* **Fuldt automatisk:** Bedst til enkle lead-til-kunde-workflows, hvor kategoriændringer er forudsigelige og konsistente. For eksempel automatisk flytning af en lead til kategorien *Kunde*, når et salg er markeret som solgt.
...
En almindelig use case er at opdatere et lead automatisk til en kundekategori, når et salg er solgt:

1. Aktiver **Opdater kategorien, når et salg er solgt**.
...
Nu, når et salg knyttet til et firma i gruppen *Potentiel kunde* markeres som solgt, vil firmakategorien automatisk ændres til *Kunde*.
