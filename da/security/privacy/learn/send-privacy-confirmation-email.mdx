...
related:
  - Rediger e-mailen med bekræftelse om personbeskyttelse i Indstillinger og vedligeholdelse: /da/security/privacy/admin/edit-privacy-confirmation-email
language: da
---
...
<Frame caption="Denne video viser dig, hvordan du opretter en grundlæggende webformular og tilføjer den til din webside">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/18m6Dx1t9wI"
    title="Denne video viser dig, hvordan du opretter en grundlæggende webformular og tilføjer den til din webside"
    frameborder="0"
