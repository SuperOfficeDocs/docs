...
userflow_index: true
related:
  - Sådan opsættes et ERP-link: /da/sale/admin/quote/set-up-quote-connector
  - Tilføj prislister og produkter: /da/sale/admin/quote/price-list-and-products
  - Tilpas tilbudsvisningen: /da/sale/admin/quote/configure-product-fields
  - /da/erp/admin/index
language: da
---
...
## Faner i Tilbud/Sync-skærmbilledet {#tabs}
...
[1]: /da/sale/admin/quote/set-up-quote-connector
[2]: /da/sale/admin/quote/price-list-and-products
[3]: /da/sale/admin/quote/configure-product-fields
[4]: /da/erp/admin/index
[5]: /da/sale/admin/sale-type
