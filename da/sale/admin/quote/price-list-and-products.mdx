...
userflow_index: true
related:
  - Konfigurér felter i Tilføj/rediger produkt-dialogboksen: /da/sale/admin/quote/configure-product-fields
  - Importer produkter fra Excel: /da/admin/import/products-from-excel
  - Konfigurer ERP-link: /da/sale/admin/quote/set-up-quote-connector
language: da
---

import ImageTypeAndSize from "../../../learn/snippets/image-type-and-size.md";
...
## Tilføj produkter til en prisliste {#add-product}
...
## Tilføj eller skift produktbillede {#image}
...
## Deaktiver produkter eller prislister {#deactivate}
...
[4]: ../../../learn/section-tabs/configure-columns
[5]: ../../../admin/import/products-from-excel
[7]: ../../../admin/user-management/role/index
[8]: ../../../admin/preferences/index
