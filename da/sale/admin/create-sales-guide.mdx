...
## Opret faser til salgsguiden {#create-stages}
...
## Opret en salgstype til salgsguiden {#create-type}
...
## Opret en salgsguide {#create-guide}
...
## Tilføj en opfølgning til en fase {#add-fo-stage}
...
## Tilføj et dokument til en fase {#add-doc-stage}
