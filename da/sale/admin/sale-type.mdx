...
userflow_index: true
related:
  - Tilføj en salgsfase: /da/sale/admin/sale-stage
  - Opret en salgsguide: /da/sale/admin/create-sales-guide
  - Rediger en salgsguide: /da/sale/admin/edit-sales-guide
...
## Tilbudsfelter forklaret {#quote-fields}
...
<Tabs>
<Tab title="Fanen Tilbudsvedhæftninger">
...
<Tab title="Fanen Tilbudsstandarder">
...
<Tab title="Fanen Tilbudsgodkendelse">
...
## Gendan en slettet salgstype {#restore}
