...
related:
  ...
  - Udskift tilbudsdokument: /da/sale/learn/quote/create-quote-document#replace
  - Opret ordre: /da/sale/learn/quote/place-order
  - Konfigurer regler for tilbudsgodkendelse i Indstillinger og vedligeholdelse: /da/sale/admin/sale-type#quote-fields
language: da
---
...
## Redigere et sendt tilbud {#versions}
