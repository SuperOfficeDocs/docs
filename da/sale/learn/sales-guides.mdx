...
related:
  - Introduktion til salg: /da/sale/learn/index
  - Opret et salg: /da/sale/learn/create
  - Salgsguide-tutorial: /da/sale/learn/tutorial
  - /da/sale/admin/create-sales-guide
  - /da/sale/admin/edit-sales-guide
language: da
---
...
<Frame caption="Se denne video for at lære, hvor nemt det er at bruge salgsguiden">
  <iframe
    width="100%"
    height="420"
    src="https://www.youtube-nocookie.com/embed/IyETjAtn3po"
    title="Se denne video for at lære, hvor nemt det er at bruge salgsguiden"
    frameborder="0"
...
## Detaljekortet Salgsguide {#sales-guide-tab}
...
## Skift til næste fase {#change-stage}
