...
title: Sådan ændrer du en præference
...
## Dialogboksen Præferencer - indstillinger {#options}
...
| <i class="ph ph-at" aria-label="Email icon"></i> | E-mail | Indstillingerne for e-mail og fax, f.eks. den e-mail-klient, du har installeret, og om nye e-mails skal åbnes i dit lokale e-mailprogram. |
