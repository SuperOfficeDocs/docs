...
Når du er tilsluttet, kan du også vælge, om nye e-mails du opretter, og e-mailadresser du klikker på, skal åbnes i dit eget lokale e-mailprogram i stedet for SuperOffices egen dialog. Aktivér dette under [Personlige indstillinger > Præferencer > E-mail][2].
