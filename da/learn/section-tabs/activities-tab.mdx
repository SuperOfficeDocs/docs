...
keywords: ['Aktivitets-fanen', 'Aktivitetsfanen', 'Fanen Aktiviteter', 'detaljekortet Aktiviteter', 'detaljekort', 'aktivitetsarkiv', 'download']
author: digitaldiina
date: 18.09.2026
so_version: 12.2
content_type: howto
...
redirect_from:
  - /da/company/learn/screen/activities-tab
  - /da/contact/learn/screen/activities-tab
  - /da/diary/learn/screen/activities-tab
  - /da/project/learn/screen/activities-project
  - /da/sale/learn/screen/activities-sale
related:
  - Introduktion til aktiviteter: /da/learn/basics/activity
  - Opret opfølgninger: /da/diary/learn/create-follow-up
  - Besvar eller videresend e-mail fra detaljekortet Aktiviteter (Aktivitetsfanen): /da/learn/section-tabs/send-email
  - Ændre Udført-status for en aktivitet: /da/diary/learn/change-completed-status
  - Slet aktiviteter i aktivitetslisten: /da/learn/basics/activity
  - Filtrer aktiviteter: /da/learn/section-tabs/filter
  - Gruppér kolonner og opsummér: /da/learn/section-tabs/configure-columns#calculate
language: da
---
...
## Kolonneoversigt i Aktivitetsfanen {#columns}
...
* **Download en e-mail eller et dokument:** Find elementet, højreklik, og vælg **Download** for at gemme en kopi på din enhed. Ikke tilgængelig, når flere elementer er valgt.

    ![Kontekstmenu i detaljekortet Aktiviteter for Person -screenshot][img3]
...
[img3]: ../../../media/loc/en/contact/contact-activites-email-context-menu-download.png
