...
related:
  ...
  - Ændr status til Udført for en aktivitet: /da/diary/learn/change-completed-status
  - Tilføj opfølgning (møde, opgave, samtale): /da/diary/learn/create-follow-up
  - /da/contact/learn/dial
  - Arbejd med dokumenter: /da/document/learn/index
  - Skriv en e-mail: /da/email/inbox/learn/compose
