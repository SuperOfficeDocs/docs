...
title: Opdater flere poster (masseopdatering)
...
related:
  - Hvordan udfylder jeg felterne "Retsgrundlag", "Samtykkekilde" og "Formål" til mange personer i SuperOffice CRM på samme tid?: /en/security/privacy/learn/edit-legal-base#bulk
...
## Søg og erstat {#search-and-replace}
