...
redirect_from: /da/ai/configuration-ai/getting-started
userflow_index: true
related:
  - Sådan opretter du et udvalg: /da/search-options/selection/learn/create
  - Sagkategorisering: /da/ai/learn/categorization
