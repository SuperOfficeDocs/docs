...
keywords: ['opret firma', 'tilføj interesse', 'fanen Interesser', 'firma', 'Company Insight']
...
related:
  - Tilføj firma som foretrukken: /da/learn/basics/fav
  - Præferencer-dialog - standardfeltværdier og listeværdier: /da/learn/getting-started/preferences
language: da
---
...
Når du indtaster et navn i feltet **Firmanavn**, viser **Company Insight** matchende firmaer fra officielle virksomhedsregistre, såsom Brreg (Norge), Virk (Danmark), Companies House (Storbritannien) og Zefix (Schweiz), som standard tjekket mod dit eget lands register.

Vælg et match for at se en forhåndsvisning af oplysningerne, såsom adresse, telefonnummer og websted. Klik på **Gem** for at tilføje firmaet med disse oplysninger, eller **Annuller** for at fortsætte med at indtaste oplysningerne manuelt.

Dette hjælper med at undgå manuel copy-paste og reducerer risikoen for at registrere det forkerte firma eller oprette en dublet.

<Note>
Company Insight kræver CRM Suite Growth eller højere.
</Note>

![Valg af et firma foreslået af Company Insight -screenshot][img3]

## Tilføj interesser {#interests-tab}
