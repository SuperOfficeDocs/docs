...
|---|---|---|---|---|
| `SuperOfficeDocs/docs` | `main` | **"Base" / production, live** | 2026-08-06 | Added via Mintlify dashboard Git settings (required an org-owner-approved GitHub App repository-access grant - see Authority below), then promoted to "Base" the same day. First deploy triggered manually; live at `docs.superoffice.com`. |
