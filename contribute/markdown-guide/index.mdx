...
* The import path is the relative path to the file.
...
* Place images used by includes in the */media/includes* folder.
...
* You can use reference-style links within the file, but the import path itself must be a literal relative path.
