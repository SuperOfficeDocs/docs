...
* */snippets/merge-field* and */snippets/variable* — merge-field reference tables, imported identically by all 6 languages. This is the repository-root pattern working as intended.
