...
* Download links, for example, `<a href="/downloads/mirroredtables.zip" download>Mirrored Tables document</a>`. Office-format files (`.xlsx`/`.docx`/`.pptx`) must always be zipped before linking — see [Automated tests][14] for why.
