...
<Note>
Add explicit anchors only when the heading is long, hard to write/remember, or expected to change. By default, rely on the bookmark links Mintlify generates automatically from the heading text.
</Note>

## Link to download a file

1. Place the file to be downloaded to the *downloads* folder.
2. Format the link like this:

    ```markdown
    <a href="RELATIVEPATH/downloads/FILE" download>LINKTEXT</a>
    ```
