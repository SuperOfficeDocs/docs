...
keywords: ['git workflows', 'clone', 'pull', 'branch', 'commit', 'push', 'pull request', 'git bash', 'vs code']
author: digitaldiina
date: 07.22.2026
content_type: howto
related:
  ...
  - title: "Git commands"
    href: "/contribute/git-cheat-sheet"
language: en
---

import StepsCreatePr from "./snippets/steps-create-pr.md";
...
1. Click to expand the green **Code** button.
...
<Tabs>
<Tab title="Git Bash command line">

1. Go to the folder you want to create the copy.

1. Run `git clone [INSERT REPO URL]`:
...
1. Expand **SOURCE CONTROL** and click the three dots to show more actions.
1. Select **Clone**.
1. Paste the repo URL you copied above.
...
## Go to a branch to do work {#branch}
...
1. Go to GitHub.
1. Move the issue from **To do** to **In progress** to let your peers know what you are working on.
...
1. Click the source control icon.
1. Expand **SOURCE CONTROL** and click the three dots to show more actions.
1. Point to **Branch** and then select **Create branch**.
...
1. Save the changes to your local Git repo (the clone). In Git terms, this is to **stage** and **commit**.
...
1. Publish the changes to GitHub (sync to cloud). In Git terms, **push**.
...
### Save the changes to your local Git repo {#commit}
...
1. Click the source control icon.
1. Expand **SOURCE CONTROL** and click the three dots to show more actions.
1. Point to **Changes** and then select **Stage All Changes**.

    ![VS Code stage all changes -screenshot][img8]

1. Click the three dots again, point to **Commit**, and then select **Commit Staged**.
...
1. Click the source control icon.
1. Expand **SOURCE CONTROL**. Then expand **Changes**.
1. Click the **+ sign** on the heading to stage all changes. Click the + sign on individual files to stage just those.
1. Click the **checkmark** on the Source control heading to commit.
1. Enter a commit message.
...
1. Click the source control icon.
1. Expand **COMMITS**.
1. Click the upward-arrow icon on the heading.
...
1. [Stage and commit your changes](#commit).

    If this is inconvenient, use **Stash**.

1. Switch to the main branch and pull.

1. [Start a new issue](#branch) or switch to an existing branch (and pull).
...
1. Switch to the next branch and pull:
...
1. Click the source control icon.
1. Expand **BRANCHES**
1. Click the curved arrow icon.

    ![VS Code switch branch -screenshot][img12]

1. Select a branch to switch to.
1. Pull.
...
[4]: ./branch-strategy
[5]: ./git-cheat-sheet#saving-changes-to-your-repository

[img1]: /media/loc/en/contribute/github-clone.png
[img2]: /media/loc/en/contribute/vscode-clone.png
[img3]: /media/loc/en/contribute/gitbash-pull.png
[img4]: /media/loc/en/contribute/vscode-source-control-menu.png
[img5]: /media/loc/en/contribute/vscode-branch-menu.png
[img6]: /media/loc/en/contribute/vscode-create-branch.png
[img7]: /media/loc/en/contribute/vscode-branches.png
[img8]: /media/loc/en/contribute/vscode-stage-all-changes.png
[img9]: /media/loc/en/contribute/vscode-commit-menu.png
[img12]: /media/loc/en/contribute/vscode-switch-branch.png
[img13]: /media/loc/en/contribute/vscode-push-commit.png
[img14]: /media/loc/en/contribute/vscode-confirm-commit.png
[img15]: /media/loc/en/contribute/vscode-sync-changes.png
[img16]: /media/loc/en/contribute/vscode-push.png
