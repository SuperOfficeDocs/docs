...
### Moved-page sources also need a `.html` duplicate {#html-suffix-duplicates}
...
That means a moved, renamed, or deleted page needs **two** entries pointing at the same destination - the bare source, and a second entry with `.html` appended:
