...
<Note>
For retention windows and lifecycle decisions (when to keep 1:1 redirects, when to collapse to wildcard redirects, and when to retire content pages), see [Content and redirect retention policy][4].
</Note>
