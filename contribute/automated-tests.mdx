...
keywords: ['ci', 'automated tests', 'markdownlint', 'vale', 'broken links', 'mint validate', 'automations', 'crmscript', 'stale pages', 'generated pages', 'landing page', 'template guard']
author: digitaldiina
date: 08.14.2026
...
[10]: https://github.com/SuperOfficeDocs/docs/issues/257
