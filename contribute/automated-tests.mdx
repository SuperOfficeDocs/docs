...
| Generated-reference auto-fix | GitHub Action (`.github/workflows/generated-reference-autofix.yml`) | No - auto-fixes and pushes a commit | This repo, `tools/ci/add-mdo-provider-sidebar-titles.py` + `apply-wide-mode.py` + `apply-code-wrap.py` + `fix-webapi-bare-relative-links.py` + `fix-docfx-see-cref.py` + `fix-docfx-xref.py` |
