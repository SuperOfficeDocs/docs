...
| Reserved `version` frontmatter guard | GitHub Action (`.github/workflows/version-frontmatter-guard.yml`) | No - advisory (warns only) | This repo, `tools/check-reserved-version-property.py` |
