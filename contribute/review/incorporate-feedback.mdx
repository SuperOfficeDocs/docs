...
keywords: ['review', 'feedback', 'PR', 'commit suggestion']
author: digitaldiina
date: 07.22.2026
content_type: howto
related:
  ...
  - title: "Reviewing a PR"
    href: "/contribute/review/check-changes"
language: en
---
...
1. Scroll to a review and click **View changes**.
...
[2]: ../overview#editing-in-github

[img1]: /media/loc/en/contribute/conversation-view-changes.png
[img2]: /media/loc/en/contribute/commit-suggestion.png
[img3]: /media/loc/en/contribute/checkout-pr.png
[img4]: /media/loc/en/contribute/create-patch.png
[img5]: /media/loc/en/contribute/copy-branch-name.png
[img6]: /media/loc/en/contribute/edit-file-in-pr.png
[img7]: /media/loc/en/contribute/edit-in-patch.png
[img8]: /media/loc/en/contribute/commit-to-patch.png
[img9]: /media/loc/en/contribute/copy-path.png
[img10]: /media/loc/en/contribute/select-branch.png
