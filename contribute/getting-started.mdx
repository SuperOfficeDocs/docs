...
If you use an AI coding assistant such as Cursor or Claude Code to help draft or review content, install the SuperOffice CRM skill so your assistant understands the product you're documenting.
