...
1. Commit your saved changes to your local repository. End the message with the issue ID in parentheses: see [branch strategy][1] for why.

    ```sh
    git commit -m "Short description of changes (#[ISSUE ID])"
    ```

1. Send your changes to GitHub.
